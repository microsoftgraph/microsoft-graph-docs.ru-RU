...
API Microsoft Graph поддерживает доступ к данным в _основных_ и [общих почтовых ящиках](https://support.office.com/article/open-and-use-a-shared-mailbox-in-outlook-d94a8e9e-21f1-4240-808b-de9c9c088afd) пользователей. Данные могут быть календарем, почтой или личными контактами, хранящимися в почтовом ящике в облаке в Exchange Online в составе Microsoft 365, или на локальном сервере Exchange в [гибридном развертывании](/graph/hybrid-rest-support).

...
1. Замените функцию **getUserData** приведенным ниже кодом. Он настраивает и отправляет запрос GET в конечную точку */me*, а затем обрабатывает ответ.
...
1. Замените функцию **postSendMail** приведенным ниже кодом. Этот код настраивает и отправляет запрос POST в конечную точку */me/sendMail*, а затем обрабатывает ответ.

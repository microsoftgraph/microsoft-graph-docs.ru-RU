<span data-ttu-id="04def-p102">Готовые примеры Connect вы найдете в репозитории [Microsoft Graph ](https://github.com/microsoftgraph) на сайте GitHub. Ниже представлены примеры для разных поставщиков проверки подлинности и платформ, а также указано, что они используют для подключения к Microsoft Graph: REST или клиентскую библиотеку Microsoft Graph.</span><span class="sxs-lookup"><span data-stu-id="04def-p102">To explore the finished Connect samples, see [Microsoft Graph](https://github.com/microsoftgraph) in GitHub. The following table lists the samples by authentication provider and platform, and notes whether they connect to Microsoft Graph using REST or a Microsoft Graph client library.</span></span>
...
<table>
  <tr>
    <th><span data-ttu-id="04def-109">Платформа</span><span class="sxs-lookup"><span data-stu-id="04def-109">Platform</span></span></th>
    <th><span data-ttu-id="04def-110">Конечная точка Azure AD</span><span class="sxs-lookup"><span data-stu-id="04def-110">Azure AD endpoint</span></span></th> 
    <th><span data-ttu-id="04def-111">Конечная точка Azure AD версии 2.0</span><span class="sxs-lookup"><span data-stu-id="04def-111">Azure AD v2.0 endpoint</span></span></th>
  </tr>
  <tr>
    <td><span data-ttu-id="04def-112">Android</span><span class="sxs-lookup"><span data-stu-id="04def-112">Android</span></span></td>
    <td><span data-ttu-id="04def-113">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-114">
  ...
  <tr>
    <td><span data-ttu-id="04def-115">AngularJS</span><span class="sxs-lookup"><span data-stu-id="04def-115">AngularJS</span></span></td>
    <td><span data-ttu-id="04def-116">
        <a href="https://github.com/microsoftgraph/angular-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="04def-116">
        <a href="https://github.com/microsoftgraph/angular-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td> 
        <td><span data-ttu-id="04def-117">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-117">
  ...
  <tr>
    <td><span data-ttu-id="04def-118">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="04def-118">ASP.NET</span></span></td>
    <td><span data-ttu-id="04def-119">
        <a href="https://github.com/microsoftgraph/aspnet-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="04def-119">
        <a href="https://github.com/microsoftgraph/aspnet-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td>     
    <td><span data-ttu-id="04def-120">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-120">
  ...
  <tr>
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-129">    
  ...
  <tr>
    <td><span data-ttu-id="04def-130">PHP</span><span class="sxs-lookup"><span data-stu-id="04def-130">PHP</span></span></td>
    <td><span data-ttu-id="04def-131">
        <a href="https://github.com/microsoftgraph/php-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="04def-131">
        <a href="https://github.com/microsoftgraph/php-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td>     
    <td><span data-ttu-id="04def-132">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-132">
  ...
  <tr>
    <td><span data-ttu-id="04def-133">Python</span><span class="sxs-lookup"><span data-stu-id="04def-133">Python</span></span></td>
    <td><span data-ttu-id="04def-134">
        <a href="https://github.com/microsoftgraph/python3-connect-rest-sample">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="04def-134">
  ...
  <tr>
    ...
    </span><span class="sxs-lookup"><span data-stu-id="04def-140">
  ...
  <tr>
    <td><span data-ttu-id="04def-141">Xamarin</span><span class="sxs-lookup"><span data-stu-id="04def-141">Xamarin</span></span></td>
    <td>
    </td>     
    <td><span data-ttu-id="04def-142">
        <a href="https://github.com/microsoftgraph/xamarin-csharp-connect-sample">Пример с использованием пакета SDK</a>
    </span><span class="sxs-lookup"><span data-stu-id="04def-142">
        <a href="https://github.com/microsoftgraph/xamarin-csharp-connect-sample">SDK sample</a>
    </span></span></td> 
  </tr>
</table>

## <span data-ttu-id="04def-143">См. также</span><span class="sxs-lookup"><span data-stu-id="04def-143">See also</span></span>
<a id="see-also" class="xliff"></a>
- <span data-ttu-id="04def-144">Попробуйте примеры вызовов REST в нашем [обозревателе API](https://graph.microsoft.io/graph-explorer).</span><span class="sxs-lookup"><span data-stu-id="04def-144">Try out sample REST calls in our [API Explorer](https://graph.microsoft.io/graph-explorer).</span></span>
- [<span data-ttu-id="04def-145">Документация по конечной точке Azure AD</span><span class="sxs-lookup"><span data-stu-id="04def-145">Azure AD endpoint documentation</span></span>](https://azure.microsoft.com/en-us/documentation/services/active-directory/)
- [<span data-ttu-id="04def-146">Документация по конечной точке Azure AD версии 2.0</span><span class="sxs-lookup"><span data-stu-id="04def-146">Azure AD v2.0 endpoint documentation</span></span>](https://azure.microsoft.com/en-us/documentation/articles/?service=active-directory&term=azure+ad+v2.0)

...
<table style="width:100%">
  ...
  <tr>
    ...
    <td style="vertical-align: text-top;"><p>Веб-приложения</p><p>Веб-API</p><p>Мобильные и собственные приложения</p><p>Одностраничное приложение (SPA)</p><p>Автономные веб-API</p><p>Управляющие программы и серверные приложения</p><p>Приложения поставщиков облачных решений</p><p><a href="https://azure.microsoft.com/en-us/documentation/articles/active-directory-authentication-scenarios/" target="_newtab">дополнительные сведения</a></p></td> 

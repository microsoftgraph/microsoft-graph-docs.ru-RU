...
Вход в браузерах Internet Explorer и Microsoft Edge не работал. Эта проблема устранена 2 февраля 2017 г.
...
В настоящее время существует проблема, из-за которой нельзя установить свойство **allowExternalSenders** группы в операции POST или PATCH как в `/v1.0`, так и в `/beta`.

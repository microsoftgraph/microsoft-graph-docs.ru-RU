...
Более сложные сценарии, предусматривающие использование нескольких разрешений, представлены в разделе [Сценарии с использованием разрешений](#permission-scenarios).
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора |
|:-----------------------------|:-----------------------------------------|:-----------------|:-----------------|
| _Sites.Read.All_ |    Считывание элементов во всех семействах веб-сайтов (предварительная версия) | Позволяет приложению считывать документы и элементы списка во всех семействах веб-сайтов, когда пользователь не вошел. | Да |
| _Sites.ReadWrite.All_ |    Считывание и запись элементов во всех семействах веб-сайтов (предварительная версия) | Позволяет приложению создавать, считывать, обновлять и удалять документы и элементы списка во всех семействах веб-сайтов, когда пользователь не вошел. | Да |

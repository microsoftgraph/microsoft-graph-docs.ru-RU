...
> |||UNTRANSLATED_CONTENT_START|||**Note**:|||UNTRANSLATED_CONTENT_END|||
...
| Разрешение | Отображаемая строка | Описание | Необходимость в согласии администратора |
| :--------- | :------------- | :---------- | :--------------------- |
| _Files.Read.All_ | Чтение файлов во всех семействах веб-сайтов | Позволяет приложению читать все файлы во всех семействах веб-сайтов, когда пользователь не выполнил вход.  | Да |
| _Files.ReadWrite.All_ | Чтение и запись файлов во всех семействах веб-сайтов | Позволяет приложению читать, создавать, обновлять и удалять все файлы во всех семействах веб-сайтов, когда пользователь не выполнил вход. | Да |

### <a name="remarks"></a>Заметки

> **Примечание**. В личных учетных записях Files.Read и Files.ReadWrite также предоставляют доступ к файлам, используемым совместно с авторизовавшимся пользователем. 
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора |
|:-----------------------------|:-----------------------------------------|:-----------------|:-----------------|
| _Group.Read.All_ | Чтение всех групп | Позволяет приложению считывать сведения о членстве во всех группах, когда вход пользователя не предусмотрен. > **Примечание.**  Не все групповые API поддерживают доступ с помощью разрешений только для приложений. Примеры см. в разделе [Известные проблемы](../concepts/known_issues.md). | Да |
| _Group.ReadWrite.All_ | Чтение и запись всех групп | Позволяет приложению создавать группы, считывать и обновлять информацию о членстве в группах, а также удалять группы. Все эти операции могут выполняться приложением без авторизации пользователя. > **Примечание.** Не все групповые API поддерживают доступ с помощью разрешений только для приложений. Примеры см. в разделе [Известные проблемы](../concepts/known_issues.md).| Да |
...
* _Group.ReadWrite.All_: обновление информации о членах группы (`POST /groups/{id}/members/$ref`). 
> **Примечание.** При этом также необходимо разрешение _User.ReadBasic.All_ для считывания информации о пользователе, добавляемом в группу.
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _адрес электронной почты_ |    Просмотр электронных адресов пользователей | Позволяет приложению считывать основные электронные адреса пользователей. | Нет | Нет |
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Sites.Read.All_        | Чтение элементов во всех семействах веб-сайтов | Позволяет приложению считывать документы и элементы списков во всех семействах веб-сайтов от имени вошедшего пользователя. | Нет  | Нет |
| _Sites.ReadWrite.All_   | Чтение и запись элементов во всех семействах веб-сайтов | Позволяет приложению редактировать и удалять документы и элементы списков во всех семействах веб-сайтов от имени вошедшего пользователя. | Нет  | Нет |
| _Sites.Manage.All_      | Создание, редактирование и удаление элементов и списков во всех семействах веб-сайтов | Позволяет приложению создавать списки, документы и элементы списков, а также управлять ими во всех семействах веб-сайтов от имени вошедшего пользователя. | Нет | Нет |
| _Sites.FullControl.All_ | Полный доступ ко всем семействам веб-сайтов | Разрешает приложению получить полный доступ к сайтам SharePoint во всех семействах веб-сайтов от имени вошедшего пользователя.  | Да  | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора |
|:----------------|:------------------|:-------------|:-----------------------|
| _Sites.Read.All_        | Чтение элементов во всех семействах веб-сайтов | Разрешает приложению считывать документы и элементы списков во всех семействах веб-сайтов, когда пользователь не выполнил вход. | Да |
| _Sites.ReadWrite.All_   | Чтение и запись элементов во всех семействах веб-сайтов | Разрешает приложению создавать, считывать, обновлять и удалять документы и элементы списков во всех семействах веб-сайтов, когда пользователь не выполнил вход. | Да |
| _Sites.Manage.All_      | Полный доступ ко всем семействам веб-сайтов | Разрешает приложению создавать списки, документы и элементы списков, а также управлять ими во всех семействах веб-сайтов, когда пользователь не выполнил вход.  | Да  |
| _Sites.FullControl.All_ | Создание, редактирование и удаление элементов и списков во всех семействах веб-сайтов | Разрешает приложению получить полный доступ к сайтам SharePoint во всех семействах, когда пользователь не выполнил вход.  | Да  |
...
|Разрешение    |Отображаемая строка   |Описание |Необходимость в согласии администратора |
|:-----------------------------|:-----------------------------------------|:-----------------|:-----------------|
| _Notifications.ReadWrite.CreatedByApp_ | Предоставление и управление уведомлениями для данного приложения. | Позволяет приложению отправлять уведомления от имени авторизованных пользователей. Также позволяет приложению считывать, обновлять и удалять элементы уведомления пользователя для данного приложения. |Нет |
### <a name="remarks"></a>Замечания
*Notifications.ReadWrite.CreatedByApp* действует и для учетных записей Майкрософт, и для рабочих или учебных рабочих записей. Ограничение *CreatedByApp*, связанное с этим разрешением, означает, что служба применяет неявную фильтрацию результатов на основе удостоверения вызывающего приложения: либо идентификатора приложения учетной записи Майкрософт, либо набора идентификаторов, настроенных для идентификации кроссплатформенных приложений. 
### <a name="example-usage"></a>Примеры использования
#### <a name="delegated"></a>Делегированные разрешения
* _Notifications.ReadWrite.CreatedByApp_. Публикует пользовательское уведомление, которое далее отправляется на несколько клиентов пользовательского приложения, работающих на разных устройствах. (POST /me/notifications/).

...
> **Примечание.** Не указывайте поставщика на уровне клиента "Microsoft.SecurityGraph" (API Security Graph) в качестве поставщика ресурсов в своей подписке Azure. Настройка на уровне клиента рассматривается в п. 6 ниже. 

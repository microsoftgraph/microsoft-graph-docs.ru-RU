...
description: Узнайте о поддерживаемых наборах данных, регионах Microsoft 365 и типах хранилищ приемников, которые можно использовать с подключением к данным Microsoft Graph.
author: fercobo-msft
...
Подключение к данным Microsoft Graph поддерживает извлечение данных из множества регионов Microsoft 365. Чтобы успешно перемещать данные из центра обработки данных Microsoft 365 в хранилище Microsoft Azure, экземпляр фабрики данных Azure и место хранения Azure должны быть сопоставлены с поддерживаемым регионом для расположения данных Microsoft 365. 

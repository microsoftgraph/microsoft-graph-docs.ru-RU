...
В Azure AD только администратор клиента может войти для выполнения запроса. Администратору будет предложено утвердить все разрешения приложения, запрошенные вами на портале регистрации приложений. Ниже представлен пример диалогового окна согласия, которое Azure AD представляет администратору:

...
| область         | обязательно    | Разделенный пробелами список разрешений Microsoft Graph, на предоставление которых должен согласиться пользователь. Область `offline_access` указывает, что вашему приложению требуется маркер обновления для длительного доступа к ресурсам. Вы также можете включить области OpenID.                                                                                                                                                                                                                                                                                                                                                                  |

---
title: Определение участников больших представлений коллекции в списке при использовании API microsoft Graph для облачных коммуникаций
description: Узнайте, как определить участников больших представлений коллекции в списке.
author: navali-msft
...
ms.locfileid: "65017020"
---
# <a name="identify-large-gallery-view-participants-in-a-roster-when-using-the-microsoft-graph-cloud-communications-api"></a>Определение участников больших представлений коллекции в списке при использовании API microsoft Graph для облачных коммуникаций

API облачных коммуникаций предоставляет конечную точку для добавления представления большой [коллекции](/graph/api/call-addlargegalleryview) в вызов. После успешного добавления представления большой коллекции в вызов можно подписаться на видеопоток участника.
...
## <a name="identifying-large-gallery-view-participants"></a>Определение участников представления большой коллекции

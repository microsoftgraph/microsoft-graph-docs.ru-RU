...
- ** Вы можете [искать информацию о доступности для пользователей и ресурсов](outlook-get-free-busy-schedule.md) для определенного периода времени. Затем эти данные можно использовать, чтобы применить к различным сценариям, включая планирование ресурсов и планирование событий.

...
Используйте [API мест](/graph/api/resources/place?view=graph-rest-beta) (предварительная версия), чтобы предоставлять пользователям маршрут до места или интеллектуальное решение на основе расположения пользователя. Ниже рассмотрены примеры некоторых сценариев.

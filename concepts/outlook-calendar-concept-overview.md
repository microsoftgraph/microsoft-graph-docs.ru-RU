...
Календарь Outlook является частью центра обмена сообщениями Outlook в Microsoft 365, который также позволяет управлять электронными сообщениями и контактами, находить информацию о пользователях в Организации, инициировать Интерактивные беседы, обмениваться файлами и совместно работать в группах.

...
description: С помощью REST API для Excel в Microsoft Graph вы можете получить больше пользы от ваших данных Excel, вычислений, отчетов и информационных панелей.
ms.localizationpriority: high
author: lumine2008
ms.prod: excel
ms.custom: scenarios:getting-started
ms.openlocfilehash: 43c0ffe881b491efbe9cfeb53c99859a707da3a3
...
> [!NOTE]
> REST API для Excel поддерживает только книги в формате Office Open XML (файлы с расширением `.xlsx`). Книги с расширением `.xls` не поддерживаются.

### <a name="use-the-excel-rest-api"></a>Использование REST API для Excel
...
- [API Excel в Microsoft Graph 1.0](/graph/api/resources/excel?view=graph-rest-1.0&preserve-view=true)
- [API Excel в Microsoft Graph (бета-версия)](/graph/api/resources/excel?view=graph-rest-beta&preserve-view=true)

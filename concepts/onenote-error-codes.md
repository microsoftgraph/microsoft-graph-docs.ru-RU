...
Дополнительные сведения см. в [Graph руководстве](./throttling.md#service-specific-limits)по регулированием, определенными для служб.
...
| Причина | Решение |
|:------|:------|
| Личный сайт пользователя не подготовлен к работе. | Пользователь должен открыть OneDrive для бизнеса и следовать указаниям по подготовке сайта к работе. Если это не удается, они должны связаться с Microsoft 365 администратором клиента. |
| В данный момент личный сайт пользователя подготавливается к работе. | Попробуйте отправить запрос позже. |
| У пользователя нет действительной лицензии на OneDrive для бизнеса. | Пользователь должен связаться с администратором Microsoft 365 клиента. |

...
Дополнительные сведения см. в руководстве по регулированию для конкретной службы [Microsoft Graph](./throttling.md#service-specific-limits).

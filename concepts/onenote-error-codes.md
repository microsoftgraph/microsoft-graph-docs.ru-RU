...
| Причина | Решение |
|:------|:------|
| Личный сайт пользователя не подготовлен к работе. | Пользователь должен открыть OneDrive для бизнеса и следовать указаниям по подготовке сайта к работе. В противном случае им следует обратиться к администратору клиента Microsoft 365. |

...
- Из [подсказок почты](../api-reference/v1.0/resources/mailtips.md), отображаемых при составлении сообщения, можно узнать о состоянии получателя (например, получатель отправляет автоматический ответ или его почтовый ящик переполнен). Подсказки почты могут предупреждать приложения об определенных условиях, благодаря чему приложения могут предпринимать более эффективные последующие действия. 

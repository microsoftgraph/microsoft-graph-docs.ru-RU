...
| [Задача](/graph/api/resources/todotask?view=graph-rest-beta) | Только предварительная версия | Только предварительная версия |
| [Список задач](/graph/api/resources/todotasklist?view=graph-rest-beta) | Только предварительная версия | Только предварительная версия |

...
| [event](/graph/api/resources/event?view=graph-rest-1.0) для календаря | Общедоступная версия | Общедоступная версия |
| [device](/graph/api/resources/device?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [group](/graph/api/resources/group?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [event для календаря группы](/graph/api/resources/event?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [post цепочки беседы группы](/graph/api/resources/post?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [message](/graph/api/resources/message?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [organization](/graph/api/resources/organization?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |
| [contact](/graph/api/resources/contact?view=graph-rest-1.0) (личный контакт)| Общедоступная версия | Общедоступная версия |
| [user](/graph/api/resources/user?view=graph-rest-1.0) | Общедоступная версия | Общедоступная версия |

...
|[Задача](./components/tasks.md)|Показывает и разрешает добавлять, удалять, завершать или изменять задачи из планировщика (Майкрософт) или задачи Майкрософт.|
...
- Приступите к [работе](get-started.md) с набором инструментов Microsoft Graph.

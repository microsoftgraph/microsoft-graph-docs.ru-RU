...
|[MSAL2](./providers/msal2.md)| Использует msal-браузер для регистрации пользователей и приобретения маркеров для использования в Microsoft Graph.|
...
|[Teams](./providers/teams.md)|Использует msal.js для регистрации пользователей и приобретения маркеров на клиенте в Microsoft Teams вкладок.|
|[Teams MSAL2](./providers/teams-msal2.md)|Использует msal-browser для регистрации пользователей и приобретения маркеров в Microsoft Teams вкладками. Поддерживает единую Sign-On с настраиваемой поддержкой. |

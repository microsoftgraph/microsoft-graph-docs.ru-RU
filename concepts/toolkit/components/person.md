...
| Атрибут    |  Свойство     | Описание                                                                     |
| ------------ | ------------- | ------------------------------------------------------------------------------- |
| Person — карточка | персонкардинтерактион | Перечисление для определения действия пользователя, необходимого для активации `hover` всплывающей `click`панели. Значение по умолчанию:`none` |
...
| рендеримаже | Отрисовывает часть изображения. |
...
| рендеремаил | Отрисовывает часть сведений о лице, вложенную в сообщение электронной почты. |
| рендернаме | Отображает имя вложенной части сведений о лице. |

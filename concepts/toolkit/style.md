...
Каждый компонент документирует набор [настраиваемых свойств CSS](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties) , которые можно использовать для изменения внешнего вида и поведения определенных элементов. Например:

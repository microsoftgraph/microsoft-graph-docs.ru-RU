...
API аналитики использует расширенную аналитику и машинное обучение для предоставления наиболее релевантных файлов, необходимых пользователю в течение рабочего дня. API включает знакомые возможности Microsoft 365, в том числе Office delve, SharePoint Home, представление обнаружения в OneDrive для бизнеса и Outlook в Интернете.
...
В Microsoft 365 delve использует анализ _тенденций_ , чтобы помочь пользователям найти в них документы, которые наиболее интересны вам. См. рисунок 1.
...
**Рис. 1. В delve в Microsoft 365 показаны популярные документы для пользователя**
...
Новые карточки Office 365 люди отделяются на _используемые_ и _Общие_ аналитики для подключения точек между людьми и единицами измерения знаний. На карточке человека отображаются релевантные для него документы. Карточки людей отображаются во всех программах набора, например в Outlook в Интернете. См. рисунок 2.

API аналитики предоставляет аналогичную функциональность с сущностями [used](/graph/api/resources/insights-used?view=graph-rest-1.0) и [shared](/graph/api/resources/insights-shared?view=graph-rest-1.0). Они возвращают сведения о том, что пользователь просматривал или работал в последнее время, или какие коллеги имеют доступ к последним пользователям в Microsoft 365.
...
## <a name="why-configure-profilecardproperties-in-your-organization-preview"></a>Зачем настраивать Профилекардпропертиес в Организации (Предварительная версия)?

API [профилекардпропертиес](/graph/api/resources/profileCardProperties?view=graph-rest-beta) позволяет администраторам настраивать сведения о поверхностях Организации в Microsoft 365 люди.  

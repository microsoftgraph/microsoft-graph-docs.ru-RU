...
API профилей позволяет разработчикам приложений, моделировать и представлять людей в службах Microsoft 365, а API карты профиля позволяет администраторам управлять информацией, отображаемой на картах профилей пользователей в Организации.
...
## <a name="why-configure-profile-cards-in-your-organization-preview"></a>Зачем настраивать карты профилей в Организации (Предварительная версия)?

Карты профилей позволяют пользователям в организации просматривать сведения друг о друга, такие как их имена и контактные данные. Администраторы могут использовать API [карточки профиля](/graph/api/resources/profilecardproperty) для настройки того, как сведения об их поверхностях организации находятся в Microsoft 365 люди.
...
- Ресурс [Person](/graph/api/resources/person) API людей
- Ресурс [Profile (Предварительная версия)](/graph/api/resources/profile)
- Ресурс ["свойство карточки профиля" (Предварительная версия)](/graph/api/resources/profilecardproperty)
...
* Узнайте больше об [API людей](people-example.md).

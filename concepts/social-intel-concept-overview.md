...
* Узнайте больше о [настройке конфиденциальности пользователей](insights-customize-item-insights-privacy.md), а также о [insights API](/api-reference/beta/resources/iteminsights.md).

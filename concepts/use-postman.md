...
description: Postman — это платформа API для создания и использования API. Чтобы начать работу с API Microsoft Graph, используйте коллекцию Microsoft Graph Postman.
author: jasonjoh

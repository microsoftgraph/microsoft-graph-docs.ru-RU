...
description: Выполните действия, описанные в этом примере, чтобы зарегистрировать определение расширения схемы, создать группу с расширенными данными и обновить пользовательские данные в существующей группе.
author: dkershaw10
...
> [!NOTE]
> В этом разделе показано, как создавать и считывать значения расширения схемы на **групповом** ресурсе (шаги 3–5). Также поддерживаются расширения схемы, и ими можно управлять для [других типов ресурсов](extensibility-overview.md).

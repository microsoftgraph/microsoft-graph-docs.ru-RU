---
title: Настройка конфиденциальности аналитики элементов в Microsoft Graph (предварительная версия)
description: Настройте видимость аналитических данных, полученных из Microsoft Graph, с помощью центра администрирования Microsoft, PowerShell или ресурса userInsightsSettings REST API.
author: simonhult
...
---
# <a name="customize-item-insights-privacy-in-microsoft-graph-preview"></a>Настройка конфиденциальности аналитики элементов в Microsoft Graph (предварительная версия)
...
## <a name="how-to-customize-item-insights"></a>Как настроить аналитику элементов?
...
### <a name="configure-item-insights-settings-via-microsoft-admin-center"></a>Настройте параметры анализа элементов через центр администрирования Microsoft.
...
### <a name="configure-item-insights-settings-via-powershell"></a>Настройте параметры анализа элементов с помощью PowerShell.
...
### <a name="configure-item-insights-settings-using-the-rest-api"></a>Настройте параметры анализа элементов с помощью REST API.

...
| **Задачи приложения, связанные с пользователем**   |  **Обязательные разрешения** | **Строки разрешений** |
|:-------------------------------|:---------------------|:---------------|
...
| **Задачи приложения, связанные с группой**  |  **Обязательные разрешения** |  **Строки разрешений** |
|:-------------------------------|:---------------------|:---------------|

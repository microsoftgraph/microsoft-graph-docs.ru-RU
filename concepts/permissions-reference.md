...
## <a name="teams-resource-specific-consent-permissions"></a>Разрешения для конкретных ресурсов Teams
...
|File.Read.Group| Чтение файлов и папок команды. | **Ограниченная поддержка** <br/> (Предварительная версия) Чтение файлов и папок команды без необходимости входа пользователей. | Нет | Нет |
...
| TeamSettings.ReadWrite.All | Считывание и изменение параметров всех команд| Считывает и изменяет параметры всех команд без необходимости выполнять вход.|Нет | Нет |

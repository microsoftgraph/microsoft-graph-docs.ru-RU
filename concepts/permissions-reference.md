...
| _Teams.Create_ (закрытая ознакомительная версия) | Создание команд | Создание команд от имени вошедшего в систему пользователя. | Да | Нет |
...
| _Teams.Create_ (закрытая ознакомительная версия) | Создание команд | Создание команд без необходимости выполнять вход. | Да | Нет |
|_Teamwork.Migrate.All_|Управление миграцией в Microsoft Teams|Создание ресурсов для миграции в Microsoft Teams и управление ими|Да|Да|

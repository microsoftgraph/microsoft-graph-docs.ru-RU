...
|   Разрешение    |  Отображаемая строка   |  Описание | Требуется согласие администратора |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_RecordsManagement.Read.All_ |Чтение данных из Microsoft Purview Records Management. |Позволяет приложению считывать любые данные из решения Microsoft Purview Records Management, такие как имена меток, имена событий и имена типов событий, от имени вошедшего в систему пользователя. |Да | 
|_RecordsManagement.ReadWrite.All_ | Чтение и запись любых данных из Microsoft Purview Records Management. |Разрешить приложению создавать, обновлять и удалять любые данные из решения Microsoft Purview Records Management, такие как метки, события и типы событий, от имени вошедшего в систему пользователя. |Да |

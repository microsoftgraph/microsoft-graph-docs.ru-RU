...
> [!CAUTION]
> Разрешения, позволяющие предоставлять авторизацию, такие как _RoleManagement.ReadWrite.All_, позволяют приложению предоставлять себе, другим приложениям или любому пользователю дополнительные привилегии. Соблюдайте осторожность при предоставлении каких-либо из этих разрешений.

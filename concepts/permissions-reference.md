...
| _Policy.ReadWrite.CrossTenantAccessPolicy_ | Чтение и запись политики доступа между клиентами в организации | Позволяет приложению считывать и записывать политику доступа между клиентами в организации от имени выполнившего вход пользователя. | Да | Нет |
...
| _Policy.ReadWrite.CrossTenantAccessPolicy_ | Чтение и запись политики доступа между клиентами в организации | Позволяет приложению считывать и записывать политику доступа между клиентами в вашей организации без необходимости входа пользователя. | Да |
...
* _Policy.ReadWrite.CrossTenantAccessPolicy_. Чтение и запись политики доступа между клиентами в организации (`PATCH /beta/policies/crossTenantAccessPolicy`)

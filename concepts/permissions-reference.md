...
* _Analytics. Read_: [связанные параметры списка для пользователя](/graph/api/useranalytics-get-settings?view=graph-rest-beta) ( `GET /beta/me/analytics/settings` ).
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Обязательная учетная запись Майкрософт |
|:-----------------------------|:-----------------------------------------|:-----------------|:-----------------| :----------|
| _CamlQuery. Read. ALL_ | Чтение всех каталогов приложений | Позволяет приложению читать приложения в каталогах приложений.| Нет | Нет |
...
| _Аппролеассигнмент. ReadWrite. ALL_ | Управление предоставлением разрешений для приложений и назначениями ролей приложений | Позволяет приложению управлять предоставлением разрешений для разрешений приложений любому API (включая Microsoft Graph) и назначения приложений для любого приложения, от имени вошедшего пользователя. | Да |
...
* _Букингсаппоинтмент. ReadWrite. ALL_: Создание встречи для службы на предприятии ( `POST /bookingBusinesses/{id}/appointments` ).
* _Bookings.ReadWrite.All_: создание новой службы для указанной компании Bookings (`POST /bookingBusinesses/{id}/services`).
* _Резервирования. Manage. ALL_: Сделайте страницу планирования этого бизнеса доступной внешним клиентам ( `POST /bookingBusinesses/{id}/publish` ).
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Channel. ReadBasic. ALL_ | Прочитайте имена и описания каналов. | Считывание имен каналов и их описаний от имени вошедшего пользователя.    | Нет | Нет |
| _Channel. Create_ | Создание каналов. | Создавайте каналы в любой команде, от имени пользователя, выполнившего вход в систему.   | Да | Нет |
...
| _Channel. Create_ | Создание каналов. | Создавайте каналы в любой команде без вошедшего пользователя.  | Да | Нет |
| _Channel. Delete. ALL_ | Удаление каналов. | Удалять каналы в любой команде без вошедшего пользователя.  | Да | Нет |
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Чаннелсеттингс. Read. ALL_ | Прочтите имена, описания и параметры каналов. | Прочитайте все имена каналов, описания каналов и параметры канала от имени вошедшего пользователя.   | Да | Нет |
| _Чаннелсеттингс. ReadWrite. ALL_ | Чтение и запись имен, описаний и параметров каналов. | Чтение и запись имен, описаний и параметров всех каналов от имени вошедшего пользователя.  | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Чаннелсеттингс. Read. ALL_ | Прочтите имена, описания и параметры всех каналов. | Читать все имена каналов, описания каналов и параметры канала без вошедшего пользователя.  | Да | Нет |
| _Чаннелсеттингс. ReadWrite. ALL_ | Чтение и запись имен, описаний и параметров всех каналов. | Чтение и запись имен, описаний и параметров всех каналов без вошедшего пользователя. | Да | Нет |
...
Разрешение _каллрекордс. Read. ALL_ предоставляет приложению привилегированный доступ к [каллрекордс](/graph/api/resources/callrecords-callrecord) для каждого вызова и собрания по сети в Организации, в том числе звонки и внешние телефонные номера. Сюда входят потенциально конфиденциальные сведения о том, кто участвовал в вызове, а также технические сведения, касающиеся этих звонков и собраний, которые можно использовать для устранения неполадок сети, таких как IP-адреса, сведения об устройствах и другие сетевые данные.

> **Важно.** При предоставлении этого разрешения приложениям следует соблюдать осторожность. Записи звонков могут содержать сведения о работе вашей компании и могут быть целями злоумышленников. Предоставляйте это разрешение только приложениям, которым вы доверяете в плане соблюдения ваших требований к защите данных.
...
## <a name="channel-member-permissions"></a>Разрешения участников маркетинговых программ

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_Чаннелмембер. Read. ALL_  |Чтение участников каналов. |Чтение участников каналов от имени вошедшего пользователя. |Да | Нет |
|_Чаннелмембер. ReadWrite. ALL_ | Добавление и удаление участников каналов.| Добавление и удаление участников каналов от имени вошедшего пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя.| Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_Чаннелмембер. Read. ALL_ |Чтение участников всех каналов. |Чтение участников всех каналов без необходимости входа пользователя. |Да | Нет |
|_Чаннелмембер. ReadWrite. ALL_ |Добавление и удаление участников всех каналов.|Добавление и удаление участников всех каналов без необходимости входа пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя.| Да | Нет |
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_Чаннелмессаже. Delete_ (частный предварительный просмотр)|Удаление сообщений канала пользователя |Позволяет приложению удалять сообщения канала в Microsoft Teams от имени вошедшего пользователя. |Да | Нет |
|_Чаннелмессаже. Edit_ (частный предварительный просмотр)|Изменение сообщений канала пользователя |Позволяет приложению редактировать сообщения канала в Microsoft Teams от имени пользователя, выполнившего вход в систему. |Да | Нет |
|_ChannelMessage.Read.All_ |Чтение сообщений о канале пользователя  |Позволяет приложению считывать сообщения канала в Microsoft Teams от имени пользователя, выполнившего вход в систему. |Да | Нет |
...
|_Chat. ReadBasic_ |Чтение имен и членов потоков чата пользователя  |Позволяет приложению считывать сведения о членах и описаниях потоков 1:1 и групповых бесед от имени вошедшего пользователя. |Нет | Нет |
...
|_Чат. Send_ (частный предварительный просмотр)|Отправка сообщений разговора пользователя  |Позволяет приложению отправлять сообщения для общения 1:1 и групповых бесед в Microsoft Teams от имени вошедшего пользователя. |Нет | Нет |
...
|_Чат. ReadBasic. ALL_ |Чтение имен и членов потоков чата пользователя  |Чтение имен и членов всех потоков чата. |Нет | Нет |
...
|_Чат. Send. ALL_ (частный предварительный просмотр)|Отправка сообщений разговора пользователя  |Позволяет приложению отправлять сообщения в Microsoft Teams в формате 1:1 и группового чата без вошедшего пользователя. |Нет | Нет |

> **Примечание.** В отношении сообщений в канале см. раздел [Разрешения ChannelMessage](#channel-message-permissions).

## <a name="chatmessage-permissions-private-preview"></a>Разрешения ChatMessage ([частный предварительный просмотр](#permissions-availability-status))
...
## <a name="cloud-printing-permissions"></a>Разрешения облачной печати

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора |
|:----------------|:------------------|:-------------|:-----------------------|
| _Printer. ReadWrite. ALL_ | Чтение и обновление принтеров | Позволяет приложению считывать и обновлять принтеры без вошедшего пользователя. Запрещает создание (регистрацию) или удаление (отмену регистрации) принтеров. | Да |
| _PrintJob. Read. ALL_ | Чтение заданий печати | Позволяет приложению считывать метаданные и содержимое документов заданий печати без вошедшего пользователя. | Да |
| _PrintJob. ReadBasic. ALL_ | Чтение основных сведений о заданиях печати | Позволяет приложению считывать метаданные заданий печати без вошедшего пользователя. Запрещает доступ к содержимому документа задания печати. | Да |
| _PrintJob. ReadWrite. ALL_ | Чтение и запись заданий печати | Позволяет приложению считывать и обновлять метаданные и содержимое документов заданий печати без вошедшего пользователя. | Да |
| _PrintJob. Реадвритебасик. ALL_ | Чтение и запись основных сведений о заданиях печати | Позволяет приложению считывать и обновлять метаданные заданий печати без вошедшего пользователя. Запрещает доступ к содержимому документа задания печати. | Да |
...
|Разрешение|Отображаемая строка|Описание|Необходимость в согласии администратора|
|:----------|:--------------|:-----------|:-------|
|_EntitlementManagement.ReadWrite.All_|Чтение и запись ресурсов по управлению правами|Позволяет приложению запрашивать доступ для чтения пакетов доступа и управления ими, а также связанных ресурсов управления обслуживанием от имени вошедшего пользователя.|Да|
|_Ентитлементманажемент. Read. ALL_|Чтение ресурсов управления обслуживанием|Позволяет приложению запрашивать доступ к пакетам доступа чтения и связанным ресурсам управления обслуживанием от имени пользователя, выполнившего вход в систему.|Да|
...
Для групп Microsoft 365 разрешения групп предоставляют приложению доступ к содержимому группы; Например, беседы, файлы, заметки и т. д.
...
Чтобы задать атрибут **преферреддаталокатион** для группы Microsoft 365, приложению необходимо разрешение Directory. ReadWrite. ALL. Когда пользователи в среде с поддержкой нескольких регионов создают группу Microsoft 365, значение **преферреддаталокатион** для группы автоматически становится равным значению этого пользователя. Дополнительные сведения о предпочтительном расположении данных для групп приведены в [статье Создание группы Microsoft 365 с определенным параметром PDL](https://docs.microsoft.com/office365/enterprise/multi-geo-add-group-with-pdl).
...
* _Group. Read. ALL_: чтение всех групп Microsoft 365, участником которых является вошедшего пользователь ( `GET /me/memberOf/$/microsoft.graph.group?$filter=groupTypes/any(a:a%20eq%20'unified')` ).
* _Group. Read. ALL_: чтение всего содержимого группы Microsoft 365, например бесед ( `GET /groups/{id}/conversations` ).
...
* _Group. ReadWrite. ALL_: служба демона создает новые события в календаре группы Microsoft 365 ( `POST /groups/{id}/events` ).
...
#### <a name="application"></a>Разрешения приложений
...
Членство в некоторых группах Microsoft 365 можно скрыть. Это означает, что только члены группы могут просматривать ее элементы. Эту функцию можно использовать, чтобы обеспечить соответствие требованиям, которые необходимы Организации для скрытия членства в группе извне (например, группы Microsoft 365, которая представляет учащихся в классе).
...
| _Policy. ReadWrite. Аусентикатионфловс_ | Чтение и запись политик управления процессами проверки подлинности в Организации | Позволяет приложению считывать и записывать политики для процесса проверки подлинности от имени вошедшего пользователя. | Да | Нет |
...
| _Policy. ReadWrite. Аусентикатионфловс_ | Чтение и запись политик управления процессами проверки подлинности в Организации | Позволяет приложению считывать и записывать политики для процесса проверки подлинности для клиента без пользователя, выполнившего вход в систему. | Да |
...
* _Policy. ReadWrite. аусентикатионфловс_: чтение и запись политики потоков проверки подлинности вашей организации ( `PATCH /beta/policies/authenticationFlowsPolicy` )
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Reports.Read.All_ | Чтение всех отчетов об использовании | Позволяет приложению читать все отчеты об использовании служб от имени вошедшего пользователя. Службы, предоставляющие отчеты об использовании, включают Microsoft 365 и Azure Active Directory. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора |
|:----------------|:------------------|:-------------|:-----------------------|
| _Reports.Read.All_ | Чтение всех отчетов об использовании | Позволяет приложению читать все отчеты об использовании без вошедшего пользователя. Службы, предоставляющие отчеты об использовании, включают Microsoft 365 и Azure Active Directory. | ДА |
...
* _Reports. Read. ALL_: чтение подробного отчета по активациям Microsoft 365 ( `GET /reports/Office365Activations(view='Detail')/content` ).
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Teams. ReadBasic. ALL_ | Чтение имен и описаний Teams | Прочтите имена и описания Teams от имени вошедшего пользователя. | Нет | Нет |
| _Teams. Create_ (частный предварительный просмотр) | Создание команд | Создание Teams от имени вошедшего пользователя. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Teams. ReadBasic. ALL_ | Получение списка всех команд | Получение списка всех команд без вошедшего пользователя.  | Да | Нет |
| _Teams. Create_ (частный предварительный просмотр) | Создание команд | Создание Teams без вошедшего пользователя. | Да | Нет |

## <a name="team-settings-permissions"></a>Разрешения для параметров группы

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теамссеттингс. Read. ALL_ | Считывание параметров Teams | Считывание параметров этой группы от имени вошедшего пользователя. | Да | Нет |
| _Теамссеттингс. ReadWrite. ALL_ | Чтение и изменение параметров Teams | Чтение и изменение всех параметров Teams, от имени вошедшего пользователя.   | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теамссеттингс. Read. ALL_ | Чтение всех параметров Teams | Считывание параметров этой группы без вошедшего пользователя.    | Да | Нет |
| _Теамссеттингс. ReadWrite. ALL_ | Чтение и изменение всех параметров Teams. | Чтение и изменение всех параметров Teams без вошедшего пользователя. | Да | Нет |
...
## <a name="teams-app-permissions-deprecated"></a>Разрешения приложения Teams (не рекомендуется)

>[!NOTE]
>Эти разрешения устарели. Используйте эквивалентный Теамсаппинсталлатион. \* . Вместо этого все разрешения.

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamsApp. Read. ALL_ (не**рекомендуется**)| Чтение всех установленных приложений Teams | Позволяет приложению читать приложения Teams, установленные для вошедшего пользователя и во всех командах, участником которых является пользователь. Не предоставляет возможности чтения параметров, относящихся к приложению. | Да | Нет |
| _TeamsApp. ReadWrite. ALL_ (не**рекомендуется**)| Управление всеми приложениями группы | Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams от имени вошедшего пользователя, а также для команд, участником которых является пользователь. Не предоставляет возможности чтения или записи параметров, относящихся к приложению. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamsApp. Read. ALL_ (не**рекомендуется**)| Чтение всех установленных пользовательских приложений Teams | Позволяет приложению читать приложения Teams, установленные для любого пользователя, без необходимости входа пользователя. Не предоставляет возможность чтения параметров, относящихся к приложению. | Да | Нет |
| _TeamsApp. ReadWrite. ALL_ (не**рекомендуется**)| Управление всеми пользовательскими приложениями группы  | Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams, установленные для любого пользователя, без необходимости входа пользователя. Не предоставляет возможность чтения или записи параметров, относящихся к приложению.   | Да | Нет |

## <a name="teams-app-installation-permissions-private-preview"></a>Разрешения на установку приложений Teams ([частный предварительный просмотр](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теамсаппинсталлатион. реадфорусер_ (частный предварительный просмотр) | Чтение установленных приложений Teams пользователя| Позволяет приложению считывать приложения Teams, установленные для вошедшего пользователя. Не предоставляет возможности чтения параметров, относящихся к приложению.| Да | Нет |
| _Теамсаппинсталлатион. реадвритефорусер_ (частный предварительный просмотр) | Управление установленными пользователями приложения Teams| Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams, установленные для пользователя, выполнившего вход в систему. Не предоставляет возможности чтения параметров, относящихся к приложению.| Нет | Нет |
| _Теамсаппинсталлатион. реадвритеселффорусер_ (частный предварительный просмотр) | Предоставление приложению возможности самостоятельного управления в Teams| Позволяет приложению Teams читать, устанавливать, обновлять и удалять их в Teams, которые пользователь, вошедшего в Teams, может получить доступ к Teams.| Да | Нет |
| _Теамсаппинсталлатион. реадфортеам_ (частный предварительный просмотр) | Чтение установленных приложений Teams в Teams| Позволяет приложению считывать приложения Teams, установленные в Teams, к которым пользователь, вошедшего в Teams, может получить доступ. Не предоставляет возможности чтения параметров, относящихся к приложению.| Да | Нет |
| _Теамсаппинсталлатион. реадвритефортеам_ (частный предварительный просмотр) | Управление установленными приложениями Teams в Teams| Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams в Teams, доступ к которым может получить пользователь, вошедшего в систему. Не предоставляет возможности чтения параметров, относящихся к приложению.| Да | Нет |
...
## <a name="team-member-permissions-private-preview"></a>Разрешения для участников команды ([закрытая ознакомительная версия](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теаммембер. Read. ALL_ | Чтение участников команд. | Чтение участников команд от имени вошедшего пользователя. | Да | Нет |
| _Теаммембер. ReadWrite. ALL_ | Добавление и удаление участников команд. | Добавление и удаление участников команд от имени вошедшего пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теаммембер. Read. ALL_ | Чтение участников всех команд. | Чтение участников всех команд без необходимости входа пользователя. | Да | Нет |
| _Теаммембер. ReadWrite. ALL_ | Добавление и удаление участников всех команд. | Добавление и удаление участников всех команд без необходимости входа пользователя. Также позволяет изменять роль участника команды, например с владельца на обычного пользователя. | Да | Нет |

## <a name="teams-resource-specific-consent-permissions"></a>Разрешения на согласие с определенными ресурсами в Teams

| Разрешение | Отображаемая строка | Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| Теамсеттингс. Read. Group | Прочтите параметры этой группы. | Считывание параметров этой группы без вошедшего пользователя. |Нет | Нет |
| Чаннелсеттингс. Read. Group | Прочтите имена, описания и параметры каналов этой группы. | Прочтите имена каналов, описания каналов и параметры канала, не имея вошедшего пользователя. |Нет | Нет |
| Чаннелсеттингс. Edit. Group | Изменить имена, описания и параметры каналов этой группы.| Измените имена каналов, описания каналов и каналы для этой группы без вошедшего пользователя. |Нет | Нет |
|Channel. Create. Group | Создание каналов в этой команде. | Создание каналов в этой группе без вошедшего пользователя. |Нет | Нет |
|Channel. Delete. Group | Удаление каналов этой группы. | Удалить каналы этой группы без вошедшего пользователя. |Нет | Нет |
|Чаннелмессаже. Read. Group | Считывание сообщений в каналах группы. | Позволяет приложению читать сообщения чаннел'с этой группы без вошедшего пользователя. |Нет | Нет |
|TeamsApp. Read. Group | Узнайте, какие приложения установлены в этой команде. | Узнайте, какие приложения установлены в этой группе без вошедшего пользователя. |Нет | Нет |
|TeamsTab. Read. Group | Прочтите вкладки этой группы. | Прочтите вкладки этой группы без вошедшего пользователя. |Нет | Нет |
|TeamsTab. Create. Group | Создание вкладок в этой команде. | Создание вкладок в этой группе без пользователя, выполнившего вход в систему. |Нет | Нет |
|TeamsTab. Edit. Group | Изменение вкладок группы. | Изменение вкладок группы без вошедшего пользователя. |Нет | Нет |
|TeamsTab. Delete. Group | Удаление вкладок этой группы. | Удаление вкладок группы без пользователя, выполнившего вход в систему. |Нет | Нет |
|Member. Read. Group | Прочтите участников этой группы.| Прочесть членов этой группы без вошедшего пользователя. |Нет | Нет |
|Владелец. чтение. Группа| Прочтите сведения о владельцах этой группы. | Прочесть владельцев этой группы без вошедшего пользователя. |Нет | Нет |
...
| Разрешение | Отображаемая строка | Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| Team. ReadBasic. ALL | Чтение имен и описаний Teams| Прочтите имена и описания Teams от имени вошедшего пользователя.|Да| Нет |
| Теамсеттингс. Read. ALL | Считывание параметров Teams| Читать все параметры Teams, от имени пользователя, выполнившего вход в систему.|Да| Нет |
| Теамсеттингс. ReadWrite. ALL | Чтение и изменение параметров Teams.| Чтение и изменение всех параметров Teams, от имени вошедшего пользователя.|Да| Нет |

### <a name="application-permissions"></a>Разрешения приложений

| Разрешение | Отображаемая строка | Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| Team. ReadBasic. ALL | Получение списка всех команд.| Получение списка всех команд без вошедшего пользователя.|Да| Нет |
| Теамсеттингс. Read. ALL | Чтение всех параметров Teams| Считывание параметров этой группы без вошедшего пользователя.|Да| Нет |
| Теамсеттингс. ReadWrite. ALL | Чтение и изменение всех параметров Teams| Чтение и изменение всех параметров Teams без вошедшего пользователя.|Нет | Нет |

## <a name="teams-tab-permissions"></a>Разрешения для вкладки Teams
...
| Приложение хочет прочитать все содержимое всех групп Microsoft 365, включая файлы, беседы.  Ему также требуется показывать членов группы и обновлять эти данные (если пользователь — владелец).  |  _Group.Read.All_ | Чтение элементов во всех семействах веб-сайтов, чтение всех групп|
| Приложение запрашивает разрешение на чтение и запись всего контента во всех группах Microsoft 365, включая файлы, беседы.  Ему также требуется показывать членов группы и обновлять эти данные (если пользователь — владелец).  |    _Group.ReadWrite.All_, _Sites.ReadWrite.All_ |  Чтение и запись всех групп, редактирование и удаление элементов во всех семействах веб-сайтов |
| Приложение пытается найти (найти) группу Microsoft 365. Пользователь сможет найти определенную группу, выбрать ее из нумерованного списка, чтобы затем присоединиться к ней.   | _Group.ReadWrite.All_ | Чтение и запись всех групп|

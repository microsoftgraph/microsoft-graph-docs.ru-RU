...
* _Policy.Read.All_. Чтение политик организации (`GET /beta/trustFramework/policies`)
...
* _Policy.Read.All_. Чтение политик организации (`GET /beta/directory/featureRolloutPolicies`)

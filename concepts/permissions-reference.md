...
_AccessReview.Read.All_ и _AccessReview.ReadWrite.All_ допустимы только для рабочих или учебных учетных записей.
...
|EduRostering.ReadBasic| Чтение части представления списка пользователей | Позволяет приложению считывать часть данных из структуры учебных заведений и курсов в составе организации, а также педагогическую информацию о пользователях от имени пользователя.  | Да  | Нет |
...
## <a name="trust-framework-policy-permissions"></a>Разрешения политики инфраструктуры доверия

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Policy.Read.All_ | Чтение всех политик инфраструктуры доверия | Позволяет приложению считывать все политики инфраструктуры доверия от имени выполнившего вход пользователя. | Да | Нет |
| _Policy.ReadWrite.TrustFramework_ | Чтение и запись всех политик инфраструктуры доверия | Позволяет приложению считывать и записывать политики инфраструктуры доверия от имени выполнившего вход пользователя. | Да | Нет |
...
* _Policy.Read.All_: чтение всех политик инфраструктуры доверия (`GET /beta/trustFramework/policies`)
* _Policy.ReadWrite.TrustFramework_: чтение и запись всех политик инфраструктуры доверия (`POST /beta/trustFramework/policies`)
...
## <a name="feature-rollout-policy-permissions"></a>Разрешения политики развертывания функций

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Policy.Read.All_ | Чтение всех политик развертывания функций | Позволяет приложению считывать все политики развертывания функций от имени выполнившего вход пользователя. | Да | Нет |
| _Policy.ReadWrite.FeatureRollout_ | Чтение и запись всех политик развертывания функций | Позволяет приложению считывать и записывать политики развертывания функций от имени выполнившего вход пользователя. | Да | Нет |
...
* _Policy.Read.All_: чтение всех политик развертывания функций (`GET /beta/directory/featureRolloutPolicies`)
* _Policy.ReadWrite.FeatureRollout_: Чтение и запись всех политик развертывания функций (`POST /beta/directory/featureRolloutPolicies`)

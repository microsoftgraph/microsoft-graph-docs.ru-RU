...
## <a name="channel-permissions-private-preview"></a>Разрешения канала ([частный предварительный просмотр](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Channel. ReadBasic. ALL_ (частный предварительный просмотр)| Прочитайте имена и описания каналов. | Считывание имен каналов и их описаний от имени вошедшего пользователя.   | Нет | Нет |
| _Channel. Create_ (частный предварительный просмотр)| Создание каналов. | Создавайте каналы в любой команде, от имени пользователя, выполнившего вход в систему.  | Да | Нет |
| _Channel. Delete. ALL_ (частный предварительный просмотр)| Удаление каналов. | Удалять каналы в любой команде от имени пользователя, выполнившего вход в систему.  | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Channel. ReadBasic. ALL_ (частный предварительный просмотр)| Прочитайте имена и описания всех каналов. | Прочтите имена всех каналов и их описания без вошедшего пользователя. | Да | Нет |
| _Channel. Create_ (частный предварительный просмотр)| Создание каналов. | Создавайте каналы в любой команде без вошедшего пользователя. | Да | Нет |
| _Channel. Delete. ALL_ (частный предварительный просмотр)| Удаление каналов. | Удалять каналы в любой команде без вошедшего пользователя. | Да | Нет |

## <a name="channel-settings-permissions-private-preview"></a>Разрешения для параметров канала ([частный предварительный просмотр](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Чаннелсеттингс. Read. ALL_ (частный предварительный просмотр)| Прочтите имена, описания и параметры каналов. | Прочитайте все имена каналов, описания каналов и параметры канала от имени вошедшего пользователя.  | Да | Нет |
| _Чаннелсеттингс. ReadWrite. ALL_ (частный предварительный просмотр)| Чтение и запись имен, описаний и параметров каналов. | Чтение и запись имен, описаний и параметров всех каналов от имени вошедшего пользователя. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Чаннелсеттингс. Read. ALL_ (частный предварительный просмотр)| Прочтите имена, описания и параметры всех каналов. | Читать все имена каналов, описания каналов и параметры канала без вошедшего пользователя. | Да | Нет |
| _Чаннелсеттингс. ReadWrite. ALL_ (частный предварительный просмотр)| Чтение и запись имен, описаний и параметров всех каналов. | Чтение и запись имен, описаний и параметров всех каналов без вошедшего пользователя.    | Да | Нет |
...
## <a name="channel-message-permissions-private-preview"></a>Разрешения для сообщений маркетинговых программ ([частный предварительный просмотр](#permissions-availability-status))
...
|_Чаннелмессаже. Read. ALL_ (частный предварительный просмотр)|Чтение сообщений о канале пользователя  |Позволяет приложению считывать сообщения канала в Microsoft Teams от имени пользователя, выполнившего вход в систему. |Да | Нет |
|_Чаннелмессаже. Send_ (частный предварительный просмотр)|Отправка сообщений канала |Позволяет приложению отправлять сообщения в Microsoft Teams от имени вошедшего в систему пользователя. |Да | Нет |
...
## <a name="channel-member-permissions-private-preview"></a>Разрешения для участников канала ([закрытая ознакомительная версия](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_ChannelMember.Read.All_ (закрытая ознакомительная версия) |Чтение участников каналов. |Чтение участников каналов от имени вошедшего пользователя. |Да | Нет |
|_ChannelMember.ReadWrite.All_ (закрытая ознакомительная версия)| Добавление и удаление участников каналов. | Добавление и удаление участников каналов от имени вошедшего пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
|_ChannelMember.Read.All_ (закрытая ознакомительная версия)|Чтение участников всех каналов. |Чтение участников всех каналов без необходимости входа пользователя. |Да | Нет |
|_ChannelMember.ReadWrite.All_ (закрытая ознакомительная версия)| Добавление и удаление участников всех каналов. |Добавление и удаление участников всех каналов без необходимости входа пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя. | Да | Нет |

## <a name="chats-permissions-private-preview"></a>Разрешения для сеансов ([частный предварительный просмотр](#permissions-availability-status))
...
|_Chat. ReadBasic_ (частный предварительный просмотр)|Чтение имен и членов потоков чата пользователя  |Позволяет приложению считывать сведения о членах и описаниях потоков 1:1 и групповых бесед от имени вошедшего пользователя. |Нет | Нет |
...
|_Чат. ReadBasic. ALL_ (частный предварительный просмотр)|Чтение имен и членов потоков чата пользователя  |Чтение имен и членов всех потоков чата. |Нет | Нет |
...
> **Примечание.** В отношении сообщений в канале см. раздел [Разрешения ChannelMessage](#channel-message-permissions-private-preview).
...
## <a name="team-permissions-private-preview"></a>Разрешения для группы ([частный предварительный просмотр](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Teams. ReadBasic. ALL_ (частный предварительный просмотр)| Чтение имен и описаний Teams | Прочтите имена и описания Teams от имени вошедшего пользователя.    | Нет | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Teams. ReadBasic. ALL_ (частный предварительный просмотр)| Получение списка всех команд | Получение списка всех команд без вошедшего пользователя. | Да | Нет |

## <a name="team-settings-permissions-private-preview"></a>Разрешения для параметров группы ([частный предварительный просмотр](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теамссеттингс. Read. ALL_ (частный предварительный просмотр)| Считывание параметров Teams | Считывание параметров этой группы от имени вошедшего пользователя.    | Да | Нет |
| _Теамссеттингс. ReadWrite. ALL_ (частный предварительный просмотр)| Чтение и изменение параметров Teams | Чтение и изменение всех параметров Teams, от имени вошедшего пользователя.  | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _Теамссеттингс. Read. ALL_ (частный предварительный просмотр)| Чтение всех параметров Teams | Считывание параметров этой группы без вошедшего пользователя.   | Да | Нет |
| _Теамссеттингс. ReadWrite. ALL_ (частный предварительный просмотр)| Чтение и изменение всех параметров Teams. | Чтение и изменение всех параметров Teams без вошедшего пользователя.    | Да | Нет |
...
## <a name="teams-app-permissions-private-preview"></a>Разрешения для приложений в Teams ([закрытая ознакомительная версия](#permissions-availability-status))
...
| _TeamsApp.ReadWrite.All_ (закрытая ознакомительная версия)| Управление всеми приложениями группы | Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams от имени вошедшего пользователя, а также для команд, участником которых является пользователь. Не предоставляет возможности чтения или записи параметров, относящихся к приложению. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamsApp.Read.All_ (закрытая ознакомительная версия)| Чтение всех установленных пользовательских приложений Teams | Позволяет приложению читать приложения Teams, установленные для любого пользователя, без необходимости входа пользователя. Не предоставляет возможность чтения параметров, относящихся к приложению. | Да | Нет |
| _TeamsApp.ReadWrite.All_ (закрытая ознакомительная версия)| Управление всеми пользовательскими приложениями группы  | Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams, установленные для любого пользователя, без необходимости входа пользователя. Не предоставляет возможность чтения или записи параметров, относящихся к приложению.  | Да | Нет |
...
|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamMember.Read.All_ (закрытая ознакомительная версия)| Чтение участников команд. | Чтение участников команд от имени вошедшего пользователя. | Да | Нет |
| _TeamMember.ReadWrite.All_ (закрытая ознакомительная версия)| Добавление и удаление участников команд. | Добавление и удаление участников команд от имени вошедшего пользователя. Также позволяет изменять роль участника, например с владельца на обычного пользователя. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamMember.Read.All_ (закрытая ознакомительная версия)| Чтение участников всех команд. | Чтение участников всех команд без необходимости входа пользователя.    | Да | Нет |
| _TeamMember.ReadWrite.All_ (закрытая ознакомительная версия)| Добавление и удаление участников всех команд. | Добавление и удаление участников всех команд без необходимости входа пользователя. Также позволяет изменять роль участника команды, например с владельца на обычного пользователя. | Да | Нет |
...
## <a name="teams-tab-permissions-private-preview"></a>Разрешения для вкладок в Teams ([закрытая ознакомительная версия](#permissions-availability-status))

#### <a name="delegated-permissions"></a>Делегированные разрешения

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamsTab.Read.All_ (закрытая ознакомительная версия)| Чтение вкладок в Microsoft Teams. | Позволяет приложению читать приложения Teams, установленные для вошедшего пользователя и во всех командах, участником которых является пользователь. Не предоставляет возможности чтения параметров, относящихся к приложению.    | Да | Нет |
| _TeamsTab.ReadWrite.All_ (закрытая ознакомительная версия)| Чтение и запись вкладок в Microsoft Teams. | Позволяет приложению читать, устанавливать, обновлять и удалять приложения Teams от имени вошедшего пользователя, а также для команд, участником которых является пользователь. Не предоставляет возможности чтения или записи параметров, относящихся к приложению.   | Да | Нет |
| _TeamsTab.Create_ (закрытая ознакомительная версия)| Создание вкладок в Microsoft Teams. | Позволяет приложению создавать вкладки в любой команде Microsoft Teams от имени вошедшего в систему пользователя. При этом возможности читать, изменять и удалять вкладки после их создания, как и доступа к контенту внутри вкладок, не предоставляется. | Да | Нет |

#### <a name="application-permissions"></a>Разрешения приложений

|   Разрешение    |  Отображаемая строка   |  Описание | Необходимость в согласии администратора | Поддержка учетной записи Майкрософт |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _TeamsTab.Read.All_ (закрытая ознакомительная версия)| Чтение вкладок в Microsoft Teams. | Чтение названий и параметров вкладок в любой команде Microsoft Teams без входа пользователя в систему. Доступа к контенту внутри вкладок не предоставляется.    | Да | Нет |
| _TeamsTab.ReadWrite.All_ (закрытая ознакомительная версия)| Чтение и запись вкладок в Microsoft Teams. | В Microsoft Teams можно читать и записывать вкладки любой команды без входа пользователя в систему. Доступа к контенту внутри вкладок не предоставляется. | Да | Нет |
| _TeamsTab.Create_ (закрытая ознакомительная версия)| Создание вкладок в Microsoft Teams. | Позволяет приложению создавать вкладки в любой команде Microsoft Teams без входа пользователя в систему При этом возможности читать, изменять и удалять вкладки после их создания, как и доступа к контенту внутри вкладок, не предоставляется. | Да | Нет |

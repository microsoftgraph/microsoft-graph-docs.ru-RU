...
| _Sites.Selected_ | Доступ к выбранным семействам веб-сайтов (предварительная версия) | _Это разрешение для ожидаемой функции, которая еще не выпущена. Не следует использовать._ | Да  |

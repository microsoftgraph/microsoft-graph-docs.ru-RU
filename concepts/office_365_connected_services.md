...
- Оформите подписку на Office 365. Чтобы получить бесплатную пробную версию, зарегистрируйтесь в [программе разработчиков приложений для Office 365](https://dev.office.com/devprogram).
...
> **Совет.** Каждый комментарий начинается со слова "//Uncomment:"
...
Если вам нужна помощь, задайте вопрос на сайте [StackOverflow](https://stackoverflow.com/questions/tagged/microsoftgraph?sort=newest). Пометьте его тегом {microsoftgraph}.

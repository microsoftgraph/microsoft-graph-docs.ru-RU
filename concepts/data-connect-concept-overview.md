...
description: Используйте подключение к данным Microsoft Graph для доступа к данным Microsoft 365 в широком масштабе, реализации функции детального согласия и обеспечения безопасности данных и управления.
author: fercobo-msft

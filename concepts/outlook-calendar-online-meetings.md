...
description: Используйте API календаря Outlook, чтобы организовать событие, в котором приглашенные на собрание могут выбрать URL-адрес присоединения и посетить собрание по сети в Microsoft Teams или Skype.
author: juforan
...
Используйте API календаря Outlook, чтобы организовать событие, в котором приглашенные на собрание могут выбрать URL-адрес присоединения и посетить собрание по сети в Microsoft Teams или Skype.

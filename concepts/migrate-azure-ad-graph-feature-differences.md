...
Однако Microsoft Graph не предоставляет возможности для управления определениями расширений схемы каталога Azure AD Graph или для просмотра всех определений расширений схемы, доступных в клиенте.
...
>**Note**: использование свойств расширения схемы Microsoft Graph в качестве утверждений в маркере с использованием необязательных утверждений также пока не поддерживается.

...
ms.openlocfilehash: 403937a61fd5cc23b0ad4b177058b2d6b8d49e4f
...
> [!NOTE]
> Соединители Microsoft Graph доступны в предварительной версии. Дополнительные сведения о предварительной версии см. в статье [Предварительная версия соединителей](https://docs.microsoft.com/MicrosoftSearch/connectors-preview). Чтобы принять участие в программе предварительной оценки, необходимо сначала отправить [форму для регистрации на предварительную версию соединителей Microsoft Graph](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbRxWYgu82J_RFnMMATAS6_chUNVYwNU1CMDNZUDBSSDZKWVo2RDJDRjRLQi4u).

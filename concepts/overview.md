---
title: Общие сведения о Microsoft Graph
description: Используйте данные Microsoft Graph и другие наборы данных, чтобы получить статистику и аналитику, расширить возможности Microsoft 365 и создавать уникальные интеллектуальные приложения.

...
Полный список поддерживаемых функций см. в классе [Excel.Functions.](/javascript/api/excel/excel.functions?view=excel-js-preview) Имена определенных параметров и типы данных см. в сигнатуре функции.

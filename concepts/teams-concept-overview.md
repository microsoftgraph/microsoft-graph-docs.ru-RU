...
Широкие возможности приложения Microsoft Teams и его API открывают множество сценариев для разработчиков приложений. В следующих разделах перечислены некоторые из них.
...
### <a name="types-of-apps-enabled-for-microsoft-teams"></a>Типы приложений, которые разрешено использовать в Microsoft Teams
...
## <a name="enable-employee-learning-using-the-collaborative-capabilities-in-teams"></a>Поддерживайте обучение сотрудников, используя возможности совместной работы в Teams
Решение Viva Обучение, созданное для Microsoft Teams и Microsoft 365, реализует возможности обучения сотрудников в потоке работы. С помощью Viva Обучение работодатели могут регистрировать поставщиков обучения, отправлять метаданные содержимого, задания учащимся и записи о выполнении заданий, а также управлять этими элементами. Сотрудники могут делаться учебным содержимым в сообщениях Teams, в чатах собраний и в сообщениях электронной почты, чтобы способствовать обучению коллег и поддерживать наставничество. 

Используйте интерфейсы API обучения сотрудников в Viva Обучение для решения следующих задач: 
- Регистрация [поставщиков обучения](/graph/api/resources/learningprovider) и управление ими.
- Вставка, обновление, извлечение и удаление метаданных [учебного содержимого](/graph/api/resources/learningcontent).

## <a name="api-reference"></a>Справочные материалы по API

Нужен справочник по API для Teams и Viva Обучение?
...
- [Использование API обучения сотрудников для интеграции с Viva Обучение](/graph/api/resources/viva-learning-api-overview)

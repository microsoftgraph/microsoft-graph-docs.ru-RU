...
1. Просмотрите остальные выходные данные PowerShell для команды, `Connect-Graph` заполненные значениями для регистрации приложения.
...
Замените заполнители в `Connect-Graph` команде информацией. Сохраните файл, а затем откройте PowerShell в каталоге, в котором вы создали файл. Выполните сценарий с помощью приведенной ниже команды.

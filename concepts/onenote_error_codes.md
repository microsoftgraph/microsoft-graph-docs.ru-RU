...
В запросе превышено максимальное количество тегов изображений, в которых атрибут **data-render-src** содержит PDF-файл. См. статью [Добавление изображений и файлов](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-images-files).
...
Оператор **expand** не поддерживается для этого запроса. См. раздел [Поддерживаемые параметры строки запроса OData](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-get-content#query-options).
...
Запрос содержит недопустимый атрибут **data-render-src** или **data-render-method**, либо этот атрибут отсутствует. См. статью [Извлечение данных из записей](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-extract-data).
...
Запрос содержит неподдерживаемое значение атрибута **data-tag**. См. статью [Использование тегов заметок](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-note-tags).
...
```
См. статью [Использование тегов заметок](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-note-tags).
...
Запрос содержит выражение **expand** для родительского объекта дочерних сущностей или дочернего объекта родительских сущностей. Такие выражения не поддерживаются. См. раздел [Поддерживаемые параметры строки запроса OData](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-get-content#query-options).
...
Источник видео, указанный в запросе, не поддерживается. См. актуальный список [поддерживаемых сайтов с видео](https://msdn.microsoft.com/ru-RU/office/office365/howto/onenote-images-files#videos).
...
Для учетной записи пользователя превышена квота OneDrive. См. страницу [OneDrive](https://onedrive.live.com/about/ru-RU/).

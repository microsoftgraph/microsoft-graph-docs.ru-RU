...
Во время реализации обработки ошибок можно обнаружить регулирование с помощью кода ошибки HTTP 429. Неудачный отклик содержит в заголовке поле *Retry-After*. Самый быстрый способ откорректировать регулирование — применить к запросам задержку *Retry-After*, так как Microsoft Graph продолжает регистрировать в журнале использование ресурсов при регулировании клиента.
...
- [пользователь](../api-reference/v1.0/resources/user.md);
- [фотография](../api-reference/v1.0/resources/profilephoto.md);
- [почта](../api-reference/v1.0/resources/message.md);
- [календарь (пользователи и группы)](../api-reference/v1.0/resources/event.md);
- [контакт](../api-reference/v1.0/resources/contact.md);
- [вложение](../api-reference/v1.0/resources/attachment.md);
- [групповые чаты](../api-reference/v1.0/resources/conversation.md);

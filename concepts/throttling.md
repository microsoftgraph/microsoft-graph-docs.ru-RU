...
description: Найдите рекомендации по поддержанию оптимальной производительности службы Microsoft Graph в случае чрезмерного количества запросов. Включает ограничения для определенных служб.
author: FaithOmbongi

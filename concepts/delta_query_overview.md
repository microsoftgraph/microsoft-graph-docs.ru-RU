...
Интерфейсы API поддерживают фильтры области, позволяющие отслеживать изменения для одного или нескольких пользователей либо групп по objectId. Например, запрос https://graph.microsoft.com/beta/groups/delta/?$filter= id eq '477e9fc6-5de7-4406-bb2a-7e5c83c9ae5f' or id eq '004d6a07-fe70-4b92-add5-e6e37b8acd8e' вернет изменения для групп, идентификаторы которых соответствуют указанным в фильтре запроса. 

...
description: Сведения о развертываниях в национальных облаках Microsoft Graph и возможностях, доступных разработчикам в каждом из них.
...
* Microsoft Azure и Microsoft 365, предоставляемые 21Vianet в Китае
...
Следующие функции Microsoft Graph доступны в предварительной версии (`/beta`в конечной точке) в Microsoft Cloud для Китая и Microsoft Cloud в Германии (конечные точки версии 1.0 для этих функций доступны только в Microsoft Cloud for US Government).

...
Вы можете создать [сообщение](/graph/api-reference/v1.0/resources/message) в формате JSON или MIME. Укажите нужный формат в заголовке запроса:
...
При указании для текста формата MIME укажите соответствующие [заголовки сообщений Интернета](https://tools.ietf.org/html/rfc2076) и [содержимое MIME](https://tools.ietf.org/html/rfc2045), а также закодируйте их в формате **base64** в тексте запроса. Microsoft Graph не поддерживает изменение или обновление свойств MIME по отдельности.

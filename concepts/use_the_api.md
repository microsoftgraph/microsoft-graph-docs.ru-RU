...
* Ссылка **Далее** — если найдено много данных, чтобы пролистать их все, нажимайте кнопку **Далее**. Дополнительные сведения см. в статье [Разбиение на страницы](paging.md).
...
Дополнительные сведения о версиях API см. в статье [Управления версиями и поддержка](versioning_and_support.md).

...
### <a name="working-with-feature-implementation"></a>Внедрение функции «Работа с»
...
Люди за пределами организации не будут отображаться в списке владельца профиля. Люди, с которыми они обмениваются электронными письмами или встречаются, но которые не являются частью одной организации, не будут отображаться в разделе «Работа с»

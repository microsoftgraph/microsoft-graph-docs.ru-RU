---
title: Использование API людей для получения сведений о релевантных для вас людях
description: Используйте API людей в Microsoft Graph для просмотра или поиска людей, наиболее релевантных для пользователя, на основе шаблонов взаимодействия и совместной работы пользователя.
ms.date: 4/9/2019
author: anthona
...
ms.locfileid: "66437655"
---
# <a name="use-the-people-api-to-get-information-about-the-people-most-relevant-to-you"></a>Использование API людей для получения сведений о наиболее релевантных для вас людях

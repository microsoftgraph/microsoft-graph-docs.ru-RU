# <a name="get-freebusy-schedule-for-users-and-resources-preview"></a>Получение графика доступности пользователей и ресурсов (предварительная версия)
...
### <a name="application"></a>Применение
...
## <a name="time-zone-representation"></a>Отображение часового пояса

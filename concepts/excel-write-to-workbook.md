...
Дополнительные сведения о том, как получить доступ к файлам в папках OneDrive, см. в разделе [Тип ресурса DriveItem](https://developer.microsoft.com/ru-RU/graph/docs/api-reference/v1.0/resources/driveitem) в нашей справочной документации.
...
Вы можете протестировать этот запрос в своей учетной записи OneDrive, отправив файл demo.xlsx в корневую папку OneDrive и выполнив этот запрос в [песочнице Microsoft Graph](https://developer.microsoft.com/ru-RU/graph/graph-explorer).

...
| :-------------- | :------------ | :--------------------------------------- |
| Дополнение        | Бета-версия и версия 1.0          | [Добавление файловых вложений до 150 МБ](outlook-large-attachments.md) к экземпляру [события](/graph/api/resources/event?view=graph-rest-1.0). |

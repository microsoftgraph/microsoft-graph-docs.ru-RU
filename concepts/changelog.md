...
ms.openlocfilehash: 860e361b406ed0d9f788ac291acfadea4753ef74
ms.sourcegitcommit: 55e9497c8e003be389f8b5d641f80dae7bf6004b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/27/2020
ms.locfileid: "44909760"
---
...
| Изменение | Бета-версия | Переименованные типы enum: <br/><ul><li>Принтпресентатиондиректион — > Принтмултипажелайаут</li><li>Принтдуплексконфигуратион — > Принтдуплексмоде</li><li>Принтколорконфигуратион — > Принтколормоде</li><li>Конфигурация Документконфигуратион ></li></ul>|
...
| **Тип изменения** | 
  **Version**   | **Описание**                          |
| :-------------- | :------------ | :--------------------------------------- |
|Добавление|1.0|Добавлено отношение **клаимсмаппингполиЦиес** к ресурсу [servicePrincipal](/graph/api/resources/servicePrincipal?view=graph-rest-1.0) .|
...
|Добавление|1.0|Добавлено новое свойство **sourceParticipantId**в сложный тип [incomingContext](/graph/api/resources/incomingcontext?view=graph-rest-1.0).
...
| Добавление | Бета-версия | Добавлено новое отношение `shiftPreferences` для объекта [userSettings](/graph/api/resources/usersettings?view=graph-rest-beta). |
...
| Дополнение | Бета-версия | Метод [Чтение изображений в сообщениях](/graph/api/chatmessagehostedcontent-get?view=graph-rest-beta) теперь поддерживает разрешения приложений. |
...
|Добавление|бета|Добавлено действие [hasPayloadLinks](/graph/api/intune-shared-androidmanagedappprotection-haspayloadlinks.md) для коллекции [androidManagedAppProtection](/graph/api/resources/intune-mam-androidmanagedappprotection) |
...
| Добавление        | бета        | Добавлено свойство **location** для сложного типа [itemActivity](/graph/api/resources/itemactivity?view=graph-rest-beta) |
...
| **Тип изменения** | 
  **Version** | **Описание**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Дополнение          | Бета-версия        | Добавлен тип ресурса [notification](/graph/api/resources/projectrome-notification?view=graph-rest-beta). |
...
|Дополнение|1.0|Добавлена функция [deviceConfigurationUserActivity](/graph/api/intune-deviceconfig-reportroot-deviceconfigurationuseractivity?view=graph-rest-1.0) для объекта [reportRoot](/graph/api/resources/intune-deviceconfig-reportroot?view=graph-rest-1.0). |
|Дополнение|1.0|Добавлена функция [deviceConfigurationDeviceActivity](/graph/api/intune-deviceconfig-reportroot-deviceconfigurationdeviceactivity?view=graph-rest-1.0) для объекта [reportRoot](/graph/api/resources/intune-deviceconfig-reportroot?view=graph-rest-1.0). |
|Дополнение|1.0|Добавлена функция [verifyWindowsEnrollmentAutoDiscovery](/graph/api/intune-onboarding-devicemanagement-verifywindowsenrollmentautodiscovery?view=graph-rest-1.0) к объекту [deviceManagement](/graph/api/resources/intune-androidforwork-devicemanagement?view=graph-rest-1.0). |
|Дополнение|1.0|Добавлена функция **getUserIdsWithFlaggedAppRegistration** в коллекции [managedAppRegistration](/graph/api/resources/intune-mam-managedappregistration?view=graph-rest-1.0). |
...
| Дополнение        | Бета-версия        | Добавлено свойство **Theme** , которое позволяет указать цветовую тему группы Microsoft 365. |

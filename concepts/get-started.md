<span data-ttu-id="a5937-p102">Готовые примеры Connect вы найдете в репозитории [Microsoft Graph ](https://github.com/microsoftgraph) на сайте GitHub. Ниже представлены примеры для разных поставщиков проверки подлинности и платформ, а также указано, что они используют для подключения к Microsoft Graph: REST или клиентскую библиотеку Microsoft Graph.</span><span class="sxs-lookup"><span data-stu-id="a5937-p102">To explore the finished Connect samples, see [Microsoft Graph](https://github.com/microsoftgraph) in GitHub. The following table lists the samples by authentication provider and platform, and notes whether they connect to Microsoft Graph using REST or a Microsoft Graph client library.</span></span>
...
<table>
  <tr>
    <th><span data-ttu-id="a5937-109">Платформа</span><span class="sxs-lookup"><span data-stu-id="a5937-109">Platform</span></span></th>
    <th><span data-ttu-id="a5937-110">Конечная точка Azure AD</span><span class="sxs-lookup"><span data-stu-id="a5937-110">Azure AD endpoint</span></span></th> 
    <th><span data-ttu-id="a5937-111">Конечная точка Azure AD версии 2.0</span><span class="sxs-lookup"><span data-stu-id="a5937-111">Azure AD v2.0 endpoint</span></span></th>
  </tr>
  <tr>
    <td><span data-ttu-id="a5937-112">Android</span><span class="sxs-lookup"><span data-stu-id="a5937-112">Android</span></span></td>
    <td><span data-ttu-id="a5937-113">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="a5937-114">
  ...
  <tr>
    <td><span data-ttu-id="a5937-115">AngularJS</span><span class="sxs-lookup"><span data-stu-id="a5937-115">AngularJS</span></span></td>
    <td><span data-ttu-id="a5937-116">
        <a href="https://github.com/microsoftgraph/angular-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-116">
        <a href="https://github.com/microsoftgraph/angular-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td> 
        <td><span data-ttu-id="a5937-117">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="a5937-117">
  ...
  <tr>
    <td><span data-ttu-id="a5937-118">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a5937-118">ASP.NET</span></span></td>
    <td><span data-ttu-id="a5937-119">
        <a href="https://github.com/microsoftgraph/aspnet-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-119">
        <a href="https://github.com/microsoftgraph/aspnet-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td>     
    <td><span data-ttu-id="a5937-120">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="a5937-120">
  ...
  <tr>
    <td><span data-ttu-id="a5937-121">iOS (Obj-C)</span><span class="sxs-lookup"><span data-stu-id="a5937-121">iOS (Obj-C)</span></span></td>
    <td><span data-ttu-id="a5937-122">
        <a href="https://github.com/microsoftgraph/ios-objectivec-connect-rest-sample">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-122">
        <a href="https://github.com/microsoftgraph/ios-objectivec-connect-rest-sample">REST sample</a>
    </span></span></td>     
    <td><span data-ttu-id="a5937-123">
        <a href="https://github.com/microsoftgraph/ios-objectivec-connect-sample">Пример с использованием пакета SDK</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-123">
        <a href="https://github.com/microsoftgraph/ios-objectivec-connect-sample">SDK sample</a>
    </span></span></td> 
  </tr>
  <tr>
    <td><span data-ttu-id="a5937-124">iOS (Swift)</span><span class="sxs-lookup"><span data-stu-id="a5937-124">iOS (Swift)</span></span></td>
    <td><span data-ttu-id="a5937-125">
    ...
    <td><span data-ttu-id="a5937-126">
        <a href="https://github.com/microsoftgraph/ios-swift-connect-sample">Пример с использованием пакета SDK</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-126">
        <a href="https://github.com/microsoftgraph/ios-swift-connect-sample">SDK sample</a>
    </span></span></td> 
  </tr>
  <tr>
    <td><span data-ttu-id="a5937-127">NodeJS</span><span class="sxs-lookup"><span data-stu-id="a5937-127">NodeJS</span></span></td>
    <td><span data-ttu-id="a5937-128">
        <a href="https://github.com/microsoftgraph/nodejs-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-128">
        <a href="https://github.com/microsoftgraph/nodejs-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td>     
    <td>    
        <span data-ttu-id="a5937-129"><a href="https://github.com/microsoftgraph/nodejs-connect-sample">Пример с использованием пакета SDK</a> или <a href="https://github.com/microsoftgraph/nodejs-connect-rest-sample">REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-129"><a href="https://github.com/microsoftgraph/nodejs-connect-sample">SDK sample</a> or <a href="https://github.com/microsoftgraph/nodejs-connect-rest-sample">REST sample</a>
    </span></span></td> 
  </tr>
  <tr>
    <td><span data-ttu-id="a5937-130">PHP</span><span class="sxs-lookup"><span data-stu-id="a5937-130">PHP</span></span></td>
    <td><span data-ttu-id="a5937-131">
        <a href="https://github.com/microsoftgraph/php-connect-rest-sample/tree/last_v1_auth">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-131">
        <a href="https://github.com/microsoftgraph/php-connect-rest-sample/tree/last_v1_auth">REST sample</a>
    </span></span></td>     
    <td><span data-ttu-id="a5937-132">
    ...
    </span><span class="sxs-lookup"><span data-stu-id="a5937-132">
  ...
  <tr>
    <td><span data-ttu-id="a5937-133">Python</span><span class="sxs-lookup"><span data-stu-id="a5937-133">Python</span></span></td>
    <td><span data-ttu-id="a5937-134">
        <a href="https://github.com/microsoftgraph/python3-connect-rest-sample">Пример с использованием REST</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-134">
  ...
  <tr>
    ...
    </span><span class="sxs-lookup"><span data-stu-id="a5937-140">
  ...
  <tr>
    <td><span data-ttu-id="a5937-141">Xamarin</span><span class="sxs-lookup"><span data-stu-id="a5937-141">Xamarin</span></span></td>
    <td>
    </td>     
    <td><span data-ttu-id="a5937-142">
        <a href="https://github.com/microsoftgraph/xamarin-csharp-connect-sample">Пример с использованием пакета SDK</a>
    </span><span class="sxs-lookup"><span data-stu-id="a5937-142">
        <a href="https://github.com/microsoftgraph/xamarin-csharp-connect-sample">SDK sample</a>
    </span></span></td> 
  </tr>
</table>

## <a name="see-also"></a><span data-ttu-id="a5937-143">См. также</span><span class="sxs-lookup"><span data-stu-id="a5937-143">See also</span></span>
- <span data-ttu-id="a5937-144">Попробуйте примеры вызовов REST в нашем [обозревателе API](https://graph.microsoft.io/graph-explorer).</span><span class="sxs-lookup"><span data-stu-id="a5937-144">Try out sample REST calls in our [API Explorer](https://graph.microsoft.io/graph-explorer)</span></span>
- [<span data-ttu-id="a5937-145">Документация по конечной точке Azure AD</span><span class="sxs-lookup"><span data-stu-id="a5937-145">Azure AD endpoint documentation</span></span>](https://azure.microsoft.com/documentation/services/active-directory/)
- [<span data-ttu-id="a5937-146">Документация по конечной точке Azure AD версии 2.0</span><span class="sxs-lookup"><span data-stu-id="a5937-146">Azure AD v2.0 endpoint documentation</span></span>](https://azure.microsoft.com/documentation/articles/?service=active-directory&term=azure+ad+v2.0)

...
3. Добавьте всех участников (и гостей при необходимости) в группу с помощью операции [добавления участника](/graph/api/group-post-members?view=graph-rest-1.0), если это не сделано на шаге 1. При добавлении нескольких участников добавьте 1-секундную задержку после каждой операции добавления. 

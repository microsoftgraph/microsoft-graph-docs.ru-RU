...
Все команды поддерживаются группами Microsoft 365. Самый быстрый способ начать работу при создании команд с помощью Microsoft Graph — настроить новую группу Microsoft 365, всех ее владельцев и участников, а затем преобразовать ее в команду.

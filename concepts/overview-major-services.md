...
| Задачи To-Do | To-Do | Позволяет пользователям управлять своими личными задачами для работы и жизни. Они также интегрируются с Outlook, Teams, Планировщиком и Кортаной, что делает их единым центром для личных задач пользователя в Microsoft 365 | [Обзор задач To Do](todo-concept-overview.md) |

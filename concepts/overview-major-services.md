...
|Группы | Azure AD, OneDrive, OneNote, Outlook, Планировщик | Группа Office 365 — это основа для совместной работы. В группах пользователи могут обмениваться беседами, файлами, заметками, календарями планами и т. д. | [Обзор групп Office 365 в Microsoft Graph](office365-groups-concept-overview.md) |
...
|Компонент     |Вспомогательные службы  |Описание |Дополнительные сведения |
|:-----------|:--------------------|:-----------|:----------------|
| Сайты и списки  | SharePoint | Веб-платформа для пользователей и групп Office 365, на которой можно делиться контентом (в том числе списками, файлами и заметками), упорядочивать и искать его, а также управлять им. | [Обзор сайтов и контента SharePoint](sharepoint-concept-overview.md) | 
|Задачи и планы | Планировщик | Дает пользователям в группах Office 365 возможность создавать планы, назначать задачи и отслеживать ход их выполнения. | [Обзор планов и задач в Планировщике](planner-concept-overview.md) |
...
|:-----------|:--------------------|:-----------|:----------------|
| Социальная аналитика: люди | Azure AD, Outlook, SharePoint и т. д. | Получение информации о людях в порядке их релевантности для пользователя на основе шаблонов общения и совместной работы пользователей, а также их бизнес-связей.  | [Обзор социальной и рабочей аналитики в Microsoft Graph](social-intel-concept-overview.md) |
| Социальная аналитика: аналитика по документам (ознакомительная версия) | Delve, OneDrive, Outlook, SharePoint | Использование расширенной аналитики и методов машинного обучения для получения документов, популярных в среде пользователя, просмотренных или измененных пользователем, а также документов, к которым пользователь предоставил общий доступ.  | [Обзор социальной и рабочей аналитики в Microsoft Graph](social-intel-concept-overview.md)  |
| Социальная и рабочая аналитика: аналитические сведения (предварительная версия) | MyAnalytics | Использование расширенной аналитики и методов машинного обучения для получения сведений о том, как и с кем пользователи тратят свое время. Эти данные помогают пользователям спланировать свой день, получить аналитику о различных рабочих закономерностях и обеспечить баланс работы и личной жизни.  | [Обзор социальной и рабочей аналитики в Microsoft Graph](social-intel-concept-overview.md) |
...
|Компонент     |Вспомогательные службы  |Описание |Дополнительные сведения |
|:-----------|:--------------------|:-----------|:----------------|
|Устройства и приложения | Intune | Регистрация и настройка устройств, а также управление мобильными приложениями в организации. | [Обзор устройств и приложений в Intune](intune-concept-overview.md) |

...
## <a name="print-services"></a>Службы печати

|Функция     |Вспомогательные службы  |Описание |Дополнительные сведения |
|:-----------|:--------------------|:-----------|:----------------|
| Универсальная печать (предварительная версия) | Универсальная печать | Универсальная печать — это облачная инфраструктура печати Microsoft 365, которая обеспечивает простую и безопасную печать для пользователей и экономит время и усилия ИТ-персонала. | [Обзор API универсальной печати](universal-print-concept-overview.md) |

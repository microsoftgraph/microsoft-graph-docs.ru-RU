...
7. SDK получает изменения данных: в этом случае — новый контент уведомлений. 
...
```
Затем перейдите к классам действий, в которых нужно разместить функции подключенных устройств. Импортируйте следующие пространства имен.

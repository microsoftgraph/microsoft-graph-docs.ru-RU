...
* [Экспорт содержимого Teams](/graph/api/export-teams-content.md)
* [Создание подписки](/graph/api/subscription-post-subscriptions.md)
* [Обновление сообщения чата](/graph/api/chatmessage-update.md)
...
Обратите внимание, что за оплату отвечает организация, владеющая регистрацией приложения. Кроме того, требуется активная подписка Azure в том же клиенте. Для мультитенантных приложений организация может отличаться от организации, которая запускает приложение.

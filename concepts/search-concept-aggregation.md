...
- Свойство **Count** указывает количество таких объектов, собранных в том же сегменте. Обратите внимание, что это значение является приближением количества совпадений и не обеспечивает точное количество совпадений.

...
---
# <a name="configure-the-scope-of-your-access-review-definition-using-the-microsoft-graph-api"></a>Настройка области определения обзора доступа с помощью API microsoft Graph

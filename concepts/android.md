...
1. Войдите на [портал регистрации приложений Майкрософт](https://apps.dev.microsoft.com/), используя личную, рабочую или учебную учетную запись.
...
## <a name="authenticate-the-user-and-get-an-access-token"></a>Аутентификация пользователя и получение токена доступа

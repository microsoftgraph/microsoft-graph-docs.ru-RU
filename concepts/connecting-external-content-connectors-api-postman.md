...
ms.locfileid: "65176632"
---
# <a name="use-postman-with-the-microsoft-graph-connectors-api"></a>Использование Postman с API соединителей Microsoft Graph

В этой статье описывается, как можно использовать API-интерфейсы соединителя Microsoft Graph с Postman.
...
11. Выберите **Разрешения приложения**, введите "Пользователь" и выберите **Разрешения приложения**.
12. Разверните **Параметры пользователя** и выберите **`ExternalItem.ReadWrite.All`**.
...
15. В меню слева выберите **Обзор**. Отсюда вы можете получить идентификатор приложения (клиента) и идентификатор каталога (клиента). Они понадобятся вам на шаге 4.

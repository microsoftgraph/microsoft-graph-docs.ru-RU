...
Дополнительные сведения об областях разрешений и принципах их работы см. в разделе, посвященном [областям разрешений OneNote](permissions_reference.md#notes-permissions).

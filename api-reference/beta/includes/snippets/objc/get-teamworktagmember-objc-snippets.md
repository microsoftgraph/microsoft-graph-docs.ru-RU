...
ms.openlocfilehash: 560aa1da2edc8813f093d567fd995aedb50fcb04062a1ccdba39087f85db6797
ms.sourcegitcommit: 986c33b848fa22a153f28437738953532b78c051
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/05/2021
ms.locfileid: "57209714"
---
```objc
...
MSURLSessionDataTask *meDataTask = [httpClient dataTaskWithRequest:urlRequest 
    completionHandler: ^(NSData *data, NSURLResponse *response, NSError *nserror) {
        ...
        MSGraphTeamworkTagMember *teamworkTagMember = [[MSGraphTeamworkTagMember alloc] initWithData:data error:&nserror];

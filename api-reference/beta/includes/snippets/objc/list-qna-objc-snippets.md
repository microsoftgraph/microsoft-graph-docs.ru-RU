...
ms.openlocfilehash: 6054ec5449219ab3146f63df787fc76d9235fad3
...
MSURLSessionDataTask *meDataTask = [httpClient dataTaskWithRequest:urlRequest 
    completionHandler: ^(NSData *data, NSURLResponse *response, NSError *nserror) {
        ...
        MSGraphQna *qna = [[MSGraphQna alloc] initWithDictionary:[[collection value] objectAtIndex: 0] error:&nserror];

...
Обновление схемы синхронизации для заданного задания или шаблона. Этот метод полностью заменяет текущую схему схемой, предоставленной в запросе. Чтобы обновить схему шаблона, вызовите объект приложения. Вы должны быть владельцем приложения.
...
В теле запроса укажи объект [synchronizationSchema](../resources/synchronization-synchronizationschema.md) для замены существующей схемы.
...
>**Примечание.** Показанный здесь объект запроса сокращен для учитаемости. Укавите все свойства в реальном вызове.

...
---
# <a name="get-macoscertificateprofilebase"></a>Get macOSCertificateProfileBase
...
Чтение свойств и связей объекта [macOSCertificateProfileBase.](../resources/intune-deviceconfig-macoscertificateprofilebase.md)
...
В случае успеха этот метод возвращает код ответа и `200 OK` [объект macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) в тексте ответа.

...
Запись данных качества видеоконференций для видеоконференций.
...
| User — Agent    | Описывает имя и версию вызывающего приложения. Подробные сведения отображаются в Azure Information Protection Analytics. Рекомендуемый формат — ApplicationName/Version. Обязательный элемент.|
...
|:-------------|:------------|:------------|
|отображения|[телеконференцедевицекуалити](../resources/teleconferencedevicequality.md)|Данные о качестве VTCной стороны носителя.|

...
Создание нового объекта [bookingCustomer](../resources/bookingcustomer.md) .
...
Успешно завершена, этот метод возвращает `201, Created` объект [bookingCustomer](../resources/bookingcustomer.md) и кода ответа в теле ответа.

...
Обновление свойства объекта [groupPolicyPresentationValueList](../resources/intune-grouppolicy-grouppolicypresentationvaluelist.md) .
...
В тексте запроса укажите представление JSON для объекта [groupPolicyPresentationValueList](../resources/intune-grouppolicy-grouppolicypresentationvaluelist.md) .

В следующей таблице показаны свойства, которые необходимы для создания [groupPolicyPresentationValueList](../resources/intune-grouppolicy-grouppolicypresentationvaluelist.md).
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и обновленные [groupPolicyPresentationValueList](../resources/intune-grouppolicy-grouppolicypresentationvaluelist.md) объекта в теле ответа.

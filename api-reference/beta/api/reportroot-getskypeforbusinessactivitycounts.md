...
В случае успешной работы этот метод возвращает код отклика и `200 OK` **[объект SkypeForBusinessActivityCounts](../resources/skypeforbusinessactivitycounts.md)** в тексте ответа.

...
ms.openlocfilehash: 38783b7ea2c4f8e0fcf23e98da6a29a0c79cb1ab
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "61019493"
---
# <a name="list-educationalactivities"></a>List educationalActivities

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение списка [объектов educationalActivity](../resources/educationalactivity.md) из профиля [пользователя.](../resources/profile.md)
...
В случае успешной работы этот метод возвращает код ответа и коллекцию `200 OK` объектов [educationalActivity](../resources/educationalactivity.md) в тексте ответа.

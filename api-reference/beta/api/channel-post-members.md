...
```
### <a name="example-6-add-a-user-who-is-part-of-the-same-or-a-different-tenant-as-a-member-to-a-shared-channel-using-user-principal-name"></a>Пример 6. Добавление пользователя, который является частью того же или другого клиента в качестве участника, в общий канал с использованием имени участника-пользователя

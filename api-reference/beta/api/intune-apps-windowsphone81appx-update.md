...
Обновление свойства объекта [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) .
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и обновленные [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) объекта в теле ответа.

...
---
# <a name="delete-microsofttunnelconfiguration"></a>Удаление Микрософттуннелконфигуратион
...
Удаляет объект [микрософттуннелконфигуратион](../resources/intune-mstunnel-microsofttunnelconfiguration.md).

...
---
# <a name="get-suspiciousipriskevent-deprecated"></a>Get suspiciousIpRiskEvent (deprecated)
...
Извлечение свойств и связей объекта suspiciousipriskevent.
...
В случае успешной работы этот метод возвращает код ответа и подозрительный `200 OK` [объектIpRiskEvent](../resources/suspiciousipriskevent.md) в тексте ответа.

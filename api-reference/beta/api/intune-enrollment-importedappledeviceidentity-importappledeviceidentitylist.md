...
ms.openlocfilehash: ff368dbb0b397a19f10552eaf656a9d12202e613
ms.sourcegitcommit: 6c04234af08efce558e9bf926062b4686a84f1b2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/12/2021
ms.locfileid: "59052176"
---
...
|:---|:---|:---|
|importedAppleDeviceIdentities|[importedAppleDeviceIdentity collection](../resources/intune-enrollment-importedappledeviceidentity.md)|Пока не задокументировано.|
|overwriteImportedDeviceIdentities|Boolean|Н/Д|



## <a name="response"></a>Ответ
В случае успеха это действие возвращает код ответа и импортируемую `200 OK` [коллекциюAppleDeviceIdentityResult](../resources/intune-enrollment-importedappledeviceidentityresult.md) в тексте ответа.

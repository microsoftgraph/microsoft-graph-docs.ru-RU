...
Создайте сеанс отправки, который позволяет приложению итеративно загружать диапазоны файла, чтобы встроить файл в элемент Outlook. Элемент может быть [сообщением или](../resources/message.md) [событием.](../resources/event.md)
...
Ниже обзор действий по прикреплению файла к элементу Outlook с помощью сеанса отправки.
...
См. пример прикрепления больших файлов к сообщениям или [событиям Outlook.](/graph/outlook-large-attachments)
...
Чтобы создать сеанс отправки для вложения файла в **сообщение:** 

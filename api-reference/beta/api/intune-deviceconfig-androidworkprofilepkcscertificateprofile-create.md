...
ms.openlocfilehash: cb1cfff69cd387d4c113d53285b0b3c6aa356bfef1c4853c97a51fb18bc9ec17
...
---
# <a name="create-androidworkprofilepkcscertificateprofile"></a>Создание androidWorkProfilePkcsCertificateProfile
...
Создайте [новый объект AndroidWorkProfilePkcsCertificateProfile.](../resources/intune-deviceconfig-androidworkprofilepkcscertificateprofile.md)
...
В корпусе запроса поставляем представление JSON для объекта AndroidWorkProfilePkcsCertificateProfile.

В следующей таблице показаны свойства, необходимые при создании androidWorkProfilePkcsCertificateProfile.
...
В случае успеха этот метод возвращает код отклика и `201 Created` [объект AndroidWorkProfilePkcsCertificateProfile](../resources/intune-deviceconfig-androidworkprofilepkcscertificateprofile.md) в теле отклика.

...
Создайте, обновив или удалив приложения, не выполняя полное чтение всей коллекции ресурсов. Подробные [сведения см. в](/graph/delta-query-overview) этой теме.
...
В случае успеха этот метод возвращает код отклика и объект коллекции приложений `200 OK` в тексте [](../resources/application.md) отклика. Ответ также включает URL-адрес nextLink или URL-адрес deltaLink. 

...
В случае успешного применения этот метод возвращает объект кода отклика и коллекции `200 OK` приложений в тексте отклика. [](../resources/application.md) Ответ также включает URL-адрес nextLink или URL-адрес deltaLink. 

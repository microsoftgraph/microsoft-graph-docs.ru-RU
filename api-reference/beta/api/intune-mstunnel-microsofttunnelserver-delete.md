...
---
# <a name="delete-microsofttunnelserver"></a>Удаление Микрософттуннелсервер
...
Удаляет объект [микрософттуннелсервер](../resources/intune-mstunnel-microsofttunnelserver.md).

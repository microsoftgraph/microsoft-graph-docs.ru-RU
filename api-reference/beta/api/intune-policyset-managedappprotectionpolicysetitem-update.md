...
ms.openlocfilehash: bdaaa8ea18d4ac087e8a56734ae47bbc9c942ee0
ms.sourcegitcommit: dcf237b515e70302aec0d0c490feb1de7a60613e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/31/2021
ms.locfileid: "58783640"
---
# <a name="update-managedappprotectionpolicysetitem"></a>Обновление управляемогоAppProtectionPolicySetItem
...
Обновление свойств управляемого [объектаAppProtectionPolicySetItem.](../resources/intune-policyset-managedappprotectionpolicysetitem.md)
...
В теле запроса поставляем представление JSON для объекта [managedAppProtectionPolicySetItem.](../resources/intune-policyset-managedappprotectionpolicysetitem.md)

В следующей таблице показаны свойства, необходимые при создании [управляемогоAppProtectionPolicySetItem.](../resources/intune-policyset-managedappprotectionpolicysetitem.md)
...
В случае успешной работы этот метод возвращает код ответа и обновленный управляемый `200 OK` [объектAppProtectionPolicySetItem](../resources/intune-policyset-managedappprotectionpolicysetitem.md) в тексте ответа.

...
---
# <a name="list-privilegedroles"></a>Список privilegedRoles
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и коллекцию объектов [privilegedRole](../resources/privilegedrole.md) в теле ответа.

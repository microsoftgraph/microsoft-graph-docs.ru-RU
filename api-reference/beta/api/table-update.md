...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и [обновленный объект](../resources/workbooktable.md) таблицы в тексте отклика.

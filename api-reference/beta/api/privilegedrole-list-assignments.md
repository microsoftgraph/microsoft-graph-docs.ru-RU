...
Получение списка объектов [privilegedRoleAssignment](../resources/privilegedroleassignment.md) , связанных с ролью. Каждый [privilegedRoleAssignment](../resources/privilegedroleassignment.md) представляет назначения ролей для пользователя.

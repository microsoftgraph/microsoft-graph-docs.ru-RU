...
Обновление свойств объекта Currency для Dynamics 365 Business Central.
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и обновленный объект **валюты** в теле отклика.

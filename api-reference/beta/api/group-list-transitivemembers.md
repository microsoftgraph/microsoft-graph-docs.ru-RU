...
Получение списка участников группы. В качестве участников группы могут быть пользователи, контакты, устройства, субъекты-службы и другие группы. Эта операция является транзитивной и также возвращает плоский список всех вложенных элементов.

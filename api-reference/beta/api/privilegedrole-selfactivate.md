...
|duration|string|Необязательно. Допустимые значения могут быть (минимальная продолжительность активации), (продолжительность активации по умолчанию для роли) или двойное значение, чтобы указать, сколько часов ```min``` ```default``` является активацией. Указанная продолжительность не может быть больше, чем продолжительность активации роли из параметра роли. |
|ticketNumber|string|Необязательно. Номер билета, используемый для отслеживания активации этой роли.|

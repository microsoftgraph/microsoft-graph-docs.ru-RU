...
ms.locfileid: "31772617"
---
# <a name="updatedeviceprofileassignment-action"></a><span data-ttu-id="f9b82-103">Действие updateDeviceProfileAssignment</span><span class="sxs-lookup"><span data-stu-id="f9b82-103">updateDeviceProfileAssignment action</span></span>
...
> <span data-ttu-id="f9b82-105">**Примечание:** Для API Microsoft Graph для Intune требуется [Активная лицензия Intune](https://go.microsoft.com/fwlink/?linkid=839381) для клиента.</span><span class="sxs-lookup"><span data-stu-id="f9b82-105">**Note:** The Microsoft Graph API for Intune requires an [active Intune license](https://go.microsoft.com/fwlink/?linkid=839381) for the tenant.</span></span>

<span data-ttu-id="f9b82-106">Пока не задокументировано.</span><span class="sxs-lookup"><span data-stu-id="f9b82-106">Not yet documented</span></span>

## <a name="prerequisites"></a><span data-ttu-id="f9b82-107">Предварительные условия</span><span class="sxs-lookup"><span data-stu-id="f9b82-107">Prerequisites</span></span>
...
|<span data-ttu-id="f9b82-116">Для приложений</span><span class="sxs-lookup"><span data-stu-id="f9b82-116">Application</span></span>|<span data-ttu-id="f9b82-117">Не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="f9b82-117">Not supported.</span></span>|
...
## <a name="request-headers"></a><span data-ttu-id="f9b82-119">Заголовки запросов</span><span class="sxs-lookup"><span data-stu-id="f9b82-119">Request headers</span></span>
...
<span data-ttu-id="f9b82-127">В тело запроса добавьте параметры в формате JSON.</span><span class="sxs-lookup"><span data-stu-id="f9b82-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="f9b82-128">В приведенной ниже таблице указаны параметры, которые можно использовать с этим действием.</span><span class="sxs-lookup"><span data-stu-id="f9b82-128">The following table shows the parameters that can be used with this action.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="f9b82-132">Девицеидс</span><span class="sxs-lookup"><span data-stu-id="f9b82-132">deviceIds</span></span>|<span data-ttu-id="f9b82-133">Коллекция строк</span><span class="sxs-lookup"><span data-stu-id="f9b82-133">String collection</span></span>|<span data-ttu-id="f9b82-134">Н/Д</span><span class="sxs-lookup"><span data-stu-id="f9b82-134">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="f9b82-135">Ответ</span><span class="sxs-lookup"><span data-stu-id="f9b82-135">Response</span></span>
<span data-ttu-id="f9b82-136">В случае успешного выполнения это действие возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="f9b82-136">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="f9b82-137">Пример</span><span class="sxs-lookup"><span data-stu-id="f9b82-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="f9b82-138">Запрос</span><span class="sxs-lookup"><span data-stu-id="f9b82-138">Request</span></span>
<span data-ttu-id="f9b82-139">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="f9b82-139">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="f9b82-140">Отклик</span><span class="sxs-lookup"><span data-stu-id="f9b82-140">Response</span></span>
<span data-ttu-id="f9b82-p102">Ниже приведен пример ответа. Примечание. Объект отклика, показанный здесь, может быть усечен для краткости. При фактическом вызове будут возвращены все свойства.</span><span class="sxs-lookup"><span data-stu-id="f9b82-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http

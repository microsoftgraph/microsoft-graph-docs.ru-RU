...
---
# <a name="get-customerpayments"></a>Get customerPayments

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение свойств и связей объекта оплаты клиента для Центра бизнеса Dynamics 365.
...
В случае успешного выполнения этот метод возвращает код отклика и объект `200 OK` **customerPayments** в тексте ответа.

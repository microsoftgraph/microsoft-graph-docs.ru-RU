---
title: Удаление объекта mobileAppTroubleshootingEvent
description: Описывает метод Delete mobileAppTroubleshootingEvent microsoft API Graph for Intune, который поддерживает несколько рабочих процессов.
...
ms.locfileid: "66436639"
---
# <a name="delete-mobileapptroubleshootingevent"></a>Удаление объекта mobileAppTroubleshootingEvent
...
Удаляет объект [mobileAppTroubleshootingEvent](../resources/intune-shared-mobileapptroubleshootingevent.md).

...
---
# <a name="create-paymentterms"></a>Создание paymentTerms

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Создание объекта терминов оплаты в Центре бизнеса Dynamics 365.
...
В теле запроса поставляем представление JSON объекта **paymentTerms.**

## <a name="response"></a>Отклик
В случае успешной работы этот метод возвращает код отклика и объект ```201 Created``` **paymentTerms** в тексте ответа.

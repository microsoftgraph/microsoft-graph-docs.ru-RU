...
---
# <a name="list-ediscoverycases"></a>Список Едисковерикасес

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение списка объектов [едисковерикасе](../resources/ediscoverycase.md) .
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и коллекцию объектов [едисковерикасе](../resources/ediscoverycase.md) в тексте отклика.

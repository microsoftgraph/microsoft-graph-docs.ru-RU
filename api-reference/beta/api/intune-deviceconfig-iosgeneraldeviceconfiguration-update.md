...
## <a name="http-request"></a><span data-ttu-id="2a19c-118">HTTP-запрос</span><span class="sxs-lookup"><span data-stu-id="2a19c-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
...
|<span data-ttu-id="2a19c-167">description</span><span class="sxs-lookup"><span data-stu-id="2a19c-167">description</span></span>|<span data-ttu-id="2a19c-168">String</span><span class="sxs-lookup"><span data-stu-id="2a19c-168">String</span></span>|<span data-ttu-id="2a19c-169">Указанное администратором описание конфигурации устройства.</span><span class="sxs-lookup"><span data-stu-id="2a19c-169">Admin provided description of the Device Configuration.</span></span> <span data-ttu-id="2a19c-170">Наследуется от объекта [deviceConfiguration](../resources/intune-shared-deviceconfiguration.md).</span><span class="sxs-lookup"><span data-stu-id="2a19c-170">Inherited from [deviceConfiguration](../resources/intune-shared-deviceconfiguration.md)</span></span>|
...
|<span data-ttu-id="2a19c-253">cellularBlockPersonalHotspot</span><span class="sxs-lookup"><span data-stu-id="2a19c-253">cellularBlockPersonalHotspot</span></span>|<span data-ttu-id="2a19c-254">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-254">Boolean</span></span>|<span data-ttu-id="2a19c-255">Указывает, следует ли заблокировать личный хот-спот.</span><span class="sxs-lookup"><span data-stu-id="2a19c-255">Indicates whether or not to block Personal Hotspot.</span></span>|
...
|<span data-ttu-id="2a19c-304">diagnosticDataBlockSubmissionModification</span><span class="sxs-lookup"><span data-stu-id="2a19c-304">diagnosticDataBlockSubmissionModification</span></span>|<span data-ttu-id="2a19c-305">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-305">Boolean</span></span>|<span data-ttu-id="2a19c-306">Указывает, можно ли изменять настройки отправки диагностической информации, когда устройство находится в защищенном режиме (iOS 9.3.2 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-306">Indicates whether or not to allow diagnostics submission settings modification when the device is in supervised mode (iOS 9.3.2 and later).</span></span>|
...
|<span data-ttu-id="2a19c-362">iCloudBlockManagedAppsSync</span><span class="sxs-lookup"><span data-stu-id="2a19c-362">iCloudBlockManagedAppsSync</span></span>|<span data-ttu-id="2a19c-363">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-363">Boolean</span></span>|<span data-ttu-id="2a19c-364">Указывает, следует ли заблокировать облачную синхронизацию управляемых приложений.</span><span class="sxs-lookup"><span data-stu-id="2a19c-364">Indicates whether or not to block Managed Apps Cloud Sync.</span></span>|
...
|<span data-ttu-id="2a19c-419">kioskModeAllowRingerSwitch</span><span class="sxs-lookup"><span data-stu-id="2a19c-419">kioskModeAllowRingerSwitch</span></span>|<span data-ttu-id="2a19c-420">Boolean</span><span class="sxs-lookup"><span data-stu-id="2a19c-420">Boolean</span></span>|<span data-ttu-id="2a19c-421">Указывает, можно ли использовать переключатель звонка в режиме киоска.</span><span class="sxs-lookup"><span data-stu-id="2a19c-421">Indicates whether or not to allow use of the ringer switch while in kiosk mode.</span></span> <span data-ttu-id="2a19c-422">Функция этого свойства является избыточной по умолчанию для ОС и является устаревшей.</span><span class="sxs-lookup"><span data-stu-id="2a19c-422">This property's functionality is redundant with the OS default and is deprecated.</span></span> <span data-ttu-id="2a19c-423">Вместо этого используйте Киоскмодеблоккринжерсвитч.</span><span class="sxs-lookup"><span data-stu-id="2a19c-423">Use KioskModeBlockRingerSwitch instead.</span></span>|
...
|<span data-ttu-id="2a19c-448">киоскмодеблокктаучскрин</span><span class="sxs-lookup"><span data-stu-id="2a19c-448">kioskModeBlockTouchscreen</span></span>|<span data-ttu-id="2a19c-449">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-449">Boolean</span></span>|<span data-ttu-id="2a19c-450">Указывает, следует ли запретить использование сенсорного экрана в режиме киоска.</span><span class="sxs-lookup"><span data-stu-id="2a19c-450">Indicates whether or not to block use of the touchscreen while in kiosk mode.</span></span>|
...
|<span data-ttu-id="2a19c-479">kioskModeRequireAssistiveTouch</span><span class="sxs-lookup"><span data-stu-id="2a19c-479">kioskModeRequireAssistiveTouch</span></span>|<span data-ttu-id="2a19c-480">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-480">Boolean</span></span>|<span data-ttu-id="2a19c-481">Указывает, обязательно ли использовать сенсорное управление со специальными возможностями в режиме киоска.</span><span class="sxs-lookup"><span data-stu-id="2a19c-481">Indicates whether or not to require assistive touch while in kiosk mode.</span></span>|
...
|<span data-ttu-id="2a19c-510">mediaContentRatingAustralia</span><span class="sxs-lookup"><span data-stu-id="2a19c-510">mediaContentRatingAustralia</span></span>|[<span data-ttu-id="2a19c-511">mediaContentRatingAustralia</span><span class="sxs-lookup"><span data-stu-id="2a19c-511">mediaContentRatingAustralia</span></span>](../resources/intune-deviceconfig-mediacontentratingaustralia.md)|<span data-ttu-id="2a19c-512">Настройки возрастных ограничений для Австралии</span><span class="sxs-lookup"><span data-stu-id="2a19c-512">Media content rating settings for Australia</span></span>|
|<span data-ttu-id="2a19c-513">mediaContentRatingCanada</span><span class="sxs-lookup"><span data-stu-id="2a19c-513">mediaContentRatingCanada</span></span>|[<span data-ttu-id="2a19c-514">mediaContentRatingCanada</span><span class="sxs-lookup"><span data-stu-id="2a19c-514">mediaContentRatingCanada</span></span>](../resources/intune-deviceconfig-mediacontentratingcanada.md)|<span data-ttu-id="2a19c-515">Настройки возрастных ограничений для Канады</span><span class="sxs-lookup"><span data-stu-id="2a19c-515">Media content rating settings for Canada</span></span>|
|<span data-ttu-id="2a19c-516">mediaContentRatingFrance</span><span class="sxs-lookup"><span data-stu-id="2a19c-516">mediaContentRatingFrance</span></span>|[<span data-ttu-id="2a19c-517">mediaContentRatingFrance</span><span class="sxs-lookup"><span data-stu-id="2a19c-517">mediaContentRatingFrance</span></span>](../resources/intune-deviceconfig-mediacontentratingfrance.md)|<span data-ttu-id="2a19c-518">Настройки возрастных ограничений для Франции</span><span class="sxs-lookup"><span data-stu-id="2a19c-518">Media content rating settings for France</span></span>|
|<span data-ttu-id="2a19c-519">mediaContentRatingGermany</span><span class="sxs-lookup"><span data-stu-id="2a19c-519">mediaContentRatingGermany</span></span>|[<span data-ttu-id="2a19c-520">mediaContentRatingGermany</span><span class="sxs-lookup"><span data-stu-id="2a19c-520">mediaContentRatingGermany</span></span>](../resources/intune-deviceconfig-mediacontentratinggermany.md)|<span data-ttu-id="2a19c-521">Настройки возрастных ограничений для Германии</span><span class="sxs-lookup"><span data-stu-id="2a19c-521">Media content rating settings for Germany</span></span>|
|<span data-ttu-id="2a19c-522">mediaContentRatingIreland</span><span class="sxs-lookup"><span data-stu-id="2a19c-522">mediaContentRatingIreland</span></span>|[<span data-ttu-id="2a19c-523">mediaContentRatingIreland</span><span class="sxs-lookup"><span data-stu-id="2a19c-523">mediaContentRatingIreland</span></span>](../resources/intune-deviceconfig-mediacontentratingireland.md)|<span data-ttu-id="2a19c-524">Настройки возрастных ограничений для Ирландии</span><span class="sxs-lookup"><span data-stu-id="2a19c-524">Media content rating settings for Ireland</span></span>|
|<span data-ttu-id="2a19c-525">mediaContentRatingJapan</span><span class="sxs-lookup"><span data-stu-id="2a19c-525">mediaContentRatingJapan</span></span>|[<span data-ttu-id="2a19c-526">mediaContentRatingJapan</span><span class="sxs-lookup"><span data-stu-id="2a19c-526">mediaContentRatingJapan</span></span>](../resources/intune-deviceconfig-mediacontentratingjapan.md)|<span data-ttu-id="2a19c-527">Настройки возрастных ограничений для Японии</span><span class="sxs-lookup"><span data-stu-id="2a19c-527">Media content rating settings for Japan</span></span>|
|<span data-ttu-id="2a19c-528">mediaContentRatingNewZealand</span><span class="sxs-lookup"><span data-stu-id="2a19c-528">mediaContentRatingNewZealand</span></span>|[<span data-ttu-id="2a19c-529">mediaContentRatingNewZealand</span><span class="sxs-lookup"><span data-stu-id="2a19c-529">mediaContentRatingNewZealand</span></span>](../resources/intune-deviceconfig-mediacontentratingnewzealand.md)|<span data-ttu-id="2a19c-530">Настройки возрастных ограничений для Новой Зеландии</span><span class="sxs-lookup"><span data-stu-id="2a19c-530">Media content rating settings for New Zealand</span></span>|
|<span data-ttu-id="2a19c-531">mediaContentRatingUnitedKingdom</span><span class="sxs-lookup"><span data-stu-id="2a19c-531">mediaContentRatingUnitedKingdom</span></span>|[<span data-ttu-id="2a19c-532">mediaContentRatingUnitedKingdom</span><span class="sxs-lookup"><span data-stu-id="2a19c-532">mediaContentRatingUnitedKingdom</span></span>](../resources/intune-deviceconfig-mediacontentratingunitedkingdom.md)|<span data-ttu-id="2a19c-533">Настройки возрастных ограничений для Соединенного Королевства</span><span class="sxs-lookup"><span data-stu-id="2a19c-533">Media content rating settings for United Kingdom</span></span>|
|<span data-ttu-id="2a19c-534">mediaContentRatingUnitedStates</span><span class="sxs-lookup"><span data-stu-id="2a19c-534">mediaContentRatingUnitedStates</span></span>|[<span data-ttu-id="2a19c-535">mediaContentRatingUnitedStates</span><span class="sxs-lookup"><span data-stu-id="2a19c-535">mediaContentRatingUnitedStates</span></span>](../resources/intune-deviceconfig-mediacontentratingunitedstates.md)|<span data-ttu-id="2a19c-536">Настройки возрастных ограничений для Соединенных Штатов</span><span class="sxs-lookup"><span data-stu-id="2a19c-536">Media content rating settings for United States</span></span>|
|<span data-ttu-id="2a19c-537">networkUsageRules</span><span class="sxs-lookup"><span data-stu-id="2a19c-537">networkUsageRules</span></span>|<span data-ttu-id="2a19c-538">Коллекция [iosNetworkUsageRule](../resources/intune-deviceconfig-iosnetworkusagerule.md)</span><span class="sxs-lookup"><span data-stu-id="2a19c-538">[iosNetworkUsageRule](../resources/intune-deviceconfig-iosnetworkusagerule.md) collection</span></span>|<span data-ttu-id="2a19c-539">Список управляемых приложений и сетевых правил, которые к ним применяются.</span><span class="sxs-lookup"><span data-stu-id="2a19c-539">List of managed apps and the network rules that applies to them.</span></span> <span data-ttu-id="2a19c-540">Эта коллекция может содержать не более 1000 элементов.</span><span class="sxs-lookup"><span data-stu-id="2a19c-540">This collection can contain a maximum of 1000 elements.</span></span>|
|<span data-ttu-id="2a19c-541">mediaContentRatingApps</span><span class="sxs-lookup"><span data-stu-id="2a19c-541">mediaContentRatingApps</span></span>|[<span data-ttu-id="2a19c-542">ратингаппстипе</span><span class="sxs-lookup"><span data-stu-id="2a19c-542">ratingAppsType</span></span>](../resources/intune-deviceconfig-ratingappstype.md)|<span data-ttu-id="2a19c-543">Параметры оценки контента мультимедиа для приложений.</span><span class="sxs-lookup"><span data-stu-id="2a19c-543">Media content rating settings for Apps.</span></span> <span data-ttu-id="2a19c-544">Возможные значения: `allAllowed`, `allBlocked`, `agesAbove4`, `agesAbove9`, `agesAbove12`, `agesAbove17`.</span><span class="sxs-lookup"><span data-stu-id="2a19c-544">Possible values are: `allAllowed`, `allBlocked`, `agesAbove4`, `agesAbove9`, `agesAbove12`, `agesAbove17`.</span></span>|
|<span data-ttu-id="2a19c-545">messagesBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-545">messagesBlocked</span></span>|<span data-ttu-id="2a19c-546">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-546">Boolean</span></span>|<span data-ttu-id="2a19c-547">Указывает, следует ли запретить использовать приложение "Сообщения" на защищенном устройстве.</span><span class="sxs-lookup"><span data-stu-id="2a19c-547">Indicates whether or not to block the user from using the Messages app on the supervised device.</span></span>|
|<span data-ttu-id="2a19c-548">notificationsBlockSettingsModification</span><span class="sxs-lookup"><span data-stu-id="2a19c-548">notificationsBlockSettingsModification</span></span>|<span data-ttu-id="2a19c-549">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-549">Boolean</span></span>|<span data-ttu-id="2a19c-550">Указывает, можно ли изменять настройки уведомлений (iOS 9.3 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-550">Indicates whether or not to allow notifications settings modification (iOS 9.3 and later).</span></span>|
|<span data-ttu-id="2a19c-551">passcodeBlockFingerprintUnlock</span><span class="sxs-lookup"><span data-stu-id="2a19c-551">passcodeBlockFingerprintUnlock</span></span>|<span data-ttu-id="2a19c-552">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-552">Boolean</span></span>|<span data-ttu-id="2a19c-553">Указывает, следует ли запретить разблокировку с помощью отпечатка пальца.</span><span class="sxs-lookup"><span data-stu-id="2a19c-553">Indicates whether or not to block fingerprint unlock.</span></span>|
|<span data-ttu-id="2a19c-554">passcodeBlockFingerprintModification</span><span class="sxs-lookup"><span data-stu-id="2a19c-554">passcodeBlockFingerprintModification</span></span>|<span data-ttu-id="2a19c-555">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-555">Boolean</span></span>|<span data-ttu-id="2a19c-556">Позволяет заблокировать изменение зарегистрированных отпечатков пальцев Touch ID в защищенном режиме.</span><span class="sxs-lookup"><span data-stu-id="2a19c-556">Block modification of registered Touch ID fingerprints when in supervised mode.</span></span>|
|<span data-ttu-id="2a19c-557">passcodeBlockModification</span><span class="sxs-lookup"><span data-stu-id="2a19c-557">passcodeBlockModification</span></span>|<span data-ttu-id="2a19c-558">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-558">Boolean</span></span>|<span data-ttu-id="2a19c-559">Указывает, можно ли изменять секретный код на защищенном устройстве (iOS 9.0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-559">Indicates whether or not to allow passcode modification on the supervised device (iOS 9.0 and later).</span></span>|
|<span data-ttu-id="2a19c-560">passcodeBlockSimple</span><span class="sxs-lookup"><span data-stu-id="2a19c-560">passcodeBlockSimple</span></span>|<span data-ttu-id="2a19c-561">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-561">Boolean</span></span>|<span data-ttu-id="2a19c-562">Указывает, следует ли заблокировать простые секретные коды.</span><span class="sxs-lookup"><span data-stu-id="2a19c-562">Indicates whether or not to block simple passcodes.</span></span>|
|<span data-ttu-id="2a19c-563">passcodeExpirationDays</span><span class="sxs-lookup"><span data-stu-id="2a19c-563">passcodeExpirationDays</span></span>|<span data-ttu-id="2a19c-564">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-564">Int32</span></span>|<span data-ttu-id="2a19c-565">Количество дней до окончания срока действия секретного кода.</span><span class="sxs-lookup"><span data-stu-id="2a19c-565">Number of days before the passcode expires.</span></span> <span data-ttu-id="2a19c-566">Допустимые значения: от 1 до 65 535.</span><span class="sxs-lookup"><span data-stu-id="2a19c-566">Valid values 1 to 65535</span></span>|
|<span data-ttu-id="2a19c-567">passcodeMinimumLength</span><span class="sxs-lookup"><span data-stu-id="2a19c-567">passcodeMinimumLength</span></span>|<span data-ttu-id="2a19c-568">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-568">Int32</span></span>|<span data-ttu-id="2a19c-569">Минимальная длина секретного кода.</span><span class="sxs-lookup"><span data-stu-id="2a19c-569">Minimum length of passcode.</span></span> <span data-ttu-id="2a19c-570">Допустимые значения: от 4 до 14.</span><span class="sxs-lookup"><span data-stu-id="2a19c-570">Valid values 4 to 14</span></span>|
|<span data-ttu-id="2a19c-571">passcodeMinutesOfInactivityBeforeLock</span><span class="sxs-lookup"><span data-stu-id="2a19c-571">passcodeMinutesOfInactivityBeforeLock</span></span>|<span data-ttu-id="2a19c-572">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-572">Int32</span></span>|<span data-ttu-id="2a19c-573">Период бездействия (в минутах) до запроса пароля.</span><span class="sxs-lookup"><span data-stu-id="2a19c-573">Minutes of inactivity before a passcode is required.</span></span>|
|<span data-ttu-id="2a19c-574">passcodeMinutesOfInactivityBeforeScreenTimeout</span><span class="sxs-lookup"><span data-stu-id="2a19c-574">passcodeMinutesOfInactivityBeforeScreenTimeout</span></span>|<span data-ttu-id="2a19c-575">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-575">Int32</span></span>|<span data-ttu-id="2a19c-576">Время с момента последнего действия до отключения экрана (в минутах).</span><span class="sxs-lookup"><span data-stu-id="2a19c-576">Minutes of inactivity before the screen times out.</span></span>|
|<span data-ttu-id="2a19c-577">passcodeMinimumCharacterSetCount</span><span class="sxs-lookup"><span data-stu-id="2a19c-577">passcodeMinimumCharacterSetCount</span></span>|<span data-ttu-id="2a19c-578">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-578">Int32</span></span>|<span data-ttu-id="2a19c-579">Количество наборов символов, которые должен содержать секретный код.</span><span class="sxs-lookup"><span data-stu-id="2a19c-579">Number of character sets a passcode must contain.</span></span> <span data-ttu-id="2a19c-580">Допустимые значения: от 0 до 4.</span><span class="sxs-lookup"><span data-stu-id="2a19c-580">Valid values 0 to 4</span></span>|
|<span data-ttu-id="2a19c-581">passcodePreviousPasscodeBlockCount</span><span class="sxs-lookup"><span data-stu-id="2a19c-581">passcodePreviousPasscodeBlockCount</span></span>|<span data-ttu-id="2a19c-582">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-582">Int32</span></span>|<span data-ttu-id="2a19c-583">Количество предыдущих секретных кодов, которые следует блокировать.</span><span class="sxs-lookup"><span data-stu-id="2a19c-583">Number of previous passcodes to block.</span></span> <span data-ttu-id="2a19c-584">Допустимые значения: от 1 до 24.</span><span class="sxs-lookup"><span data-stu-id="2a19c-584">Valid values 1 to 24</span></span>|
|<span data-ttu-id="2a19c-585">passcodeSignInFailureCountBeforeWipe</span><span class="sxs-lookup"><span data-stu-id="2a19c-585">passcodeSignInFailureCountBeforeWipe</span></span>|<span data-ttu-id="2a19c-586">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-586">Int32</span></span>|<span data-ttu-id="2a19c-587">Количество неудачных попыток входа до очистки устройства.</span><span class="sxs-lookup"><span data-stu-id="2a19c-587">Number of sign in failures allowed before wiping the device.</span></span> <span data-ttu-id="2a19c-588">Допустимые значения: от 4 до 11.</span><span class="sxs-lookup"><span data-stu-id="2a19c-588">Valid values 4 to 11</span></span>|
|<span data-ttu-id="2a19c-589">passcodeRequiredType</span><span class="sxs-lookup"><span data-stu-id="2a19c-589">passcodeRequiredType</span></span>|[<span data-ttu-id="2a19c-590">рекуиредпассвордтипе</span><span class="sxs-lookup"><span data-stu-id="2a19c-590">requiredPasswordType</span></span>](../resources/intune-deviceconfig-requiredpasswordtype.md)|<span data-ttu-id="2a19c-591">Необходимый тип секретного кода.</span><span class="sxs-lookup"><span data-stu-id="2a19c-591">Type of passcode that is required.</span></span> <span data-ttu-id="2a19c-592">Возможные значения: `deviceDefault`, `alphanumeric`, `numeric`.</span><span class="sxs-lookup"><span data-stu-id="2a19c-592">Possible values are: `deviceDefault`, `alphanumeric`, `numeric`.</span></span>|
|<span data-ttu-id="2a19c-593">passcodeRequired</span><span class="sxs-lookup"><span data-stu-id="2a19c-593">passcodeRequired</span></span>|<span data-ttu-id="2a19c-594">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-594">Boolean</span></span>|<span data-ttu-id="2a19c-595">Указывает, обязательно ли использовать секретный код.</span><span class="sxs-lookup"><span data-stu-id="2a19c-595">Indicates whether or not to require a passcode.</span></span>|
|<span data-ttu-id="2a19c-596">podcastsBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-596">podcastsBlocked</span></span>|<span data-ttu-id="2a19c-597">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-597">Boolean</span></span>|<span data-ttu-id="2a19c-598">Указывает, следует ли запретить использовать подкасты на защищенном устройстве (iOS 8.0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-598">Indicates whether or not to block the user from using podcasts on the supervised device (iOS 8.0 and later).</span></span>|
|<span data-ttu-id="2a19c-599">проксимитиблокксетуптоневдевице</span><span class="sxs-lookup"><span data-stu-id="2a19c-599">proximityBlockSetupToNewDevice</span></span>|<span data-ttu-id="2a19c-600">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-600">Boolean</span></span>|<span data-ttu-id="2a19c-601">Указывает, следует ли включить запрос на установку находящихся рядом устройств с защищенным устройством.</span><span class="sxs-lookup"><span data-stu-id="2a19c-601">Indicates whether or not to enable the prompt to setup nearby devices with a supervised device.</span></span>|
|<span data-ttu-id="2a19c-602">safariBlockAutofill</span><span class="sxs-lookup"><span data-stu-id="2a19c-602">safariBlockAutofill</span></span>|<span data-ttu-id="2a19c-603">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-603">Boolean</span></span>|<span data-ttu-id="2a19c-604">Указывает, следует ли запретить использовать автозаполнение в Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-604">Indicates whether or not to block the user from using Auto fill in Safari.</span></span> <span data-ttu-id="2a19c-605">Для iOS 13 и более поздних версий требуется контролируемое устройство.</span><span class="sxs-lookup"><span data-stu-id="2a19c-605">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="2a19c-606">safariBlockJavaScript</span><span class="sxs-lookup"><span data-stu-id="2a19c-606">safariBlockJavaScript</span></span>|<span data-ttu-id="2a19c-607">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-607">Boolean</span></span>|<span data-ttu-id="2a19c-608">Указывает, следует ли заблокировать JavaScript в Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-608">Indicates whether or not to block JavaScript in Safari.</span></span>|
|<span data-ttu-id="2a19c-609">safariBlockPopups</span><span class="sxs-lookup"><span data-stu-id="2a19c-609">safariBlockPopups</span></span>|<span data-ttu-id="2a19c-610">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-610">Boolean</span></span>|<span data-ttu-id="2a19c-611">Указывает, следует ли блокировать всплывающие окна в Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-611">Indicates whether or not to block popups in Safari.</span></span>|
|<span data-ttu-id="2a19c-612">safariBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-612">safariBlocked</span></span>|<span data-ttu-id="2a19c-613">Boolean</span><span class="sxs-lookup"><span data-stu-id="2a19c-613">Boolean</span></span>|<span data-ttu-id="2a19c-614">Указывает, следует ли запретить использовать Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-614">Indicates whether or not to block the user from using Safari.</span></span> <span data-ttu-id="2a19c-615">Для iOS 13 и более поздних версий требуется контролируемое устройство.</span><span class="sxs-lookup"><span data-stu-id="2a19c-615">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="2a19c-616">safariCookieSettings</span><span class="sxs-lookup"><span data-stu-id="2a19c-616">safariCookieSettings</span></span>|[<span data-ttu-id="2a19c-617">webBrowserCookieSettings</span><span class="sxs-lookup"><span data-stu-id="2a19c-617">webBrowserCookieSettings</span></span>](../resources/intune-deviceconfig-webbrowsercookiesettings.md)|<span data-ttu-id="2a19c-618">Настройки файлов cookie для Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-618">Cookie settings for Safari.</span></span> <span data-ttu-id="2a19c-619">Возможные значения: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited`, `allowAlways`.</span><span class="sxs-lookup"><span data-stu-id="2a19c-619">Possible values are: `browserDefault`, `blockAlways`, `allowCurrentWebSite`, `allowFromWebsitesVisited`, `allowAlways`.</span></span>|
|<span data-ttu-id="2a19c-620">safariManagedDomains</span><span class="sxs-lookup"><span data-stu-id="2a19c-620">safariManagedDomains</span></span>|<span data-ttu-id="2a19c-621">Коллекция String</span><span class="sxs-lookup"><span data-stu-id="2a19c-621">String collection</span></span>|<span data-ttu-id="2a19c-622">URL-адреса, соответствующие приведенным здесь шаблонам, будут считаться управляемыми.</span><span class="sxs-lookup"><span data-stu-id="2a19c-622">URLs matching the patterns listed here will be considered managed.</span></span>|
|<span data-ttu-id="2a19c-623">safariPasswordAutoFillDomains</span><span class="sxs-lookup"><span data-stu-id="2a19c-623">safariPasswordAutoFillDomains</span></span>|<span data-ttu-id="2a19c-624">Коллекция String</span><span class="sxs-lookup"><span data-stu-id="2a19c-624">String collection</span></span>|<span data-ttu-id="2a19c-625">Пользователи могут сохранять пароли в Safari только с URL-адресов, соответствующих приведенным здесь шаблонам.</span><span class="sxs-lookup"><span data-stu-id="2a19c-625">Users can save passwords in Safari only from URLs matching the patterns listed here.</span></span> <span data-ttu-id="2a19c-626">Применяется к устройствам в защищенном режиме (iOS 9.3 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-626">Applies to devices in supervised mode (iOS 9.3 and later).</span></span>|
|<span data-ttu-id="2a19c-627">safariRequireFraudWarning</span><span class="sxs-lookup"><span data-stu-id="2a19c-627">safariRequireFraudWarning</span></span>|<span data-ttu-id="2a19c-628">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-628">Boolean</span></span>|<span data-ttu-id="2a19c-629">Указывает, обязательно ли предупреждение о мошенничестве в Safari.</span><span class="sxs-lookup"><span data-stu-id="2a19c-629">Indicates whether or not to require fraud warning in Safari.</span></span>|
|<span data-ttu-id="2a19c-630">screenCaptureBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-630">screenCaptureBlocked</span></span>|<span data-ttu-id="2a19c-631">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-631">Boolean</span></span>|<span data-ttu-id="2a19c-632">Указывает, следует ли запретить пользователю делать снимки экрана.</span><span class="sxs-lookup"><span data-stu-id="2a19c-632">Indicates whether or not to block the user from taking Screenshots.</span></span>|
|<span data-ttu-id="2a19c-633">siriBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-633">siriBlocked</span></span>|<span data-ttu-id="2a19c-634">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-634">Boolean</span></span>|<span data-ttu-id="2a19c-635">Указывает, следует ли запретить использовать Siri.</span><span class="sxs-lookup"><span data-stu-id="2a19c-635">Indicates whether or not to block the user from using Siri.</span></span>|
|<span data-ttu-id="2a19c-636">siriBlockedWhenLocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-636">siriBlockedWhenLocked</span></span>|<span data-ttu-id="2a19c-637">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-637">Boolean</span></span>|<span data-ttu-id="2a19c-638">Указывает, следует ли запретить использовать Siri, когда устройство заблокировано.</span><span class="sxs-lookup"><span data-stu-id="2a19c-638">Indicates whether or not to block the user from using Siri when locked.</span></span>|
|<span data-ttu-id="2a19c-639">siriBlockUserGeneratedContent</span><span class="sxs-lookup"><span data-stu-id="2a19c-639">siriBlockUserGeneratedContent</span></span>|<span data-ttu-id="2a19c-640">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-640">Boolean</span></span>|<span data-ttu-id="2a19c-641">Указывает, следует ли запретить Siri запрашивать данные о пользовательском контенте на защищенном устройстве.</span><span class="sxs-lookup"><span data-stu-id="2a19c-641">Indicates whether or not to block Siri from querying user-generated content when used on a supervised device.</span></span>|
|<span data-ttu-id="2a19c-642">siriRequireProfanityFilter</span><span class="sxs-lookup"><span data-stu-id="2a19c-642">siriRequireProfanityFilter</span></span>|<span data-ttu-id="2a19c-643">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-643">Boolean</span></span>|<span data-ttu-id="2a19c-644">Указывает, следует ли запретить Siri записывать или произносить нецензурные выражения на защищенном устройстве.</span><span class="sxs-lookup"><span data-stu-id="2a19c-644">Indicates whether or not to prevent Siri from dictating, or speaking profane language on supervised device.</span></span>|
|<span data-ttu-id="2a19c-645">софтвареупдатесенфорцедделайиндайс</span><span class="sxs-lookup"><span data-stu-id="2a19c-645">softwareUpdatesEnforcedDelayInDays</span></span>|<span data-ttu-id="2a19c-646">Int32</span><span class="sxs-lookup"><span data-stu-id="2a19c-646">Int32</span></span>|<span data-ttu-id="2a19c-647">Задает число дней, в течение которых обновление программного обеспечения будет делед для защищенного устройства.</span><span class="sxs-lookup"><span data-stu-id="2a19c-647">Sets how many days a software update will be delyed for a supervised device.</span></span> <span data-ttu-id="2a19c-648">Допустимые значения: от 0 до 90.</span><span class="sxs-lookup"><span data-stu-id="2a19c-648">Valid values 0 to 90</span></span>|
|<span data-ttu-id="2a19c-649">софтвареупдатесфорцеделайед</span><span class="sxs-lookup"><span data-stu-id="2a19c-649">softwareUpdatesForceDelayed</span></span>|<span data-ttu-id="2a19c-650">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-650">Boolean</span></span>|<span data-ttu-id="2a19c-651">Указывает, следует ли откладывать видимость обновлений программного обеспечения, когда устройство находится в защищенном режиме.</span><span class="sxs-lookup"><span data-stu-id="2a19c-651">Indicates whether or not to delay user visibility of software updates when the device is in supervised mode.</span></span>|
|<span data-ttu-id="2a19c-652">spotlightBlockInternetResults</span><span class="sxs-lookup"><span data-stu-id="2a19c-652">spotlightBlockInternetResults</span></span>|<span data-ttu-id="2a19c-653">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-653">Boolean</span></span>|<span data-ttu-id="2a19c-654">Указывает, следует ли запретить показывать результаты из Интернета при поиске полезных сведений на защищенном устройстве.</span><span class="sxs-lookup"><span data-stu-id="2a19c-654">Indicates whether or not to block Spotlight search from returning internet results on supervised device.</span></span>|
|<span data-ttu-id="2a19c-655">voiceDialingBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-655">voiceDialingBlocked</span></span>|<span data-ttu-id="2a19c-656">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-656">Boolean</span></span>|<span data-ttu-id="2a19c-657">Указывает, следует ли заблокировать голосовой набор.</span><span class="sxs-lookup"><span data-stu-id="2a19c-657">Indicates whether or not to block voice dialing.</span></span>|
|<span data-ttu-id="2a19c-658">wallpaperBlockModification</span><span class="sxs-lookup"><span data-stu-id="2a19c-658">wallpaperBlockModification</span></span>|<span data-ttu-id="2a19c-659">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-659">Boolean</span></span>|<span data-ttu-id="2a19c-660">Указывает, можно ли изменять обои на защищенном устройстве (iOS 9.0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-660">Indicates whether or not to allow wallpaper modification on supervised device (iOS 9.0 and later) .</span></span>|
|<span data-ttu-id="2a19c-661">wiFiConnectOnlyToConfiguredNetworks</span><span class="sxs-lookup"><span data-stu-id="2a19c-661">wiFiConnectOnlyToConfiguredNetworks</span></span>|<span data-ttu-id="2a19c-662">Boolean</span><span class="sxs-lookup"><span data-stu-id="2a19c-662">Boolean</span></span>|<span data-ttu-id="2a19c-663">Указывает, обязательно ли использовать только сети Wi-Fi из профилей конфигурации, когда устройство находится в защищенном режиме.</span><span class="sxs-lookup"><span data-stu-id="2a19c-663">Indicates whether or not to force the device to use only Wi-Fi networks from configuration profiles when the device is in supervised mode.</span></span>|
|<span data-ttu-id="2a19c-664">классрумфорцерекуестпермиссионтолеавеклассес</span><span class="sxs-lookup"><span data-stu-id="2a19c-664">classroomForceRequestPermissionToLeaveClasses</span></span>|<span data-ttu-id="2a19c-665">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-665">Boolean</span></span>|<span data-ttu-id="2a19c-666">Указывает, является ли студент, зарегистрированный в неуправляемом курсе, запрашивать разрешение у преподавателя при попытке выйти из курса (iOS 11,3 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-666">Indicates whether a student enrolled in an unmanaged course via Classroom will request permission from the teacher when attempting to leave the course (iOS 11.3 and later).</span></span>|
|<span data-ttu-id="2a19c-667">кэйчаинблоккклаудсинк</span><span class="sxs-lookup"><span data-stu-id="2a19c-667">keychainBlockCloudSync</span></span>|<span data-ttu-id="2a19c-668">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-668">Boolean</span></span>|<span data-ttu-id="2a19c-669">Указывает, заблокирована ли синхронизация ключей iCloud для iCloud.</span><span class="sxs-lookup"><span data-stu-id="2a19c-669">Indicates whether or not iCloud keychain synchronization is blocked.</span></span> <span data-ttu-id="2a19c-670">Для iOS 13 и более поздних версий требуется контролируемое устройство.</span><span class="sxs-lookup"><span data-stu-id="2a19c-670">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="2a19c-671">пкиблоккотаупдатес</span><span class="sxs-lookup"><span data-stu-id="2a19c-671">pkiBlockOTAUpdates</span></span>|<span data-ttu-id="2a19c-672">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-672">Boolean</span></span>|<span data-ttu-id="2a19c-673">Указывает, блокируются ли обновления PKI беспроводной сети.</span><span class="sxs-lookup"><span data-stu-id="2a19c-673">Indicates whether or not over-the-air PKI updates are blocked.</span></span> <span data-ttu-id="2a19c-674">Если задать для этого ограничения значение false, проверки CRL и OCSP (iOS 7,0 и более поздних версий) не отключаются.</span><span class="sxs-lookup"><span data-stu-id="2a19c-674">Setting this restriction to false does not disable CRL and OCSP checks (iOS 7.0 and later).</span></span>|
|<span data-ttu-id="2a19c-675">привацифорцелимитадтраккинг</span><span class="sxs-lookup"><span data-stu-id="2a19c-675">privacyForceLimitAdTracking</span></span>|<span data-ttu-id="2a19c-676">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-676">Boolean</span></span>|<span data-ttu-id="2a19c-677">Указывает, ограничено ли отслеживание AD. (iOS 7,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-677">Indicates if ad tracking is limited.(iOS 7.0 and later).</span></span>|
|<span data-ttu-id="2a19c-678">ентерприсебукблоккбаккуп</span><span class="sxs-lookup"><span data-stu-id="2a19c-678">enterpriseBookBlockBackup</span></span>|<span data-ttu-id="2a19c-679">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-679">Boolean</span></span>|<span data-ttu-id="2a19c-680">Указывает, блокируется ли резервное копирование корпоративной книги.</span><span class="sxs-lookup"><span data-stu-id="2a19c-680">Indicates whether or not Enterprise book back up is blocked.</span></span>|
|<span data-ttu-id="2a19c-681">ентерприсебукблоккметадатасинк</span><span class="sxs-lookup"><span data-stu-id="2a19c-681">enterpriseBookBlockMetadataSync</span></span>|<span data-ttu-id="2a19c-682">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-682">Boolean</span></span>|<span data-ttu-id="2a19c-683">Указывает, блокируется ли синхронизация заметок и выделений корпоративных книг.</span><span class="sxs-lookup"><span data-stu-id="2a19c-683">Indicates whether or not Enterprise book notes and highlights sync is blocked.</span></span>|
|<span data-ttu-id="2a19c-684">airPrintBlocked</span><span class="sxs-lookup"><span data-stu-id="2a19c-684">airPrintBlocked</span></span>|<span data-ttu-id="2a19c-685">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-685">Boolean</span></span>|<span data-ttu-id="2a19c-686">Указывает, заблокировано ли Аирпринт (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-686">Indicates whether or not AirPrint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-687">аирпринтблокккредентиалсстораже</span><span class="sxs-lookup"><span data-stu-id="2a19c-687">airPrintBlockCredentialsStorage</span></span>|<span data-ttu-id="2a19c-688">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-688">Boolean</span></span>|<span data-ttu-id="2a19c-689">Указывает, заблокировано ли хранение цепочки ключей имени пользователя и пароля для Аирпринт (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-689">Indicates whether or not keychain storage of username and password for Airprint is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-690">airPrintForceTrustedTLS</span><span class="sxs-lookup"><span data-stu-id="2a19c-690">airPrintForceTrustedTLS</span></span>|<span data-ttu-id="2a19c-691">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-691">Boolean</span></span>|<span data-ttu-id="2a19c-692">Указывает, требуются ли доверенные сертификаты для обмена данными при печати TLS (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-692">Indicates if trusted certificates are required for TLS printing communication (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-693">airPrintBlockiBeaconDiscovery</span><span class="sxs-lookup"><span data-stu-id="2a19c-693">airPrintBlockiBeaconDiscovery</span></span>|<span data-ttu-id="2a19c-694">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-694">Boolean</span></span>|<span data-ttu-id="2a19c-695">Указывает, блокируется ли Ибеакон обнаружение принтеров Аирпринт.</span><span class="sxs-lookup"><span data-stu-id="2a19c-695">Indicates whether or not iBeacon discovery of AirPrint printers is blocked.</span></span> <span data-ttu-id="2a19c-696">Это предотвращает ложные сигналы Аирпринт Bluetooth от фишинга для сетевого трафика (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-696">This prevents spurious AirPrint Bluetooth beacons from phishing for network traffic (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-697">филеснетворкдривеакцессблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-697">filesNetworkDriveAccessBlocked</span></span>|<span data-ttu-id="2a19c-698">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-698">Boolean</span></span>|<span data-ttu-id="2a19c-699">Указывает, могут ли устройства получать доступ к файлам или другим ресурсам на сетевом сервере с помощью протокола SMB.</span><span class="sxs-lookup"><span data-stu-id="2a19c-699">Indicates if devices can access files or other resources on a network server using the Server Message Block (SMB) protocol.</span></span> <span data-ttu-id="2a19c-700">Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.</span><span class="sxs-lookup"><span data-stu-id="2a19c-700">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="2a19c-701">филесусбдривеакцессблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-701">filesUsbDriveAccessBlocked</span></span>|<span data-ttu-id="2a19c-702">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-702">Boolean</span></span>|<span data-ttu-id="2a19c-703">Указывает, могут ли севицес с Access подключаться к файлам и открывать их на USB-диске.</span><span class="sxs-lookup"><span data-stu-id="2a19c-703">Indicates if sevices with access can connect to and open files on a USB drive.</span></span> <span data-ttu-id="2a19c-704">Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.</span><span class="sxs-lookup"><span data-stu-id="2a19c-704">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="2a19c-705">вифиповеронфорцед</span><span class="sxs-lookup"><span data-stu-id="2a19c-705">wifiPowerOnForced</span></span>|<span data-ttu-id="2a19c-706">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-706">Boolean</span></span>|<span data-ttu-id="2a19c-707">Указывает, остается ли Wi-Fi On, даже если устройство находится в режиме "в самолете".</span><span class="sxs-lookup"><span data-stu-id="2a19c-707">Indicates whether or not Wi-Fi remains on, even when device is in airplane mode.</span></span> <span data-ttu-id="2a19c-708">Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.</span><span class="sxs-lookup"><span data-stu-id="2a19c-708">Available for devices running iOS and iPadOS, versions 13.0 and later.</span></span>|
|<span data-ttu-id="2a19c-709">блокксистемаппремовал</span><span class="sxs-lookup"><span data-stu-id="2a19c-709">blockSystemAppRemoval</span></span>|<span data-ttu-id="2a19c-710">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-710">Boolean</span></span>|<span data-ttu-id="2a19c-711">Указывает, заблокировано ли удаление системных приложений с устройства на контролируемом устройстве (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-711">Indicates whether or not the removal of system apps from the device is blocked on a supervised device (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-712">впнблокккреатион</span><span class="sxs-lookup"><span data-stu-id="2a19c-712">vpnBlockCreation</span></span>|<span data-ttu-id="2a19c-713">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-713">Boolean</span></span>|<span data-ttu-id="2a19c-714">Указывает, блокируется ли создание конфигураций VPN (iOS 11,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-714">Indicates whether or not the creation of VPN configurations is blocked (iOS 11.0 and later).</span></span>|
|<span data-ttu-id="2a19c-715">аппремовалблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-715">appRemovalBlocked</span></span>|<span data-ttu-id="2a19c-716">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-716">Boolean</span></span>|<span data-ttu-id="2a19c-717">Указывает, разрешено ли удаление приложений.</span><span class="sxs-lookup"><span data-stu-id="2a19c-717">Indicates if the removal of apps is allowed.</span></span>|
|<span data-ttu-id="2a19c-718">усбрестриктедмодеблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-718">usbRestrictedModeBlocked</span></span>|<span data-ttu-id="2a19c-719">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-719">Boolean</span></span>|<span data-ttu-id="2a19c-720">Указывает, разрешена ли подключаться к стандарту USB, пока устройство заблокировано (iOS 11.4.1 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-720">Indicates if connecting to USB accessories while the device is locked is allowed (iOS 11.4.1 and later).</span></span>|
|<span data-ttu-id="2a19c-721">пассвордблоккаутофилл</span><span class="sxs-lookup"><span data-stu-id="2a19c-721">passwordBlockAutoFill</span></span>|<span data-ttu-id="2a19c-722">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-722">Boolean</span></span>|<span data-ttu-id="2a19c-723">Указывает, разрешена ли функция автозаполнения паролей (iOS 12,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-723">Indicates if the AutoFill passwords feature is allowed (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="2a19c-724">пассвордблоккпроксимитирекуестс</span><span class="sxs-lookup"><span data-stu-id="2a19c-724">passwordBlockProximityRequests</span></span>|<span data-ttu-id="2a19c-725">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-725">Boolean</span></span>|<span data-ttu-id="2a19c-726">Указывает, следует ли запретить запрашивать пароли с близлежащих устройств (iOS 12,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-726">Indicates whether or not to block requesting passwords from nearby devices (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="2a19c-727">пассвордблоккаирдропшаринг</span><span class="sxs-lookup"><span data-stu-id="2a19c-727">passwordBlockAirDropSharing</span></span>|<span data-ttu-id="2a19c-728">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-728">Boolean</span></span>|<span data-ttu-id="2a19c-729">Указывает, следует ли заблокировать общий доступ к паролям с помощью AirDrop паролей iOS 12,0 и более поздних версий.</span><span class="sxs-lookup"><span data-stu-id="2a19c-729">Indicates whether or not to block sharing passwords with the AirDrop passwords feature iOS 12.0 and later).</span></span>|
|<span data-ttu-id="2a19c-730">датеандтимефорцесетаутоматикалли</span><span class="sxs-lookup"><span data-stu-id="2a19c-730">dateAndTimeForceSetAutomatically</span></span>|<span data-ttu-id="2a19c-731">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-731">Boolean</span></span>|<span data-ttu-id="2a19c-732">Указывает, включена ли функция даты и времени "автоматически задано" и не может быть отключена пользователем (iOS 12,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-732">Indicates whether or not the Date and Time "Set Automatically" feature is enabled and cannot be turned off by the user (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="2a19c-733">контактсалловманажедтаунманажедврите</span><span class="sxs-lookup"><span data-stu-id="2a19c-733">contactsAllowManagedToUnmanagedWrite</span></span>|<span data-ttu-id="2a19c-734">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-734">Boolean</span></span>|<span data-ttu-id="2a19c-735">Указывает, могут ли управляемые приложения записывать контакты в неуправляемые учетные записи контактов (iOS 12,0 и более поздних версий).</span><span class="sxs-lookup"><span data-stu-id="2a19c-735">Indicates whether or not managed apps can write contacts to unmanaged contacts accounts (iOS 12.0 and later).</span></span>|
|<span data-ttu-id="2a19c-736">контактсалловунманажедтоманажедреад</span><span class="sxs-lookup"><span data-stu-id="2a19c-736">contactsAllowUnmanagedToManagedRead</span></span>|<span data-ttu-id="2a19c-737">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-737">Boolean</span></span>|<span data-ttu-id="2a19c-738">Указывает, могут ли неуправляемые приложения читать из управляемых учетных записей контактов (iOS 12,0 или более поздней версии).</span><span class="sxs-lookup"><span data-stu-id="2a19c-738">Indicates whether or not unmanaged apps can read from managed contacts accounts (iOS 12.0 or later).</span></span>|
|<span data-ttu-id="2a19c-739">целлуларблоккперсоналхотспотмодификатион</span><span class="sxs-lookup"><span data-stu-id="2a19c-739">cellularBlockPersonalHotspotModification</span></span>|<span data-ttu-id="2a19c-740">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-740">Boolean</span></span>|<span data-ttu-id="2a19c-741">Указывает, следует ли запретить пользователю изменять параметр личных гиперобъектов (iOS 12,2 или более поздней версии).</span><span class="sxs-lookup"><span data-stu-id="2a19c-741">Indicates whether or not to block the user from modifying the personal hotspot setting (iOS 12.2 or later).</span></span>|
|<span data-ttu-id="2a19c-742">континуауспаскэйбоардблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-742">continuousPathKeyboardBlocked</span></span>|<span data-ttu-id="2a19c-743">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-743">Boolean</span></span>|<span data-ttu-id="2a19c-744">Указывает, следует ли заблокировать клавиатуру непрерывного пути, когда устройство защищено (iOS 13 или более поздней версии).</span><span class="sxs-lookup"><span data-stu-id="2a19c-744">Indicates whether or not to block the continuous path keyboard when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="2a19c-745">финдмидевицеинфиндмяппблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-745">findMyDeviceInFindMyAppBlocked</span></span>|<span data-ttu-id="2a19c-746">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-746">Boolean</span></span>|<span data-ttu-id="2a19c-747">Указывает, следует ли заблокировать Поиск устройства, когда устройство защищено (iOS 13 или более поздней версии).</span><span class="sxs-lookup"><span data-stu-id="2a19c-747">Indicates whether or not to block Find My Device when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="2a19c-748">финдмифриендсинфиндмяппблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-748">findMyFriendsInFindMyAppBlocked</span></span>|<span data-ttu-id="2a19c-749">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-749">Boolean</span></span>|<span data-ttu-id="2a19c-750">Указывает, следует ли заблокировать "найти друзей", когда устройство защищено (iOS 13 или более поздней версии).</span><span class="sxs-lookup"><span data-stu-id="2a19c-750">Indicates whether or not to block Find My Friends when the device is supervised (iOS 13 or later).</span></span>|
|<span data-ttu-id="2a19c-751">итунесблоккед</span><span class="sxs-lookup"><span data-stu-id="2a19c-751">iTunesBlocked</span></span>|<span data-ttu-id="2a19c-752">Логический</span><span class="sxs-lookup"><span data-stu-id="2a19c-752">Boolean</span></span>|<span data-ttu-id="2a19c-753">Указывает, следует ли заблокировать приложение iTunes.</span><span class="sxs-lookup"><span data-stu-id="2a19c-753">Indicates whether or not to block the iTunes app.</span></span> <span data-ttu-id="2a19c-754">Для iOS 13 и более поздних версий требуется контролируемое устройство.</span><span class="sxs-lookup"><span data-stu-id="2a19c-754">Requires a supervised device for iOS 13 and later.</span></span>|
|<span data-ttu-id="2a19c-755">киоскмодеапптипе</span><span class="sxs-lookup"><span data-stu-id="2a19c-755">kioskModeAppType</span></span>|[<span data-ttu-id="2a19c-756">иоскиоскмодеапптипе</span><span class="sxs-lookup"><span data-stu-id="2a19c-756">iosKioskModeAppType</span></span>](../resources/intune-deviceconfig-ioskioskmodeapptype.md)|<span data-ttu-id="2a19c-757">Тип приложения, которое будет запускаться в режиме киоска.</span><span class="sxs-lookup"><span data-stu-id="2a19c-757">Type of app to run in kiosk mode.</span></span> <span data-ttu-id="2a19c-758">Возможные значения: `notConfigured`, `appStoreApp`, `managedApp`, `builtInApp`.</span><span class="sxs-lookup"><span data-stu-id="2a19c-758">Possible values are: `notConfigured`, `appStoreApp`, `managedApp`, `builtInApp`.</span></span>|



## <a name="response"></a><span data-ttu-id="2a19c-759">Отклик</span><span class="sxs-lookup"><span data-stu-id="2a19c-759">Response</span></span>
<span data-ttu-id="2a19c-760">В случае успешного выполнения этот метод возвращает код отклика `200 OK` и обновленный объект [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) в тексте отклика.</span><span class="sxs-lookup"><span data-stu-id="2a19c-760">If successful, this method returns a `200 OK` response code and an updated [iosGeneralDeviceConfiguration](../resources/intune-deviceconfig-iosgeneraldeviceconfiguration.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="2a19c-761">Пример</span><span class="sxs-lookup"><span data-stu-id="2a19c-761">Example</span></span>

### <a name="request"></a><span data-ttu-id="2a19c-762">Запрос</span><span class="sxs-lookup"><span data-stu-id="2a19c-762">Request</span></span>
<span data-ttu-id="2a19c-763">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="2a19c-763">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="2a19c-764">Отклик</span><span class="sxs-lookup"><span data-stu-id="2a19c-764">Response</span></span>
<span data-ttu-id="2a19c-p157">Ниже приведен пример отклика. Примечание. Объект отклика, показанный здесь, может быть усечен для краткости. При фактическом вызове будут возвращены все свойства.</span><span class="sxs-lookup"><span data-stu-id="2a19c-p157">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
HTTP/1.1 200 OK
Content-Type: application/json

---
title: 'cloudPC: перезагрузка'
description: Перезагрузка определенного облачного КОМПЬЮТЕРА.
author: RuiHou105
ms.localizationpriority: medium
ms.prod: cloud-pc
doc_type: apiPageType
ms.openlocfilehash: ddc7b7d6931deeff62e478381300752290b0b22a
...
---
# <a name="cloudpc-reboot"></a>cloudPC: перезагрузка

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Перезагрузка определенного облачного КОМПЬЮТЕРА.

...
Извлечение свойств и связи объекта oAuth2Permissiongrant.
...
Успешно завершена, этот метод возвращает `200 OK` объект [oAuth2Permissiongrant](../resources/oauth2permissiongrant.md) и кода ответа в теле ответа.

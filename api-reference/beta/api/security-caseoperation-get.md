...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и объект [microsoft.graph.security.caseOperation](../resources/security-caseoperation.md) в тексте отклика.

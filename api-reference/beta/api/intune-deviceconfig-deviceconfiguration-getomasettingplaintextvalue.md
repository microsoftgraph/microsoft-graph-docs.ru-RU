...
ms.locfileid: "54123519"
---
# <a name="getomasettingplaintextvalue-function"></a>функция getOmaSettingPlainTextValue
...
|:---|:---|:---|
|secretReferenceValueId|String|Пока не задокументировано.|

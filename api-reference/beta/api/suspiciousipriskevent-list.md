...
Получение списка объектов suspiciousipriskevent.
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и коллекцию объектов [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) в теле ответа.

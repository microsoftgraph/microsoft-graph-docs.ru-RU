...
Создание объекта [win32LobApp.](../resources/intune-apps-win32lobapp.md)
...
В теле запроса укажийте представление объекта win32LobApp в JSON.
...
В случае успеха этот метод возвращает код отклика и `201 Created` [объект win32LobApp](../resources/intune-apps-win32lobapp.md) в тексте отклика.

...
В следующей таблице показаны свойства, доступные при создании расширения схемы.
...
В ответе содержится уникальная строка в свойстве **id,** основанная на имени схемы, предоставленном в запросе, а также остальная часть вновь созданного определения схемы. Значение в **id** в ответе основано на формате ext&#65279;\{ _8-random-alphanumeric-chars_ \} \_ \{ _&#65279;схемы-имя_ \} . Примечание. Объект отклика, показанный здесь, может быть сокращен для удобочитаемости.
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.schemaExtension"
...
Отклик содержит **owner** со значением, указанным в запросе. Примечание. Объект отклика, показанный здесь, может быть сокращен для удобочитаемости.
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.schemaExtension"

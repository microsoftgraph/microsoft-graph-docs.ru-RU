---
title: Создание macOSDmgApp
description: Создание нового объекта macOSDmgApp.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 1a5f4274a8a3efd5efb6613233199594225b224b
ms.sourcegitcommit: 00ac72f7b1cdde4f71ff332c2e7953908ef9de52
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/04/2022
ms.locfileid: "61712192"
---
# <a name="create-macosdmgapp"></a>Создание macOSDmgApp
...
Создание нового [объекта macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)
...
В теле запроса поставляем представление JSON для объекта macOSDmgApp.

В следующей таблице показаны свойства, необходимые при создании macOSDmgApp.
...
В случае успешной работы этот метод возвращает код отклика и `201 Created` [объект macOSDmgApp](../resources/intune-apps-macosdmgapp.md) в тексте ответа.

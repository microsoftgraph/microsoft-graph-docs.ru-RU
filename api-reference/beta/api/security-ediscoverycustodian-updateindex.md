...
description: Активирует indexOperation, чтобы сделать хранителя и связанные источники доступны для поиска.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: d81fab207f6328c5ef69529383a4efc6592e2123
ms.sourcegitcommit: a345f96fb22115f65840702a4acf0acc7c1b0679
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/08/2022
ms.locfileid: "65946196"
---
# <a name="ediscoverycustodian-updateindex"></a>ediscoveryCustodian: updateIndex
Пространство имен: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Активирует [indexOperation](../resources/security-ediscoveryIndexOperation.md)

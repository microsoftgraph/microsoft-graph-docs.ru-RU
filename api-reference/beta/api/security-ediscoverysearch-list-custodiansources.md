...
description: Получение ресурсов dataSource из свойства навигации custodianSources.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: 5642e3db50b823846ae9a8b55a914d1703c50abb
ms.sourcegitcommit: 6bb3c5c043d35476e41ef2790bcf4813fae0769d
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/15/2022
ms.locfileid: "66094388"
---
...
Получение ресурсов dataSource из свойства навигации custodianSources.
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и коллекцию объектов [dataSource](../resources/security-datasource.md) в теле отклика.

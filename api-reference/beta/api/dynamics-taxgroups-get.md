...
---
# <a name="get-taxgroups"></a>Get taxGroups

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение свойств и связей объекта налоговых групп для Центра бизнеса Dynamics 365.
...
В случае успешной работы этот метод возвращает код ответа и `200 OK` **объект taxGroups** в тексте ответа.

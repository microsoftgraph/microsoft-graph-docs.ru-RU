...
> **Примечание:** API приглашения может перемещать только одного участника на запрос. Если вы предоставите несколько участников в тексте запроса, API приглашения переместит только первый.

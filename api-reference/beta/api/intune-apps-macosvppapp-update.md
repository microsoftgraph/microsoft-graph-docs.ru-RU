...
ms.openlocfilehash: 31f40fcbf6b3f91036db1be640d578af964d801a8d5c04c337f2526c0d084855
...
Обновление свойств объекта [macOsVppApp.](../resources/intune-apps-macosvppapp.md)
...
В теле запроса поставляем представление JSON для [объекта macOsVppApp.](../resources/intune-apps-macosvppapp.md)

В следующей таблице показаны свойства, необходимые при создании [macOsVppApp.](../resources/intune-apps-macosvppapp.md)
...
В случае успешной работы этот метод возвращает код отклика и обновленный `200 OK` [объект macOsVppApp](../resources/intune-apps-macosvppapp.md) в тексте ответа.

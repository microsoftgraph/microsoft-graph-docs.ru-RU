---
title: Удаление операцииApprovalPolicy
description: Удаляет операциюApprovalPolicy.
author: dougeby
...
Удаляет [операциюApprovalPolicy](../resources/intune-rbac-operationapprovalpolicy.md).

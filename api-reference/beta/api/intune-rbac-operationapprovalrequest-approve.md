---
title: утверждение действия
description: Утверждает запрошенный экземпляр операцииApprovalRequest
author: dougeby
...
Утверждает запрошенный экземпляр операцииApprovalRequest

...
Создание нового объекта [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .
...
В тексте запроса укажите представление JSON для объекта androidForWorkApp.

В следующей таблице показаны свойства, которые необходимы для создания androidForWorkApp.
...
Успешно завершена, этот метод возвращает `201 Created` код ответа и объект [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) в теле ответа.

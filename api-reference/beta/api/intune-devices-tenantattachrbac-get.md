---
title: Получить tenantAttachRBAC
description: Чтение свойств и отношений объекта tenantAttachRBAC.
author: dougeby
...
ms.locfileid: "64631316"
---
# <a name="get-tenantattachrbac"></a>Получить tenantAttachRBAC
...
Чтение свойств и отношений объекта [tenantAttachRBAC](../resources/intune-devices-tenantattachrbac.md) .
...
В случае успешной работы этот метод возвращает код `200 OK` ответа и [объект tenantAttachRBAC](../resources/intune-devices-tenantattachrbac.md) в тексте ответа.

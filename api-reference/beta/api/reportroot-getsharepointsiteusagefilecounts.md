...
Успешно завершена, этот метод возвращает `200 OK` код ответа и объект **[sharePointSiteUsageFileCounts](../resources/sharepointsiteusagefilecounts.md)** в теле ответа.

...
В случае успеха этот метод возвращает код отклика и объект `200 OK` **[sharePointSiteUsageFileCounts](../resources/sharepointsiteusagefilecounts.md)** в тексте отклика.

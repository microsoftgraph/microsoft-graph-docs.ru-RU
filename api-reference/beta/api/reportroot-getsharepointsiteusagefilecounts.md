...
В случае успешной работы этот метод возвращает код ответа и `200 OK` **[объект sharePointSiteUsageFileCounts](../resources/sharepointsiteusagefilecounts.md)** в тексте ответа.

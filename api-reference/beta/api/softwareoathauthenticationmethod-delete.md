---
title: Удаление softwareOathAuthenticationMethod
description: Удаляет объект softwareOathAuthenticationMethod.
author: mmcla
ms.localizationpriority: medium
ms.prod: identity-and-sign-in
doc_type: apiPageType
ms.openlocfilehash: 9b6b87791d5461d19e6f5cbc92b8eac63a73afe2
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "61031782"
---
# <a name="delete-softwareoathauthenticationmethod"></a>Удаление softwareOathAuthenticationMethod
Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Удалите объект метода проверки подлинности маркеров [SOFTWARE OATH пользователя.](../resources/softwareoathauthenticationmethod.md)

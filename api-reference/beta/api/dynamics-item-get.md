...
Извлечение свойств и связей объекта элемента для Центра бизнеса Dynamics 365.
...
В случае успешной работы этот метод возвращает код ответа и `200 OK` объект **элементов** в тексте ответа.

...
ms.openlocfilehash: ac084cf0efb40f38d0ffb195ec4c297c1246877b
...
Этот метод поддерживает `$count` параметры `$select` запроса , `$search` , , `$filter` и `$expand` [OData,](/graph/query-parameters) чтобы помочь настроить ответ.

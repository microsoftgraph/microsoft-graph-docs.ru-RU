...
---
# <a name="get-windows10xwificonfiguration"></a>Получение windows10XWifiConfiguration
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и объект [windows10XWifiConfiguration](../resources/intune-rapolicy-windows10xwificonfiguration.md) в тексте отклика.

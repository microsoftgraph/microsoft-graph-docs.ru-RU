...
Создание прямого черновик сообщения добавить примечание или обновить все свойства сообщения  
в вызове одной **createForward** . После этого можно [Отправить](../api/message-send.md) сообщение черновиков.

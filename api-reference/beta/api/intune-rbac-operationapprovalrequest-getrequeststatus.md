---
title: действие getRequestStatus
...
ms.locfileid: "60481611"
---
# <a name="getrequeststatus-action"></a>действие getRequestStatus
...
|:---|:---|:---|
|entityId|String|Пока не задокументировано.|
|entityType|String|Пока не задокументировано.|



## <a name="response"></a>Ответ
В случае успешного действия возвращается код ответа и `200 OK` [операцияApprovalRequestEntityStatus](../resources/intune-rbac-operationapprovalrequestentitystatus.md) в тексте ответа.

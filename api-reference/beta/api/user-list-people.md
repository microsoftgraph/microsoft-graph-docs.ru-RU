...
## <a name="http-request"></a><span data-ttu-id="4bbcd-118">HTTP-запрос</span><span class="sxs-lookup"><span data-stu-id="4bbcd-118">HTTP request</span></span>
...
## <a name="optional-query-parameters"></a><span data-ttu-id="4bbcd-119">Необязательные параметры запросов</span><span class="sxs-lookup"><span data-stu-id="4bbcd-119">Optional query parameters</span></span>

<span data-ttu-id="4bbcd-120">Этот метод поддерживает следующие параметры запроса OData для настройки ответа.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-120">This method supports the following OData query parameters to help customize the response.</span></span>

|<span data-ttu-id="4bbcd-121">Имя</span><span class="sxs-lookup"><span data-stu-id="4bbcd-121">Name</span></span>|<span data-ttu-id="4bbcd-122">Значение</span><span class="sxs-lookup"><span data-stu-id="4bbcd-122">Value</span></span>|<span data-ttu-id="4bbcd-123">Описание</span><span class="sxs-lookup"><span data-stu-id="4bbcd-123">Description</span></span>|
|:---------------|:--------|:-------|
|<span data-ttu-id="4bbcd-124">$filter</span><span class="sxs-lookup"><span data-stu-id="4bbcd-124">$filter</span></span>|<span data-ttu-id="4bbcd-125">string</span><span class="sxs-lookup"><span data-stu-id="4bbcd-125">string</span></span>|<span data-ttu-id="4bbcd-126">Позволяет возвращать в отклике только тех людей, чьи записи содержат указанные критерии.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-126">Limits the response to only those people whose record contains the specified criteria.</span></span>|
|<span data-ttu-id="4bbcd-127">$orderby</span><span class="sxs-lookup"><span data-stu-id="4bbcd-127">$orderby</span></span>|<span data-ttu-id="4bbcd-128">строка</span><span class="sxs-lookup"><span data-stu-id="4bbcd-128">string</span></span>|<span data-ttu-id="4bbcd-129">По умолчанию люди в ответе сортируются по степени соответствия запросу.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-129">By default the people in the response are sorted by their relevance to your query.</span></span> <span data-ttu-id="4bbcd-130">Этот порядок можно изменить с помощью параметра *$orderby*.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-130">You can change the order of the people in the response using the *$orderby* parameter.</span></span>|
|<span data-ttu-id="4bbcd-131">$search</span><span class="sxs-lookup"><span data-stu-id="4bbcd-131">$search</span></span>|<span data-ttu-id="4bbcd-132">string</span><span class="sxs-lookup"><span data-stu-id="4bbcd-132">string</span></span>|<span data-ttu-id="4bbcd-133">Поиск пользователей по имени или псевдониму.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-133">Search for people by name or alias.</span></span> <span data-ttu-id="4bbcd-134">Поддерживается нечеткое соответствие.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-134">Supports Fuzzy matching.</span></span> <span data-ttu-id="4bbcd-135">Параметр работает только при поиске людей соответствующий пользователь выполнил вход, не для поиска людей, предназначенных для других пользователей.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-135">Parameter only works for searching the signed-in user's relevant people, not for searching people relevant to other users.</span></span> <span data-ttu-id="4bbcd-136">Также поддерживает `topic` ключевое слово для поиска людей на основании разделы, извлеченные из сообщений электронной почты с этим контактом.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-136">Also supports the `topic` keyword to find people based on topics extracted from e-mail conversations with that person.</span></span> <span data-ttu-id="4bbcd-137">В разделе *Perform Нечеткое поиска* в [получить информацию о пользователях](/graph/people-example#perform-a-fuzzy-search) сведения и примеры.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-137">See the *Perform a fuzzy search* section at [Get relevant information about people](/graph/people-example#perform-a-fuzzy-search) for information and examples.</span></span>|
|<span data-ttu-id="4bbcd-138">$select</span><span class="sxs-lookup"><span data-stu-id="4bbcd-138">$select</span></span>|<span data-ttu-id="4bbcd-139">string</span><span class="sxs-lookup"><span data-stu-id="4bbcd-139">string</span></span>|<span data-ttu-id="4bbcd-p105">Список разделенных запятыми свойств, которые необходимо включить в отклик. Для оптимизации производительности выбирайте только необходимые свойства.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-p105">Comma-separated list of properties to include in the response. For optimal performance, only select the subset of properties needed.</span></span>|
|<span data-ttu-id="4bbcd-142">$skip</span><span class="sxs-lookup"><span data-stu-id="4bbcd-142">$skip</span></span>|<span data-ttu-id="4bbcd-143">целое</span><span class="sxs-lookup"><span data-stu-id="4bbcd-143">int</span></span>|<span data-ttu-id="4bbcd-p106">Пропуск первых n результатов; эту функцию удобно использовать при разбиении результатов на страницы. Эта возможность не поддерживается при использовании параметра *$search*.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-p106">Skip the first n results, useful for paging. This is not supported when using *$search*.</span></span>|
|<span data-ttu-id="4bbcd-146">$top</span><span class="sxs-lookup"><span data-stu-id="4bbcd-146">$top</span></span>|<span data-ttu-id="4bbcd-147">целое</span><span class="sxs-lookup"><span data-stu-id="4bbcd-147">int</span></span>|<span data-ttu-id="4bbcd-148">Количество возвращаемых результатов.</span><span class="sxs-lookup"><span data-stu-id="4bbcd-148">Number of results to be returned.</span></span>|

## <a name="request-headers"></a><span data-ttu-id="4bbcd-149">Заголовки запроса</span><span class="sxs-lookup"><span data-stu-id="4bbcd-149">Request headers</span></span>

| <span data-ttu-id="4bbcd-150">Имя</span><span class="sxs-lookup"><span data-stu-id="4bbcd-150">Name</span></span>      |<span data-ttu-id="4bbcd-151">Описание</span><span class="sxs-lookup"><span data-stu-id="4bbcd-151">Description</span></span>|
|:----------|:----------|
...
#### <a name="response"></a><span data-ttu-id="4bbcd-168">Ответ</span><span class="sxs-lookup"><span data-stu-id="4bbcd-168">Response</span></span>
...
#### <a name="using-a-filter-to-limit-the-response"></a><span data-ttu-id="4bbcd-187">С помощью фильтра для ограничения ответа</span><span class="sxs-lookup"><span data-stu-id="4bbcd-187">Using a filter to limit the response</span></span>
...
#### <a name="using-search-to-select-people"></a><span data-ttu-id="4bbcd-197">Использование поиска для выбора людей</span><span class="sxs-lookup"><span data-stu-id="4bbcd-197">Using search to select people</span></span>

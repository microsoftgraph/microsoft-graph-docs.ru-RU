...
|advancedThreatProtectionAutoPopulateOnboardingBlob|Boolean|Автоматическое заполнение бортового BLOB программным путем из службы advanced Threat Protection|

---
title: Получение zebraFotaDeployment
description: Чтение свойств и связей объекта zebraFotaDeployment.
author: dougeby
...
ms.locfileid: "65213293"
---
# <a name="get-zebrafotadeployment"></a>Получение zebraFotaDeployment
...
Чтение свойств и связей объекта [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) .
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и объект [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) в тексте отклика.

...
ms.openlocfilehash: b0b289eb4353c9fb34de0b48f938fc44c51dabec
ms.sourcegitcommit: 6c04234af08efce558e9bf926062b4686a84f1b2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/12/2021
ms.locfileid: "59055306"
---
# <a name="create-iostrustedrootcertificate"></a>Создание iosTrustedRootCertificate
...
Создайте новый [объект iosTrustedRootCertificate.](../resources/intune-deviceconfig-iostrustedrootcertificate.md)
...
В теле запроса поставляем представление JSON для объекта iosTrustedRootCertificate.

В следующей таблице показаны свойства, необходимые при создании iosTrustedRootCertificate.
...
В случае успеха этот метод возвращает код ответа и `201 Created` [объект iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md) в тексте ответа.

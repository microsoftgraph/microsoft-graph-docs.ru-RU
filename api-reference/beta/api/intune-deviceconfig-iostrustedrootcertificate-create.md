...
Создание нового объекта [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md) .
...
В тексте запроса укажите представление JSON для объекта iosTrustedRootCertificate.

В следующей таблице показаны свойства, которые необходимы для создания iosTrustedRootCertificate.
...
Успешно завершена, этот метод возвращает `201 Created` код ответа и объект [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md) в теле ответа.

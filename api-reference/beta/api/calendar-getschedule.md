...
|Для приложения | Calendar.Read Calendar.ReadWrite |
...
| Content-Type  | string | Характер данные в теле сущности, который является приложение/json. Обязательный атрибут.  |

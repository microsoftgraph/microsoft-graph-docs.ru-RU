...
---
# <a name="list-windowsautopilotdeploymentprofileassignments"></a>Список windowsAutopilotDeploymentProfileAssignments
...
Список свойств и связей [объектов windowsAutopilotDeploymentProfileAssignment.](../resources/intune-enrollment-windowsautopilotdeploymentprofileassignment.md)
...
В случае успешного выполнения этот метод возвращает код отклика и коллекцию `200 OK` [объектов windowsAutopilotDeploymentProfileAssignment](../resources/intune-enrollment-windowsautopilotdeploymentprofileassignment.md) в теле отклика.

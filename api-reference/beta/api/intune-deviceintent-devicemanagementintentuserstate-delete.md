...
---
# <a name="delete-devicemanagementintentuserstate"></a>Удаление Девицеманажементинтентусерстате
...
Удаляет объект [девицеманажементинтентусерстате](../resources/intune-deviceintent-devicemanagementintentuserstate.md).

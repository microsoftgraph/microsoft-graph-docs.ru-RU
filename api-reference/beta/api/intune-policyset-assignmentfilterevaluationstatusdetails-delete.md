...
---
# <a name="delete-assignmentfilterevaluationstatusdetails"></a>Удаление назначенияFilterEvaluationStatusDetails
...
Удаляет [назначениеFilterEvaluationStatusDetails](../resources/intune-policyset-assignmentfilterevaluationstatusdetails.md).

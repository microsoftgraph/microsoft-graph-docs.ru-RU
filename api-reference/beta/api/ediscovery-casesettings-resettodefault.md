...
description: Сброс объекта caseSetting в значения по умолчанию.
author: mahage-msft
...
Сброс [объекта caseSettings](../resources/ediscovery-caseSettings.md) с значениями по умолчанию.

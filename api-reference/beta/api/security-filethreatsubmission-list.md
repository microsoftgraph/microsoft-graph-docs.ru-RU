---
title: Перечисление fileThreatSubmissions
description: Получение списка объектов fileThreatSubmission и их свойств.
author: caigen
ms.localizationpriority: medium
ms.prod: security
doc_type: apiPageType
ms.openlocfilehash: a564f6735f7da41146de518355c6531d605a17f1
ms.sourcegitcommit: af7a33e92d0e84e6108dd5d9466f869061ac0c97
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/19/2022
ms.locfileid: "66856741"
---
# <a name="list-filethreatsubmissions"></a>Перечисление fileThreatSubmissions
Пространство имен: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение списка объектов [fileThreatSubmission](../resources/security-filethreatsubmission.md) и их свойств.
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и коллекцию объектов [fileThreatSubmission](../resources/security-filethreatsubmission.md) в тексте отклика.

...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и [обновленный объект](../resources/termstore-term.md) термина в тексте отклика.

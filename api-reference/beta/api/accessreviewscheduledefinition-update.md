...
description: Обновите существующий объект accessReviewScheduleDefinition, чтобы изменить одно или несколько его свойств.
...
Обновите [существующий объект accessReviewScheduleDefinition](../resources/accessreviewscheduledefinition.md) , чтобы изменить одно или несколько его свойств.

>[!NOTE]
>Все обновления, внесенные в accessReviewScheduleDefinition, применяются только к будущим экземплярам. В настоящее время не удается обновить запущенные экземпляры.
...
|:-------------|:------------|:------------|
| descriptionForAdmins | Строка | Контекст проверки, предоставленной администраторам. |

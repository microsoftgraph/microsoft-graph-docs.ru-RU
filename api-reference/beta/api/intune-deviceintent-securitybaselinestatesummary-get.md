...
---
# <a name="get-securitybaselinestatesummary"></a>Получить securityBaselineStateSummary
...
Чтение свойств и связей объекта [securityBaselineStateSummary.](../resources/intune-deviceintent-securitybaselinestatesummary.md)
...
В случае успешной работы этот метод возвращает код ответа и `200 OK` [объект securityBaselineStateSummary](../resources/intune-deviceintent-securitybaselinestatesummary.md) в тексте ответа.

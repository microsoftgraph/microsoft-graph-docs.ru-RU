...
Извлечение списка объектов unfamiliarlocationriskevent.
...
В случае успешной работы этот метод возвращает код отклика и коллекцию незнакомых `200 OK` [объектовLocationRiskEvent](../resources/unfamiliarlocationriskevent.md) в тексте ответа.

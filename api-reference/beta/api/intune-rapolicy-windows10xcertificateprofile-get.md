...
---
# <a name="get-windows10xcertificateprofile"></a>Получение windows10XCertificateProfile
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и объект [windows10XCertificateProfile](../resources/intune-rapolicy-windows10xcertificateprofile.md) в тексте отклика.

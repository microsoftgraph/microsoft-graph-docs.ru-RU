...
Создание нового объекта [iosLobApp](../resources/intune-apps-ioslobapp.md).
...
|buildNumber|Строка|Номер сборки бизнес-приложения для iOS.|
|identityVersion|String|Версия удостоверения.|



## <a name="response"></a>Ответ
В случае успешного выполнения этот метод возвращает код ответа `201 Created` и объект [iosLobApp](../resources/intune-apps-ioslobapp.md) в теле ответа.

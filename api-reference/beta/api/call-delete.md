...
Удаление или разрыв активного вызова. При вызове с использованием многосторонних вызовов это приведет к удалению только этой стороны; Базовый вызов по-прежнему будет продолжаться.

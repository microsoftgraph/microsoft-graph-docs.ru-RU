...
В частности, можно использовать $разверните параметр запроса для включения всех встроенного вложений сообщений с помощью rest свойства сообщения. Примеры:

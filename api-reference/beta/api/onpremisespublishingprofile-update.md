...
Обновление свойств объекта [onPremisesPublishingProfile.](../resources/onpremisespublishingprofile.md)
...
|:-------------|:------------|:------------|
|hybridAgentUpdaterConfiguration|hybridAgentUpdaterConfiguration|Представляет [гибридAgentUpdaterConfiguration](../resources/hybridagentupdaterconfiguration.md).|
...
### <a name="example-1-update-updatewindow-in-the-hybridagentupdaterconfiguration"></a>Пример 1. ОбновлениеWindow в hybridAgentUpdaterConfiguration

В следующем примере **обновляется обновлениеWindow** в **гибридеAgentUpdaterConfiguration.**
...
### <a name="example-2-update-deferupdate-in-the-hybridagentupdaterconfiguration"></a>Пример 2. Обновление deferUpdate в гибридной версииAgentUpdaterConfiguration 

В следующем примере обновления **deferUpdate** в **гибридеAgentUpdaterConfiguration**.
...
### <a name="example-3-update-allowupdateconfigurationoverride-in-the-hybridagentupdaterconfiguration"></a>Пример 3. Обновление allowUpdateConfigurationOverride в hybridAgentUpdaterConfiguration

В следующем примере обновления **позволяютUpdateConfigurationOverride в** **hybridAgentUpdaterConfiguration.**

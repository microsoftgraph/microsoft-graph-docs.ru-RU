...
|:--------------------------------------|:---------------------------------------------------------|
|Делегированные (рабочая или учебная учетная запись)     | Акцессревиев. ReadWrite. ALL, а также должен иметь сценарий Програмконтрол. ReadWrite. ALL для завершения с вызовом для удаления Програмконтрол |

---
title: Получение retentionEvent
description: Чтение свойств и связей объекта retentionEvent.
author: sseth
...
ms.locfileid: "66447850"
---
# <a name="get-retentionevent"></a>Получение retentionEvent
Пространство имен: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Чтение свойств и связей объекта [retentionEvent](../resources/security-retentionevent.md) .
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и объект [microsoft.graph.security.retentionEvent](../resources/security-retentionevent.md) в тексте отклика.

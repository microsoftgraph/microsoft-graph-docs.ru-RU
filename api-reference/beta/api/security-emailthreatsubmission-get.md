---
title: Получение emailThreatSubmission
description: Чтение свойств и связей объекта emailThreatSubmission.
author: caigen
...
ms.locfileid: "66856753"
---
# <a name="get-emailthreatsubmission"></a>Получение emailThreatSubmission
Пространство имен: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Чтение свойств и связей объекта [emailThreatSubmission](../resources/security-emailthreatsubmission.md) .
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и объект [emailThreatSubmission](../resources/security-emailthreatsubmission.md) в тексте отклика.

...
В случае успешной работы этот метод возвращает код `200 OK` отклика и [объект printUsageByPrinter](../resources/printUsageByPrinter.md) в тексте ответа.

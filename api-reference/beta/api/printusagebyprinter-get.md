...
[Извлечение сводки](../resources/printer.md)использования принтера за определенный период времени.

Описание каждой из конечных точек см. в [printUsageByPrinter.](../resources/printUsageByPrinter.md)

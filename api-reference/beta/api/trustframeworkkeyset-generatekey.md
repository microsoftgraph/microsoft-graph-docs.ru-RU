...
Создание [trustFrameworkKey и](../resources/trustFrameworkKey.md) секрет автоматически в [trustFrameworkKeyset](../resources/trustframeworkkeyset.md). Вызываемая не должна предоставлять секрет.

...
---
# <a name="delete-importeddeviceidentityresult"></a>Удаление Импортеддевицеидентитиресулт
...
Удаляет объект [импортеддевицеидентитиресулт](../resources/intune-enrollment-importeddeviceidentityresult.md).

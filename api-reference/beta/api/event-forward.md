...
Это действие позволяет Организатор или участник собрания [события](../resources/event.md) пересылать запрос на собрание на нового получателя. 

Если событие собрания пересылается из почтового ящика Office 365 участника другому получателю, это действие также отправляет сообщение для уведомления Организатор переадресации и добавляет получателя копии организатора собрания события. В этом удобства недоступна при пересылке из учетной записи Outlook.com.

...
ms.openlocfilehash: ae3f655a3c8d28119e016e883b320d9952e7e8f4
ms.sourcegitcommit: a16b765507093d892022603d521c0ae8043de432
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/20/2022
ms.locfileid: "62100171"
---
# <a name="list-reviewsetqueries"></a>Обзор спискаSetQueries

Пространство имен: microsoft.graph.ediscovery

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение списка объектов проверки [электронных данныхSetQuery.](../resources/ediscovery-reviewsetquery.md)
...
В случае успеха этот метод возвращает код ответа и коллекцию объектов `200 OK` [microsoft.graph.ediscovery.reviewSetQuery](../resources/ediscovery-reviewsetquery.md) в тексте ответа.

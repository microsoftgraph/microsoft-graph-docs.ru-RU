...
|:---|:---|:---|
|windowsPrivacyAccessControls|[коллекция windowsPrivacyDataAccessControlItem](../resources/intune-deviceconfig-windowsprivacydataaccesscontrolitem.md)|Пока не задокументировано.|

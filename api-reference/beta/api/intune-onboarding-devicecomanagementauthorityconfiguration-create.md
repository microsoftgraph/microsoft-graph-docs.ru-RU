---
title: Создание объекта deviceComanagementAuthorityConfiguration
description: Создайте объект deviceComanagementAuthorityConfiguration.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: cd8a36ea8b23099e83cd23abf4f062249c13defd
ms.sourcegitcommit: 4f5a5aef6cfe2fab2ae39ff7eccaf65f44b7aea1
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 05/05/2022
ms.locfileid: "65206148"
---
# <a name="create-devicecomanagementauthorityconfiguration"></a>Создание объекта deviceComanagementAuthorityConfiguration
...
Создайте объект [deviceComanagementAuthorityConfiguration](../resources/intune-onboarding-devicecomanagementauthorityconfiguration.md) .
...
В теле запроса добавьте представление объекта deviceComanagementAuthorityConfiguration в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта deviceComanagementAuthorityConfiguration.
...
В случае успешного выполнения `201 Created` этот метод возвращает код отклика и объект [deviceComanagementAuthorityConfiguration](../resources/intune-onboarding-devicecomanagementauthorityconfiguration.md) в теле отклика.

...
Отзывать назначенную лицензию пользователя IOS VPP для данного приложения.
...
|:---|:---|:---|
|userId|String|UserId, для которого должна быть отозвана назначенная лицензия приложения|

...
---
# <a name="delete-comanagementeligibledevice"></a>Удаление Команажементелигибледевице
...
Удаляет объект [команажементелигибледевице](../resources/intune-devices-comanagementeligibledevice.md).

...
| Здание               | Строка                                            | Указывает имя здания или номер здания, в котором находится комната. |
| Емкость               | Int32                                             | Указывает емкость комнаты. |
| displayDeviceName      | Строка                                            | Указывает имя отображаемого устройства в комнате. |
| floorLabel             | Строка                                            | Указывает букву пола, в котором находится комната. |
...
| label                  | Строка                                            | Указывает описательную метку для комнаты, например номер или имя. |

...
Обновление свойств объекта [profileCardProperty,](../resources/profilecardproperty.md) определенного свойством **directoryPropertyName.**
...
В случае успешной работы этот метод возвращает код отклика и обновленный `200 OK` [объект profileCardProperty](../resources/profilecardproperty.md) в тексте ответа.

## <a name="examples"></a>Примеры

### <a name="request"></a>Запрос

В следующем примере добавляется локализованная метка "Senter Kostnads" для локального "no-NB".

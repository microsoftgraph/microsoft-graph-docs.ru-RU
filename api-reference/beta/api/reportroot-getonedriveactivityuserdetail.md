...
В случае успешной работы этот метод возвращает код отклика и `200 OK` **[объект oneDriveActivityUserDetail](../resources/onedriveactivityuserdetail.md)** в тексте ответа.

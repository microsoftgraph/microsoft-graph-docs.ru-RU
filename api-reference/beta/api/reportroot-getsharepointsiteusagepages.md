...
В случае успешной работы этот метод возвращает код ответа и `200 OK` **[объект sharePointSiteUsagePages](../resources/sharepointsiteusagepages.md)** в тексте ответа.

...
|:---|:---|:---|
|ids|Коллекция String|Список идентификаторов, соответствующих ресурсам [updatableAsset](../resources/windowsupdates-updatableasset.md) , которые необходимо удалить в качестве членов **updatableAssetGroup**.|

...
Получить список [групповых](../resources/termstore-group.md) объектов [магазина](../resources/termstore-store.md)
...
В случае успешной работы этот метод возвращает код отклика и коллекцию групповых `200 OK` объектов в тексте ответа. [](../resources/termstore-group.md)

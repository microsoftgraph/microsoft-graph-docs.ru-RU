...
Отзывать все назначенные лицензии VPP iOS для данного приложения.
...
|:---|:---|:---|
|notifyManagedDevices|Boolean|Boolean, который указывает, следует ли отправить уведомление об отводе на устройство|

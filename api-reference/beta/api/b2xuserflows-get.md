...
---
# <a name="get-b2xuserflow"></a>Получение b2xUserFlow

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение свойств и связей объекта [b2xUserFlow](../resources/b2xuserflows.md) .
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и представление объекта [усерфловаттрибуте](../resources/b2xuserflows.md) в тексте отклика в формате JSON.

...
Успешно завершена, этот метод возвращает `200 OK` код ответа и объект [политики](../resources/policy.md) в теле ответа. Если unsucccessful...

## <a name="example"></a>Пример
В следующем примере извлекается определенной политики.

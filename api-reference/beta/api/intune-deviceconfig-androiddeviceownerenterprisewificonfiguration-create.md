---
title: Создание объекта androidDeviceOwnerEnterpriseWiFiConfiguration
description: Создайте объект androidDeviceOwnerEnterpriseWiFiConfiguration.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 3bdd7be7110f12b0208a98d9e36bced6f856ccb5
ms.sourcegitcommit: 435d70e7adb27e6cedaf485ebfdab7c3ef9ffacf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/02/2022
ms.locfileid: "65857957"
---
# <a name="create-androiddeviceownerenterprisewificonfiguration"></a>Создание объекта androidDeviceOwnerEnterpriseWiFiConfiguration
...
Создайте объект [androidDeviceOwnerEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androiddeviceownerenterprisewificonfiguration.md) .
...
В теле запроса добавьте представление объекта androidDeviceOwnerEnterpriseWiFiConfiguration в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта androidDeviceOwnerEnterpriseWiFiConfiguration.
...
В случае успешного выполнения `201 Created` этот метод возвращает код отклика и объект [androidDeviceOwnerEnterpriseWiFiConfiguration](../resources/intune-deviceconfig-androiddeviceownerenterprisewificonfiguration.md) в тексте отклика.

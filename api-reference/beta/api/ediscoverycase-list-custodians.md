...
---
# <a name="list-custodians"></a>Список custodians

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение списка объектов [хранитель](../resources/custodian.md) и их свойств.
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и коллекцию объектов [хранитель](../resources/custodian.md) в тексте отклика.

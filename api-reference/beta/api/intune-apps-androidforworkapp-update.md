...
ms.openlocfilehash: 1a249112e06457f37260a9986a4ebabf2f2da747f8127c87c3b4b99d0ad11d3a
ms.sourcegitcommit: 986c33b848fa22a153f28437738953532b78c051
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/05/2021
ms.locfileid: "54171723"
---
# <a name="update-androidforworkapp"></a>Обновление AndroidForWorkApp
...
Обновление свойств объекта [AndroidForWorkApp.](../resources/intune-apps-androidforworkapp.md)
...
В теле запроса поставляем представление JSON для [объекта AndroidForWorkApp.](../resources/intune-apps-androidforworkapp.md)

В следующей таблице показаны свойства, необходимые при создании [androidForWorkApp.](../resources/intune-apps-androidforworkapp.md)
...
В случае успешной работы этот метод возвращает код отклика и обновленный `200 OK` [объект AndroidForWorkApp](../resources/intune-apps-androidforworkapp.md) в тексте отклика.

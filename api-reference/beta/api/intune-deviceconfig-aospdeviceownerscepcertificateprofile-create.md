---
title: Создание aospDeviceOwnerScepCertificateProfile
description: Создайте новый объект aospDeviceOwnerScepCertificateProfile.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 960d2616118abdbaa359478b8ba844a3016c8b2f
ms.sourcegitcommit: 0076eb6abb89be3dca3575631924a74a5202be30
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/03/2022
ms.locfileid: "64631332"
---
# <a name="create-aospdeviceownerscepcertificateprofile"></a>Создание aospDeviceOwnerScepCertificateProfile
...
Создайте [новый объект aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .
...
В теле запроса поставляем представление JSON для объекта aospDeviceOwnerScepCertificateProfile.

В следующей таблице показаны свойства, необходимые при создании aospDeviceOwnerScepCertificateProfile.
...
В случае успеха `201 Created` этот метод возвращает код отклика и [объект aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) в тексте ответа.

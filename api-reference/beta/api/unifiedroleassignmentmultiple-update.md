...
Обновление существующего unfiedRoleAssignmentMultiple для поставщика облачных ПК:
<!-- { "blockType": "ignored" } -->
...
Обновление существующего unfiedRoleAssignmentMultiple для поставщика Intune:
<!-- { "blockType": "ignored" } -->
...
### <a name="example-1-update-an-existing-unfiedroleassignmentmultiple-in-an-intune-provider"></a>Пример 1. Обновление существующего unfiedRoleAssignmentMultiple в поставщике Intune
...
## <a name="example-2-update-an-existing-unfiedroleassignmentmultiple-in-a-cloud-pc-provider"></a>Пример 2. Обновление существующего unfiedRoleAssignmentMultiple в поставщике облачных ПК

---
title: Удаление программы (не рекомендуется)
description: В Azure AD проверки доступа удалите объект программы.
...
ms.locfileid: "65821108"
---
# <a name="delete-program-deprecated"></a>Удаление программы (не рекомендуется)
...
В Azure AD [проверки доступа](../resources/accessreviews-root.md) удалите [объект](../resources/program.md) программы.

Не удаляйте программу, `programControl` которая по-прежнему связана с ней. Сначала эти проверки доступа должны быть удалены или удалены из программы и связаны с другой программой.  Кроме того, обратите внимание, что встроенную программу по умолчанию нельзя удалить.

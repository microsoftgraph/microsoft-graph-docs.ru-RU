...
ms.openlocfilehash: 5c2d3a02e258f7ff77e18c7d24a2dbb7abc5fba3
...
---
# <a name="delete-mobileappcategory"></a><span data-ttu-id="2a9e5-103">Delete mobileAppCategory</span><span class="sxs-lookup"><span data-stu-id="2a9e5-103">Delete mobileAppCategory</span></span>
...
<span data-ttu-id="2a9e5-106">Удаляет объект [mobileAppCategory](../resources/intune-apps-mobileappcategory.md).</span><span class="sxs-lookup"><span data-stu-id="2a9e5-106">Deletes a [mobileAppCategory](../resources/intune-apps-mobileappcategory.md).</span></span>

## <a name="prerequisites"></a><span data-ttu-id="2a9e5-107">Необходимые разрешения</span><span class="sxs-lookup"><span data-stu-id="2a9e5-107">Prerequisites</span></span>
...
|<span data-ttu-id="2a9e5-116">Для приложений</span><span class="sxs-lookup"><span data-stu-id="2a9e5-116">Application</span></span>|<span data-ttu-id="2a9e5-117">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="2a9e5-117">DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="2a9e5-127">Не указывайте текст запроса для этого метода.</span><span class="sxs-lookup"><span data-stu-id="2a9e5-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="2a9e5-128">Отклик</span><span class="sxs-lookup"><span data-stu-id="2a9e5-128">Response</span></span>
<span data-ttu-id="2a9e5-129">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="2a9e5-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="2a9e5-130">Пример</span><span class="sxs-lookup"><span data-stu-id="2a9e5-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="2a9e5-131">Запрос</span><span class="sxs-lookup"><span data-stu-id="2a9e5-131">Request</span></span>
<span data-ttu-id="2a9e5-132">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="2a9e5-132">Here is an example of the request.</span></span>
``` http
DELETE https://graph.microsoft.com/beta/deviceAppManagement/mobileAppCategories/{mobileAppCategoryId}
```

### <a name="response"></a><span data-ttu-id="2a9e5-133">Отклик</span><span class="sxs-lookup"><span data-stu-id="2a9e5-133">Response</span></span>
<span data-ttu-id="2a9e5-p102">Ниже приведен пример ответа. Примечание. Объект отклика, показанный здесь, может быть усечен для краткости. При фактическом вызове будут возвращены все свойства.</span><span class="sxs-lookup"><span data-stu-id="2a9e5-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http

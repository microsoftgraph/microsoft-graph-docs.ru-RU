...
Получите определенной политики.
...
Успешно завершена, этот метод возвращает `200 OK` объект [officeClientConfiguration](../resources/intune-cirrus-officeclientconfiguration.md) и кода ответа в теле ответа.

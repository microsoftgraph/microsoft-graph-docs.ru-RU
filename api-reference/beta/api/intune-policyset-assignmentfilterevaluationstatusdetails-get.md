...
---
# <a name="get-assignmentfilterevaluationstatusdetails"></a>Получить назначениеFilterEvaluationStatusDetails
...
В случае успешного выполнения этот метод возвращает код ответа и назначение `200 OK` [объектаFilterEvaluationStatusDetails](../resources/intune-policyset-assignmentfilterevaluationstatusdetails.md) в теле ответа.

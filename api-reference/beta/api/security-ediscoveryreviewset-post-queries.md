...
|:---|:---|:---|
|displayName|Строка|Имя запроса. Обязательный аргумент.|
|contentQuery|String|Запрос KQL для набора проверки. [Дополнительные сведения](https://docs.microsoft.com/microsoft-365/compliance/review-set-search).|

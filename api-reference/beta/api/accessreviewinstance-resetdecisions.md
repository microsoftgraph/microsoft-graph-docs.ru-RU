...
Сбрасывает решения всех [объектов accessReviewInstanceDecisionItem](../resources/accessreviewinstancedecisionitem.md) в [accessReviewInstance](../resources/accessreviewinstance.md) в значение `notReviewed`.

...
<!-- Please verify the revised description here. -->| classCode | Строка | Класс код, используемый в школе. | | externalId | Строка | Идентификатор класса в системе выполняется синхронизация. Свойство externalName типа String представляет собой название курса в системе синхронизации. Свойство externalSource типа String представляет собой способ создания курса. Возможные значения: `sis`, `manual`, `enum_sentinel`.

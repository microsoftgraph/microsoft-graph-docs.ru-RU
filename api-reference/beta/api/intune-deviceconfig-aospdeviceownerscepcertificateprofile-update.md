---
title: Обновление aospDeviceOwnerScepCertificateProfile
description: Обновление свойств объекта aospDeviceOwnerScepCertificateProfile.
author: dougeby
...
ms.locfileid: "64631272"
---
# <a name="update-aospdeviceownerscepcertificateprofile"></a>Обновление aospDeviceOwnerScepCertificateProfile
...
Обновление свойств [объекта aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .
...
В теле запроса поставляем представление JSON для [объекта aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .

В следующей таблице показаны свойства, необходимые при создании [aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md).
...
В случае успеха `200 OK` этот метод возвращает код отклика и обновленный [объект aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) в тексте ответа.

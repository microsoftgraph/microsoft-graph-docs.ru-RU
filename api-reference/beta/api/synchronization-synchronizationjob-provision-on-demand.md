...
description: Выберите пользователя и подготовите учетную запись по запросу.
...
ms.locfileid: "66436626"
---
# <a name="synchronizationjob-provisionondemand"></a>synchronizationJob: provisionOnDemand

Пространство имен: microsoft.graph

Выберите пользователя и подготовите учетную запись по запросу. Ограничение скорости для этого API — 5 запросов в 10 секунд. 
...
|:---|:---|:---|
|parameters|[Коллекция synchronizationJobApplicationParameters](../resources/synchronization-synchronizationjobapplicationparameters.md)|Представляет объекты, которые будут подготовлены, и выполняемые правила синхронизации. Ресурс в основном используется для подготовки по запросу. |



## <a name="response"></a>Отклик

В случае успешного выполнения этот метод возвращает код `200 OK` отклика и stringKeyStringValuePair.

## <a name="examples"></a>Примеры

### <a name="example-1-provision-users-from-azure-ad-to-third-party-applications"></a>Пример 1. Подготовка пользователей Azure AD приложениям сторонних производителей
...
### <a name="example-2-sync-on-demand-from-active-directory-to-azure-active-directory-azure-ad-cloud-sync"></a>Пример 2. Синхронизация по запросу из Active Directory в Azure Active Directory (Azure AD облачной синхронизации)
...
### <a name="example-3-provision-a-group-and-two-of-its-members-on-demand"></a>Пример 3. Подготовка группы и двух ее членов по запросу

...
|филеснетворкдривеакцессблоккед|Boolean|Указывает, могут ли устройства получать доступ к файлам или другим ресурсам на сетевом сервере с помощью протокола SMB. Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.|
|филесусбдривеакцессблоккед|Boolean|Указывает, могут ли севицес с Access подключаться к файлам и открывать их на USB-диске. Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.|
|вифиповеронфорцед|Boolean|Указывает, остаются ли Wi-Fi, даже если устройство находится в режиме "в самолете". Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.|
...
|аппклипсблоккед|Boolean|Запрещает пользователю добавлять какие бы то ни было клипы приложений и удалять существующие клипы приложений на устройстве.|

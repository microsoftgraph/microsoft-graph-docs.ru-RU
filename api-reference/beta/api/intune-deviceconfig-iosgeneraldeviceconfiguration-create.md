...
|вифиповеронфорцед|Логический|Указывает, остаются ли Wi-Fi, даже если устройство находится в режиме "в самолете". Доступно для устройств с iOS и Ипадос версии 13,0 и более поздних версий.|
...
|шареддевицеблокктемпорарисессионс|Логический|Указывает, следует ли заблокировать временные сеансы на общем iPad (iOS 13,4 или более поздней версии).|
|аппклипсблоккед|Логический|Запрещает пользователю добавлять какие бы то ни было клипы приложений и удалять существующие клипы приложений на устройстве.|

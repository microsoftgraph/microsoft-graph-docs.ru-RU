---
title: Удаление объекта windowsManagedAppProtection
description: Удаляет объект windowsManagedAppProtection.
author: dougeby
...
---
# <a name="delete-windowsmanagedappprotection"></a>Удаление объекта windowsManagedAppProtection
...
Удаляет объект [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md).

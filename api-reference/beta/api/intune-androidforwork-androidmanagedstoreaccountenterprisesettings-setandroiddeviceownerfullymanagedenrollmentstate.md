...
Задает Значение AndroidManagedStoreAccountEnterpriseSettings AndroidDeviceOwnerFullyManagedEnrollmentEnabled.
...
|:---|:---|:---|
|enabled|Boolean|Значение для набора AndroidDeviceOwnerFullyManagedEnrollmentEnabled.|

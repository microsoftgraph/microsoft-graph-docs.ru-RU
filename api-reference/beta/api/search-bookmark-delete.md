...
description: Удаление объекта закладки.
author: jakeost-msft
...
ms.locfileid: "63339865"
---
# <a name="delete-bookmark"></a>Удаление закладки
Пространство имен: microsoft.graph.search

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Удаление объекта [закладки](../resources/search-bookmark.md) .

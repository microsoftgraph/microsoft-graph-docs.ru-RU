---
title: Список oemWarrantyInformationOnboardings
description: Список свойств и связей объектов oemWarrantyInformationOnboarding.
author: dougeby
...
ms.locfileid: "62290208"
---
# <a name="list-oemwarrantyinformationonboardings"></a>Список oemWarrantyInformationOnboardings
...
Список свойств и связей объектов [oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) .
...
В случае успеха этот `200 OK` метод возвращает код ответа и коллекцию объектов [oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) в теле ответа.

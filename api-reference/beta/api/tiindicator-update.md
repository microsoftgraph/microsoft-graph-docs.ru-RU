...
---
# <a name="update-tiindicator"></a>Обновление Тииндикатор
...
|description|Строка|Краткое описание угрозы, представленное индикатором (100 символов или меньше).|
...
|Киллчаин|Коллекция строк|Массив строк JSON, указывающий, какая точка или точки в цепочке аннулирования этот индикатор. Точные значения приведены в разделе "значения Киллчаин".|
...
|Тлплевел|строка| Значение протокола светофора для индикатора. Возможные значения: `unknown`, `white`, `green`, `amber`, `red`.|

...
---
# <a name="get-identityriskevent-deprecated"></a>Get identityRiskEvent (deprecated)
...
Извлечение свойств и связей объекта identityriskevent.
...
В случае успешной работы этот метод возвращает код ответа и `200 OK` [объект identityRiskEvent](../resources/identityriskevent.md) в тексте отклика.

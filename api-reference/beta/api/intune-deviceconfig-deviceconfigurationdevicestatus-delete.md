...
ms.locfileid: "51131647"
---
# <a name="delete-deviceconfigurationdevicestatus"></a><span data-ttu-id="284e2-103">Удаление объекта deviceConfigurationDeviceStatus</span><span class="sxs-lookup"><span data-stu-id="284e2-103">Delete deviceConfigurationDeviceStatus</span></span>
...
> <span data-ttu-id="284e2-105">**Важно:** API Microsoft Graph в /бета-версии могут изменяться; использование продукции не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="284e2-105">**Important:** Microsoft Graph APIs under the /beta version are subject to change; production use is not supported.</span></span>
...
|<span data-ttu-id="284e2-111">Тип разрешения</span><span class="sxs-lookup"><span data-stu-id="284e2-111">Permission type</span></span>|<span data-ttu-id="284e2-112">Разрешения (в порядке повышения привилегий)</span><span class="sxs-lookup"><span data-stu-id="284e2-112">Permissions (from least to most privileged)</span></span>|
|:---|:---|
|<span data-ttu-id="284e2-113">Делегированное (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="284e2-113">Delegated (work or school account)</span></span>|<span data-ttu-id="284e2-114">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="284e2-114">DeviceManagementConfiguration.ReadWrite.All</span></span>|
|<span data-ttu-id="284e2-115">Делегированное (личная учетная запись Майкрософт)</span><span class="sxs-lookup"><span data-stu-id="284e2-115">Delegated (personal Microsoft account)</span></span>|<span data-ttu-id="284e2-116">Не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="284e2-116">Not supported.</span></span>|
|<span data-ttu-id="284e2-117">Приложение</span><span class="sxs-lookup"><span data-stu-id="284e2-117">Application</span></span>|<span data-ttu-id="284e2-118">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="284e2-118">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|:---|:---|
|<span data-ttu-id="284e2-123">Authorization</span><span class="sxs-lookup"><span data-stu-id="284e2-123">Authorization</span></span>|<span data-ttu-id="284e2-124">Bearer &lt;token&gt;. Обязательный.</span><span class="sxs-lookup"><span data-stu-id="284e2-124">Bearer &lt;token&gt; Required.</span></span>|
...
<span data-ttu-id="284e2-130">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="284e2-130">If successful, this method returns a `204 No Content` response code.</span></span>

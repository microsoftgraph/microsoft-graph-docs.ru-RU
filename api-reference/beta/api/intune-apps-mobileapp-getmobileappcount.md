...
---
# <a name="getmobileappcount-function"></a><span data-ttu-id="85756-103">Функция getMobileAppCount</span><span class="sxs-lookup"><span data-stu-id="85756-103">getMobileAppCount function</span></span>
...
<span data-ttu-id="85756-106">Пока не задокументировано.</span><span class="sxs-lookup"><span data-stu-id="85756-106">Not yet documented</span></span>

## <a name="prerequisites"></a><span data-ttu-id="85756-107">Предварительные условия</span><span class="sxs-lookup"><span data-stu-id="85756-107">Prerequisites</span></span>
...
|:---|:---|
|<span data-ttu-id="85756-112">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="85756-112">Delegated (work or school account)</span></span>|<span data-ttu-id="85756-113">DeviceManagementApps.ReadWrite.All, DeviceManagementApps.Read.All</span><span class="sxs-lookup"><span data-stu-id="85756-113">DeviceManagementApps.ReadWrite.All, DeviceManagementApps.Read.All</span></span>|
...
|<span data-ttu-id="85756-116">Для приложений</span><span class="sxs-lookup"><span data-stu-id="85756-116">Application</span></span>|<span data-ttu-id="85756-117">Не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="85756-117">Not supported.</span></span>|
...
## <a name="request-body"></a><span data-ttu-id="85756-126">Текст запроса</span><span class="sxs-lookup"><span data-stu-id="85756-126">Request body</span></span>
<span data-ttu-id="85756-127">В URL-адресе запроса укажите перечисленные ниже параметры запроса и их значения.</span><span class="sxs-lookup"><span data-stu-id="85756-127">In the request URL, provide the following query parameters with values.</span></span>
<span data-ttu-id="85756-128">В приведенной ниже таблице указаны параметры, которые можно использовать с этой функцией.</span><span class="sxs-lookup"><span data-stu-id="85756-128">The following table shows the parameters that can be used with this function.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="85756-132">status</span><span class="sxs-lookup"><span data-stu-id="85756-132">status</span></span>|<span data-ttu-id="85756-133">String</span><span class="sxs-lookup"><span data-stu-id="85756-133">String</span></span>|<span data-ttu-id="85756-134">Н/Д</span><span class="sxs-lookup"><span data-stu-id="85756-134">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="85756-135">Ответ</span><span class="sxs-lookup"><span data-stu-id="85756-135">Response</span></span>
<span data-ttu-id="85756-136">В случае успеха эта функция возвращает код `200 OK` отклика и значение Int64 в тексте отклика.</span><span class="sxs-lookup"><span data-stu-id="85756-136">If successful, this function returns a `200 OK` response code and a Int64 in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="85756-137">Пример</span><span class="sxs-lookup"><span data-stu-id="85756-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="85756-138">Запрос</span><span class="sxs-lookup"><span data-stu-id="85756-138">Request</span></span>
<span data-ttu-id="85756-139">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="85756-139">Here is an example of the request.</span></span>
``` http
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/getMobileAppCount(status='parameterValue')
```

### <a name="response"></a><span data-ttu-id="85756-140">Отклик</span><span class="sxs-lookup"><span data-stu-id="85756-140">Response</span></span>

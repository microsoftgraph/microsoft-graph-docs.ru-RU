...
ms.locfileid: "58790593"
---
# <a name="get-androidcertificateprofilebase"></a>Get androidCertificateProfileBase
...
Чтение свойств и связей [объекта AndroidCertificateProfileBase.](../resources/intune-deviceconfig-androidcertificateprofilebase.md)
...
В случае успешной работы этот метод возвращает код отклика и `200 OK` [объект AndroidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) в тексте ответа.

...
Обновление свойств объекта [едукатионауткоме](../resources/educationoutcome.md) .
...
Ниже приведен пример запроса на обновление результатов обратной связи.
...
### <a name="example-2-update-a-points-outcome"></a>Пример 2: обновление результата баллов

#### <a name="request"></a>Запрос

Ниже приведен пример запроса на обновление результата баллов.
...
### <a name="example-3-update-a-rubric-outcome"></a>Пример 3: обновление результата Rubric

#### <a name="request"></a>Запрос

Ниже приведен пример запроса на обновление результата Rubric.

...
Получение списка объектов назначений. Преподаватель может видеть все объекты назначения для класса. Студентов можно видеть только назначения, которые были им назначены.

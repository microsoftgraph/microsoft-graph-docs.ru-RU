...
|If-Match      |Обязательный. Если этот загон запроса включен и предоставленный eTag не совпадает с текущим тегом в **customerPaymentJournals,** **клиентPaymentJournals** не обновляется. |

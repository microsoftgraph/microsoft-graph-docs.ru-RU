...
В случае успешной работы этот метод возвращает код ответа и `200 OK` **[объект oneDriveUsageFileCounts](../resources/onedriveusagefilecounts.md)** в тексте ответа.

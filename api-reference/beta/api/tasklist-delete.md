...
ms.locfileid: "65819925"
---
# <a name="delete-basetasklist-deprecated"></a>Удаление baseTaskList (не рекомендуется)
...
Удаляет объект [baseTaskList](../resources/tasklist.md) .

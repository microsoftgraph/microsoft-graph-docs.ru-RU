...
ms.openlocfilehash: 0062c9e48715379486666a465a2a560f23f02d19
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "60994355"
---
# <a name="list-addtoreviewsetoperation"></a>Список addToReviewSetOperation

Пространство имен: microsoft.graph.ediscovery

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получите последний [объект addToReviewSetOperation,](../resources/ediscovery-addtoreviewsetoperation.md) связанный с исходным собранием. 
...
В случае успеха этот метод возвращает код ответа и `200 OK` [объект microsoft.graph.ediscovery.addToReviewSetOperation](../resources/ediscovery-addtoreviewsetoperation.md) в тексте ответа.

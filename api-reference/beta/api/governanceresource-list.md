...
Получите коллекцию [governanceResource](../resources/governanceresource.md) с доступом к инициатора запроса.
...
В этом примере выводятся все ресурсы, которые в настоящее время доступна.

...
Чтение свойств и связей [объекта AndroidDeviceOwnerCertificateProfileBase.](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)
...
В случае успешной работы этот метод возвращает код отклика и `200 OK` [объект AndroidDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md) в тексте ответа.

...
ms.openlocfilehash: 6bc2322cd6dc1e03b74fd044958007f945f248b2691092534431755ee5190607
...
Создайте новый [объект iosScepCertificateProfile.](../resources/intune-deviceconfig-iosscepcertificateprofile.md)
...
В теле запроса поставляем представление JSON для объекта iosScepCertificateProfile.

В следующей таблице показаны свойства, необходимые при создании iosScepCertificateProfile.
...
В случае успеха этот метод возвращает код отклика и `201 Created` [объект iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md) в тексте ответа.

...
|wipeAfterCompanyPortalUpdateDeferralInDays|Int32|Максимальное количество дней, в течение которое обновление на портале компании может быть отложено на устройстве, или данные компании в приложении будут стираться|

...
Чтение свойства и связи объекта [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) .
...
Успешно завершена, этот метод возвращает `200 OK` объект [ndesConnector](../resources/intune-deviceconfig-ndesconnector.md) и кода ответа в теле ответа.

...
Создание нового объекта [androidLobApp](../resources/intune-apps-androidlobapp.md).
...
|versionCode|Строка|Код версии бизнес-приложения Android.|
|identityVersion|String|Версия удостоверения.|



## <a name="response"></a>Ответ
В случае успешного выполнения этот метод возвращает код ответа `201 Created` и объект [androidLobApp](../resources/intune-apps-androidlobapp.md) в теле ответа.

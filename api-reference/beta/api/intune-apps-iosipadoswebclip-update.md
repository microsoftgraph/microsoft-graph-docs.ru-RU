---
title: Обновление iosiPadOSWebClip
description: Обновление свойств объекта iosiPadOSWebClip.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: dd6f089e3590b3ecd6b703fc421683b0e17f01f9
ms.sourcegitcommit: 435d70e7adb27e6cedaf485ebfdab7c3ef9ffacf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/02/2022
ms.locfileid: "65858849"
---
# <a name="update-iosipadoswebclip"></a>Обновление iosiPadOSWebClip
...
Обновление свойств объекта [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) .
...
В тексте запроса добавьте представление объекта [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) в формате JSON.

В следующей таблице показаны свойства, необходимые при создании [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md).
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и обновленный объект [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) в тексте отклика.

...
ms.locfileid: "34986482"
---
# <a name="targetapps-action"></a><span data-ttu-id="fc597-103">Действие targetApps</span><span class="sxs-lookup"><span data-stu-id="fc597-103">targetApps action</span></span>
...
<span data-ttu-id="fc597-106">Пока не задокументировано.</span><span class="sxs-lookup"><span data-stu-id="fc597-106">Not yet documented</span></span>

## <a name="prerequisites"></a><span data-ttu-id="fc597-107">Предварительные условия</span><span class="sxs-lookup"><span data-stu-id="fc597-107">Prerequisites</span></span>
...
|:---|:---|
|<span data-ttu-id="fc597-112">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="fc597-112">Delegated (work or school account)</span></span>|<span data-ttu-id="fc597-113">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="fc597-113">DeviceManagementApps.ReadWrite.All</span></span>|
...
## <a name="request-body"></a><span data-ttu-id="fc597-126">Тело запроса</span><span class="sxs-lookup"><span data-stu-id="fc597-126">Request body</span></span>
<span data-ttu-id="fc597-127">В тело запроса добавьте параметры в формате JSON.</span><span class="sxs-lookup"><span data-stu-id="fc597-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="fc597-128">В приведенной ниже таблице указаны параметры, которые можно использовать с этим действием.</span><span class="sxs-lookup"><span data-stu-id="fc597-128">The following table shows the parameters that can be used with this action.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="fc597-132">apps</span><span class="sxs-lookup"><span data-stu-id="fc597-132">apps</span></span>|<span data-ttu-id="fc597-133">Коллекция [managedMobileApp](../resources/intune-mam-managedmobileapp.md)</span><span class="sxs-lookup"><span data-stu-id="fc597-133">[managedMobileApp](../resources/intune-mam-managedmobileapp.md) collection</span></span>|<span data-ttu-id="fc597-134">Н/Д</span><span class="sxs-lookup"><span data-stu-id="fc597-134">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="fc597-135">Ответ</span><span class="sxs-lookup"><span data-stu-id="fc597-135">Response</span></span>
<span data-ttu-id="fc597-136">В случае успешного выполнения это действие возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="fc597-136">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="fc597-137">Пример</span><span class="sxs-lookup"><span data-stu-id="fc597-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="fc597-138">Запрос</span><span class="sxs-lookup"><span data-stu-id="fc597-138">Request</span></span>
<span data-ttu-id="fc597-139">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="fc597-139">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="fc597-140">Отклик</span><span class="sxs-lookup"><span data-stu-id="fc597-140">Response</span></span>
<span data-ttu-id="fc597-p102">Ниже приведен пример ответа. Примечание. Объект отклика, показанный здесь, может быть усечен для краткости. При фактическом вызове будут возвращены все свойства.</span><span class="sxs-lookup"><span data-stu-id="fc597-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http

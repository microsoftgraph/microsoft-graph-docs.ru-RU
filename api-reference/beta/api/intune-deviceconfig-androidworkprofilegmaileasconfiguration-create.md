...
---
# <a name="create-androidworkprofilegmaileasconfiguration"></a>Создание androidWorkProfileGmailEasConfiguration
...
Создайте новый [объект AndroidWorkProfileGmailEasConfiguration.](../resources/intune-deviceconfig-androidworkprofilegmaileasconfiguration.md)
...
В теле запроса предоставляем представление JSON для объекта AndroidWorkProfileGmailEasConfiguration.

В следующей таблице показаны свойства, необходимые при создании androidWorkProfileGmailEasConfiguration.
...
В случае успеха этот метод возвращает код отклика и `201 Created` [объект AndroidWorkProfileGmailEasConfiguration](../resources/intune-deviceconfig-androidworkprofilegmaileasconfiguration.md) в теле отклика.

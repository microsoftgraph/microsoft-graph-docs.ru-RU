...
---
# <a name="delete-macossoftwareupdatestatesummary"></a>Удаление Макоссофтвареупдатестатесуммари
...
Удаляет объект [макоссофтвареупдатестатесуммари](../resources/intune-deviceconfig-macossoftwareupdatestatesummary.md).

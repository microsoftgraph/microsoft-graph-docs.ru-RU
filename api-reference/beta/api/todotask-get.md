...
---
# <a name="get-todotask"></a>Вывод задачи todoTask
...
При успешном выполнении этот метод возвращает код `200 OK` ответа [и объект todoTask](../resources/todotask.md) в теле отклика.

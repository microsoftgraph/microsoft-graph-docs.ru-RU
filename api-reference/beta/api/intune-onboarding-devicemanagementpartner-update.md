...
|whenPartnerDevicesWillBeMarkedAsNonCompliant|DateTimeOffset|DateTime в UTC, когда PartnerDevices будет помечен как несовершенный. Скоро это не будет работать.|

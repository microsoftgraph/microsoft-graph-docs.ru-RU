---
title: Создание iosiPadOSWebClip
description: Создайте объект iosiPadOSWebClip.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 1bf6a20367f9ca8cccf15faa241c2b849eef724b
ms.sourcegitcommit: 435d70e7adb27e6cedaf485ebfdab7c3ef9ffacf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/02/2022
ms.locfileid: "65858826"
---
# <a name="create-iosipadoswebclip"></a>Создание iosiPadOSWebClip
...
Создайте объект [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) .
...
В тексте запроса добавьте представление объекта iosiPadOSWebClip в формате JSON.

В следующей таблице показаны свойства, необходимые при создании iosiPadOSWebClip.
...
В случае успешного выполнения этот метод возвращает код `201 Created` отклика и объект [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) в тексте отклика.

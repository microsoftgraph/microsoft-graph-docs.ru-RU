...
ms.openlocfilehash: b9ea4246cffd86ca6c38b6df3d7ab99e3032f711
ms.sourcegitcommit: 0116750a01323bc9bedd192d4a780edbe7ce0fdc
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/13/2021
ms.locfileid: "58264383"
---
...
В теле запроса предоставляем представление JSON для [объекта AndroidForWorkVpnConfiguration.](../resources/intune-deviceconfig-androidforworkvpnconfiguration.md)

В следующей таблице показаны свойства, необходимые при создании [androidForWorkVpnConfiguration.](../resources/intune-deviceconfig-androidforworkvpnconfiguration.md)
...
В случае успеха этот метод возвращает код отклика и обновленный `200 OK` [объект AndroidForWorkVpnConfiguration](../resources/intune-deviceconfig-androidforworkvpnconfiguration.md) в тексте ответа.

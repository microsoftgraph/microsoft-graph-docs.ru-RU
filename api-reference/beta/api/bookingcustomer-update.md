...
Обновление свойства объекта [bookingCustomer](../resources/bookingcustomer.md) .
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и обновленные [bookingCustomer](../resources/bookingcustomer.md) объект в теле ответа.

...
ms.locfileid: "48700012"
---
# <a name="delete-iosvppappassigneduserlicense"></a><span data-ttu-id="8edd1-103">Удаление Иосвппаппассигнедусерлиценсе</span><span class="sxs-lookup"><span data-stu-id="8edd1-103">Delete iosVppAppAssignedUserLicense</span></span>
...
<span data-ttu-id="8edd1-107">Удаляет объект [иосвппаппассигнедусерлиценсе](../resources/intune-apps-iosvppappassigneduserlicense.md).</span><span class="sxs-lookup"><span data-stu-id="8edd1-107">Deletes a [iosVppAppAssignedUserLicense](../resources/intune-apps-iosvppappassigneduserlicense.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="8edd1-113">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="8edd1-113">Delegated (work or school account)</span></span>|<span data-ttu-id="8edd1-114">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="8edd1-114">DeviceManagementApps.ReadWrite.All</span></span>|
...
|<span data-ttu-id="8edd1-117">Для приложений</span><span class="sxs-lookup"><span data-stu-id="8edd1-117">Application</span></span>|<span data-ttu-id="8edd1-118">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="8edd1-118">DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="8edd1-128">Не указывайте текст запроса для этого метода.</span><span class="sxs-lookup"><span data-stu-id="8edd1-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="8edd1-129">Отклик</span><span class="sxs-lookup"><span data-stu-id="8edd1-129">Response</span></span>
<span data-ttu-id="8edd1-130">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="8edd1-130">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="8edd1-131">Пример</span><span class="sxs-lookup"><span data-stu-id="8edd1-131">Example</span></span>

### <a name="request"></a><span data-ttu-id="8edd1-132">Запрос</span><span class="sxs-lookup"><span data-stu-id="8edd1-132">Request</span></span>
<span data-ttu-id="8edd1-133">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="8edd1-133">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="8edd1-134">Отклик</span><span class="sxs-lookup"><span data-stu-id="8edd1-134">Response</span></span>

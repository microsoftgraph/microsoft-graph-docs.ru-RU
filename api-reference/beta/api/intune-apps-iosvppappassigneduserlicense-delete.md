...
---
# <a name="delete-iosvppappassigneduserlicense"></a>Удаление Иосвппаппассигнедусерлиценсе
...
Удаляет объект [иосвппаппассигнедусерлиценсе](../resources/intune-apps-iosvppappassigneduserlicense.md).

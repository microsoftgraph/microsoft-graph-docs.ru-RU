...
description: Ознакомьтесь с свойствами и отношениями объекта softwareOathAuthenticationMethod.
author: mmcla
ms.localizationpriority: medium
ms.prod: identity-and-sign-in
doc_type: apiPageType
ms.openlocfilehash: 8accc198b897c20a5afe7fea4f51943e9ac96428
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "61020399"
---
# <a name="get-softwareoathauthenticationmethod"></a>Get softwareOathAuthenticationMethod
Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение единого объекта проверки подлинности маркеров [SOFTWARE OATH](../resources/softwareoathauthenticationmethod.md) пользователя и его свойств.
...
В случае успешной работы этот метод возвращает код ответа и объект `200 OK` [softwareOathAuthenticationMethod](../resources/softwareoathauthenticationmethod.md) в тексте ответа.

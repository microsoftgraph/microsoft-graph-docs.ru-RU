...
---
# <a name="delete-macostrustedrootcertificate"></a>Удаление Макострустедрутцертификате
...
Удаляет объект [макострустедрутцертификате](../resources/intune-deviceconfig-macostrustedrootcertificate.md).

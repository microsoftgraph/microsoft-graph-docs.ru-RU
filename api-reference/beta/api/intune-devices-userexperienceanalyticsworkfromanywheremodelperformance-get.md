...
description: Чтение свойств и связей объекта userExperienceAnalyticsWorkFromAnywhereModelPerformance.
author: dougeby
...
ms.locfileid: "62292425"
---
# <a name="get-userexperienceanalyticsworkfromanywheremodelperformance"></a>Get userExperienceAnalyticsWorkFromAnywhereModelPerformance
...
Чтение свойств и связей [объекта userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) .
...
В случае успеха этот `200 OK` метод возвращает код отклика и [объект userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) в тексте ответа.

...
ms.openlocfilehash: 231977bb715e2e32e78394197411c0186286f18f
ms.sourcegitcommit: 6c04234af08efce558e9bf926062b4686a84f1b2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/12/2021
ms.locfileid: "59042678"
---
...
|localSecurityOptionsDisableClientDigitallySignCommunicationsIfServerAgrees|Логическое|Этот параметр безопасности определяет, пытается ли клиент SMB договориться о подписании пакета SMB.|
...
|applicationGuardCertificateThumbprints|Коллекция объектов string|Позволяет совместно использовать корневые сертификаты определенного уровня устройств с Application Guard в Microsoft Defender контейнером.|
...
|defenderAllowBehaviorMonitoring|Логическое|Позволяет или не разрешает Защитник Windows функции мониторинга поведения.|
...
|defenderEnableScanIncomingMail|Логическое|Позволяет или не разрешает сканирование электронной почты.|
|defenderEnableScanMappedNetworkDrivesDuringFullScan|Логическое|Позволяет или не разрешает полное сканирование картографифицированных сетевых дисков.|
...
|defenderDisableScanNetworkFiles|Логическое|Позволяет или не разрешает сканирование сетевых файлов.|
...
|defenderCheckForSignaturesBeforeRunningScan|Логическое|Этот параметр политики позволяет управлять проверкой новых определений вирусов и программ-шпионов перед запуском сканирования.|

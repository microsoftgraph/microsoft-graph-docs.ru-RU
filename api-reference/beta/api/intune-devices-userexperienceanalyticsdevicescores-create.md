---
title: Создание объекта userExperienceAnalyticsDeviceScores
description: Создайте объект userExperienceAnalyticsDeviceScores.
author: dougeby
...
ms.locfileid: "65857906"
---
# <a name="create-userexperienceanalyticsdevicescores"></a>Создание объекта userExperienceAnalyticsDeviceScores
...
Создайте объект [userExperienceAnalyticsDeviceScores](../resources/intune-devices-userexperienceanalyticsdevicescores.md) .
...
В тексте запроса добавьте представление объекта userExperienceAnalyticsDeviceScores в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта userExperienceAnalyticsDeviceScores.
...
В случае успешного выполнения `201 Created` этот метод возвращает код отклика и объект [userExperienceAnalyticsDeviceScores](../resources/intune-devices-userexperienceanalyticsdevicescores.md) в тексте отклика.

...
В случае успеха этот метод возвращает код ответа и `200 OK` **[объект sharePointSiteUsageSiteCounts](../resources/sharepointsiteusagesitecounts.md)** в тексте ответа.

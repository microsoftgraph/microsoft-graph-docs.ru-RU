...
В случае успеха этот метод возвращает код отклика и объект `200 OK` **[sharePointSiteUsageSiteCounts](../resources/sharepointsiteusagesitecounts.md)** в тексте отклика.

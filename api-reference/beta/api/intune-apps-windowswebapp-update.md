---
title: Обновление windowsWebApp
description: Обновление свойств объекта windowsWebApp.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 521886fb696f3a0f7e107f67911e6ba23e5e8884
ms.sourcegitcommit: 435d70e7adb27e6cedaf485ebfdab7c3ef9ffacf
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/02/2022
ms.locfileid: "65858823"
---
# <a name="update-windowswebapp"></a>Обновление windowsWebApp
...
Обновление свойств объекта [windowsWebApp](../resources/intune-apps-windowswebapp.md) .
...
В тексте запроса добавьте представление объекта [windowsWebApp в формате](../resources/intune-apps-windowswebapp.md) JSON.

В следующей таблице показаны свойства, необходимые при создании [windowsWebApp](../resources/intune-apps-windowswebapp.md).
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и обновленный объект [windowsWebApp](../resources/intune-apps-windowswebapp.md) в тексте отклика.

---
title: Создание aospDeviceOwnerPkcsCertificateProfile
description: Создание нового объекта aospDeviceOwnerPkcsCertificateProfile.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 9cc130b9f2eba105d4da6e655439401a608396a4
...
---
# <a name="create-aospdeviceownerpkcscertificateprofile"></a>Создание aospDeviceOwnerPkcsCertificateProfile
...
Создание нового [объекта aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) .
...
В теле запроса поставляем представление JSON для объекта aospDeviceOwnerPkcsCertificateProfile.

В следующей таблице показаны свойства, необходимые при создании aospDeviceOwnerPkcsCertificateProfile.
...
В случае успешной `201 Created` работы этот метод возвращает код ответа и [объект aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) в теле ответа.

---
title: Создание объекта deviceManagementConfigurationChoiceSettingDefinition
description: Создайте объект deviceManagementConfigurationChoiceSettingDefinition.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 52e65219675e9108f8c02f3e65aa745ce75e88dc
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66668225"
---
# <a name="create-devicemanagementconfigurationchoicesettingdefinition"></a>Создание объекта deviceManagementConfigurationChoiceSettingDefinition
...
Создайте объект [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) .
...
В теле запроса добавьте представление объекта deviceManagementConfigurationChoiceSettingDefinition в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта deviceManagementConfigurationChoiceSettingDefinition.
...
В случае успешного выполнения `201 Created` этот метод возвращает код отклика и объект [deviceManagementConfigurationChoiceSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationchoicesettingdefinition.md) в теле отклика.

...
Получить список организационных контакты для данной организации.
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и коллекцию объектов [orgContact](../resources/orgcontact.md) в теле ответа.

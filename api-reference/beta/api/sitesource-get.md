...
Чтение свойств и связей объекта [siteSource.](../resources/sitesource.md)
...
В случае успеха этот метод возвращает код отклика и объект `200 OK` [siteSource](../resources/sitesource.md) в тексте отклика.

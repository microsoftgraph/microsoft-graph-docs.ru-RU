...
ms.openlocfilehash: 021bcb483cce7068dfe6c4bff8de27341d915710a73ed447e48a39477b63d89b
...
---
# <a name="update-macosmicrosoftedgeapp"></a>Обновление macOSMicrosoftEdgeApp
...
Обновление свойств объекта [macOSMicrosoftEdgeApp.](../resources/intune-apps-macosmicrosoftedgeapp.md)
...
В теле запроса поставляем представление JSON для [объекта macOSMicrosoftEdgeApp.](../resources/intune-apps-macosmicrosoftedgeapp.md)

В следующей таблице показаны свойства, необходимые при создании [macOSMicrosoftEdgeApp.](../resources/intune-apps-macosmicrosoftedgeapp.md)
...
В случае успеха этот метод возвращает код ответа и обновленный `200 OK` [объект macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) в тексте ответа.

...
description: Ознакомьтесь с свойствами и отношениями объекта baseTaskList.
author: devindrajit
...
ms.locfileid: "62116649"
---
# <a name="get-basetasklist"></a>Get baseTaskList
Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Ознакомьтесь с свойствами и отношениями объекта [baseTaskList.](../resources/basetasklist.md)
...
В случае успешной работы этот метод возвращает код ответа и `200 OK` [объект baseTaskList](../resources/basetasklist.md) в тексте ответа.

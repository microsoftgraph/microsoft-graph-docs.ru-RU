...
В случае успешной работы `200 OK` этот метод возвращает код ответа и новый объект [informationProtectionContentLabel](../resources/informationprotectioncontentlabel.md) в тексте ответа.

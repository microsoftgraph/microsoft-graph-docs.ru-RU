...
ms.openlocfilehash: bffb926816fe80741903bb0c80b5e6e9e3abd302
ms.sourcegitcommit: c541d3eceafda4812e2c0c029c95ddfb92ef58b3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/04/2021
ms.locfileid: "53726756"
---
...
|почта;|String|SMTP-адрес пользователя, например `jeff@contoso.onmicrosoft.com`. Для учетных записей Azure AD B2C это свойство может обновляться до десяти раз с помощью уникальных SMTP-адресов. Изменение этого свойства также приведет к обновлению коллекции пользователя **proxyAddresses**, которая будет включать это значение как SMTP-адрес.|

...
|assignedLicenses|[microsoft.graph.assignedLicense](../resources/assignedlicense.md) коллекции|Лицензии, назначенные пользователю. Значение null не допускается.            |
...
|employeeId|Строка|Идентификатор сотрудника, назначенных пользователю организацией. Поддерживает параметр $filter.|

...
Получение свойств и связей объекта worksheetprotection.
...
В случае успеха этот метод возвращает код отклика `200 OK` и объект [WorksheetProtection](../resources/worksheetprotection.md) в тексте отклика.

...
---
# <a name="get-companyinformation"></a>Get companyInformation

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Извлечение свойств и связей информационного объекта компании для Центра бизнеса Dynamics 365.
...
В случае успешной работы этот метод возвращает код отклика и `200 OK` **объект companyInformation** в тексте ответа.

...
В случае успешной работы этот метод возвращает код ответа и объект `200 OK` **[emailAppUsageUserDetail](../resources/emailappusageuserdetail.md)** в тексте ответа.

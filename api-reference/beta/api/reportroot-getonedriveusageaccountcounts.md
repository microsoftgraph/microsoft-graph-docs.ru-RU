...
В случае успешной работы этот метод возвращает код отклика и `200 OK` **[объект oneDriveUsageAccountCounts](../resources/onedriveusageaccountcounts.md)** в тексте ответа.

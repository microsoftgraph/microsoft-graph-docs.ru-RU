...
Чтение свойства и связи объекта [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) .
...
Успешно завершена, этот метод возвращает `200 OK` объект [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) и кода ответа в теле ответа.

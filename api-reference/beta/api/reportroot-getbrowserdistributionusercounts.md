...
description: Получите отчет, который предоставляет общее число пользователей, использующих Microsoft Edge, устаревшая версия Microsoft Edge и Internet Explorer, когда используется для доступа к Microsoft 365 служб в течение определенного периода.
...
Получите отчет, который предоставляет общее число пользователей, использующих Microsoft Edge, устаревшая версия Microsoft Edge и Internet Explorer, когда используется для доступа к Microsoft 365 служб в течение определенного периода.

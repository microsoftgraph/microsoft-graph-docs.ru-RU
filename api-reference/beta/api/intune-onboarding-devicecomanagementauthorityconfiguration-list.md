---
title: Перечисление объектов deviceComanagementAuthorityConfiguration
...
---
# <a name="list-devicecomanagementauthorityconfigurations"></a>Перечисление объектов deviceComanagementAuthorityConfiguration
...
В случае успешного выполнения `200 OK` этот метод возвращает код отклика и коллекцию объектов [deviceComanagementAuthorityConfiguration](../resources/intune-onboarding-devicecomanagementauthorityconfiguration.md) в теле отклика.

...
---
# <a name="delete-grouppolicyuploadedcategory"></a>Удаление Граупполициуплоадедкатегори
...
Удаляет объект [граупполициуплоадедкатегори](../resources/intune-grouppolicy-grouppolicyuploadedcategory.md).

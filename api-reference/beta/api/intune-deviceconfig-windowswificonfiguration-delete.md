...
ms.openlocfilehash: 698838ccb3659c935fb9681a40fbd7d0f41d8dce
ms.sourcegitcommit: 86903a4730bbd825eabb7f0a1b2429723cc8b1e6
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/26/2019
ms.locfileid: "37186339"
---
# <a name="delete-windowswificonfiguration"></a><span data-ttu-id="d9301-103">Удаление Виндовсвификонфигуратион</span><span class="sxs-lookup"><span data-stu-id="d9301-103">Delete windowsWifiConfiguration</span></span>
...
<span data-ttu-id="d9301-106">Удаляет объект [виндовсвификонфигуратион](../resources/intune-deviceconfig-windowswificonfiguration.md).</span><span class="sxs-lookup"><span data-stu-id="d9301-106">Deletes a [windowsWifiConfiguration](../resources/intune-deviceconfig-windowswificonfiguration.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="d9301-112">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="d9301-112">Delegated (work or school account)</span></span>|<span data-ttu-id="d9301-113">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="d9301-113">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|<span data-ttu-id="d9301-116">Для приложений</span><span class="sxs-lookup"><span data-stu-id="d9301-116">Application</span></span>|<span data-ttu-id="d9301-117">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="d9301-117">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
## <a name="request-body"></a><span data-ttu-id="d9301-126">Тело запроса</span><span class="sxs-lookup"><span data-stu-id="d9301-126">Request body</span></span>
...
## <a name="response"></a><span data-ttu-id="d9301-128">Отклик</span><span class="sxs-lookup"><span data-stu-id="d9301-128">Response</span></span>
<span data-ttu-id="d9301-129">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="d9301-129">If successful, this method returns a `204 No Content` response code.</span></span>

...
---
# <a name="delete-grouppolicysettingmapping"></a>Удаление Граупполицисеттингмаппинг
...
Удаляет объект [граупполицисеттингмаппинг](../resources/intune-gpanalyticsservice-grouppolicysettingmapping.md).

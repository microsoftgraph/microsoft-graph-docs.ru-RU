...
| onPremisesPublishing    | [onPremisesPublishing](../resources/onpremisespublishing.md)                | Представляет набор свойств для настройки прокси приложения [Azure AD](https://aka.ms/whyappproxy) для локального приложения. Это свойство можно установить только после создания приложения.                                                                                                                                                                                                                                                                                                                                                       |

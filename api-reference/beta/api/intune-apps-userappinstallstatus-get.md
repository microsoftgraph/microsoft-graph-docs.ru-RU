...
Чтение свойств и связей [объекта userAppInstallStatus.](../resources/intune-apps-userappinstallstatus.md)
...
В случае успешной работы этот метод возвращает код отклика и `200 OK` [объект userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md) в тексте ответа.

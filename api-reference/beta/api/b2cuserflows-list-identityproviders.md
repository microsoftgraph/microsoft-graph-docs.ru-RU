...
---
# <a name="list-all-identityproviders-in-a-b2cuserflow"></a>Перечисление всех Идентитипровидерс в b2cUserFlow

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение поставщиков удостоверений в объекте [b2cUserFlow](../resources/b2cuserflows.md)

...
---
# <a name="update-androidmanagedstorewebapp"></a>Обновление AndroidManagedStoreWebApp
...
Обновление свойств объекта [AndroidManagedStoreWebApp.](../resources/intune-apps-androidmanagedstorewebapp.md)
...
В теле запроса поставляем представление JSON для [объекта AndroidManagedStoreWebApp.](../resources/intune-apps-androidmanagedstorewebapp.md)

В следующей таблице показаны свойства, необходимые при создании [androidManagedStoreWebApp.](../resources/intune-apps-androidmanagedstorewebapp.md)
...
|isPrivate|Boolean|Указывает, доступно ли приложение только пользователям данного предприятия. Унаследованный от [AndroidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|
|isSystemApp|Boolean|Указывает, является ли приложение предустановленным системным приложением. Унаследованный от [AndroidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|
...
|supportsOemConfig|Boolean|Поддерживает ли это приложение политику OEMConfig. Унаследованный от [AndroidManagedStoreApp](../resources/intune-apps-androidmanagedstoreapp.md)|



## <a name="response"></a>Отклик
В случае успеха этот метод возвращает код отклика и обновленный `200 OK` [объект AndroidManagedStoreWebApp](../resources/intune-apps-androidmanagedstorewebapp.md) в тексте ответа.

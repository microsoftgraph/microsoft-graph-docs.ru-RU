...
Извлечение свойств и связи объекта orgcontact.
...
Успешно завершена, этот метод возвращает `200 OK` объект [orgContact](../resources/orgcontact.md) и кода ответа в теле ответа.

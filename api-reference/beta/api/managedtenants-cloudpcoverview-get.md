...
Ознакомьтесь с свойствами и отношениями объекта [cloudPcOverview.](../resources/managedtenants-cloudpcoverview.md)
...
В случае успешной работы этот метод возвращает код отклика и `200 OK` [объект cloudPcOverview](../resources/managedtenants-cloudpcoverview.md) в тексте ответа.

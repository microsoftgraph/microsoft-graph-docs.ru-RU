...
ms.openlocfilehash: 0bb291387c9d8b6ef8d598c384c21d920ba8b5b87394653f282536205e52a5f6
...
Создание нового [объекта macOSMicrosoftEdgeApp.](../resources/intune-apps-macosmicrosoftedgeapp.md)
...
В теле запроса поставляем представление JSON для объекта macOSMicrosoftEdgeApp.

В следующей таблице показаны свойства, необходимые при создании macOSMicrosoftEdgeApp.
...
В случае успешной работы этот метод возвращает код отклика и `201 Created` [объект macOSMicrosoftEdgeApp](../resources/intune-apps-macosmicrosoftedgeapp.md) в тексте ответа.

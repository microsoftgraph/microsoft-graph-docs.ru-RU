...
Обновление свойства объекта [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и обновленные [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) объекта в теле ответа.

...
Получите отчет, который предоставляет тенденцию в количестве активных пользователей для каждого приложения — Outlook, Word, Excel, PowerPoint, OneNote и Teams - в вашей организации.

...
Получение connectorgroup, которое соединитель.
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и коллекцию объектов [connectorGroup](../resources/connectorgroup.md) в теле ответа.

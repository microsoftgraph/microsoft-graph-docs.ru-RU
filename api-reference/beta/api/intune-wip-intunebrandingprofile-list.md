...
Свойства списка и связей объектов [intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) .
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и коллекцию объектов [intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) в теле ответа.

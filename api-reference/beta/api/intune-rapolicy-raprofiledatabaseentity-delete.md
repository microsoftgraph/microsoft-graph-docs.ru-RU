...
---
# <a name="delete-raprofiledatabaseentity"></a>Удаление Рапрофиледатабасинтити
...
Удаляет объект [рапрофиледатабасинтити](../resources/intune-rapolicy-raprofiledatabaseentity.md).

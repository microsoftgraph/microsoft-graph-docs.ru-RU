...
description: 'Получение свойств и связей объекта privilegedRole. '
...
Получение свойств и связей объекта [privilegedRole](../resources/privilegedrole.md) . 
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и объект [privilegedRole](../resources/privilegedrole.md) в тексте отклика.

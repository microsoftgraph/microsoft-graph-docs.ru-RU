---
title: Создание объекта deviceManagementConfigurationSimpleSettingDefinition
description: Создайте объект deviceManagementConfigurationSimpleSettingDefinition.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: c6f8786eade99cb777273dd656fa1ebc2b3f1961
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667292"
---
# <a name="create-devicemanagementconfigurationsimplesettingdefinition"></a>Создание объекта deviceManagementConfigurationSimpleSettingDefinition
...
Создайте объект [deviceManagementConfigurationSimpleSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsimplesettingdefinition.md) .
...
В теле запроса добавьте представление объекта deviceManagementConfigurationSimpleSettingDefinition в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта deviceManagementConfigurationSimpleSettingDefinition.
...
|valueDefinition|[deviceManagementConfigurationSettingValueDefinition](../resources/intune-shared-devicemanagementconfigurationsettingvaluedefinition.md)|Определение значения для этого параметра|
|Defaultvalue|[deviceManagementConfigurationSettingValue](../resources/intune-shared-devicemanagementconfigurationsettingvalue.md)|Значение параметра по умолчанию для этого параметра|
|dependentOn|[Коллекция deviceManagementConfigurationDependentOn](../resources/intune-shared-devicemanagementconfigurationdependenton.md)|Список родительских параметров, от которые зависит этот параметр|
...
В случае успешного `201 Created` выполнения этот метод возвращает код отклика и объект [deviceManagementConfigurationSimpleSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsimplesettingdefinition.md) в теле отклика.

...
Отключить вход в SMS для существующего `mobile` номера телефона. 

>**Примечание:** Этот номер больше не будет доступен для входа в SMS, что может препятствовать входу пользователя в систему.

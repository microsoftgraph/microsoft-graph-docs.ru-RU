...
Получите только что созданный, обновленный или удаленный **административеунитс** , не требуя полного считывания всей коллекции ресурсов. Подробнее: [Использование запроса изменений](/graph/delta-query-overview).
...
Чтобы начать отслеживание изменений, необходимо создать запрос, включающий функцию Delta в ресурсе **administrativeUnit** .
...
Для получения дополнительных сведений и примера обратитесь к разделу [Использование разностного запроса](/graph/delta-query-overview) и [получение добавочных изменений для пользователей](/graph/delta-query-users).

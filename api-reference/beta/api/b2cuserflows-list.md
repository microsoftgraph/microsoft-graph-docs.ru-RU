...
Получение списка объектов [b2cUserFlow](../resources/b2cuserflows.md) .
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и коллекцию объектов [b2cUserFlow](../resources/b2cuserflows.md)  в тексте отклика.

## <a name="examples"></a>Примеры

### <a name="example-1-list-all-b2cuserflows"></a>Пример 1: List All ALL b2cUserFlows
...
### <a name="example-2-list-all-b2cuserflows-and-expand-identityproviders"></a>Пример 2: List All b2cUserFlows and Expand Идентитипровидерс

...
author: tfitzmac
ms.prod: Intune
ms.openlocfilehash: 86e1166c7476fe906fac79511196d1a4e49acac9
ms.sourcegitcommit: dcc5907f2c3ffc0f0e82e953b7ab9cf4ab938360
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/23/2019
ms.locfileid: "29420803"
---
# <a name="delete-androidimportedpfxcertificateprofile"></a><span data-ttu-id="ff560-103">Удаление androidImportedPFXCertificateProfile</span><span class="sxs-lookup"><span data-stu-id="ff560-103">Delete androidImportedPFXCertificateProfile</span></span>
...
<span data-ttu-id="ff560-107">Удаляет [androidImportedPFXCertificateProfile](../resources/intune-deviceconfig-androidimportedpfxcertificateprofile.md).</span><span class="sxs-lookup"><span data-stu-id="ff560-107">Deletes a [androidImportedPFXCertificateProfile](../resources/intune-deviceconfig-androidimportedpfxcertificateprofile.md).</span></span>

## <a name="prerequisites"></a><span data-ttu-id="ff560-108">Предварительные требования</span><span class="sxs-lookup"><span data-stu-id="ff560-108">Prerequisites</span></span>
...
|:---|:---|
|<span data-ttu-id="ff560-113">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="ff560-113">Delegated (work or school account)</span></span>|<span data-ttu-id="ff560-114">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="ff560-114">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|:---|:---|
|<span data-ttu-id="ff560-123">Авторизация</span><span class="sxs-lookup"><span data-stu-id="ff560-123">Authorization</span></span>|<span data-ttu-id="ff560-124">Требуется Bearer &lt;маркер&gt;
...
## <a name="request-body"></a><span data-ttu-id="ff560-127">Текст запроса</span><span class="sxs-lookup"><span data-stu-id="ff560-127">Request body</span></span>
<span data-ttu-id="ff560-128">Не указывайте тело запроса для этого метода.</span><span class="sxs-lookup"><span data-stu-id="ff560-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="ff560-129">Отклик</span><span class="sxs-lookup"><span data-stu-id="ff560-129">Response</span></span>
<span data-ttu-id="ff560-130">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="ff560-130">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="ff560-131">Пример</span><span class="sxs-lookup"><span data-stu-id="ff560-131">Example</span></span>

### <a name="request"></a><span data-ttu-id="ff560-132">Запрос</span><span class="sxs-lookup"><span data-stu-id="ff560-132">Request</span></span>
<span data-ttu-id="ff560-133">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="ff560-133">Here is an example of the request.</span></span>
``` http
DELETE https://graph.microsoft.com/beta/deviceManagement/deviceConfigurations/{deviceConfigurationId}
```

### <a name="response"></a><span data-ttu-id="ff560-134">Отклик</span><span class="sxs-lookup"><span data-stu-id="ff560-134">Response</span></span>

...
- Отображаемая имя сети
- "Report Period" (Отчетный период).

### <a name="json"></a>JSON

В случае успеха этот метод возвращает код отклика и объект `200 OK` **[yammerGroupsActivityDetail](../resources/yammergroupsactivitydetail.md)** в тексте отклика.

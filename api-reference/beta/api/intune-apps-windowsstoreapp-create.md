...
|appStoreUrl|String|Windows store URL-адрес приложения.|



## <a name="response"></a>Отклик
Успешно завершена, этот метод возвращает `201 Created` код ответа и объект [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) в теле ответа.

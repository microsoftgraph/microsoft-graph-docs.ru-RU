...
Обновление фотографии для любого пользователя в клиенте, в том числе пользователя, выполнившего вход, или указанной группы или контакта. Так как ограничение общего размера каждого запроса REST в 8 МБ, размер фотографии, которую можно добавить, ограничен до 8 МБ.
...
Чтобы обновить фотографию для команды, выполните следующие действия:

---
title: Обновление deviceManagementConfigurationRedirectSettingDefinition
...
ms.locfileid: "60494401"
---
# <a name="update-devicemanagementconfigurationredirectsettingdefinition"></a>Обновление deviceManagementConfigurationRedirectSettingDefinition
...
В теле запроса поставляем представление JSON для [объекта deviceManagementConfigurationRedirectSettingDefinition.](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md)

В следующей таблице показаны свойства, необходимые при создании [устройстваManagementConfigurationRedirectSettingDefinition.](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md)
...
В случае успешного выполнения этот метод возвращает код ответа и обновленный `200 OK` [объект deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) в тексте ответа.

...
ms.prod: governance
author: shauliu1
ms.openlocfilehash: 474de4d9b5cc665de7802584191d64ad37a1d283
ms.sourcegitcommit: 01755ac7c0ab7becf28052e05e58567caa8364cd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/21/2021
ms.locfileid: "58453221"
---
...
<!-- { "blockType": "ignored" } -->
1. Получить [управлениеRoleAssignment на](../resources/governanceroleassignment.md) ресурсе

    *Примечание. Помимо области разрешений требуется, чтобы у запросителя было по крайней мере одно назначение ролей на ресурсе.* 
```http
...
Получить [governanceRoleAssignment](../resources/governanceroleassignment.md) по подписке "Wingtip Toys - Prod"

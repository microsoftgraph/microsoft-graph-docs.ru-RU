...
ms.openlocfilehash: 317191f238164b77d27427c93f5cd214d5f26e35
...
|microsoftLauncherFeedEnabled|Логическое|Указывает, хотите ли вы включить канал запуска на устройстве.|
...
|kioskModeManagedHomeScreenSignInEnabled|Логическое|Показывается ли экран регистрации для управляемого домашнего экрана.|
...
|passwordBlockKeyguard|Логическое|Указывает, отключен ли ключ-гарант.|
...
|storageAllowUsb|Логическое|Указывает, следует ли разрешить массовое хранилище USB.|
...
|systemWindowsBlocked|Логическое|Блокировка windows системы Android, например всплывающие уведомления, телефонные действия и системные оповещения.|
...
|VPNAlwaysOnLockdownMode|Логическое|Если всегда указано имя пакета VPN, следует ли заблокировать сетевой трафик при отключении VPN.|
...
|wifiBlockEditConfigurations|Логическое|Указывает, следует ли блокировать пользователю редактирование параметров подключения к Wi-Fi.|
|wifiBlockEditPolicyDefinedConfigurations|Логическое|Указывает, следует ли блокировать пользователю редактирование только сетей, определенных политикой.|

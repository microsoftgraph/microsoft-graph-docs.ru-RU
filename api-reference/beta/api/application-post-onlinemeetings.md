...
```
> **Примечание.** путь `/app` или `/communications` с маркером приложения является устаревшим. В дальнейшем используйте путь /me с маркером пользователя для создания онлайн-собраний.

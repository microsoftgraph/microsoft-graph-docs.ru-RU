...
``{id}`` Обратите внимание, что он имеет формат userId_roleId, где userId — это строка GUID для идентификатора Azure AD пользователя, а roleId — строка GUID для идентификатора роли администратора Azure.

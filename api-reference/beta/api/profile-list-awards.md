---
title: Награды списка
description: Получите коллекцию personAwards из свойства навигации awards.
ms.localizationpriority: medium
author: kevinbellinger
ms.prod: people
doc_type: apiPageType
ms.openlocfilehash: 7adec1575ccd09d7ffdd97aaac342ff52104ae66
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "61019535"
---
# <a name="list-awards"></a>Награды списка

Пространство имен: microsoft.graph

Извлечение списка [объектов personAward](../resources/personaward.md) из профиля [пользователя.](../resources/profile.md)
...
В случае успешной работы этот метод возвращает код отклика и коллекцию `200 OK` [объектов personAward](../resources/personaward.md) в тексте ответа.

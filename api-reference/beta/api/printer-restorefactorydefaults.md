...
Восстановите параметры [принтера](../resources/printer.md)в заводские настройки.
...
|:---------------|:--------------------------------------------|
|Делегированное (рабочая или учебная учетная запись)| Printer. ReadWrite. ALL, Printer. FullControl. ALL |

...
Извлечение свойств объекта соединителя.
...
Успешно завершена, этот метод возвращает `200 OK` объект [соединителя](../resources/connector.md) и кода ответа в теле ответа.

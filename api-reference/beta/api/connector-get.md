...
Извлечение свойств и связей объекта [соединители](../resources/connector.md) .
...
В случае успешной работы этот метод возвращает код `200 OK` ответа и [соединители](../resources/connector.md) объект в тексте отклика.

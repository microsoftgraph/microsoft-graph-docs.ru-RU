...
В случае успешной работы этот метод возвращает код отклика и обновленный объект `200 OK` [книгиChartTitle](../resources/workbookcharttitle.md) в тексте ответа.

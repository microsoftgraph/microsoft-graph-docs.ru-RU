...
Получение списка объектов [учетных записей для учетных записей](../resources/webaccount.md) в [профиле](../resources/profile.md)пользователя.
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и коллекцию объектов [Account](../resources/webaccount.md) в тексте отклика.

...
Извлечение свойств объекта connectorGroup.
...
Успешно завершена, этот метод возвращает `200 OK` объект [connectorGroup](../resources/connectorgroup.md) и кода ответа в теле ответа.

...
---
# <a name="list-macmanagedappprotections"></a>Список Макманажедапппротектионс

> **Важно!** API Microsoft Graph в версии/Beta могут изменяться; рабочее использование не поддерживается.

> **Примечание:** Для API Microsoft Graph для Intune требуется [Активная лицензия Intune](https://go.microsoft.com/fwlink/?linkid=839381) для клиента.

Список свойств и связей объектов [макманажедапппротектион](../resources/intune-policyset-macmanagedappprotection.md) .
...
В случае успешного выполнения этот метод возвращает `200 OK` код отклика и коллекцию объектов [макманажедапппротектион](../resources/intune-policyset-macmanagedappprotection.md) в тексте отклика.

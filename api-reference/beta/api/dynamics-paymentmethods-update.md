...
|If-Match      |Обязательный. Если этот загон запроса включен и предоставленный eTag не соответствует текущему тегу на **paymentMethods,** **платежMethods** не обновляется. |

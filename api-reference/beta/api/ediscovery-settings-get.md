...
Ознакомьтесь с свойствами и отношениями объекта [параметров.](../resources/ediscovery-settings.md)
...
В случае успешной работы этот метод возвращает код отклика и объект `200 OK` [параметров](../resources/ediscovery-settings.md) в тексте ответа.

---
title: Создание объекта windowsManagedAppProtection
description: Создайте объект windowsManagedAppProtection.
author: dougeby
...
ms.locfileid: "65858913"
---
# <a name="create-windowsmanagedappprotection"></a>Создание объекта windowsManagedAppProtection
...
Создайте объект [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) .
...
В тексте запроса добавьте представление объекта windowsManagedAppProtection в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта windowsManagedAppProtection.
...
В случае успешного выполнения этот метод возвращает код `201 Created` отклика и объект [windowsManagedAppProtection](../resources/intune-mam-windowsmanagedappprotection.md) в тексте отклика.

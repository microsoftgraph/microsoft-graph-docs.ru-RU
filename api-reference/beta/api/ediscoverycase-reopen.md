...
Повторное открытие дела eDiscovery, которое было закрыто. For details, see [Reopen a closed case](/microsoft-365/compliance/close-or-delete-case#reopen-a-closed-case).

...
---
# <a name="delete-devicecompliancescript"></a>Удаление Девицекомплианцескрипт
...
Удаляет объект [девицекомплианцескрипт](../resources/intune-devices-devicecompliancescript.md).

...
ms.openlocfilehash: 52b34d94cbbd4e76f30d85ecc5afa2212ae75c4c
...
---
# <a name="delete-devicecompliancescript"></a><span data-ttu-id="bcbd3-103">Удаление Девицекомплианцескрипт</span><span class="sxs-lookup"><span data-stu-id="bcbd3-103">Delete deviceComplianceScript</span></span>
...
<span data-ttu-id="bcbd3-107">Удаляет объект [девицекомплианцескрипт](../resources/intune-devices-devicecompliancescript.md).</span><span class="sxs-lookup"><span data-stu-id="bcbd3-107">Deletes a [deviceComplianceScript](../resources/intune-devices-devicecompliancescript.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="bcbd3-113">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="bcbd3-113">Delegated (work or school account)</span></span>|<span data-ttu-id="bcbd3-114">DeviceManagementManagedDevices.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="bcbd3-114">DeviceManagementManagedDevices.ReadWrite.All</span></span>|
...
|<span data-ttu-id="bcbd3-117">Приложение</span><span class="sxs-lookup"><span data-stu-id="bcbd3-117">Application</span></span>|<span data-ttu-id="bcbd3-118">DeviceManagementManagedDevices.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="bcbd3-118">DeviceManagementManagedDevices.ReadWrite.All</span></span>|
...
|:---|:---|
|<span data-ttu-id="bcbd3-123">Авторизация</span><span class="sxs-lookup"><span data-stu-id="bcbd3-123">Authorization</span></span>|<span data-ttu-id="bcbd3-124">Bearer &lt;token&gt;. Обязательный.</span><span class="sxs-lookup"><span data-stu-id="bcbd3-124">Bearer &lt;token&gt; Required.</span></span>|
...
## <a name="request-body"></a><span data-ttu-id="bcbd3-127">Текст запроса</span><span class="sxs-lookup"><span data-stu-id="bcbd3-127">Request body</span></span>
<span data-ttu-id="bcbd3-128">Не указывайте текст запроса для этого метода.</span><span class="sxs-lookup"><span data-stu-id="bcbd3-128">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="bcbd3-129">Отклик</span><span class="sxs-lookup"><span data-stu-id="bcbd3-129">Response</span></span>
<span data-ttu-id="bcbd3-130">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="bcbd3-130">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="bcbd3-131">Пример</span><span class="sxs-lookup"><span data-stu-id="bcbd3-131">Example</span></span>

### <a name="request"></a><span data-ttu-id="bcbd3-132">Запрос</span><span class="sxs-lookup"><span data-stu-id="bcbd3-132">Request</span></span>
<span data-ttu-id="bcbd3-133">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="bcbd3-133">Here is an example of the request.</span></span>
``` http
DELETE https://graph.microsoft.com/beta/deviceManagement/deviceComplianceScripts/{deviceComplianceScriptId}
```

### <a name="response"></a><span data-ttu-id="bcbd3-134">Отклик</span><span class="sxs-lookup"><span data-stu-id="bcbd3-134">Response</span></span>

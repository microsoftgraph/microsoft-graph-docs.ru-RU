...
### <a name="example-3-list-all-shared-channels"></a>Пример 3. Вывод списка всех общих каналов

#### <a name="request"></a>Запрос

В следующем примере показан запрос на перечисление всех общих каналов.

...
ms.openlocfilehash: b961e2d5557b7fc2838ed170239fd0cfbf1a657f
ms.sourcegitcommit: 65f4e128f96783c18d607a6dcffbc914291285d4
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 12/08/2021
ms.locfileid: "61341490"
---
...
|redirectReason|Строка|Указывает причину перенаправления пользователя на альтернативное расположение консоли.  Например: профили WiFi не поддерживаются в каталоге параметров и должны быть созданы с помощью политики шаблонов.|

---
title: Создание deviceManagementConfigurationRedirectSettingDefinition
description: Создание нового объекта deviceManagementConfigurationRedirectSettingDefinition.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 0e9b7a9100f8ca0beb946fc3019f77b7abb39bc5
ms.sourcegitcommit: c7ff992ef63e480d070421ba99b28ee129cb6acb
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/03/2021
ms.locfileid: "60688565"
---
# <a name="create-devicemanagementconfigurationredirectsettingdefinition"></a>Создание deviceManagementConfigurationRedirectSettingDefinition
...
Создание нового [объекта deviceManagementConfigurationRedirectSettingDefinition.](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md)
...
В теле запроса поставляем представление JSON для объекта deviceManagementConfigurationRedirectSettingDefinition.

В следующей таблице показаны свойства, необходимые при создании устройстваManagementConfigurationRedirectSettingDefinition.
...
|deepLink|String|Глубокая ссылка, которая указывает на определенное расположение консоли Intune, из которой необходимо управлять поддержкой функций.|
|redirectMessage|String|Сообщение, объясняющие, что щелкнув ссылку, перенаправляет пользователя на поддерживаемую страницу для управления настройками.|
...
В случае успешного выполнения этот метод возвращает код отклика и `201 Created` [объект deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) в теле отклика.

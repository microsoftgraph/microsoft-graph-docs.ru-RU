---
title: Создание объекта deviceManagementConfigurationRedirectSettingDefinition
description: Создайте объект deviceManagementConfigurationRedirectSettingDefinition.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: apiPageType
ms.openlocfilehash: 2b82e65653af7c9b2ce49f16ef85687e7364923b
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66669415"
---
# <a name="create-devicemanagementconfigurationredirectsettingdefinition"></a>Создание объекта deviceManagementConfigurationRedirectSettingDefinition
...
Создайте объект [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) .
...
В теле запроса добавьте представление объекта deviceManagementConfigurationRedirectSettingDefinition в формате JSON.

В следующей таблице показаны свойства, необходимые при создании объекта deviceManagementConfigurationRedirectSettingDefinition.
...
В случае успешного выполнения `201 Created` этот метод возвращает код отклика и объект [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) в теле отклика.

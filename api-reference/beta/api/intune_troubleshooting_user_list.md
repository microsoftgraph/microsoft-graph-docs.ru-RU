...
Список свойств и связей объектов [user](../resources/intune_troubleshooting_user.md).
...
При успешном выполнении этот метод возвращает код отклика `200 OK` и коллекцию объектов [user](../resources/intune_troubleshooting_user.md) в теле отклика.

...
description: Получение списка объекта ediscoveryNoncustodialDataSource.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: 8980c82c2f553af5c585c82a4648ca22feaf6437
ms.sourcegitcommit: 6bb3c5c043d35476e41ef2790bcf4813fae0769d
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/15/2022
ms.locfileid: "66092294"
---
# <a name="list-ediscoverynoncustodialdatasource"></a>List ediscoveryNoncustodialDataSource
Пространство имен: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение списка объектов источников данных [, не связанных](../resources/security-ediscoverynoncustodialdatasource.md) с хранением, и их свойств.
...
В случае успешного `200 OK` выполнения этот метод возвращает код отклика и коллекцию  [объекта ediscoveryNoncustodialDataSource](../resources/security-ediscoverynoncustodialdatasource.md) в тексте отклика.

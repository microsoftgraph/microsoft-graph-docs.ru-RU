...
description: Удаляет объект ediscoveryReviewSetQuery.
author: SeunginLyu
...
Удаляет объект [ediscoveryReviewSetQuery](../resources/security-ediscoveryreviewsetquery.md) .

...
В теле запроса предоставляем представление объекта androidWorkProfileGeneralDeviceConfiguration в JSON.
...
|workProfileBlockCrossProfileContactsSearch|Boolean|Блокировка доступности контактов профилей в личном профиле.|
...
В случае успеха этот метод возвращает код отклика и объект `201 Created` [androidWorkProfileGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidworkprofilegeneraldeviceconfiguration.md) в тексте отклика.

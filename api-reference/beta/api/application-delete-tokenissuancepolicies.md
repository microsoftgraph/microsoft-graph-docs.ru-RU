...
description: Удалите tokenIssuancePolicy из приложения.
...
Удалите [tokenIssuancePolicy](../resources/tokenissuancepolicy.md) из [приложения](../resources/application.md).

...
---
# <a name="delete-androidworkprofiletrustedrootcertificate"></a>Удаление Андроидворкпрофилетрустедрутцертификате
...
Удаляет объект [андроидворкпрофилетрустедрутцертификате](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md).

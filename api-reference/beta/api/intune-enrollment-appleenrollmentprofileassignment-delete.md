...
---
# <a name="delete-appleenrollmentprofileassignment"></a>Удаление Апплинроллментпрофилеассигнмент
...
Удаляет объект [апплинроллментпрофилеассигнмент](../resources/intune-enrollment-appleenrollmentprofileassignment.md).

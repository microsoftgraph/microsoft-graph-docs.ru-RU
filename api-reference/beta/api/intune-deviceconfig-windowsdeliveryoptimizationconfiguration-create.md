...
ms.openlocfilehash: 9d3586a6724b151fe039782d4406013a81c7e0a3
ms.sourcegitcommit: dcf237b515e70302aec0d0c490feb1de7a60613e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/31/2021
ms.locfileid: "58793184"
---
# <a name="create-windowsdeliveryoptimizationconfiguration"></a>Создание windowsDeliveryOptimizationConfiguration
...
Создайте [новый объект WindowsDeliveryOptimizationConfiguration.](../resources/intune-deviceconfig-windowsdeliveryoptimizationconfiguration.md)
...
В теле запроса поставляем представление JSON для объекта WindowsDeliveryOptimizationConfiguration.
...
|modifyCacheLocation|Строка|Указывает диск, который оптимизация доставки должна использовать для кэша.|
...
В случае успешной работы этот метод возвращает код отклика и `201 Created` [объект WindowsDeliveryOptimizationConfiguration](../resources/intune-deviceconfig-windowsdeliveryoptimizationconfiguration.md) в теле отклика.

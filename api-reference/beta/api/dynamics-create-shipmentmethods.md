...
---
# <a name="create-shipmentmethods"></a>Создание shipmentMethods

Пространство имен: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Создание объекта метода отгрузки в Dynamics 365 Business Central.
...
В теле запроса поставляем представление JSON объекта **shipmentMethods.**

## <a name="response"></a>Отклик
В случае успешной работы этот метод возвращает код ответа и объект ```201 Created``` **shipmentMethods** в тексте ответа.

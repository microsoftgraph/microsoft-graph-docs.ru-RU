...
---
# <a name="list-linkedresources"></a>Перечисление linkedResources
Пространство имен: microsoft.graph [!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Получение linkedResources из свойства навигации linkedResources.
...
При успешном выполнении этот метод возвращает `200 OK` код отклика и коллекцию [объектов linkedResource](../resources/linkedresource.md) в тексте отклика.

...
В случае успешной работы этот метод возвращает код `200 OK` ответа и объект [коллекции educationUser](../resources/educationuser.md) в тексте ответа.

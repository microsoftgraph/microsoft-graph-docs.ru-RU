...
---
# <a name="delete-macossoftwareupdateaccountsummary"></a>Удаление Макоссофтвареупдатеаккаунтсуммари
...
Удаляет объект [макоссофтвареупдатеаккаунтсуммари](../resources/intune-deviceconfig-macossoftwareupdateaccountsummary.md).

...
---
# <a name="delete-grouppolicyoperation"></a>Удаление Граупполициоператион
...
Удаляет объект [граупполициоператион](../resources/intune-grouppolicy-grouppolicyoperation.md).

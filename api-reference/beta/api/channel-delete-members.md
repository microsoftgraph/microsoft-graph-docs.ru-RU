...
description: Удалите член из канала.
author: akjo
...
Удаление [conversationMember](../resources/conversationmember.md) из [канала](../resources/channel.md). Эта операция разрешена только для каналов со значением **membershipType** или `private` `shared`.

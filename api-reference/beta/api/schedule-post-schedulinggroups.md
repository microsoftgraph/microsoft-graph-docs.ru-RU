...
В случае успешной работы этот метод возвращает код `201 Created` отклика и [объект schedulingGroup](../resources/schedulinggroup.md) в тексте ответа.

---
title: Создание windowsWebApp
description: Создайте объект windowsWebApp.
author: dougeby
...
ms.locfileid: "65858763"
---
# <a name="create-windowswebapp"></a>Создание windowsWebApp
...
Создайте объект [windowsWebApp](../resources/intune-apps-windowswebapp.md) .
...
В тексте запроса добавьте представление объекта windowsWebApp в формате JSON.

В следующей таблице показаны свойства, необходимые при создании windowsWebApp.
...
|Идентификаторы roleScopeTagId|Коллекция объектов string|Список идентификаторов тегов области для этого мобильного приложения. Наследуется от [mobileApp](../resources/intune-shared-mobileapp.md).|
...
В случае успешного выполнения этот метод возвращает код `201 Created` отклика и объект [windowsWebApp](../resources/intune-apps-windowswebapp.md) в тексте отклика.

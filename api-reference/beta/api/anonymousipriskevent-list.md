...
---
# <a name="list-anonymousipriskevents-deprecated"></a>Список анонимныхIpRiskEvents (обесценен)
...
Извлечение списка объектов anonymousipriskevent.
...
В случае успешной работы этот метод возвращает код отклика и коллекцию анонимных `200 OK` [объектовIpRiskEvent](../resources/anonymousipriskevent.md) в тексте отклика.

...
>**Важно!** Если вы обновите владельцев группы и создали команду для группы, для синхронизации владельцев с Microsoft Teams может потребоваться до 2 часов. Кроме того, если вы хотите, чтобы владелец мог вносить изменения в группу, например, создавая план планировщика, владелец также должен быть добавлен в группу или участник группы. 

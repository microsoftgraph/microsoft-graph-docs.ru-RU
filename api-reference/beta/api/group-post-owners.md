...
>**Важные:** При изменении группы владельцев и созданных групп для группы, может потребоваться до 2 часа для владельцев для синхронизации с группами Майкрософт. Кроме того Если владелец могут вносить изменения в группе — например, путем создания плана планировщик работы - владелец также необходимо добавить как участник группы/группы. 

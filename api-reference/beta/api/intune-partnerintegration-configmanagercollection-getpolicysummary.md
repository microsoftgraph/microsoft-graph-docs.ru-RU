...
ms.openlocfilehash: 1cbed323f6414c6556fc09543d6eab0e0a6f86e1
ms.sourcegitcommit: dcf237b515e70302aec0d0c490feb1de7a60613e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/31/2021
ms.locfileid: "58783332"
---
# <a name="getpolicysummary-function"></a>функция getPolicySummary
...
|:---|:---|:---|
|policyId|String|Пока не задокументировано.|



## <a name="response"></a>Ответ
В случае успешной данной функции возвращается код ответа и `200 OK` [configManagerPolicySummary](../resources/intune-partnerintegration-configmanagerpolicysummary.md) в тексте ответа.

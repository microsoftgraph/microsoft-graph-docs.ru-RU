...
---
# <a name="delete-devicecompliancepolicyassignment"></a><span data-ttu-id="07ac4-103">Удаление объекта deviceCompliancePolicyAssignment</span><span class="sxs-lookup"><span data-stu-id="07ac4-103">Delete deviceCompliancePolicyAssignment</span></span>
...
> <span data-ttu-id="07ac4-105">**Важно!** API Microsoft Graph в версии/Beta могут изменяться; рабочее использование не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="07ac4-105">**Important:** Microsoft Graph APIs under the /beta version are subject to change; production use is not supported.</span></span>
...
<span data-ttu-id="07ac4-107">Удаляет объект [deviceCompliancePolicyAssignment](../resources/intune-deviceconfig-devicecompliancepolicyassignment.md).</span><span class="sxs-lookup"><span data-stu-id="07ac4-107">Deletes a [deviceCompliancePolicyAssignment](../resources/intune-deviceconfig-devicecompliancepolicyassignment.md).</span></span>
...
|<span data-ttu-id="07ac4-111">Тип разрешения</span><span class="sxs-lookup"><span data-stu-id="07ac4-111">Permission type</span></span>|<span data-ttu-id="07ac4-112">Разрешения (в порядке убывания привилегий)</span><span class="sxs-lookup"><span data-stu-id="07ac4-112">Permissions (from most to least privileged)</span></span>|
|:---|:---|
|<span data-ttu-id="07ac4-113">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="07ac4-113">Delegated (work or school account)</span></span>|<span data-ttu-id="07ac4-114">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="07ac4-114">DeviceManagementConfiguration.ReadWrite.All</span></span>|
|<span data-ttu-id="07ac4-115">Делегированные (личная учетная запись Майкрософт)</span><span class="sxs-lookup"><span data-stu-id="07ac4-115">Delegated (personal Microsoft account)</span></span>|<span data-ttu-id="07ac4-116">Не поддерживается.</span><span class="sxs-lookup"><span data-stu-id="07ac4-116">Not supported.</span></span>|
|<span data-ttu-id="07ac4-117">Для приложений</span><span class="sxs-lookup"><span data-stu-id="07ac4-117">Application</span></span>|<span data-ttu-id="07ac4-118">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="07ac4-118">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|:---|:---|
|<span data-ttu-id="07ac4-123">Авторизация</span><span class="sxs-lookup"><span data-stu-id="07ac4-123">Authorization</span></span>|<span data-ttu-id="07ac4-124">Bearer &lt;token&gt;. Обязательный.</span><span class="sxs-lookup"><span data-stu-id="07ac4-124">Bearer &lt;token&gt; Required.</span></span>|
...
## <a name="request-body"></a><span data-ttu-id="07ac4-127">Тело запроса</span><span class="sxs-lookup"><span data-stu-id="07ac4-127">Request body</span></span>
...
## <a name="response"></a><span data-ttu-id="07ac4-129">Ответ</span><span class="sxs-lookup"><span data-stu-id="07ac4-129">Response</span></span>
<span data-ttu-id="07ac4-130">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="07ac4-130">If successful, this method returns a `204 No Content` response code.</span></span>
...
### <a name="response"></a><span data-ttu-id="07ac4-134">Ответ</span><span class="sxs-lookup"><span data-stu-id="07ac4-134">Response</span></span>

...
|:---------------|:--------|:----------|
|Получение объекта Worksheet | [Worksheet](worksheet.md) |Чтение свойств и связей объекта листа.|
|Создание объекта Chart |[Chart](chart.md)| Создание диаграммы путем добавления в коллекцию диаграмм.|
|List names |Коллекция объектов [NamedItem](nameditem.md)| Получение коллекции именованных элементов, связанной с листом.|
|List charts |Коллекция объектов Chart| Получение коллекции объектов Chart.|
|Создание объекта Table |[Table](table.md)| Создание таблицы путем добавления в коллекцию таблиц.|
|Список таблиц |Коллекция объектов [Table](table.md)| Получение коллекции объектов Table.|
...
|Usedrange|[Range](range.md)|Используемый диапазон — это наименьший диапазон, включающий в себя все ячейки, которые содержат значение или форматирование. Если лист пустой, эта функция вернет верхнюю левую ячейку.|
...
|Получение списка pivotTables |Коллекция workbookPivotTable| Получение коллекции объектов workbookPivotTable.|

...
Лист Excel — это сетка ячеек. Она может содержать данные, таблицы, диаграммы и т. д.
...
|[Перечисление имен](../api/worksheet-list-names.md) |Коллекция объектов [NamedItem](nameditem.md)| Получение именованной коллекции элементов, связанной с листом.|
|[Список диаграмм](../api/worksheet-list-charts.md) |Коллекция объектов [Chart](chart.md)| Получение коллекции объектов Chart.|
...
|[Удаление](../api/worksheet-delete.md)|Нет|Удаляет лист из книги.|
|[Список](../api/worksheet-list.md) | Коллекция объектов [Worksheet](worksheet.md) |Получение коллекции объектов листов. |
...
|Сводные таблицы|Коллекция [workbookPivotTable](workbookpivottable.md)| Коллекция сводных таблиц на листе. |

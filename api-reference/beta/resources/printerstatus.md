...
|процессингстатедескриптион|Строка|Удобное для человека описание текущего состояния обработки принтера. Только для чтения.|
...
|подключения|1 |Подключение к принтеру разорвано или не может быть установлено.|

---
title: Тип ресурса macOSMdatpApp
description: Содержит свойства и унаследованные свойства для приложения расширенной защиты от угроз (MDATP) в Microsoft Defender для macOS.
author: dougeby
...
ms.locfileid: "66670662"
---
# <a name="macosmdatpapp-resource-type"></a>Тип ресурса macOSMdatpApp
...
Содержит свойства и унаследованные свойства для приложения расширенной защиты от угроз (MDATP) в Microsoft Defender для macOS.
...
|:---|:---|:---|
|[Перечисление macOSMdatpApps](../api/intune-apps-macosmdatpapp-list.md)|[Коллекция macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md)|Список свойств и связей объектов [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .|
|[Получение macOSMdatpApp](../api/intune-apps-macosmdatpapp-get.md)|[macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md)|Чтение свойств и связей объекта [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .|
|[Создание macOSMdatpApp](../api/intune-apps-macosmdatpapp-create.md)|[macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md)|Создайте объект [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .|

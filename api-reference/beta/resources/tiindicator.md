...
| Метод | Метка Azure | ATP в Microsoft Defender |
|:-------------|:---------|:-----------------------|
...
|description|String| Краткое описание угрозы, представленное индикатором (100 символов или меньше). **Обязательный атрибут.**|

...
Указав конфигурации в этом профиле, вы можете указать устройствам Windows 8.1 (и более поздних версий) подключиться к нужной конечной точке VPN. Указав метод проверки подлинности и типы безопасности, ожидаемые конечной точкой VPN, можно сделать VPN-подключение простым для конечного пользователя.
...
|[Создание windows81VpnConfiguration](../api/intune-deviceconfig-windows81vpnconfiguration-create.md)|[windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md)|Создайте объект [windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md) .|
...
|enableSplitTunneling|Boolean|Включите раздельное туннелирование для VPN.|

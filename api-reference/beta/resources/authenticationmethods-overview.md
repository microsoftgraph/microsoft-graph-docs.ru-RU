...
* Номер для sms-входов можно включить или отключить.
...
|[emailAuthenticationMethod](emailauthenticationmethod.md)|Адрес электронной почты может быть пользователем в рамках процесса Self-Service сброса пароля (SSPR).|См. адрес электронной почты для проверки подлинности пользователя. Добавление, обновление или удаление адреса электронной почты пользователя.|

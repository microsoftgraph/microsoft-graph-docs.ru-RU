...
|blockedManufacturers|Коллекция объектов string|Коллекция заблокированных производителей.|
|blockedSkus|Коллекция объектов string|Коллекция заблокированных skus.|

...
---
# <a name="usersettings-resource-type"></a>Тип ресурса Усерсеттингс

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Текущие параметры пользователя для обнаружения контента. Сведения о получении и обновлении параметров пользователя см. в статьях [Получение параметров](../api/usersettings-get.md) и [Обновление параметров](../api/usersettings-update.md).

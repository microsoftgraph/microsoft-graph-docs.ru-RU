...
description: Windows 8.1 + Wi-Fi при импорте конфигурации. При настройке этого профиля можно указать Windows 8.1 (и более поздних версий) устройств для подключения к конечной точке желаемую Wi-Fi. Подключите устройство Windows 8.1 желаемую сеть Wi-Fi и извлеките XML из устройства для внедрения в этот профиль Wi-Fi более поздней версии.

...
|Аутбаундконнектионсрекуиред|Boolean|Настраивает брандмауэр на разрешение всех исходящих подключений по умолчанию. Если для Аутбаундконнектионсрекуиред и Аутбаундконнектионсблоккед задано значение true, Аутбаундконнектионсблоккед имеет приоритет.|

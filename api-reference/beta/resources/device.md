...
|Status | Строка| Устройство является сетевым и автономным. Возвращается только при входе пользователя с учетной записью Майкрософт в составе рим проекта. |
...
|Тип| Строка| Форм-фактора устройства. Возвращается только при входе пользователя с учетной записью Майкрософт в составе рим проекта. |

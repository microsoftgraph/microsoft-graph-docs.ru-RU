...
| [Получение количества действий](../api/reportroot-getteamsuseractivitycounts.md) | [Теамсусерактивитикаунтс](../resources/teamsuseractivitycounts.md) | Получение количества действий Microsoft Teams по типам. Доступные типы действий: сообщения в чатах группы, сообщения в приватных чатах, вызовы и собрания. |

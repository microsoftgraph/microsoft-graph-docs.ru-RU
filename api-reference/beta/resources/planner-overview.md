...
При [создании плана](../api/planner-post-plans.md) сделайте группу его контейнером. Для этого установите свойство `container` для объекта плана. Планы должны содержаться в поддерживаемом ресурсе.

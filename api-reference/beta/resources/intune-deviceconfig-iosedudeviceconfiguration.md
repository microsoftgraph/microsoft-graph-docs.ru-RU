...
description: Конфигурация устройства iOS для образовательных учреждений
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: e12f5754adb779e9464700daeba6ecabe05a40e7
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66668183"
---
...
Конфигурация устройства iOS для образовательных учреждений
...
|:---|:---|:---|
|[Перечисление объектов iosEduDeviceConfiguration](../api/intune-deviceconfig-iosedudeviceconfiguration-list.md)|[Коллекция iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md)|Список свойств и связей объектов [iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md) .|
|[Получение iosEduDeviceConfiguration](../api/intune-deviceconfig-iosedudeviceconfiguration-get.md)|[iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md);|Чтение свойств и связей объекта [iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md) .|
|[Создание объекта iosEduDeviceConfiguration](../api/intune-deviceconfig-iosedudeviceconfiguration-create.md)|[iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md);|Создайте объект [iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md) .|
|[Удаление iosEduDeviceConfiguration](../api/intune-deviceconfig-iosedudeviceconfiguration-delete.md)|Нет|Удаляет [объект iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md).|
...
|teacherCertificateSettings|[iosEduCertificateSettings](../resources/intune-deviceconfig-ioseducertificatesettings.md);|Доверенные корневые сертификаты и сертификаты PFX для преподавателя|
|studentCertificateSettings|[iosEduCertificateSettings](../resources/intune-deviceconfig-ioseducertificatesettings.md);|Доверенные корневые сертификаты и сертификаты PFX для student|
|deviceCertificateSettings|[iosEduCertificateSettings](../resources/intune-deviceconfig-ioseducertificatesettings.md);|Доверенные корневые сертификаты и сертификаты PFX для устройства|

...
|[Удаление Иосвпнконфигуратион](../api/intune-deviceconfig-iosvpnconfiguration-delete.md)|Отсутствует|Удаляет объект [иосвпнконфигуратион](../resources/intune-deviceconfig-iosvpnconfiguration.md).|

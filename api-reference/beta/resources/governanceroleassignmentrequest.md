...
|:--------------------------|:--------------|:----------|
|id                         |Строка         |ID запроса на назначение ролей.|
|resourceId                 |String         |Обязательный. ID ресурса, с которым связан запрос на назначение ролей.|
|roleDefinitionId           |Строка         |Обязательный. Id определения роли, с которым связан запрос назначения ролей.|
|subjectId                  |Строка         |Обязательный. ID субъекта, с которым связан запрос на назначение ролей.|

...
| [Список КлаимсмаппингполиЦиес](../api/claimsmappingpolicy-list.md) | [клаимсмаппингполици](claimsmappingpolicy.md) | Чтение свойств и связей объектов КлаимсмаппингполиЦиес. |
...
| Свойство     | Тип   |Описание|
|:---------------|:--------|:----------|
|Версия|Целое число|Установите значение 1. Обязательный элемент.|

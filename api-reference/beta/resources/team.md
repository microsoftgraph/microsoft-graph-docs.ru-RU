...
|classification|string| Дополнительные метки. Обычно описывает конфиденциальности данных или бизнес-рабочей группы. Должно соответствовать одному из набора предварительно настроенные в каталоге клиента. |
|специализации|[teamSpecialization](teamspecialization.md)| Необязательный атрибут. Указывает, будет ли команда предназначена для конкретного варианта использования.  Специализация каждой группы имеет доступ к уникальное поведение и каждый раз, нацелено на пример его использования. |

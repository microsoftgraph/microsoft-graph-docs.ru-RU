...
| **isBuiltIn**            | Логическое| Указывает, является ли тип контента встроенным типом контента. 
...
| **propagateChanges**   | Логическое              | Если `true`какие-либо изменения, внесенные в тип контента, будут нажаты на унаследованные типы контента и списки, которые реализуют тип контента.

...
|:---|:---|:---|
|minDeviceOccurrence|Int32|На устройстве можно задать минимальное время. Значение MinDeviceOccurrence 0 означает, что параметр является необязательным.|
|maxDeviceOccurrence|Int32|На устройстве можно задать максимальное время. |

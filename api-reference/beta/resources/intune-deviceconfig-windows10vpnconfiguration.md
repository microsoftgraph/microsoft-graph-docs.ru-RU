...
Предоставляя конфигурации в этом профиле, можно поручить устройству Windows 10 (настольному или мобильному) подключиться к нужной конечной точке VPN. Указав метод проверки подлинности и типы безопасности, ожидаемые конечной точкой VPN, можно сделать подключение VPN бесшовным для конечного пользователя.

...
|[Clear](../api/range-clear.md)|Отсутствует|Очищает значения, формат, заливку, границу диапазона и т. д.|
...
|[Merge](../api/range-merge.md)|Отсутствует|Объединяет ячейки диапазона в одну область на листе.|
...
|лист|[Воркбукворкшит](workbookworksheet.md)|Лист, содержащий текущий диапазон. Только для чтения.|

...
|locationServicesBlocked|Логическое|Указывает, следует ли заблокировать службы определения местоположения.|
...
|googlePlayStoreBlocked|Логическое|Указывает, следует ли блокировать Google Play Маркет.|
...
|securityRequireVerifyApps|Логическое|Обязательное включение функции Android "Проверка приложений".|

---
title: Тип ресурса aospDeviceOwnerCertificateProfileBase
description: База профиля сертификата владельца устройства AOSP.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 5017d9740853b92427dbafac4b057cf59f8329a4
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667952"
---
# <a name="aospdeviceownercertificateprofilebase-resource-type"></a>Тип ресурса aospDeviceOwnerCertificateProfileBase
...
База профиля сертификата владельца устройства AOSP.
...
|:---|:---|:---|
|[Перечисление aospDeviceOwnerCertificateProfileBases](../api/intune-deviceconfig-aospdeviceownercertificateprofilebase-list.md)|[Коллекция aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md)|Список свойств и связей объектов [aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md) .|
|[Получение aospDeviceOwnerCertificateProfileBase](../api/intune-deviceconfig-aospdeviceownercertificateprofilebase-get.md)|[aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md)|Чтение свойств и связей объекта [aospDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-aospdeviceownercertificateprofilebase.md) .|
...
|Идентификаторы roleScopeTagId|Коллекция объектов string|Список тегов области для этого экземпляра сущности. Наследуется от объекта [deviceConfiguration](../resources/intune-deviceconfig-deviceconfiguration.md).|
...
|subjectNameFormat|[subjectNameFormat](../resources/intune-deviceconfig-subjectnameformat.md)|Формат имени субъекта сертификата. Эта коллекция может содержать не более 500 элементов. Возможные значения: `commonName`, `commonNameIncludingEmail`, `commonNameAsEmail`, `custom`, `commonNameAsIMEI`, `commonNameAsSerialNumber`, `commonNameAsAadDeviceId`, `commonNameAsIntuneDeviceId`, `commonNameAsDurableDeviceId`.|
...
|subjectAlternativeNameType|[subjectAlternativeNameType](../resources/intune-shared-subjectalternativenametype.md)|Альтернативный тип имени субъекта сертификата. Эта коллекция может содержать не более 500 элементов. Возможные значения: `none`, `emailAddress`, `userPrincipalName`, `customAzureADAttribute`, `domainNameService`, `universalResourceIdentifier`.|
...
|rootCertificate|[aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md)|Доверенный корневой сертификат.|

...
---
# <a name="relatedcontact-resource-type"></a>Тип ресурса relatedContact

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Запись контакта, связанные с [educationUser](../resources/educationuser.md) , который предоставляет данные для опекунов, возможностей, врачи и т. д.

## <a name="properties"></a>Свойства
| Свойство     | Тип   |Описание|
|:---------------|:--------|:----------|
|id|Строка|Идентификатор контакта в Azure Active Directory.|
|displayName|String|Имя контакта. Обязательно указывать.|

...
|:-------------|:------------|:------------|
|каллчаинид|GUID|Уникальный идентификатор для всех вызовов участников в конференции или уникальный идентификатор для двух вызовов участников в вызове P2P. Он должен быть скопирован из `Microsoft.Graph.Call.CallChainId`.|

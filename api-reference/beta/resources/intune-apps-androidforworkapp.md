...
description: Содержит свойства и унаследованные свойства для приложений Android for Work (AFW).
author: dougeby
...
Содержит свойства и унаследованные свойства для приложений Android for Work (AFW).
...
|:---|:---|:---|
|[Перечисление androidForWorkApps](../api/intune-apps-androidforworkapp-list.md)|[Коллекция androidForWorkApp](../resources/intune-apps-androidforworkapp.md)|Список свойств и связей объектов [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|
|[Получение androidForWorkApp](../api/intune-apps-androidforworkapp-get.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md);|Чтение свойств и связей объекта [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|
|[Создание androidForWorkApp](../api/intune-apps-androidforworkapp-create.md)|[androidForWorkApp](../resources/intune-apps-androidforworkapp.md);|Создайте объект [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .|

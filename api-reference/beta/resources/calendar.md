...
|hexColor|String|Цвет, представляющий календаря. 6-значного, 3-байтовых шестнадцатеричный номер представлены цвета. Каждый байт представляет один из компонентов красного, зеленого и синего цвета, в диапазоне от 00 до FF в шестнадцатеричном формате. |

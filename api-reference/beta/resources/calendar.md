...
Представляет контейнер для ресурсов [event](event.md). Это может быть календарь для [пользователя](user.md) или стандартный календарь для [группы](group.md) Microsoft 365.

...
|Связь | Тип | Описание|
|:------------|:-----|:-----------|
|Historyitem| Коллекция [historyItem](../resources/projectrome-historyitem.md) | Необязательное. Свойство NavigationProperty/вложение; свойство навигации для Historyitem действия.|

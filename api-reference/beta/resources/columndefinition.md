...
Тип свойства, связанные с (типа boolean, вычисляемых, выбор, валюты, даты и времени, подстановки, номер, personOrGroup, текст) являются взаимоисключающими (столбец может иметь только один из них указан).

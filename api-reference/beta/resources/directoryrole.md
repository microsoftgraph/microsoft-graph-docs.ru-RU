...
<span data-ttu-id="1efb4-188">Ниже представлено описание ресурса в формате JSON.</span><span class="sxs-lookup"><span data-stu-id="1efb4-188">Here is a JSON representation of the resource</span></span>

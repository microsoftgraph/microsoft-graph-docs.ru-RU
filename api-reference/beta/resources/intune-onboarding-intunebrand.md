...
|roleScopeTagIds|Коллекция строк|Список тегов областей, назначенных профилю фирменной символики по умолчанию|
...
|кустомпривацимессаже|Строка|Настраиваемое сообщение о конфиденциальности, используемое для объяснения того, что Организация не может просматривать или делать на управляемых устройствах.|
|кустомкантсипривацимессаже|Строка|Настраиваемое сообщение о конфиденциальности, используемое для объяснения того, что Организация не может просматривать или делать на управляемых устройствах.|
|кустомкансипривацимессаже|Строка|Настраиваемое сообщение о конфиденциальности, используемое для объяснения того, что Организация может просматривать и выполнять на управляемых устройствах.|

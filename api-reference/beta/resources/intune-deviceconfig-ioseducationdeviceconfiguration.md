...
профиль конфигурации iOS для iOS
...
|:---|:---|:---|
|[Список Иоседукатиондевицеконфигуратионс](../api/intune-deviceconfig-ioseducationdeviceconfiguration-list.md)|Коллекция [iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md)|Список свойств и связей объектов [iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md) .|
|[Получение iosEducationDeviceConfiguration](../api/intune-deviceconfig-ioseducationdeviceconfiguration-get.md)|[iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md)|Чтение свойств и связей объекта [iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md) .|
...
|[Удаление iosEducationDeviceConfiguration](../api/intune-deviceconfig-ioseducationdeviceconfiguration-delete.md)|Нет|Удаляет объект [iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md).|
|[Обновление iosEducationDeviceConfiguration](../api/intune-deviceconfig-ioseducationdeviceconfiguration-update.md)|[iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md)|Обновление свойств объекта [iosEducationDeviceConfiguration](../resources/intune-deviceconfig-ioseducationdeviceconfiguration.md) .|

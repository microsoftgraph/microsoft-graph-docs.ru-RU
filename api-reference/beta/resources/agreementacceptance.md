...
|:-------------|:------------|:------------|
|агриментфилеид|Строка|Идентификатор файла соглашения, принятого пользователем.|
|агриментид|Строка|Идентификатор соглашения.|
...
|userDisplayName|Строка|Отображаемое имя пользователя, когда оно было записано.|
...
|userPrincipalName|Строка|Имя участника-пользователя, когда оно было записано.|

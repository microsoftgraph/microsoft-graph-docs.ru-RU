---
title: Тип ресурса macOSPkcsCertificateProfile
description: Профиль сертификата PKCS для MacOS.
author: dougeby
...
ms.locfileid: "66670416"
---
# <a name="macospkcscertificateprofile-resource-type"></a>Тип ресурса macOSPkcsCertificateProfile
...
Профиль сертификата PKCS для MacOS.
...
|:---|:---|:---|
|[Перечисление macOSPkcsCertificateProfiles](../api/intune-deviceconfig-macospkcscertificateprofile-list.md)|[Коллекция macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Список свойств и связей объектов [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) .|
|[Получение macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-get.md)|[macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Чтение свойств и связей объекта [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) .|
|[Создание macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-create.md)|[macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Создайте объект [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) .|
|[Удаление macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-delete.md)|Нет|Удаляет [файл macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md).|
|[Обновление macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-update.md)|[macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Обновление свойств объекта [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) .|
...
|renewalThresholdPercentage|Int32|Пороговое значение продления сертификата в процентах. Наследуется [от macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md)|
...
|subjectAlternativeNameType|[subjectAlternativeNameType](../resources/intune-shared-subjectalternativenametype.md)|Альтернативный тип имени субъекта сертификата. Наследуется [от macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md). Возможные значения: `none`, `emailAddress`, `userPrincipalName`, `customAzureADAttribute`, `domainNameService`, `universalResourceIdentifier`.|
|certificateValidityPeriodValue|Int32|Значение срока действия сертификата. Наследуется [от macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md)|
|certificateValidityPeriodScale|[certificateValidityPeriodScale](../resources/intune-shared-certificatevalidityperiodscale.md)|Масштабирование для срока действия сертификата. Наследуется [от macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md). Возможные значения: `days`, `months`, `years`.|
|certificationAuthority|String|Полное доменное имя центра сертификации PKCS.|
...
|subjectAlternativeNameFormatString|String|Строка форматирования, определяющее альтернативное имя субъекта.|
|subjectNameFormatString|String|Строка форматирования, определяющее имя субъекта. Пример: CN={{EmailAddress}},E={{EmailAddress}},OU=Корпоративные пользователи,O=Contoso Corporation,L=Redmond,ST=WA,C=US|

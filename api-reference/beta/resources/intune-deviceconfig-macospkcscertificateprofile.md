...
description: Профиль сертификата MacOS PKCS.
author: dougeby
ms.localizationpriority: medium
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 943a5d59a1635628ecccd0b043f6c4e9e2ed3117
ms.sourcegitcommit: 6c04234af08efce558e9bf926062b4686a84f1b2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/12/2021
ms.locfileid: "59131296"
---
...
Профиль сертификата MacOS PKCS.
...
|:---|:---|:---|
|[Список macOSPkcsCertificateProfiles](../api/intune-deviceconfig-macospkcscertificateprofile-list.md)|[коллекция macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Список свойств и связей объектов [macOSPkcsCertificateProfile.](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|
|[Получить macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-get.md)|[macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Чтение свойств и связей [объекта macOSPkcsCertificateProfile.](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|
|[Создание macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-create.md)|[macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|Создайте [новый объект macOSPkcsCertificateProfile.](../resources/intune-deviceconfig-macospkcscertificateprofile.md)|
|[Удаление macOSPkcsCertificateProfile](../api/intune-deviceconfig-macospkcscertificateprofile-delete.md)|Нет|Удаляет [macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md).|
...
|certificationAuthority|String|FQDN сертификационного органа PKCS.|
...
|subjectAlternativeNameFormatString|String|Строка формата, определяемая альтернативным именем субъекта.|
|subjectNameFormatString|String|Строка формата, определяемая имя субъекта. Пример: CN={{EmailAddress},E={EmailAddress}},OU=Enterprise Users,O=Contoso Corporation, L=Redmond,ST=WA,C=US|
...
|allowAllAppsAccess|Логическое|Параметр AllowAllAppsAccess|

...
|имя профиля|String|Это удобное имя, используемое для определения группы приложений, макета этих приложений в меню пусков и пользователей, которым назначена эта конфигурация киоска.|

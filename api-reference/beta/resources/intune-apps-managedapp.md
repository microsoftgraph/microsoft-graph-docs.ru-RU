...
|:---|:---|:---|
|[Перечисление объектов managedApp](../api/intune-apps-managedapp-list.md)|Коллекция [managedApp](../resources/intune-apps-managedapp.md)|Список свойств и связей объектов [managedApp](../resources/intune-apps-managedapp.md).|
|[Get managedApp](../api/intune-apps-managedapp-get.md)|[managedApp](../resources/intune-apps-managedapp.md)|Считывание свойств и связей объекта [managedApp](../resources/intune-apps-managedapp.md).|
...
|appAvailability|[Манажедаппаваилабилити](../resources/intune-apps-managedappavailability.md)|Доступность приложения. Возможные значения: `global`, `lineOfBusiness`.|

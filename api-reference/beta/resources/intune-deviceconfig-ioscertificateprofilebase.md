...
---
# <a name="ioscertificateprofilebase-resource-type"></a>Тип ресурса используется
...
|:---|:---|:---|
|[Список Иосцертификатепрофилебасес](../api/intune-deviceconfig-ioscertificateprofilebase-list.md)|Коллекция [используется](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Список свойств и связей объектов [используется](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|
|[Получение используется](../api/intune-deviceconfig-ioscertificateprofilebase-get.md)|[Используется](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Чтение свойств и связей объекта [используется](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|

...
| membershipType | Строка | Тип членства для административной единицы. Допустимые значения: `dynamic` и `assigned`. Если значение не задано, поведение по умолчанию — . `assigned`. |

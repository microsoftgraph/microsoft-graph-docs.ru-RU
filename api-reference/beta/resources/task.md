...
|:---|:---|:---|
|textbody|[itemBody](../resources/itembody.md)|Орган задач в текстовом формате, который обычно содержит сведения о задаче. Унаследовано от [baseTask](../resources/basetask.md).|
...
|displayName|String|Имя задачи. Унаследовано от [baseTask](../resources/basetask.md).|
...
|точки зрения|[taskViewpoint](../resources/taskviewpoint.md)|Свойства, которые являются личными для пользователя, такие как **reminderDateTime** и **категории**. Унаследовано от [baseTask](../resources/basetask.md).|

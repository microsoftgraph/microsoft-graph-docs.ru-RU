...
|:---------------|:--------|:----------|
|activeChecklistItemCount|Int32|Количество контрольный список элементов со значением, равным `false`, представляющее неполный элементов.|

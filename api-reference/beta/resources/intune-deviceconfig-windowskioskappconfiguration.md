...
description: Базовый класс приложения, используемый для определения данных приложения для конфигурации киоска
author: dougeby
...
Базовый класс приложения, используемый для определения данных приложения для конфигурации киоска

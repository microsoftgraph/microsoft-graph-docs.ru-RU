...
| [Delete](../api/call-delete.md)                                   |                                                   | DELETE или сигнала отбоя активных **вызовов**.        |
| **Обработка звонков**                                                 |                                                   |                                              |
...
| callbackUri         | String                                                                                                 | Идентификатор обратного вызова или подписки, на котором будет доставлено обратных вызовов.                                                                                                                               |
| chatInfo            | [chatInfo](chatinfo.md)                                                                                | Сведения о чата.                                                                                                                                                                               |
| Направление           | String                                                                                                 | Направление вызова. Возможное значение — `incoming` или `outgoing`. Только для чтения. Сервер, созданный.                                                                                            |
...
| myParticipantId     | String                                                                                                 | Только для чтения. Сервер, созданный.                                                                                                                                                                        |
...
| state               | String                                                                                                 | Состоянии вызова. Возможные значения: `incoming`, `establishing`, `ringing`, `established`, `hold`, `transferring`, `transferAccepted`, `redirecting`, `terminating`, `terminated`. Только для чтения. Сервер, созданный.                         |
...
| terminationReason   | String                                                                                                 | Только для чтения. Сервер, созданный.                                                                                                                                                                        |

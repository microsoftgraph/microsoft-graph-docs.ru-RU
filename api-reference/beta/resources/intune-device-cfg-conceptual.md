...
Используйте нагрузку Microsoft Intune Device Configuration для управления настройками и функциями на всех управляемых устройствах.
...
- [База профилей сертификатов владельца устройства с Android](intune-deviceconfig-androiddeviceownercertificateprofilebase.md)
...
- [Конфигурация проверки подлинности на основе учетных данных владельца устройства Android](intune-deviceconfig-androiddeviceownerderivedcredentialauthenticationconfiguration.md)
- [Тип профиля регистрации владельца устройства Android](intune-deviceconfig-androiddeviceownerenrollmentprofiletype.md)
- [Конфигурация корпоративных Wi-Fi устройств с Android](intune-deviceconfig-androiddeviceownerenterprisewificonfiguration.md)
...
- [Автоконфигуратор глобального прокси-сервера владельца устройства Android](intune-deviceconfig-androiddeviceownerglobalproxyautoconfig.md)
- [Глобальный прокси-сервер владельца устройства Android direct](intune-deviceconfig-androiddeviceownerglobalproxydirect.md)
- [Владелец устройства с Android импортирует профиль сертификата PFX](intune-deviceconfig-androiddeviceownerimportedpfxcertificateprofile.md)
- [Android device owner kiosk customization status bar](intune-deviceconfig-androiddeviceownerkioskcustomizationstatusbar.md)
- [Навигация по системе настройки терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskcustomizationsystemnavigation.md)
- [Приложение режима терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodeapp.md)
- [Элемент позиции приложения в режиме терминала владельца устройства Android](intune-deviceconfig-androiddeviceownerkioskmodeapppositionitem.md)
...
- [Элемент домашнего экрана режима терминала владельца устройства Android](intune-deviceconfig-androiddeviceownerkioskmodehomescreenitem.md)
- [Размер значка режима терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodeiconsize.md)
- [Управлия папка в режиме терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodemanagedfolder.md)
- [Справочник по управляемым папам в режиме терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodemanagedfolderreference.md)
- [Ориентация экрана в режиме терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodescreenorientation.md)
- [Веб-связь в режиме терминала владельца устройства с Android](intune-deviceconfig-androiddeviceownerkioskmodeweblink.md)
- [Профиль сертификата PKCS владельца устройства Android](intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md)
- [Режим воспроизведения владельца устройства с Android](intune-deviceconfig-androiddeviceownerplaystoremode.md)
...
- [Тип виртуальной кнопки "Домой" владельца устройства Android](intune-deviceconfig-androiddeviceownervirtualhomebuttontype.md)
...
- [База конфигурации ускоряемой проверки для Apple](intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)
- [Формат имени субъекта Apple](intune-deviceconfig-applesubjectnameformat.md)
- [Vpn Apple постоянно в конфигурации](intune-deviceconfig-applevpnalwaysonconfiguration.md)
...
- [Тип поворота пароля восстановления BitLocker](intune-deviceconfig-bitlockerrecoverypasswordrotationtype.md)
...
- [Изменение разрешения uefi settings](intune-deviceconfig-changeuefisettingspermission.md)
...
- [Набор Cryptography](intune-deviceconfig-cryptographysuite.md)
- [Альтернативное имя настраиваемого субъекта](intune-deviceconfig-customsubjectalternativename.md)
- [Настраиваемый период времени обновления](intune-deviceconfig-customupdatetimewindow.md)
...
- [Направление сканирования защитника в режиме реального времени](intune-deviceconfig-defenderrealtimescandirection.md)
...
- [Сценарий политики соответствия устройств требованиям](intune-deviceconfig-devicecompliancepolicyscript.md)
...
- [Ошибка сценария соответствия устройств требованиям](intune-deviceconfig-devicecompliancescripterror.md)
- [Оператор rul сценария соответствия устройств](intune-deviceconfig-devicecompliancescriptruloperator.md)
- [Правило сценария соответствия устройств требованиям](intune-deviceconfig-devicecompliancescriptrule.md)
- [Тип данных правила скрипта соответствия устройств](intune-deviceconfig-devicecompliancescriptruledatatype.md)
- [Ошибка правила сценария соответствия устройств требованиям](intune-deviceconfig-devicecompliancescriptruleerror.md)
- [Ошибка проверки правил скрипта соответствия устройств](intune-deviceconfig-devicecompliancescriptrulesvalidationerror.md)
- [Результат проверки сценария соответствия устройств требованиям](intune-deviceconfig-devicecompliancescriptvalidationresult.md)
...
- [Режим устройства с правилом применимости для управления устройствами](intune-deviceconfig-devicemanagementapplicabilityruledevicemode.md)
- [Выпуск ос правила управления устройствами](intune-deviceconfig-devicemanagementapplicabilityruleosedition.md)
...
- [Сертификационный орган управления устройствами](intune-deviceconfig-devicemanagementcertificationauthority.md)
...
- [Группа Диффи Диффама (Diffieie)](intune-deviceconfig-diffiehellmangroup.md)
...
- [Категория отправки групповой политики](intune-grouppolicy-grouppolicyuploadedcategory.md)
- [Определение загруженной групповой политики](intune-grouppolicy-grouppolicyuploadeddefinition.md)
- [Файл загруженного определения групповой политики](intune-grouppolicy-grouppolicyuploadeddefinitionfile.md)
- [Состояние файла загруженного определения групповой политики](intune-grouppolicy-grouppolicyuploadeddefinitionfilestatus.md)
- [Файл языка, загруженный групповой политикой](intune-grouppolicy-grouppolicyuploadedlanguagefile.md)
- [Выложенная презентация групповой политики](intune-grouppolicy-grouppolicyuploadedpresentation.md)
...
- [Расширение единого знака "Единый вход" в iOS Azure](intune-deviceconfig-iosazureadsinglesignonextension.md)
...
- [Конфигурация проверки подлинности учетных данных, производная от iOS](intune-deviceconfig-iosderivedcredentialauthenticationconfiguration.md)
...
- [Конфигурация ускорения проверки для iOS](intune-deviceconfig-iosexpeditedcheckinconfiguration.md)
...
- [Расширение единого знака kerberos для iOS](intune-deviceconfig-ioskerberossinglesignonextension.md)
- [Тип приложения в режиме терминала iOS](intune-deviceconfig-ioskioskmodeapptype.md)
...
- [Расширение единого знака перенаправления iOS](intune-deviceconfig-iosredirectsinglesignonextension.md)
- [Профиль сертификатов SCEP для iOS](intune-deviceconfig-iosscepcertificateprofile.md)
- [Расширение единого знака для iOS](intune-deviceconfig-iossinglesignonextension.md)
- [Параметры единого входа iOS](intune-deviceconfig-iossinglesignonsettings.md)
- [Тип расписания обновления программного обеспечения для iOS](intune-deviceconfig-iossoftwareupdatescheduletype.md)
...
- [Параметры связи безопасности VPN для iOS](intune-deviceconfig-iosvpnsecurityassociationparameters.md)
...
- [Конфигурация VPN для iOSik ev2](intune-deviceconfig-iosikev2vpnconfiguration.md)
- [Расширение единого знака Kerberos](intune-deviceconfig-kerberossinglesignonextension.md)
- [Пара "Ключевое значение".](intune-deviceconfig-keybooleanvaluepair.md)
- [Пара "Ключ-значение".](intune-deviceconfig-keyintegervaluepair.md)
- [Пара "Ключ реального значения"](intune-deviceconfig-keyrealvaluepair.md)
- [Пара "Значение строки ключа"](intune-deviceconfig-keystringvaluepair.md)
- [Пара значений типа "ключ"](intune-deviceconfig-keytypedvaluepair.md)
...
- [Элемент доменов, связанных с macOS](intune-deviceconfig-macosassociateddomainsitem.md)
- [Расширение единого входов в MacOS Azure ad](intune-deviceconfig-macosazureadsinglesignonextension.md)
...
- [Политика выбора родительского кэша контента macOS](intune-deviceconfig-macoscontentcachingparentselectionpolicy.md)
...
- [Конфигурация пользовательского приложения macOS](intune-deviceconfig-macoscustomappconfiguration.md)
...
- [Расширение единого знака kerberos для macOS](intune-deviceconfig-macoskerberossinglesignonextension.md)
...
- [Профиль сертификата PKCS macOS](intune-deviceconfig-macospkcscertificateprofile.md)
...
- [Расширение единого знака перенаправления macOS](intune-deviceconfig-macosredirectsinglesignonextension.md)
- [Профиль сертификата SCEP для macOS](intune-deviceconfig-macosscepcertificateprofile.md)
- [Расширение единого знака macOS](intune-deviceconfig-macossinglesignonextension.md)
...
- [Сводка по категориям обновления программного обеспечения macOS](intune-deviceconfig-macossoftwareupdatecategorysummary.md)
...
- [Сводка о состоянии обновления программного обеспечения macOS](intune-deviceconfig-macossoftwareupdatestatesummary.md)
...
- [Состояние настройки конфигурации мобильного приложения для управляемых устройств](intune-deviceconfig-manageddevicemobileappconfigurationsettingstate.md)
...
- [Присутствие док-станции запуска (Майкрософт)](intune-deviceconfig-microsoftlauncherdockpresence.md)
- [Размещение панели поиска в средстве запуска Майкрософт](intune-deviceconfig-microsoftlaunchersearchbarplacement.md)
...
- [Для предварительно зашифрованных полезной нагрузки](intune-raimportcerts-onpremencryptedpayload.md)
...
- [Идеальное сочетание секретности](intune-deviceconfig-perfectforwardsecrecygroup.md)
...
- [Тип действия "Питание"](intune-deviceconfig-poweractiontype.md)
...
- [Расширение единого знака перенаправления](intune-deviceconfig-redirectsinglesignonextension.md)
...
- [Запланированное состояние утихомодиняемой](intune-deviceconfig-scheduledretirestate.md)
...
- [Расширение единого знака](intune-deviceconfig-singlesignonextension.md)
...
- [Указанные подключаемый модуль сети](intune-deviceconfig-specifiedcaptivenetworkplugins.md)
...
- [Интерфейс настройки микропрограмм устройства с Windows 10](intune-deviceconfig-windows10devicefirmwareconfigurationinterface.md)
- [Тип режима устройства с Windows 10](intune-deviceconfig-windows10devicemodetype.md)
...
- [Параметры защиты от взлома Защитника Windows](intune-deviceconfig-windowsdefendertamperprotectionoptions.md)
...
- [Сетевой интерфейс проводной сети](intune-deviceconfig-wirednetworkinterface.md)
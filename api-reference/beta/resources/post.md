...
Представляет отдельный элемент столба в [объекте converstaionThread.](conversationthread.md)
...
|importance | String | Важность групповой публикации: `low` , `normal` `high` . |

...
Базовый профиль сертификатов Windows Phone 8.1 +.
...
|certificateValidityPeriodValue|Int32|Значение периода Validtiy сертификата.|

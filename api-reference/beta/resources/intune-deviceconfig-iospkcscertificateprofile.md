...
description: Профиль сертификата PKCS для iOS.
author: dougeby
...
Профиль сертификата PKCS для iOS.
...
|[Создание iosPkcsCertificateProfile](../api/intune-deviceconfig-iospkcscertificateprofile-create.md)|[iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md)|Создайте объект [iosPkcsCertificateProfile](../resources/intune-deviceconfig-iospkcscertificateprofile.md) .|

...
|[отклонение действия](../api/intune-rbac-operationapprovalrequest-reject.md)|String|Отклонение запрошеного экземпляра операцииApprovalRequest|

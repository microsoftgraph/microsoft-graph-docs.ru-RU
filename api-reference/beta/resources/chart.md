...
|:---------------|:--------|:----------|
|Получение объекта Chart | [Chart](chart.md) |Чтение свойств и связей объекта диаграммы.|
|Создание объекта ChartSeries |ChartSeries| Создание объекта ChartSeries путем добавления в коллекцию рядов.|
|Список рядов |Коллекция объектов ChartSeries| Получение коллекции объектов ChartSeries.|
...
|[List](../api/chart-list.md) | Коллекция объектов Chart |Получение коллекции объектов диаграмм. |

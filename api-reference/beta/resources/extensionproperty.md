...
|иссинцедфромонпремисес|Логическое| Указывает, было ли это свойство расширения сикнед из локального каталога с помощью Azure AD Connect. Только для чтения. |

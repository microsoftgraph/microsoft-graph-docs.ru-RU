...
|isSyncedFromOnPremises|Логический| Указывает, синхронизировано ли это свойство расширения из локального активного каталога с помощью Azure AD Подключение. Только для чтения. |

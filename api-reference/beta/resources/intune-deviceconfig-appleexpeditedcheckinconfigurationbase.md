---
title: Тип ресурса appleExpeditedCheckinConfigurationBase
description: Экспериментальный профиль для увеличения скорости проверки устройств в день на устройствах iOS и macOS.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 2364444fa202a753211f6aa028a44e6246c652b8
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66670108"
---
# <a name="appleexpeditedcheckinconfigurationbase-resource-type"></a>Тип ресурса appleExpeditedCheckinConfigurationBase
...
Экспериментальный профиль для увеличения скорости проверки устройств в день на устройствах iOS и macOS.
...
|:---|:---|:---|
|[Перечисление объектов appleExpeditedCheckinConfigurationBase](../api/intune-deviceconfig-appleexpeditedcheckinconfigurationbase-list.md)|[Коллекция appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|Список свойств и связей объектов [appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md) .|
|[Получение объекта appleExpeditedCheckinConfigurationBase](../api/intune-deviceconfig-appleexpeditedcheckinconfigurationbase-get.md)|[appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|Чтение свойств и связей объекта [appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md) .|
...
|enableExpeditedCheckin|Логический|Возвращает или задает значение, указывающее, следует ли включить ускоренную проверку устройств.|

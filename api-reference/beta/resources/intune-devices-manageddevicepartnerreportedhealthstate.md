...
|highSeverity|ICMPv6|Устройство считается высокой угрозой с помощью партнера по защите от угроз для мобильных устройств.|
|не отвечает|см|Устройство считается неотвечающим для системы защиты от угроз для мобильных устройств. Работоспособность устройства неизвестна.|

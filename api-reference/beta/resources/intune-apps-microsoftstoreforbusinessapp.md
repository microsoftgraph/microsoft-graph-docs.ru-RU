...
ms.openlocfilehash: 62438b664200fe8ceb780729ee75572f4d113744
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667721"
---
...
|Идентификаторы roleScopeTagId|Коллекция строк|Список идентификаторов тегов области для этого мобильного приложения. Наследуется от [mobileApp](../resources/intune-apps-mobileapp.md).|
...
|containedApps|[Коллекция mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md)|Коллекция автономных приложений в mobileApp, выполняющего роль пакета.|

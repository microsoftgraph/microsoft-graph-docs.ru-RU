...
description: Профиль конфигурации доверенного корневого сертификата рабочего профиля Android
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 44f8d8c0db87d0c692b6862b32c408338e43c166
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667273"
---
...
Профиль конфигурации доверенного корневого сертификата рабочего профиля Android
...
|:---|:---|:---|
|[Перечисление объектов androidWorkProfileTrustedRootCertificates](../api/intune-deviceconfig-androidworkprofiletrustedrootcertificate-list.md)|[Коллекция androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md)|Список свойств и связей объектов [androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md) .|
|[Получение объекта androidWorkProfileTrustedRootCertificate](../api/intune-deviceconfig-androidworkprofiletrustedrootcertificate-get.md)|[androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md)|Чтение свойств и связей объекта [androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md) .|
|[Создание объекта androidWorkProfileTrustedRootCertificate](../api/intune-deviceconfig-androidworkprofiletrustedrootcertificate-create.md)|[androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md)|Создайте объект [androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md) .|
|[Удаление объекта androidWorkProfileTrustedRootCertificate](../api/intune-deviceconfig-androidworkprofiletrustedrootcertificate-delete.md)|Нет|Удаляет [объект androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md).|
|[Обновление androidWorkProfileTrustedRootCertificate](../api/intune-deviceconfig-androidworkprofiletrustedrootcertificate-update.md)|[androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md)|Обновление свойств объекта [androidWorkProfileTrustedRootCertificate](../resources/intune-deviceconfig-androidworkprofiletrustedrootcertificate.md) .|
...
|certFileName|String|Имя файла, отображаемое в пользовательском интерфейсе.|

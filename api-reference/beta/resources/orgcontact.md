...
| [getMemberGroups](../api/directoryobject-getmembergroups.md) | Коллекция String | Верни все группы, в которые входит указанный контакт. |
...
| [getMemberObjects](../api/directoryobject-getmemberobjects.md) | Коллекция String | Получите список ролей групп, административных подразделений и каталогов, в которые входит контактная группа. |

...
|:---------------|:--------|:----------|
| устраняющее                    | [Фисикалоффицеаддресс](physicalofficeaddress.md)            | ПоЧтовые адреса для этого организационного контакта. Теперь контакт может иметь только один физический адрес. |
...
| imAddresses                  | Коллекция String                          | Список адресов для обмена МГНОВЕНными СООБЩЕНИЯми для данного контакта в Организации. Теперь контакт может иметь только один SIP адрес.                                                                                                                                                                                                                        |

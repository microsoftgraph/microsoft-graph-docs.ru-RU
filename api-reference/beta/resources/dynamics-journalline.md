...
|lineNumber            |целое число                 |Номер строки журнала.                                    |
...
|комментарий               |Строка, максимальный размер 250|Заданный пользователем комментарий в строке журнала.                      |
|lastModifiedDateTime  |отличным                |Дата и время последнего изменения строки журнала. Только для чтения.        |

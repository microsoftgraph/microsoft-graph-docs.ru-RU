...
|:---|:---|:---|
|[Перечисление объектов androidVpnConfiguration](../api/intune-deviceconfig-androidvpnconfiguration-list.md)|[Коллекция androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md)|Список свойств и связей объектов [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) .|
|[Получение объекта androidVpnConfiguration](../api/intune-deviceconfig-androidvpnconfiguration-get.md)|[androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md)|Чтение свойств и связей объекта [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) .|
|[Создание объекта androidVpnConfiguration](../api/intune-deviceconfig-androidvpnconfiguration-create.md)|[androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md)|Создайте объект [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) .|
|[Удаление объекта androidVpnConfiguration](../api/intune-deviceconfig-androidvpnconfiguration-delete.md)|Нет|Удаляет [androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md).|

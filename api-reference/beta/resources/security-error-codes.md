...
Ошибки в API-Интерфейс безопасности Microsoft Graph возвращаются с помощью стандартных код состояния HTTP 206 Частичное контента и доставляются путем получения заголовка предупреждения.
...
Пользователь запрашивает `/alerts/{alert-id}`.

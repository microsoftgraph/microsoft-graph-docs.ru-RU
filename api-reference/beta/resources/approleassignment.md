...
| principalType | Строка | Тип назначенного субъекта. Возможные значения: "User", "Group" или "ServicePrincipal". Только для чтения. Не поддерживает `$filter`. |

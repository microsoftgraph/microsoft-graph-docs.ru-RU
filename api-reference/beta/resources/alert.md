...
|:---------------|:--------|:----------|
|[получение оповещения](../api/alert-get.md); | Alert |Чтение свойства и связи оповещения объекта.|
|[обновление оповещения](../api/alert-update.md). | Alert |Обновление оповещений объекта. |
...
|Отзывы|alertFeedback|Отзыв аналитик на оповещение. Возможные значения: `unknown`, `truePositive`, `falsePositive`, `benignPositive`. (поддерживает [обновление](../api/alert-update.md))|
...
|Серьезность |alertSeverity|Серьезность оповещения — задание с поставщиком/поставщика. Возможные значения: `unknown`, `informational`, `low`, `medium`, `high`. Обязательный.|

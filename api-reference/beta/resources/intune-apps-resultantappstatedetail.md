...
|депенденцифаиледтоинсталл|1 |Не удалось установить одну или несколько зависимостей приложения.|
|депенденцивисрекуирементснотмет|2 |Одна или несколько зависимостей приложения имеют требования, которые не выполнены.|
|депенденципендингребут|3 |Для завершения установки одна или несколько зависимостей приложения требуют перезагрузки устройства.|

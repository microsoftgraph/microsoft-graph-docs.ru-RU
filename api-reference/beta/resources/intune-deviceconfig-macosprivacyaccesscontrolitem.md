...
|идентификатор|String|Идентификатор пакета или путь к приложению, процессу или исполняемому файлу.|
...
|кодерекуиремент|String|Введите требование к коду, которое можно получить с помощью команды "коконструирование – отобразить-r –" в приложении терминала. Включите все после "=>".|

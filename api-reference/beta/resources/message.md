...
|[createForward](../api/message-createforward.md)|[Сообщение](message.md)|Создайте черновик пересылаемого сообщения, чтобы добавить комментарий или обновить любые свойства сообщения одновременно в одном вызове **createForward**. После этого вы сможете [обновить](../api/message-update.md) или [отправить](../api/message-send.md) черновик.|
|[createReply](../api/message-createreply.md)|[Сообщение](message.md)|Создайте черновик ответного сообщения, чтобы добавить комментарий или обновить любые свойства сообщения одновременно в одном вызове **createReply**. После этого вы сможете [обновить](../api/message-update.md) или [отправить](../api/message-send.md) черновик.|
|[createReplyAll](../api/message-createreplyall.md)|[Сообщение](message.md)|Создайте черновик сообщения "Ответить всем", чтобы добавить комментарий или обновить любые свойства сообщения одновременно в одном вызове **createReplyAll**. После этого вы сможете [обновить](../api/message-update.md) или [отправить](../api/message-send.md) черновик.|
...
|[replyAll](../api/message-replyall.md)|Нет|Отвечайте всем получателям сообщения путем указания комментария и изменения любых обновляемых свойств ответа с помощью метода **replyAll**. Сообщение будет сохранено в папку "Отправленные".|
...
|createdDateTime|DateTimeOffset|Дата и время создания сообщения. <br><br> Для предоставления сведений о времени и дате используется формат ISO 8601 (всегда UTC). Например, значение полуночи 1 января 2014 г. в формате UTC выглядит так: `2014-01-01T00:00:00Z`.|
...
|id|String| Уникальный идентификатор сообщения. [!INCLUDE [outlook-beta-id](../../includes/outlook-immutable-id.md)] Только для чтения. |
...
|internetMessageId | String | Идентификатор сообщения в формате, определенном в документе [RFC5322](https://www.ietf.org/rfc/rfc5322.txt). Это свойство можно обновить, только если параметр **isDraft** имеет значение верен.|
...
|lastModifiedDateTime|DateTimeOffset|Дата и время последнего изменения сообщения. <br><br> Для предоставления сведений о времени и дате используется формат ISO 8601 (всегда UTC). Например, значение полуночи 1 января 2014 г. в формате UTC выглядит так: `2014-01-01T00:00:00Z`.|
...
|receivedDateTime|DateTimeOffset|Дата и время получения сообщения. <br><br> Для предоставления сведений о времени и дате используется формат ISO 8601 (всегда UTC). Например, значение полуночи 1 января 2014 г. в формате UTC выглядит так: `2014-01-01T00:00:00Z`.|
...
|sentDateTime|DateTimeOffset|Дата и время отправки сообщения. <br><br> Для предоставления сведений о времени и дате используется формат ISO 8601 (всегда UTC). Например, значение полуночи 1 января 2014 г. в формате UTC выглядит так: `2014-01-01T00:00:00Z`.|

...
ms.locfileid: "32542328"
---
# <a name="filtercriteria-resource-type"></a><span data-ttu-id="49a3c-103">Тип ресурса FilterCriteria</span><span class="sxs-lookup"><span data-stu-id="49a3c-103">FilterCriteria resource type</span></span>

<span data-ttu-id="49a3c-104">Представляет условия фильтра, применяемые к столбцу.</span><span class="sxs-lookup"><span data-stu-id="49a3c-104">Represents the filtering criteria applied to a column.</span></span>

## <a name="json-representation"></a><span data-ttu-id="49a3c-105">Представление в формате JSON</span><span class="sxs-lookup"><span data-stu-id="49a3c-105">JSON representation</span></span>

<span data-ttu-id="49a3c-106">Ниже представлено описание ресурса в формате JSON.</span><span class="sxs-lookup"><span data-stu-id="49a3c-106">Here is a JSON representation of the resource.</span></span>

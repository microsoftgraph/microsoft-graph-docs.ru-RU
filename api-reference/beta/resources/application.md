...
| appRoles                   | Коллекция [appRole](approle.md)                               | Коллекция ролей, объявленных приложением. С помощью команды [назначения ролей приложений](approleassignment.md) эти роли можно назначать пользователям, группам и другим субъектам-службам приложений. Значение null не допускается.                                                                                                                                                                                                                                                                                                                                               |
...
| onPremisesPublishing       | [onPremisesPublishing](onpremisespublishing.md)                | Представляет набор свойств, необходимых для настройки прокси-сервера приложения для этого приложения. Настройка этих свойств позволяет вам опубликовать локальное приложение для безопасного удаленного доступа.                                                                                                                                                                                                                                                                                                                                                   |

...
| [Разность](../api/oauth2permissiongrant-delta.md) | Коллекция [oAuth2PermissionGrant](oauth2permissiongrant.md) |Получить вновь созданные, обновленные или удаленные **объекты oauth2permissiongrant** без полного чтения всей коллекции ресурсов. |
...
| startTime | DateTimeOffset | В настоящее время значение времени начала игнорируется, но при создании **oAuth2PermissionGrant** требуется значение. Обязательно. |

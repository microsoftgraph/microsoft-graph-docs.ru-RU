...
|:---|:---|:---|
|[Перечисление объектов windowsVpnConfiguration](../api/intune-deviceconfig-windowsvpnconfiguration-list.md)|[Коллекция windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md)|Список свойств и связей объектов [windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md) .|
|[Получение объекта windowsVpnConfiguration](../api/intune-deviceconfig-windowsvpnconfiguration-get.md)|[windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md)|Чтение свойств и связей объекта [windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md) .|
...
|customXml|Binary|Пользовательские XML-команды, которые настраивают VPN-подключение. (массив байтов в кодировке UTF8).|

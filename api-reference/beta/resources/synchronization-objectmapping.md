...
|фловтипес      |обжектфловтипес    |Какие типы Flow включены для этого сопоставления объектов. `Add` создает новые объекты в целевом каталоге, `Update` изменяет существующие объекты и разменяет `Delete` существующие. Значение по умолчанию: `Add, Update, Delete` . |

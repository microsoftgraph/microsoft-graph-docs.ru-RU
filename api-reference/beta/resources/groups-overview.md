...
|-------------------|----------|-----------|--------------|------------------|--------------------------------|
| [Группы Office 365](#office-365-groups) | Обеспечение совместной работы пользователей с общими ресурсами Майкрософт в Интернете. | `["Unified"]` | `true` | `false` | Да |
...
```
Дополнительные сведения о группах Office 365 и интерфейсах для администраторов см. в статье [Дополнительные сведения о группах Office 365](https://support.office.com/en-us/article/Learn-about-Office-365-groups-b565caa1-5c40-40ef-9915-60fdb2d97fa2).
...
Дополнительные сведения о составлении правил членства см. в статье [Создание правил на основе атрибутов для динамического членства в группах в Azure Active Directory](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-groups-dynamic-membership-azure-portal).
...
## <a name="group-based-licensing"></a>Группа лицензирования 

Групповые лицензирования возможность можно использовать для назначения лицензий продукта к группе Azure AD. Azure AD гарантирует, что лицензии назначаются всем членам группы. Новые члены, которые присоединиться к группе назначены соответствующие лицензии. При их выхода из группы, которые удаляются. Компонент может использоваться только с группами безопасности и Office 365 группы, имеющие securityEnabled = TRUE. Для получения дополнительных сведений о лицензировании см. групповые [здесь](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).
...
| Перечисление, добавление и удаление владельцев группы. | [user](user.md) <br/> [group](group.md)| [Перечисление владельцев](../api/group-list-members.md) <br/> [Добавление члена](../api/group-post-members.md) <br/> [Удаление члена](../api/group-delete-members.md)|

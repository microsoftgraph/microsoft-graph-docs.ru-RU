...
|[Список](../api/chartpoint-list.md) | Коллекция объектов [ChartPoint](chartpoint.md) |Получение коллекции объектов chartPoint. |
...
|:---------------|:--------|:----------|
|значение|object|Возвращает значение точки диаграммы. Только для чтения.|

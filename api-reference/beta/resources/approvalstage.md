...
| исаппровержустификатионрекуиред |Логический | Указывает, является ли утверждающий обязательным для предоставления обоснования для утверждения запроса. |
| исескалатионенаблед |Логический | Если задано значение true, на этом этапе утверждения настраивается один или несколько утверждающих. |

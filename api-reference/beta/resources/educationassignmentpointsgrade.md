...
description: Если для задания задано значение типа оценки баллов, каждый объект каждой отправки будет связан со **свойством submission.grade** . При этом создается подкласс из educationAssignmentGrade.

...
|managedDeviceId|String|Идентификатор управляемого устройства на хост-устройстве. Значение может быть пустым, даже если устройством управляет хост-устройство.|
|azureADDeviceId|String|Идентификатор устройства Azure Active Directory для хост-устройства. Значение может быть пустым, даже если на хост-устройстве зарегистрирован Azure Active Directory.|
|deviceModel|String|Модель устройства для текущей регистрации приложения |
|deviceManufacturer|String|Производитель устройства для текущей регистрации приложения |

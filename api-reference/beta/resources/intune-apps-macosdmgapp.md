---
title: Тип ресурса macOSDmgApp
description: Содержит свойства и унаследованные свойства для приложения DMG для MacOS.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 7800a4f080c3f279ee6b3aeddea2eebe779bf9fa
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667763"
---
# <a name="macosdmgapp-resource-type"></a>Тип ресурса macOSDmgApp
...
Содержит свойства и унаследованные свойства для приложения DMG для MacOS.
...
|:---|:---|:---|
|[Перечисление macOSDmgApps](../api/intune-apps-macosdmgapp-list.md)|[Коллекция macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Список свойств и связей объектов [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) .|
|[Получение macOSDmgApp](../api/intune-apps-macosdmgapp-get.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Чтение свойств и связей объекта [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) .|
|[Создание macOSDmgApp](../api/intune-apps-macosdmgapp-create.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Создайте объект [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) .|
|[Удаление macOSDmgApp](../api/intune-apps-macosdmgapp-delete.md)|Нет|Удаляет [macOSDmgApp](../resources/intune-apps-macosdmgapp.md).|
|[Обновление macOSDmgApp](../api/intune-apps-macosdmgapp-update.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Обновление свойств объекта [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) .|
...
|primaryBundleId|String|Основной ОБЪЕКТ CFBundleIdentifier DMG.|
|primaryBundleVersion|String|Основная версия CFBundleVersion DMG.|
...
|ignoreVersionDetection|Boolean|Значение, указывающее, будет ли версия приложения использоваться для обнаружения приложения после его установки на устройстве. Задайте значение true для приложений, использующих функцию самостоятельного обновления. Установите для этого параметра значение false, чтобы установить приложение, если оно еще не установлено на устройстве или если номер версии развертываемого приложения не соответствует версии, которая уже установлена на устройстве.|

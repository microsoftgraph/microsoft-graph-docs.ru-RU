...
description: Содержит свойства и унаследованные свойства для приложения MacOS DMG.
author: dougeby
...
Содержит свойства и унаследованные свойства для приложения MacOS DMG.
...
|:---|:---|:---|
|[Список macOSDmgApps](../api/intune-apps-macosdmgapp-list.md)|[коллекция macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Список свойств и связей объектов [macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)|
|[Get macOSDmgApp](../api/intune-apps-macosdmgapp-get.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Чтение свойств и связей [объекта macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)|
|[Создание macOSDmgApp](../api/intune-apps-macosdmgapp-create.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Создание нового [объекта macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)|

...
| Элемент                | Значение | Описание                         |
|:----------------------|:------|:------------------------------------|
| string                | 1,1     | строковый тип данных                    |
| логический               | 2     | тип данных Boolean                   |
| переменной                 | 4     | Тип данных int                       |
...
| Элемент                | Значение | Описание                                                        |
|:----------------------|:------|:-------------------------------------------------------------------|
| builtIn               | 1,1     | Этот тип атрибута пользовательского процесса указывает, что он был создан системой |

...
description: Содержит свойства и унаследованные свойства для iOS веб-приложений.
author: dougeby
...
Содержит свойства и унаследованные свойства для iOS веб-приложений.

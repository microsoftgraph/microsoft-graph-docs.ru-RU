...
|committedContainedApps|[mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md) коллекции|Коллекция автономные приложения в зафиксировано mobileAppContent windowsUniversalAppX приложения.|

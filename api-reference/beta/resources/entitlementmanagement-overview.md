...
- [accessPackageAssignmentResourceRole](accesspackageassignmentresourcerole.md): указывает роль, определенную для ресурса, которая была назначена субъекту с помощью назначения пакета доступа.
- [accessPackageCatalog](accesspackagecatalog.md): контейнер для пакетов доступа.
- [accessPackageResource](accesspackageresource.md): ссылка на ресурс, связанный с каталогом пакетов доступа.
...
Учебник, в который показано, как использовать управление правами для создания пакета ресурсов, которые внутренние пользователи могут запрашивать для самообслуживки, см. в инструкции [Create an access package using Microsoft Graph API](/graph/tutorial-access-package-api).
...
| [Добавление accessPackage в несовместимыеAccessPackages](../api/accesspackage-post-incompatibleaccesspackage.md) | Отсутствует | Добавьте ссылку, чтобы указать другой **пакет доступа** несовместим с указанным пакетом доступа. |
| [Удаление accessPackage из несовместимыхAccessPackages](../api/accesspackage-delete-incompatibleaccesspackage.md) | Отсутствует | Удалить ссылку, которая указывала на **несовместимость accesspackage** . |
...
| [Добавление группы в несовместимые Группы](../api/accesspackage-post-incompatiblegroup.md) | Отсутствует | Добавьте ссылку, чтобы указать, что членство **в группе** несовместимо с указанным пакетом доступа. |
| [Удаление группы из несовместимых групп](../api/accesspackage-delete-incompatiblegroup.md) | Отсутствует | Удалите ссылку, которая указывала, что членство **в** группе несовместимо.|
...
| [Удаление accessPackageAssignmentRequest](../api/accesspackageassignmentrequest-delete.md) |Отсутствует | Удаление **accessPackageAssignmentRequest**. |
...
| [Обновление accessPackageCatalog](../api/accesspackagecatalog-update.md)|Отсутствует | Обновление свойств объекта **accessPackageCatalog** . |
...
| [Обновление connectedOrganization](../api/connectedorganization-update.md) |Отсутствует | Обновление **подключеннойорганизации**. |
...
|[Обновление approvalStep](../api/approvalstep-update.md) | Отсутствует | Применить утверждение или отказ в принятии решения по **объекту approvalStep** . |

...
|:---|:---|:---|
|[Список windowsCertificateProfileBases](../api/intune-deviceconfig-windowscertificateprofilebase-list.md)|[windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) коллекции|Свойства списка и связей объектов [windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) .|
|[Получение windowsCertificateProfileBase](../api/intune-deviceconfig-windowscertificateprofilebase-get.md)|[windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md)|Чтение свойства и связи объекта [windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) .|
...
|keyStorageProvider|[keyStorageProviderOption](../resources/intune-deviceconfig-keystorageprovideroption.md)|Поставщика хранилища ключей (KSP). Возможные значения: `useTpmKspOtherwiseUseSoftwareKsp`, `useTpmKspOtherwiseFail`, `usePassportForWorkKspOtherwiseFail`, `useSoftwareKsp`.|
...
|certificateValidityPeriodValue|Int32|Значение для срок действия сертификата|

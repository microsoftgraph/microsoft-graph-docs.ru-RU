...
|:-------------|:------------|:------------|
|action|Строка|Указывает имя действия или имя операции (например, создание пользователя, Добавление участника в группу). Список действий, регистрируемых в журнале, можно найти в списке действий Azure AD.|
...
|чанжеид|Строка|Уникальный идентификатор этого изменения в этом цикле.|
|циклеид|Строка|Уникальный идентификатор для итерации задания.|
|дуратионинмиллисекондс|Int32|Указывает время завершения этого действия подготовки. Измеряется в миллисекундах.|
|id|Строка| Указывает уникальный идентификатор для действия. Это GUID, предназначенный только для чтения.|
|initiatedBy|[initiator](initiator.md)|Сведения о том, кто инициировал эту подготовку.|
|jobId|Строка|Уникальный идентификатор для полного задания подготовки.|

...
description: База для профилей электронной почты EAS профиля android work
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 8bb5cc592c28271074761abda65c910fbb429296a917da97e26bf7c4273d00e5
...
База для профилей электронной почты EAS профиля android work
...
|hostName|String|Exchange (URL-адрес), к который подключается почтовое приложение.|

...
|[Удаление androidPkcsCertificateProfile](../api/intune-deviceconfig-androidpkcscertificateprofile-delete.md)|Нет|Удаляет объект [androidPkcsCertificateProfile](../resources/intune-deviceconfig-androidpkcscertificateprofile.md).|

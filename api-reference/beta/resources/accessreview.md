...
| Связь | Тип   |Описание|
|:---------------|:--------|:----------|
| `reviewers`               |Коллекция [userIdentity](useridentity.md)                     | Коллекция проверяющих для проверки доступа, если тип проверки доступа Ревиевертипе имеет значение `delegate` . |

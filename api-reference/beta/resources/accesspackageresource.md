...
|:-------------|:------------|:------------|
|accessPackageResourceEnvironment|[accessPackageResourceEnvironment](../resources/accesspackageresourceenvironment.md)|Содержит сведения о среде для ресурса. Это можно сделать с помощью `@odata.bind` аннотации или источника *среды.*|

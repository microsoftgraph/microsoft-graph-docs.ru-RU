...
Профиль базовой конфигурации VPN.
...
|:---|:---|:---|
|[Список Впнконфигуратионс](../api/intune-deviceconfig-vpnconfiguration-list.md)|Коллекция [впнконфигуратион](../resources/intune-deviceconfig-vpnconfiguration.md)|Список свойств и связей объектов [впнконфигуратион](../resources/intune-deviceconfig-vpnconfiguration.md) .|
|[Получение Впнконфигуратион](../api/intune-deviceconfig-vpnconfiguration-get.md)|[vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)|Чтение свойств и связей объекта [впнконфигуратион](../resources/intune-deviceconfig-vpnconfiguration.md) .|

...
description: Правила политики соответствия устройств по умолчанию, которые применяются для всей учетной записи.
author: dougeby
...
Правила политики соответствия устройств по умолчанию, которые применяются для всей учетной записи.

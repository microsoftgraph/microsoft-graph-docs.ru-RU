...
description: Экспериментальный профиль для увеличения скорости проверки устройств в день на устройствах iOS.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: aeee176f882bbf36ec7bdd810bc5e9bb83983d93
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66667413"
---
...
Экспериментальный профиль для увеличения скорости проверки устройств в день на устройствах iOS.
...
|enableExpeditedCheckin|Логическое|Возвращает или задает значение, указывающее, следует ли включить ускоренную проверку устройств. Наследуется [от appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|

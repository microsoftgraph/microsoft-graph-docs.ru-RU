...
Базовый профиль Android сертификат.
...
|:---|:---|:---|
|[Список androidCertificateProfileBases](../api/intune-deviceconfig-androidcertificateprofilebase-list.md)|[androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) коллекции|Свойства списка и связей объектов [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
|[Получение androidCertificateProfileBase](../api/intune-deviceconfig-androidcertificateprofilebase-get.md)|[androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md)|Чтение свойства и связи объекта [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
...
|rootCertificate|[androidTrustedRootCertificate](../resources/intune-deviceconfig-androidtrustedrootcertificate.md)|Доверенного корневого сертификата.|

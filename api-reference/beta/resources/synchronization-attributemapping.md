...
|:--------------------------|:--------------------------|:---------------|
|Значение               | Строка                    |Значение по умолчанию, используемое в **source** случае, если свойство Source `null`было оценено. Необязательно.|
...
|таржетаттрибутенаме        |Строка                     |Имя атрибута в целевом объекте. |

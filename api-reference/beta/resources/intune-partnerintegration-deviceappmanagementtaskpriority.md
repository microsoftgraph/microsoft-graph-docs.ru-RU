---
title: тип enum deviceAppManagementTaskPriority
description: Приоритет задачи управления приложениями на устройстве.
author: dougeby
...
Приоритет задачи управления приложениями на устройстве.

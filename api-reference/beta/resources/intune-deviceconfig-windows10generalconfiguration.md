...
|еджерекуиредекстенсионпаккажефамилинамес|Коллекция объектов string|Укажите список имен семейств пакетов, которые необходимы для расширения браузера и не могут быть отключены пользователем.|

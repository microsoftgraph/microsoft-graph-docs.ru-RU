...
|:---|:---|:---|
|роледефинитионидс|Коллекция объектов string|Идентификаторы определений ролей для определений ролей частности, назначенных пользователю.|
|ролеассигнментидс|Коллекция объектов string|Идентификаторы назначения ролей для назначений ролей частности, назначенных пользователю.|

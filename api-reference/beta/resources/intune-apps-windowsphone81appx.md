...
description: Содержит свойства и унаследованные свойства для Windows Phone приложений AppX 8.1.
author: dougeby
localization_priority: Normal
ms.prod: intune
doc_type: resourcePageType
ms.openlocfilehash: 15de97af0aa21ec925d5edef987ac6740fea0a44
ms.sourcegitcommit: 7bc623e73fdfb970dbd0a62154d10bb2863afaf7
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/07/2022
ms.locfileid: "66668547"
---
...
Содержит свойства и унаследованные свойства для Windows Phone приложений AppX 8.1.
...
|:---|:---|:---|
|[Перечисление windowsPhone81AppXs](../api/intune-apps-windowsphone81appx-list.md)|[Коллекция windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)|Список свойств и связей объектов [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) .|
...
|[Создание windowsPhone81AppX](../api/intune-apps-windowsphone81appx-create.md)|[windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)|Создайте объект [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) .|
...
|phonePublisherId|String|Идентификатор издателя телефона.|

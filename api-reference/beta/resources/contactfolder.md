...
|[Создание контакта в папке](../api/contactfolder-post-contacts.md) |[контакт](contact.md)| Добавление контакта в корневую папку с контактами или конечную точку `contacts` другой папки с контактами.|

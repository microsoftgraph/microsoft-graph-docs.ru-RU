...
|[Удаление рубрики](../api/educationassignment-delete-rubric.md)|Нет|**Отделять educationRubric** от этого **назначения**.|
|[Получение дельты](../api/educationassignment-delta.md)|[коллекция educationAssignment](../resources/educationassignment.md)|Получите **коллекцию объектов educationAssignment** с поддержкой запроса delta.|

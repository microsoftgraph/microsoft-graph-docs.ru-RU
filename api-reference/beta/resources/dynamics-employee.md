...
|number              |строка  |Номер сотрудника. Только для чтения.                        |
|displayName         |строка  |Сотрудник givenName + фамилия. Только для чтения.           |
|givenName;           |строка  |Заданное имя сотрудника.                        |
|middleName          |строка  |Отчество сотрудника.                       |
|surname             |строка  |Фамилия сотрудника                            |
|jobTitle;            |строка  |Полное имя сотрудника                          |
...
|phoneNumber         |строка  |Указывает номер телефона сотрудника.             |
|mobilePhone;         |строка  |Указывает номер мобильного телефона сотрудника.      |
|email               |строка  |Указывает адрес электронной почты сотрудника.                |
|Персоналемаил       |строка  |Указывает личный адрес электронной почты сотрудника.       |

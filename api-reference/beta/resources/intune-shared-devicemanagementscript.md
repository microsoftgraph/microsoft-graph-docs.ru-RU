...
Intune предоставит клиенту возможность запускать свои скрипты Powershell на зарегистрированных устройствах Azure Active Directory. Сценарий можно запускать один раз или периодически.

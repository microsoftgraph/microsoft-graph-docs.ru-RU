...
> **Примечание** Подписки, отмеченные звездочкой (*), поддерживаются только в конечной точке бета-версии.
...
Возможные значения пути ресурсов для каждого поддерживаемых ресурсов см. в Graph API Microsoft для получения [уведомлений об изменениях.](webhooks.md)

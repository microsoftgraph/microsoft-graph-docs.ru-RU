...
|:---------------|:--------|:----------|
|contractType|Строка|Тип контракта. Возможные значения:  `SyndicationPartner` , `BreadthPartner` , `ResellerPartner` . Подробнее в таблице [ниже](#contracttype-values). |
...
|id|Строка| Уникальный идентификатор для партнерства. Клавиша, только для чтения |

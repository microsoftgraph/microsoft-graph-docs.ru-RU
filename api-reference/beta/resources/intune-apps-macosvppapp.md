...
description: Содержит свойства и унаследованные свойства для приложений macOS Volume-Purchased Program (VPP).
author: dougeby
...
Содержит свойства и унаследованные свойства для приложений macOS Volume-Purchased Program (VPP).
...
|:---|:---|:---|
|[Перечисление macOsVppApps](../api/intune-apps-macosvppapp-list.md)|[Коллекция macOsVppApp](../resources/intune-apps-macosvppapp.md)|Список свойств и связей объектов [macOsVppApp](../resources/intune-apps-macosvppapp.md) .|
|[Получение macOsVppApp](../api/intune-apps-macosvppapp-get.md)|[macOsVppApp](../resources/intune-apps-macosvppapp.md)|Чтение свойств и связей объекта [macOsVppApp](../resources/intune-apps-macosvppapp.md) .|
|[Создание macOsVppApp](../api/intune-apps-macosvppapp-create.md)|[macOsVppApp](../resources/intune-apps-macosvppapp.md)|Создайте объект [macOsVppApp](../resources/intune-apps-macosvppapp.md) .|
...
|revokeLicenseActionResults|[Коллекция macOsVppAppRevokeLicensesActionResult](../resources/intune-apps-macosvppapprevokelicensesactionresult.md)|Результаты действий по отмене лицензии для этого приложения.|
...
|assignedLicenses|[Коллекция macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md)|Лицензии, назначенные этому приложению.|

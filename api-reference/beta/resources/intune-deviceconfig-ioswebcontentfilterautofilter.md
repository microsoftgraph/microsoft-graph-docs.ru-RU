...
|:---|:---|:---|
|алловедурлс|Коллекция объектов string|Дополнительные URL-адреса, разрешенные для Access|
|блоккедурлс|Коллекция объектов string|Дополнительные URL-адреса, заблокированные для Access|

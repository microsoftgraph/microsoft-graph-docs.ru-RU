...
description: Указав конфигурации в этом профиле, можно указать устройству android Work Profile подключиться к нужной конечной точке VPN. Указав метод проверки подлинности и типы безопасности, ожидаемые конечной точкой VPN, можно сделать VPN-подключение простым для конечного пользователя.
author: dougeby
...
Указав конфигурации в этом профиле, можно указать устройству android Work Profile подключиться к нужной конечной точке VPN. Указав метод проверки подлинности и типы безопасности, ожидаемые конечной точкой VPN, можно сделать VPN-подключение простым для конечного пользователя.
...
|alwaysOnLockdown|Логический|Если включено постоянное VPN-подключение, следует ли блокировать сетевой трафик при отключении этого VPN.|

...
|[Перечисление](../api/schemaextension-list.md) | schemaExtension |Перечислите схему avaialbeExtension defintions и их свойства.|
...
|targetTypes|Коллекция String|Набор типов Microsoft Graph (поддерживающих расширения), к которым можно применить это расширение схемы. Выберите из **administrativeUnit**, **contact**, **device**, **event**, **group**, **message**, **organization**, **post** или **user**.|

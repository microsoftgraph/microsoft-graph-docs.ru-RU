...
|targetTypes|Коллекция String|Набор типов Microsoft Graph (поддерживающих расширения), к которым можно применить это расширение схемы. Выберите из **administrativeUnit**, **контакт**, **устройство**, **событие**, **группа**, **сообщение**, **организация**, **сообщение**, **или пользователь**.|

...
|[Удаление macOSCustomConfiguration](../api/intune_deviceconfig_macoscustomconfiguration_delete.md)|Нет|Удаление экземпляра [macOSCustomConfiguration](../resources/intune_deviceconfig_macoscustomconfiguration.md).|
...
|userStatuses|Коллекция [deviceConfigurationUserStatus](../resources/intune_deviceconfig_deviceconfigurationuserstatus.md)|Device configuration installation status by user. Наследуется от [deviceConfiguration](../resources/intune_deviceconfig_deviceconfiguration.md).|

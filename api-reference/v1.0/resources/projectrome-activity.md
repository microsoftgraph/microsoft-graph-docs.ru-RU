...
|контентинфо | Нетипизированный объект JSON | Необязательное. Настраиваемая часть расширяемого описания содержимого Data – JSON – LD в соответствии с синтаксисом [Schema.org](https://schema.org) .|
...
|Связь | Тип | Описание|
|:------------|:-----|:-----------|
|Historyitem| Коллекция [активитихисторитем](../resources/projectrome-historyitem.md) | Необязательное. Свойство NavigationProperty/вложение; свойство навигации для Historyitem действия.|

...
|[Удаление действия](../api/projectrome-delete-activity.md) | Нет контента | Удаляет указанное действие для этого пользователя из приложения.|

...
|висуалелементс| [висуалинфо](../resources/projectrome-visualinfo.md) | Обязательное. Объект, содержащий информацию для отображения действий в пользовательском интерфейсе.|

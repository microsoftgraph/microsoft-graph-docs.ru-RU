...
|visualElements| [visualInfo](../resources/projectrome-visualinfo.md) | Обязательный элемент. Объект, содержащий сведения для отображения действия в UX.|

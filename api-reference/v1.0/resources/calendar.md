...
> **Примечание:** Существуют небольшие отличия, которые позволяют взаимодействовать с календарем пользователей и календарями группы:

 - Вы можете организовать только календари пользователей в [calendarGroup](calendargroup.md).
 - Outlook автоматически принимает все приглашения на собрания от имени группы. Вы можете [принимать](../api/event_accept.md), [принимать под вопросом](../api/event_tentativelyaccept.md)или [](../api/event_decline.md)отклонять  приглашения на собрания только для календарей пользователей.
  - Outlook не поддерживает напоминания о событиях группы. Можно [отложить](../api/event_snoozereminder.md) или [отклонить](../api/event_dismissreminder.md) [напоминание](reminder.md)только для календарей пользователей.

...
:---------------|:--------|:----------|
|каунтриесблоккедформинорс|Коллекция объектов string| Задает [двузначные коды стран ISO](https://www.iso.org/iso-3166-country-codes.html). Доступ к приложению будет заблокирован для небольших стран из стран, указанных в этом списке.|

...
| Member    | Описание|
|:---------------|:----------|
|null|Значение по умолчанию. Для пользователя не задано свойство **ageGroup**.|
...
| Member    | Описание|
|:---------------|:----------|
|null|Значение по умолчанию. Для пользователя не задано свойство **consentProvidedForMinor**|

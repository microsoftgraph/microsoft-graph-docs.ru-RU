...
|actionState|[actionState](../resources/intune_devices_actionstate.md)||||UNTRANSLATED_CONTENT_START|||State of the action Inherited from [deviceActionResult](../resources/intune_devices_deviceactionresult.md).|||UNTRANSLATED_CONTENT_END||| Возможные значения: `none`, `pending`, `canceled`, `active`, `done`, `failed`, `notSupported`.|
...
|unlockPin|String (строка)|ПИН-код для разблокировки клиента|

...
|:---|:---|:---|
|[Список объектов appleDeviceFeaturesConfigurationBase](../api/intune_deviceconfig_appledevicefeaturesconfigurationbase_list.md)|Коллекция [appleDeviceFeaturesConfigurationBase](../resources/intune_deviceconfig_appledevicefeaturesconfigurationbase.md)|Список свойств и связей объектов [appleDeviceFeaturesConfigurationBase](../resources/intune_deviceconfig_appledevicefeaturesconfigurationbase.md).|
|[Получение объекта appleDeviceFeaturesConfigurationBase](../api/intune_deviceconfig_appledevicefeaturesconfigurationbase_get.md)|[appleDeviceFeaturesConfigurationBase](../resources/intune_deviceconfig_appledevicefeaturesconfigurationbase.md)|Чтение свойств и связей объекта [appleDeviceFeaturesConfigurationBase](../resources/intune_deviceconfig_appledevicefeaturesconfigurationbase.md).|

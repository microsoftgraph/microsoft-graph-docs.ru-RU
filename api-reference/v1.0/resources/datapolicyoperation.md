...
|[Экспорт личных данных](../api/user-exportpersonaldata.md) | None; |Запрос данных политики операция экспортировать данные организации пользователя, можно просмотреть более поздней версии с помощью [получения dataPolicyOperation](../api/datapolicyoperation-get.md)|

...
description: Тип, производный от типа ресурса unifiedRoleManagementPolicyRule, который определяет максимальную продолжительность назначения роли субъекту (путем прямого назначения или активации допустимости).
author: rkarim-ms
...
Тип, производный от типа ресурса [unifiedRoleManagementPolicyRule](../resources/unifiedrolemanagementpolicyrule.md) , который определяет максимальную длительность, которую роль может быть назначена субъекту (посредством прямого назначения или активации соответствия).

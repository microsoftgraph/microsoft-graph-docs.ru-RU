...
| Получите подсказки специальные состояние других получателей, например, документов office | [пользователь](../resources/user.md) <br> [почтовые подсказки](../resources/mailtips.md) | [Получите подсказки](../api/user_getmailtips.md) |

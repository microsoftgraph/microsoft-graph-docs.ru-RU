...
Сообщения могут быть в текстовом или HTML-формате.
...
| Получение подсказки (MailTips) о специальном статусе других получателей, например, "отсутствую" (out-of-office) | [user](../resources/user.md), <br> [mailTips](../resources/mailtips.md) | [Получение подсказки (MailTips)](../api/user_getmailtips.md) |

...
|:---------------|:--------|:----------|
|[Get ChartDataLabels](../api/chartdatalabels_get.md) | [WorkbookChartDataLabels](chartdatalabels.md) |Чтение свойств и связей объекта chartDataLabels.|
|[Update](../api/chartdatalabels_update.md) | [WorkbookChartDataLabels](chartdatalabels.md) |Обновление объекта ChartDataLabels. |

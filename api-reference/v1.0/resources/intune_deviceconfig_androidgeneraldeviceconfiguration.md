...
|требуемый пароль|Boolean (логический)|Указывает, обязательно ли использовать пароль.|
...
|securityRequireVerifyApps|Boolean (логический)|Обязательное включение функции Android "Проверка приложений".|

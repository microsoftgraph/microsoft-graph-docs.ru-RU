...
ms.locfileid: "59021724"
---
# <a name="educationassignment-resource-type"></a>тип ресурса educationAssignment

Пространство имен: microsoft.graph

Ресурс **educationAssignment** представляет задачу или единицу работы, назначенную учащемуся или члену группы в классе в рамках их обучения. 

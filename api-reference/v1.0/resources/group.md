...
|isSubscribedByMail|Логическое|Указывает, подписан ли вошедший пользователь на получение бесед по электронной почте. Значение по умолчанию: **true**. <br><br>Возвращается только с помощью оператора $select. |

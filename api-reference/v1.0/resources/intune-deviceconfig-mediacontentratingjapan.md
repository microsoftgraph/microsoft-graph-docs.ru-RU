...
|tvRating|[RatingJapanTelevisionType](../resources/intune-deviceconfig-ratingjapantelevisiontype.md)|Рейтинг телевизора, выбранный для Японии. Возможные значения: `allAllowed`, `allBlocked`, `explicitAllowed`.|

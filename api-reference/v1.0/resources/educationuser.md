...
|relatedContacts|[relatedContact](relatedcontact.md) коллекции|Набор контактов, связанные с пользователем.  Это необязательный свойство должно быть указано в предложении $select и можно получить только для отдельного пользователя.|

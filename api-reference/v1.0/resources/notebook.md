...
|links|[NotebookLinks](notebooklinks.md)|Ссылки для открытия записной книжки. Ссылка `oneNoteClientURL` позволяет открыть записную книжку в собственном клиенте OneNote, если он установлен. Ссылка `oneNoteWebURL` позволяет открыть записную книжку в OneNote Online.|
...
|:---------------|:--------|:----------|
|[Получение записной книжки](../api/notebook_get.md) | [Notebook](notebook.md) |Считывание свойств и связей записной книжки.|
...
|[Создание раздела](../api/notebook_post_sections.md) |[Section](section.md)| Создайте раздел, отправив запрос POST в коллекцию sections в указанной записной книжке.|
|[Перечисление разделов](../api/notebook_list_sections.md) |Коллекция объектов [Section](section.md)| Получение коллекции разделов в указанной записной книжке.|

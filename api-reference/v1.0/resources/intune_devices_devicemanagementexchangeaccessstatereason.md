...
|неизвестный|1|Неизвестная причина состояния доступа|
...
|другой|7|Состояние доступа определяется Exchange|
|соответствующий требованиям|8|Состояние доступа, предоставленное в связи с проблемами соответствия требованиям|

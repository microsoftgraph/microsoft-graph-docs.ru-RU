...
|recipients|bookingReminderRecipients|Лица, которые должны получать напоминание. Возможные значения: `allAttendees`, `staff`, `customer`, `unknownFutureValue`.|

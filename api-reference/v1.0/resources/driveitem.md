...
| description          | Строка                              | Предоставляет видимое пользователю описание элемента. Чтение и запись. Только в личном хранилище OneDrive                                                                                    |
...
| thumbnails         | Коллекция объектов [thumbnailSet](thumbnailset.md) | Коллекция, содержащая объекты [ThumbnailSet](thumbnailSet.md), связанные с элементом. Дополнительные сведения см. в статье о [получении эскизов](../api/thumbnailset_get.md). Только для чтения. Допускает значение null. |

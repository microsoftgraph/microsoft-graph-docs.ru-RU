...
| описание          | Строка             | Предоставляет видимое пользователю описание элемента. Чтение и запись. Только в личном хранилище OneDrive
...
| webUrl               | Строка             | URL-адрес для отображения ресурса в браузере. Только для чтения.
...
| книга           | [workbook][]                | Для файлов, которые являются электронные таблицы Excel получает доступ к API для работы с содержимым электронной книги. Допускается значение null.

...
Дополнительные сведения см. в разделе об [адресации driveItems](/concepts/onedrive-addressing-driveitems.md).
...
| [Добавление разрешений](../api/driveitem-invite.md)            | коллекция объектов [разрешений][] | Отправляет пользователю приглашение к совместному доступу.

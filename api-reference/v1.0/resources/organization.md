...
| businessPhones                      | Коллекция String                                         | Номер телефона для организации. Примечание: Несмотря на то, что это коллекции строк, только один номер можно задать для этого свойства.                                                                                            |

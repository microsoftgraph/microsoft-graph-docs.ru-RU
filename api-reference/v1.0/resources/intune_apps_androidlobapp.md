...
|[Удаление androidLobApp](../api/intune_apps_androidlobapp_delete.md)|Нет|Удаление экземпляра [androidLobApp](../resources/intune_apps_androidlobapp.md).|
...
|versionCode|String (строка)|Код версии бизнес-приложения.|

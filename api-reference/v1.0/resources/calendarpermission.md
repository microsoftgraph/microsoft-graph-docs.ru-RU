...
<span data-ttu-id="b5cb0-171">Ниже указано представление ресурса в формате JSON.</span><span class="sxs-lookup"><span data-stu-id="b5cb0-171">The following is a JSON representation of the resource.</span></span>

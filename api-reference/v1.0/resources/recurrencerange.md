...
|:---------------|:--------|:--------|:--------|:----------|
|Диапазон с датой окончания | `endDate` | Событие повторяется во все дни, входящие в соответствующее расписание повторения, с даты **startDate** и до даты **endDate** включительно. | Повторение события с 1 июня 2017 г. до 15 июня 2017 г. | **type**, **startDate**, **endDate** | 

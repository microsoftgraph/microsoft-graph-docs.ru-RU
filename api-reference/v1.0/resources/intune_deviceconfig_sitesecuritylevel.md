# <a name="sitesecuritylevel-enum-type"></a><span data-ttu-id="99228-101">тип перечисления siteSecurityLevel</span><span class="sxs-lookup"><span data-stu-id="99228-101">siteSecurityLevel enum type</span></span>

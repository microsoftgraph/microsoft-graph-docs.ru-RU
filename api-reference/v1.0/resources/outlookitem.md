...
|changeKey|String (строка)|Определяет версию элемента. При каждом изменении элемента свойство ChangeKey также меняется. Это позволяет программе Exchange применять изменения к правильной версии объекта. Только для чтения.|

...
|scheduledInstallDays|Коллекция [dayOfWeek enum](../resources/intune_deviceconfig_dayofweek.md)|Дни недели, для которых настраивается период активности. Эта коллекция может содержать не более 7 элементов.|

...
Используйте тип [ресурса unifiedRoleManagementPolicyAssignment](unifiedrolemanagementpolicyassignment.md) и связанные с ним методы для получения правил, применимых к каждой Azure AD роли. Затем используйте API [Update unifiedRoleManagementPolicyRule](../api/unifiedrolemanagementpolicyrule-update.md) для обновления правил или параметров по умолчанию, применяемых к политике, назначенной определенной Azure AD роли.

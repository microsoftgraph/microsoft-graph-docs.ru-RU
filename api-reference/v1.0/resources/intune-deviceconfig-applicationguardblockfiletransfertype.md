...
Возможные значения для приложенияGuardBlockFileTransfer

## <a name="members"></a>Элементы
|Элемент|Значение|Описание|
|:---|:---|:---|
|notConfigured|0|Not Configured|
|blockImageAndTextFile|1|Блок буфера обмена для передачи изображения и текстового файла|

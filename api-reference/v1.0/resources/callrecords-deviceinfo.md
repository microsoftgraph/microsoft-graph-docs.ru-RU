...
|:-------------|:------------|:------------|
|captureDeviceDriver|String|Имя драйвера устройства захвата, используемого конечной точкой мультимедиа.|
|captureDeviceName|String|Имя устройства захвата, используемого конечной точкой мультимедиа.|
...
|renderDeviceDriver|String|Имя драйвера устройства визуализации, используемого конечной точкой мультимедиа.|
|renderDeviceName|String|Имя устройства визуализации, используемого конечной точкой мультимедиа.|

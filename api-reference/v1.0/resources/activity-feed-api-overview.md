...
Веб-канал API в Microsoft Graph активности можно использовать для возобновления actiity пользователя между устройствами и платформами. Запросы API веб-канала активности выполняются от имени пользователя с помощью [делегированных разрешений](../../../concepts/permissions_reference.md#delegated-permissions-application-permissions-and-effective-permissions) и [разрешений активности пользователя](../../../concepts/permissions_reference.md), который можно использовать с личных или рабочих и школы учетных записей. 

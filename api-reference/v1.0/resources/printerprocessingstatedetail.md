---
title: тип enum printerProcessingStateDetail
description: Представляет деталь состояния обработки принтера.
author: tomsato-ms
...
ms.locfileid: "59777203"
---
# <a name="printerprocessingstatedetail-enum-type"></a>тип enum printerProcessingStateDetail

Пространство имен: microsoft.graph

Представляет деталь состояния обработки принтера.

`Prefer: include-unknown-enum-members`Включай заготку для явного запроса значений enum за пределами `unknownFutureValue` . Подробные сведения см. [в материале Handling future members in evolvable enumerations.](/graph/best-practices-concept#handling-future-members-in-evolvable-enumerations)
...
|banderMotorFailure|55|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|chamberCooling|111|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.21.|
...
|chamberTemperatureHigh|114|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.21.|
...
|отключено|119|Это стандартное значение атрибута принтера IPP, описанное в RFC3998.|
...
|факсМодеммиссинг|166|Это стандартное значение атрибута принтера IPP, описанное в PWG5107.3.|
...
|hibernate|205|Это стандартное значение атрибута принтера IPP, описанное в PWG5106.4.|
...
|imprinterCoverClosed|214|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|imprinterCoverOpen|215|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|imprinterRecoverableStorage|232|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|imprinterUnderTemperature|240|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|interpreterCartridgeAdded|297|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|interpreterCartridgeDeleted|298|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|makeEnvelopeMotorFailure|327|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|markerTonerCartridgeMissing|363|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|materialNeeded|374|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.21.|
...
|puncherAtLimit|447|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|puncherCoverClosed|450|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|puncherCoverOpen|451|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|puncherRecoverableStorage|468|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|puncherUnderTemperature|476|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|puncherUnrecoverableFailure|477|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|puncherUnrecoverableStorageError|478|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|puncherWarmingUp|479|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|повторное|480|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.22.|
...
|режим ожидания|649|Это стандартное значение атрибута принтера IPP, описанное в PWG5106.4.|
|staplerAdded|650|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerAlmostEmpty|651|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerAlmostFull|652|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerAtLimit|653|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|staplerFull|659|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|staplerJam|662|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerLifeAlmostOver|663|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerLifeOver|664|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerMemoryExhausted|665|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerMissing|666|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerMotorFailure|667|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerNearLimit|668|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|staplerRemoved|675|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerResourceAdded|676|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerResourceRemoved|677|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|staplerThermistorFailure|678|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|staplerTurnedOn|681|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|stitcherConfigurationChange|691|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|stitcherMissing|702|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|stitcherMotorFailure|703|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|stitcherNearLimit|704|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|stitcherOffline|705|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|stitcherOpened|706|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
|stitcherOverTemperature|707|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|stitcherResourceAdded|712|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|stitcherUnrecoverableStorageError|720|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|
...
|приостановка|753|Это стандартное значение атрибута принтера IPP, описанное в PWG5106.4.|
|тестирование|754|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.22.|
...
|wrapperMotorFailure|809|Это стандартное значение атрибута принтера IPP, описанное в PWG5100.9.|

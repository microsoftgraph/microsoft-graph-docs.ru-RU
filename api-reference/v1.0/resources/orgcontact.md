...
|[getMemberGroups](../api/orgcontact-getmembergroups.md)|Коллекция объектов string| Возвращает все группы, в которых входит указанный контакт Организации. |

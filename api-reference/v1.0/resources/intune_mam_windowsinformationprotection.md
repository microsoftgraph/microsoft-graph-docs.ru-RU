...
|assignments|Коллекция объектов [targetedManagedAppPolicyAssignment](../resources/intune_mam_targetedmanagedapppolicyassignment.md)|Свойство навигации для перечисления групп безопасности, к которым применяется политика.|

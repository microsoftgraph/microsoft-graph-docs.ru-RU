...
| **hidden**        | логический              | Указывает, скрыт ли данный тип контента в меню "Создать" в списке.
...
| **order**         | [contentTypeOrder][] | Указывает порядок, в котором тип контента отображается в средстве выбора.

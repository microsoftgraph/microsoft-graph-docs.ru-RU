...
|[Список](../api/nameditem-list.md) | [WorkbookNamedItem](nameditem.md) коллекции |Получение коллекции объектов namedItem. |
...
|type|строка|Указывает, какой тип ссылки связан с именем. Возможные значения: `String`, `Integer`, `Double`, `Boolean`, `Range`. Только для чтения.|

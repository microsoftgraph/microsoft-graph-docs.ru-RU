...
|id|строка| Только для чтения. Идентификатор плана. Длина — 28 символов с учетом регистра. [Проверка формата](planner_identifiers_disclaimer.md) выполняется на службе.|
...
|title|строка|Обязательный. Название плана.|

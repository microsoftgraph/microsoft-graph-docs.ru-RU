# <a name="ratingappstype-enum-type"></a><span data-ttu-id="16f3b-101">Тип перечисления ratingAppsType</span><span class="sxs-lookup"><span data-stu-id="16f3b-101">ratingAppsType enum type</span></span>

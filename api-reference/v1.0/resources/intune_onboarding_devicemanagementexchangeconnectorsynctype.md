...
Тип запрошенной синхронизации соединителя Exchange.
## <a name="members"></a>Элементы
|Элемент|Значение|Описание|
|:---|:---|:---|
|fullSync|0|Обнаружение всех устройств в Exchange.|
|deltaSync|1|Обнаружение только тех устройств в Exchange, которые были обновлены во время окна дельта-синхронизации.|

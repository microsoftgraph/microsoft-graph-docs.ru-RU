...
|[Удаление managedIOSLobApp](../api/intune_apps_managedioslobapp_delete.md)|Нет|Удаление экземпляра [managedIOSLobApp](../resources/intune_apps_managedioslobapp.md).|

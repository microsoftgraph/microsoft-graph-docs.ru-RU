...
|rolePermissions|Коллекция объектов [rolePermission](../resources/intune_rbac_rolepermission.md)|Список разрешений, активированных для роли. Они должны соответствовать перечислению actionName, которое определено как часть объекта rolePermission.|

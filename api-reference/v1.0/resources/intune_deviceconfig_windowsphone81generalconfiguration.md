...
|compliantAppListType|[appListType](../resources/intune_deviceconfig_applisttype.md)|Список, находящийся в AppComplianceList. Возможные значения: `none`, `appsInListCompliant`, `appsNotInListCompliant`.|

...
|происхождение|Строка| Указывает, определяется ли роль приложения [](application.md) в объекте приложения или [объекте servicePrincipal.](serviceprincipal.md) Не _следует_ включать в запросы POST или PATCH. Только для чтения. |

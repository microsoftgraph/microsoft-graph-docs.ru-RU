...
- События по устранению неполадок
...
|**RBAC**|
|[Функция getEffectivePermissions](../api/intune_shared_devicemanagement_geteffectivepermissions.md)|Коллекция [rolePermission](../resources/intune_rbac_rolepermission.md) или коллекция строк|Получает действующие разрешения пользователя, прошедшего в данный момент проверку подлинности|

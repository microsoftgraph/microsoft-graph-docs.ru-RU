...
|[Удаление iosCustomConfiguration](../api/intune_deviceconfig_ioscustomconfiguration_delete.md)|Нет|Удаление экземпляра [iosCustomConfiguration](../resources/intune_deviceconfig_ioscustomconfiguration.md).|

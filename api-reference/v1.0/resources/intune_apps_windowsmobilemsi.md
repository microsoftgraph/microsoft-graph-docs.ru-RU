...
|[Удаление windowsMobileMSI](../api/intune_apps_windowsmobilemsi_delete.md)|None|Удаление экземпляра [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md).|

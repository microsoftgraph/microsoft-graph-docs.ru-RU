...
ms.openlocfilehash: 5d48d1020035d289f13d56a03d8db2c3961282b8
ms.sourcegitcommit: 5516b107d72caef6ec042fe74228be4031b32fa5
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/27/2022
ms.locfileid: "65060795"
---
...
Функции поиска групп позволяют приложению найти любую группу в каталоге организации с помощью запросов для ресурса `/groups` (например, `https://graph.microsoft.com/v1.0/groups`). Эта возможность доступна администраторам и пользователям, которые являются участниками. Однако это недоступно гостевым пользователям.

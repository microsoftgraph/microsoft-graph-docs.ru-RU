...
|[Удаление managedAndroidStoreApp](../api/intune_apps_managedandroidstoreapp_delete.md)|Нет|Удаляет экземпляр [managedAndroidStoreApp](../resources/intune_apps_managedandroidstoreapp.md).|

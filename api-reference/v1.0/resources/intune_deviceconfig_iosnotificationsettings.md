...
|издатель|Строка|Издатель, которого нужно связать со свойством bundleID.|
|включено|Логический|Указывает, разрешены ли уведомления для этого приложения.|
...
|alertType|[iosNotificationAlertType](../resources/intune_deviceconfig_iosnotificationalerttype.md)|Указывает тип оповещения для уведомления для этого приложения. Возможные значения: `deviceDefault`, `banner`, `modal`, `none`.|

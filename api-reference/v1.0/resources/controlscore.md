...
|Имя |Тип |Описание |
|:--|:--|:--|
|контролнаме|Строка|Уникальное имя элемента управления.|
...
|контролкатегори|Строка|Категория действий управления (идентификация, данные, устройство, приложения, инфраструктура).|

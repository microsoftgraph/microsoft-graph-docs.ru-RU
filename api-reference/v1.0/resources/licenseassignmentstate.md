...
Свойство **licenseAssignmentStates** объекта пользователя — [](user.md) это коллекция объектов **licenseAssignmentState**. Он предоставляет сведения о назначениях лицензий пользователю. Сведения включают такие сведения, как:  

...
|[delta](../api/event_delta.md)|Коллекция объектов [event](event.md)|Получение списка событий, которые были добавлены в **calendarView** (диапазон событий) основного календаря пользователя, обновлены в нем или удалены из него.|
...
|onlineMeetingUrl|String|URL-адрес для собрания по сети. Свойство имеет значение только в том случае, когда инициатора задает событие как собрания по сети например Скайп собрания. Только для чтения.|
...
- [Получение добавочных изменений для событий в папке](../../../concepts/delta_query_events.md)

...
| clientState | String | Необязательный. Указывает значение свойства `clientState`, отправляемого службой в каждом уведомлении об изменении. Максимальная длина составляет 128 символов. Клиент может убедиться, что уведомление об изменении пришло от службы, сравнив значение свойства `clientState`, отправленного с подпиской, со значением свойства `clientState`, получаемого с каждым уведомлением об изменении. | Все |

...
Возможные значения путей ресурсов для каждого поддерживаемого ресурса см. в статье [Получение уведомлений об изменениях с помощью API Microsoft Graph](webhooks.md).

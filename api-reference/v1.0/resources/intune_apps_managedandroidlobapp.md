...
|[Удаление managedAndroidLobApp](../api/intune_apps_managedandroidlobapp_delete.md)|None|Удаление экземпляра [managedAndroidLobApp](../resources/intune_apps_managedandroidlobapp.md).|

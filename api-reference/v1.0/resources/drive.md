...
| sharepointIds        | [sharepointIds][]             | Возвращает идентификаторы, упрощающие обеспечение совместимости с SharePoint REST. Только для чтения.                                                                                                                                                         |
| webUrl               | string (url)                  | URL-адрес для отображения ресурса в браузере. Только для чтения.                                                                                                                                                                        |

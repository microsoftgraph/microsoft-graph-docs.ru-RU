...
В случае успешной работы этот метод возвращает код `200 OK` ответа и объект [коллекции ab orgContact](../resources/orgcontact.md) в тексте ответа. Оклик также содержит URL-адрес `nextLink` или `deltaLink`.

...
>**Примечание:** Пользователь, создающий план, должен быть членом группы, которая будет владельцем плана. При создании новой группы с помощью кнопки [Создать группу](../api/group_post_groups.md) пользователь не добавляется в группу в качестве члена. После создания группы добавьте себя в качестве члена с помощью [членов группы с правом записи](../api/group_post_members.md).

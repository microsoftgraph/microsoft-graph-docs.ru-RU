...
Обновление свойств объекта [place,](../resources/place.md) который может быть [помещением или](../resources/room.md) [списком помещений.](../resources/roomlist.md) Вы можете определить помещение **или** **список помещений,** указав **свойство id** или **emailAddress.**
...
В тексте запроса укажите значения для соответствующих полей, которые необходимо обновить. Одновременно можно обновлять только один экземпляр ресурса place **(room** или **roomList).** В теле запроса укажите тип места и включив свойства этого типа для `@odata.type` обновления. Предыдущие значения существующих свойств, не включенных в текст запроса, будут сохранены или вычислены повторно с учетом изменений, внесенных в значения других свойств. Для достижения оптимальной производительности не включайте существующие значения, которые не изменились.

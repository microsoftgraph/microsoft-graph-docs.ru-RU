...
Обновление свойств объекта [user](../resources/intune_shared_user.md).
...
|:---|:---|
|Делегированные (рабочая или учебная учетная запись)| _изменяется в соответствии с контекстом_|
...
В теле запроса добавьте представление объекта [user](../resources/intune_shared_user.md) в формате JSON.

В приведенной ниже таблице указаны свойства, необходимые при создании объекта [user](../resources/intune_shared_user.md).
...
При успешном выполнении этот метод возвращает код отклика `200 OK` и обновленный объект [user](../resources/intune_shared_user.md) в теле отклика.

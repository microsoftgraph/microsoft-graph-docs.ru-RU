...
Следующий пример добавляет несколько заголовков интернет-сообщения клиента при создании черновика сообщения.
<!-- {
  "blockType": "request",
...
```
В тексте запроса укажите представление объекта [message](../resources/message.md) в формате JSON.
##### <a name="response-2"></a>Ответ 2
Ниже приведен пример ответа. Примечание. Заголовки интернет-сообщений по умолчанию не возвращаются в ответе POST. Представленный здесь объект ответа может быть усечен для краткости. При фактическом вызове будут возвращены все свойства.
<!-- {
  "blockType": "response",
  "name": "create_message_with_headers_from_user",
  "truncated": true,

...
Обновление свойств объекта chartlegend.
...
В случае успеха этот метод возвращает код отклика `200 OK` и обновленный объект [WorkbookChartLegend](../resources/chartlegend.md) в тексте отклика.

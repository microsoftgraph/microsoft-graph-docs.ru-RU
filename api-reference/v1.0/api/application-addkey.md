...
Добавьте учетные данные ключа в [приложение.](../resources/application.md) Этот метод, а также [removeKey](application-removekey.md) может использоваться приложением для автоматизации перетаскивания ключей окончания срока действия.

> [!NOTE]
> [Операции](../api/application-post-applications.md) создания [приложений](../api/application-update.md) и обновления приложений можно продолжать использовать для добавления и обновления учетных данных ключей для любого приложения с контекстом пользователя или без него.

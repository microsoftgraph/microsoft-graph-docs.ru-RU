...
Отчет об участниках трансляций Teams — это артефакт собрания по сети. Дополнительные сведения см. в [разделе "Артефакты и разрешения](/graph/cloud-communications-online-meeting-artifacts) собрания по сети".
...
- Если вы извлекаете отчет участника о трансляции [Teams](/microsoftteams/teams-live-events/what-are-teams-live-events), этот метод возвращает заголовок, `Location` указывающий URI для отчета участника.

...
<!-- { "blockType": "ignored" } --> Вложения для публикации ([post](../resources/post.md)) в цепочке ([thread](../resources/conversationthread.md)) беседы ([conversation](../resources/conversation.md)) в группе.
```http

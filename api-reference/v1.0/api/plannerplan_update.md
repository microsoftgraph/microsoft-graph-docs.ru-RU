...
|:---------------|:--------|:----------|
|owner|Строка|Идентификатор `id` [группы](../resources/group.md), которой принадлежит план. Чтобы в этом поле можно было указать значение, должна существовать подходящая группа. После задания значения его сможет обновить только владелец.|

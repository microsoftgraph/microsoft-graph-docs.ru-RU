...
description: Запустите процесс применения удержания к хранителям обнаружения электронных данных.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: a7a40b59d914b1de77f9ae48a89d4aa33bf29bf1
...
### <a name="example-1-apply-hold-to-multiple-custodians"></a>Пример 1. Применение удержания к нескольким хранителям
...
### <a name="example-2-apply-hold-to-a-single-custodian"></a>Пример 2. Применение удержания к одному хранителям
#### <a name="request"></a>Запрос
Ниже приведен пример запроса.
<!-- {
  "blockType": "request",

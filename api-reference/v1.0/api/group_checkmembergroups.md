...
> **Примечание:** в настоящее время для вызова этого API требуется разрешение `Directory.Read.All` или выше. При использовании разрешения `Gorup.Read.All` будет возвращена ошибка. Мы знаем об этой проблеме.

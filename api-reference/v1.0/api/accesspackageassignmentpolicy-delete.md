...
В [Azure AD управления правами](../resources/entitlementmanagement-overview.md) удалите [accessPackageAssignmentPolicy](../resources/accesspackageassignmentpolicy.md).

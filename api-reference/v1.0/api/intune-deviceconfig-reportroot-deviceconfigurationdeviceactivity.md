...
ms.openlocfilehash: 5035377d679c3a43baa228b86645704f8d8dc908
...
В случае успешного выполнения эта функция возвращает код отклика `200 OK` и объект [report](../resources/intune-deviceconfig-report.md) в тексте отклика.

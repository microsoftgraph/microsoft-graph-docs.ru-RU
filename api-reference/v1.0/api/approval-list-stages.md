---
title: Этапы списка
description: Этапы утверждения списка, связанные с объектом утверждения.
...
ms.locfileid: "63516021"
---
# <a name="list-stages"></a>Этапы списка

Пространство имен: microsoft.graph

В [управлении правами Azure AD](../resources/entitlementmanagement-overview.md) перечислите [объекты approvalStage](../resources/approvalstage.md) , связанные с объектом [утверждения](../resources/approval.md) . Этот вызов может быть выполнен одобрением, предоставляя идентификатор запроса на назначение [пакета доступа](../resources/accesspackageassignmentrequest.md).
...
В случае успешной работы этот метод возвращает код `200 OK` ответа и коллекцию объектов [approvalStage](../resources/approvalstage.md) в тексте ответа. Если у вызываемого нет нужных разрешений, метод возвращает код `403 Forbidden` ответа.

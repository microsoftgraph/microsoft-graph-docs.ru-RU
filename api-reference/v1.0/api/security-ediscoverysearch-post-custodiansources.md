...
description: Создайте новый источник хранителя, связанный с поиском обнаружения электронных данных.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: 6ae64ad0a58307bc749656310beba9bb5e629b39
...
|:---|:---|:---|
|@odata.id|String|Строка, определяющее объект хранителя. См [. следующий](#examples) пример.|

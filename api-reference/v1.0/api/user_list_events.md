...
Например, ваше приложение получило делегированные разрешения от пользователя John. Предположим, что другой пользователь (Garth) поделился своим календарем с пользователем John. Вы можете получить события из этого общего календаря, указав идентификатор пользователя (или имя участника-пользователя) пользователя Garth в показанном ниже примере запроса.
...
- общих папок контактов;
- общих календарей;
- контактов и событий в общих папках;
- указанных выше ресурсов в делегированных почтовых ящиках.

Эта возможность недоступна в других операциях для контактов, событий и их папок.

...
Существует два сценария, в которых приложения могут получать события в календаре другого пользователя:

* Если приложение имеет разрешения приложения, или,
* Если приложение имеет соответствующие делегированные [разрешения](#permissions) от одного пользователя и другой пользователь  поделился календарем с этим пользователем или предоставил делегированный доступ к этому пользователю. См.[сведения и примеры](../../../concepts/outlook-get-shared-events-calendars.md).

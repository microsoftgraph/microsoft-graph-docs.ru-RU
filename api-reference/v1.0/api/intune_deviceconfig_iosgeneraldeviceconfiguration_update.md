...
|kioskModeBuiltInAppId|String|Идентификатор встроенного приложения для использования в режиме киоска. Используется, когда свойства KioskModeManagedAppId и KioskModeAppStoreUrl не заданы.|

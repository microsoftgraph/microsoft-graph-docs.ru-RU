...
author: psignoret
ms.openlocfilehash: 4d55c8ec1ed331e82a6cdc8a766d637da9135eeb
ms.sourcegitcommit: a16b765507093d892022603d521c0ae8043de432
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/20/2022
ms.locfileid: "62124633"
---
...
В этом примере запрашиваемой политикой является встроенная политика предоставления разрешений, которая включает делегирование разрешений, классифицированных с низким уровнем, для приложений от проверенных издателей или приложений, зарегистрированных в `microsoft-user-default-low` этом клиенте.

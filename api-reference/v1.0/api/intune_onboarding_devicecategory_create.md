...
Создание объекта [deviceCategory](../resources/intune_onboarding_devicecategory.md).
...
В случае успешного выполнения этот метод возвращает код отклика `201 Created` и объект [deviceCategory](../resources/intune_onboarding_devicecategory.md) в теле отклика.

...
Получение свойств и связей объекта tablerow.
...
В случае успешной работы этот метод возвращает код отклика и объект `200 OK` [WorkbookTableRow](../resources/tablerow.md) в тексте ответа.

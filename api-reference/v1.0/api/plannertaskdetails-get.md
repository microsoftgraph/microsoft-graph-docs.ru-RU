...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и объект [plannerTaskDetails](../resources/plannertaskdetails.md) в теле отклика.

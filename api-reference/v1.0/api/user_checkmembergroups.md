...
> **Примечание:** в настоящее время для вызова этого API требуется разрешение `Directory.Read.All` или выше. При использовании разрешений `User.Read.All` или `User.ReadWrite.All` будет возвращена ошибка. Мы знаем об этой проблеме.
...
| :-------- | :---------------- | :-------------------- |
| groupIds  | String collection (коллекция строк) | Массив идентификаторов групп |

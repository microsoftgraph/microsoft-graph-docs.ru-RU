...
>**Примечание.** В настоящее время для работы с этим API требуется разрешение Directory.Read.All или выше. При использовании разрешения User.Read.All или User.ReadWrite.All возникает ошибка. Мы знаем об этой проблеме.

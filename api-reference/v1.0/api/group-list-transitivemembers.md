...
description: Получение списка участников группы. В качестве участников группы могут быть пользователи, устройства, контакты организации и другие группы. Эта операция является транзитивной и возвращает плоский список всех вложенных элементов.
author: psaffaie
ms.localizationpriority: medium
ms.prod: groups
doc_type: apiPageType
ms.openlocfilehash: 02fe0045fcc5dbb9c8654474d4f45b14fdb61800
ms.sourcegitcommit: b2b3c3ae00f9e2e0bb2dcff30e97b60ccdebf170
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/29/2022
ms.locfileid: "66442311"
---
# <a name="list-group-transitive-members"></a>Перечисление транзитивных участников группы

Пространство имен: microsoft.graph

Получение списка участников группы. В качестве участников группы могут быть пользователи, устройства, контакты организации и другие группы. Эта операция является транзитивной и возвращает плоский список всех вложенных элементов.
...
> **Примечание:** Чтобы получить список членов скрытой группы членства, требуется разрешение _Member.Read.Hidden_ .
...
Чтобы отфильтровать результаты по типу OData, `microsoft.graph.user` `microsoft.graph.group`например или, необходимо использовать [расширенные параметры запроса](/graph/aad-advanced-queries). То есть заголовок **ConsistencyLevel** имеет значение и `eventual` строку `$count=true` запроса.
...
### <a name="example-2-get-only-a-count-of-transitive-membership"></a>Пример 2. Получение только количества транзитивного членства
...
### <a name="example-3-use-the-microsoftgraphgroup-odata-cast-to-get-only-members-that-are-groups"></a>Пример 3. Использование приведения OData microsoft.graph.group для получения только членов, которые являются группами
...
### <a name="example-4-use-odata-cast-and-search-to-get-membership-in-groups-with-display-names-that-contain-the-letters-tier-including-a-count-of-returned-objects"></a>Пример 4. Использование приведения и $search OData для получения членства в группах с отображаемыми именами, содержащим буквы "уровень", включая количество возвращаемых объектов
...
### <a name="example-5-use-odata-cast-and-filter-to-get-user-membership-in-groups-with-a-display-name-that-starts-with-a-including-a-count-of-returned-objects"></a>Пример 5. Использование приведения и $filter OData для получения членства пользователей в группах с отображаемого имени, которое начинается с "A", включая количество возвращаемых объектов

...
description: Получение списка объектов ediscoveryIndexOperations, связанных с ediscoveryCustodian.
author: SeunginLyu
...
Получение списка объектов [ediscoveryIndexOperations](../resources/security-ediscoveryindexoperation.md) , связанных с [ediscoveryCustodian](../resources/security-ediscoverycustodian.md).

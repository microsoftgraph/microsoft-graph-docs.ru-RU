...
Создайте новый объект [vppToken](../resources/intune_onboarding_vpptoken.md).
...
|state|[vppTokenState](../resources/intune_onboarding_vpptokenstate.md)|Текущее состояние маркера Apple Volume Purchase Program. Возможные значения: `unknown`, `valid`, `expired`, `invalid`, `assignedToExternalMDM`. Возможные значения: `unknown`, `valid`, `expired`, `invalid`, `assignedToExternalMDM`.|
...
В случае успешного выполнения данный метод возвращает`201 Created` код отклика и объект [vppToken](../resources/intune_onboarding_vpptoken.md) в форме для обратной связи.

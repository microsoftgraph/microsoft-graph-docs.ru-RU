...
Создание объекта [onenoteSection](../resources/section.md) в указанной группе разделов.
...
В случае успеха этот метод возвращает код отклика `201 Created` и объект [onenoteSection](../resources/section.md) в теле отклика.

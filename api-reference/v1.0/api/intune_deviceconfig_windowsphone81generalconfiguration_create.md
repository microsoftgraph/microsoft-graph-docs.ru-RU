...
|compliantAppListType|[appListType](../resources/intune_deviceconfig_applisttype.md)|Список, указанный в списке AppComplianceList. Возможные значения: `none`, `appsInListCompliant`, `appsNotInListCompliant`.|

...
|:---------------|:--------|:----------|
|orderHintsByAssignee|[plannerOrderHintsByAssignee](..\resources\plannerOrderHintsByAssignee.md)|Словарь указаний, используемых для расположения задач в окне "Кому назначено" доски задач. Ключ каждой записи — один из пользователей, которому назначена задача, а значение — указание order. Формат значений определяется, как описано [здесь](../resources/planner_order_hint_format.md).|

...
Поддерживаемые размеры фотографий в формате HD для Office 365: 48x48, 64x64, 96x96, 120x120, 240x240, 360x360, 432x432, 504x504 и 648x648. Фотографии могут быть любого размера, если они хранятся в Azure Active Directory.
...
### <a name="get-the-photo"></a>Получить фотографию
<!-- { "blockType": "ignored" } -->
```http
GET /me/photo/$value
...
### <a name="get-the-metadata-for-a-specific-photo-size"></a>Получить метаданные для фотографии определенного размера
<!-- { "blockType": "ignored" } -->
```http
GET /me/photos/{size}
...
|:-----|:-----|:-----|
|size  |String  | Размер фотографии. Поддерживаемые размеры фотографий в формате HD для Office 365: 48x48, 64x64, 96x96, 120x120, 240x240, 360x360, 432x432, 504x504 и 648x648. Фотографии могут быть любого размера, если они хранятся в Azure Active Directory. |

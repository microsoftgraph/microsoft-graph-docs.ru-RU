...
ms.locfileid: "27880418"
---
# <a name="delete-managedebookassignment"></a><span data-ttu-id="7c269-103">Удаление объекта managedEBookAssignment</span><span class="sxs-lookup"><span data-stu-id="7c269-103">Delete managedEBookAssignment</span></span>
...
<span data-ttu-id="7c269-105">Удаляет объект [managedEBookAssignment](../resources/intune-books-managedebookassignment.md).</span><span class="sxs-lookup"><span data-stu-id="7c269-105">Deletes a [managedEBookAssignment](../resources/intune-books-managedebookassignment.md).</span></span>
## <a name="prerequisites"></a><span data-ttu-id="7c269-106">Необходимые компоненты</span><span class="sxs-lookup"><span data-stu-id="7c269-106">Prerequisites</span></span>
...
|:---|:---|
|<span data-ttu-id="7c269-111">Делегированные (рабочая или учебная учетная запись)</span><span class="sxs-lookup"><span data-stu-id="7c269-111">Delegated (work or school account)</span></span>|<span data-ttu-id="7c269-112">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="7c269-112">DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="7c269-126">Не указывайте тело запроса для этого метода.</span><span class="sxs-lookup"><span data-stu-id="7c269-126">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="7c269-127">Ответ</span><span class="sxs-lookup"><span data-stu-id="7c269-127">Response</span></span>
<span data-ttu-id="7c269-128">В случае успешного выполнения этот метод возвращает код отклика `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="7c269-128">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="7c269-129">Пример</span><span class="sxs-lookup"><span data-stu-id="7c269-129">Example</span></span>
### <a name="request"></a><span data-ttu-id="7c269-130">Запрос</span><span class="sxs-lookup"><span data-stu-id="7c269-130">Request</span></span>
<span data-ttu-id="7c269-131">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="7c269-131">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="7c269-132">Ответ</span><span class="sxs-lookup"><span data-stu-id="7c269-132">Response</span></span>
<span data-ttu-id="7c269-p102">Ниже приведен пример ответа. Примечание. Объект ответа, показанный здесь, может быть усечен для краткости. Все свойства будут возвращены при фактическом вызове.</span><span class="sxs-lookup"><span data-stu-id="7c269-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http

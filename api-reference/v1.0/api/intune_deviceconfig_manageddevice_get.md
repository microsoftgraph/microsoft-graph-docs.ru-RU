...
Чтение свойств и связей объекта [managedDevice](../resources/intune_deviceconfig_manageddevice.md).
...
В случае успешного выполнения этот метод возвращает код ответа `200 OK` и объект [managedDevice](../resources/intune_deviceconfig_manageddevice.md) в теле ответа.

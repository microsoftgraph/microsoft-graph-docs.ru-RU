...
<span data-ttu-id="411a7-179">Ниже приведен пример запроса.</span><span class="sxs-lookup"><span data-stu-id="411a7-179">Here is an example of the request.</span></span>
``` http

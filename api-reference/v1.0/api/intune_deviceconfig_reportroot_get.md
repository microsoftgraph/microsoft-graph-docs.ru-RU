...
Чтение свойств и связей объекта [reportRoot](../resources/intune_deviceconfig_reportroot.md).
...
В случае успешного выполнения этот метод возвращает код ответа `200 OK` и объект [reportRoot](../resources/intune_deviceconfig_reportroot.md) в теле ответа.

...
ms.openlocfilehash: 89d04c14ab0c6e8bbd2201545d2e369421798343
...
Пространство имен: microsoft.graph Получает список пользователей или групп, которые находятся в списке отклоненных отправителей для этой группы.

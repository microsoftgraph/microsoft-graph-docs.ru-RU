...
| Content-Type | string (строка)  | Характер данных в теле объекта. Обязательный. |
...
|:---------------|:--------|:----------|
|classifyAs|string (строка)| Указывает, как должны классифицироваться все входящие сообщения от определенного отправителя. Возможные значения: `focused`, `other`.|

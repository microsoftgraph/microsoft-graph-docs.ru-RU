...
ms.locfileid: "59016647"
---
# <a name="educationsubmission-return"></a>educationSubmission: возврат

Пространство имен: microsoft.graph

Предоставление учащемуся оценки и отзывов, связанных с этим представлением. 

Это действие меняет состояние отправки с "отправленной" на "возвращенную" и указывает, что отзывы предоставлены или сделана классификация. Это действие может сделать только учитель.

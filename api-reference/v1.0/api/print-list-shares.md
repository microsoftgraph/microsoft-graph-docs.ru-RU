...
description: Получение списка общих папок принтера.
author: braedenp-msft
ms.localizationpriority: medium
ms.prod: cloud-printing
doc_type: apiPageType
ms.openlocfilehash: 3aba801dfd7eb5bfc285606ec347edc6831360be
ms.sourcegitcommit: af7a33e92d0e84e6108dd5d9466f869061ac0c97
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 07/19/2022
ms.locfileid: "66856248"
---
# <a name="list-shares"></a>Перечисление общих ресурсов
Пространство имен: microsoft.graph

Получение списка **printerShares**.
...
> **Примечание:** Использование $top=n запроса **возвращается в общие папки**`n`. Вызывающий объект должен использовать токен пропуска для перечисления всего списка.
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика и коллекцию объектов [printerShare](../resources/printershare.md) в тексте отклика.

>**Примечание**. Ответ не будет содержать свойства **по** умолчанию **или возможности.** 

> В следующих сценариях ответ будет содержать ограниченный набор свойств (id,displayName,manufacturer,model,location):
>  - Вывод списка общих папок принтера от имени пользователя, который не является [администратором принтера](/azure/active-directory/users-groups-roles/directory-assign-admin-roles#printer-administrator).
>  - Фильтрация общих папок принтера на основе или `capabilities` `location`.

Дополнительные свойства можно получить с помощью запроса [Get printerShare](printershare-get.md) .

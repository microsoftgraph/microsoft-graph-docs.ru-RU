...
ms.openlocfilehash: 1fce8c5daa8a7713b0eb050a8958db82ed2c93ac
...
Создание объекта [user](../resources/intune-mam-user.md).
...
При успешном выполнении этот метод возвращает код отклика `201 Created` и объект [user](../resources/intune-mam-user.md) в теле отклика.

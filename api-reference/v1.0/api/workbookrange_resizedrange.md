...
|deltaColumns|Int32|Количество столбцов, на которое будет расширен нижний правый угол, относительно текущего диапазона. Используйте положительное число, чтобы расширить диапазон, или отрицательное значение, чтобы его уменьшить.|

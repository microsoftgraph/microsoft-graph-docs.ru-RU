...
Создание объекта [user](../resources/intune-onboarding-user.md).
...
При успешном выполнении этот метод возвращает код отклика `201 Created` и объект [user](../resources/intune-onboarding-user.md) в теле отклика.

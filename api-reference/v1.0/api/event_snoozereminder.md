...
Указание другого времени для откладывания напоминания.
...
В случае успешного выполнения этот метод возвращает код отклика `200 OK`. В теле отклика не возвращается никаких данных.

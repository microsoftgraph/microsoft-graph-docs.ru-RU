...
>**Примечание**. Ответ не будет содержать свойства defaults и capabilities. Эти свойства можно запросить с помощью запроса ["Получить принтер](printer-get.md) ".

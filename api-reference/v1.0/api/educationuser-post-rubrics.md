...
### <a name="example-1-post-a-credit-rubric"></a>Пример 1. Публикация кредитной рубрики
...
### <a name="example-2-post-a-points-rubric"></a>Пример 2. Публикация рубрики точки

...
description: Получите коллекцию столбцов на сайте.
...
ms.locfileid: "60729593"
---
# <a name="list-columns-in-a-site"></a>Список столбцов на сайте
Пространство имен: microsoft.graph


Получите коллекцию столбцов, представленных в [качестве columnDefinition][columnDefinition] resources in a [site.][site]

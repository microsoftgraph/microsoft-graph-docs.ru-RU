...
> **Примечание**: данных в удаленные каналы будут храниться в течение нескольких недель разрешить владельцем группы для восстановления удаленных канала. В это время новый канал с одной displayName может быть создан.

...
В следующем примере субъекту назначается роль администратора приложений в области приложения. Идентификатор объекта регистрации приложения — 661e1310-bd76-4795-89a7-8f3c8f855bfc.

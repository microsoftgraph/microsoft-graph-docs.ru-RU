...
ms.openlocfilehash: 4b8ae5f7e40101a21ee5e865d635a9fff2b70d3d
ms.sourcegitcommit: 25acfa7d0153336c9a35d30a1dd422aeadc1342c
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/03/2022
ms.locfileid: "62344209"
---
# <a name="notebook-copynotebook"></a>блокнот: copyNotebook

Пространство имен: microsoft.graph копирует записную книжку в папку Блокноты в библиотеке документов назначения. Папка создается, если ее нет.

...
### <a name="example-5-create-a-one-on-one-chat-with-a-federated-user-outside-of-own-organization"></a>Пример 5. Создание чата "один к одному" с федеративным пользователем (за пределами организации)

...
Получение свойств и связей объекта tablesort.
...
Успешно завершена, этот метод возвращает `200 OK` код ответа и объект [WorkbookTableSort](../resources/tablesort.md) в теле ответа.

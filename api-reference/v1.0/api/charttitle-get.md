...
Получение свойств и связей объекта charttitle.
...
В случае успешной работы этот метод возвращает код отклика и объект `200 OK` [WorkbookChartTitle](../resources/charttitle.md) в тексте ответа.

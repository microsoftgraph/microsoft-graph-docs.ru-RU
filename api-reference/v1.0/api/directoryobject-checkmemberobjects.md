...
ms.openlocfilehash: 392d875aa71305336d17ea0a81e1c1fd6ede6b38
ms.sourcegitcommit: 0e7927f34b7e55d323acbf281e11560cb40a89ed
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2022
ms.locfileid: "63668383"
---
...
|:-------------|:------------|:------------|
|ids|Коллекция String|Коллекция, которая содержит объектные ID групп, административные единицы, роли каталога или roleTemplate ID ролей каталога, в которых необходимо проверить членство. Можно указать до 20 объектов.|

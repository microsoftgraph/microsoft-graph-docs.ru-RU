...
description: Создайте, обновите или удалите приложения без выполнения полного чтения всей коллекции ресурсов.
...
ms.locfileid: "65246456"
---
# <a name="application-delta"></a>application: delta

Пространство имен: microsoft.graph

Создавайте, обновляйте или удаляйте приложения без необходимости чтения всей коллекции ресурсов. Дополнительные сведения см. в [разделе "Использование разностного запроса"](/graph/delta-query-overview).
...
Чтобы начать отслеживание изменений, выполните запрос, включая функцию delta в **ресурсе** приложения. 
...
В случае успешного выполнения этот метод возвращает код `200 OK` отклика [и объект коллекции](../resources/application.md) приложений в тексте отклика. Отклик также содержит URL-адрес `@odata.nextLink` или `@odata.deltaLink`.

...
См. следующее:</br>
- [Использование запросов изменений](../../../concepts/delta_query_overview.md) (дополнительные сведения)</br>
- [Получение добавочных изменений для групп](../../../concepts/delta_query_groups.md) (более подробный обзор)</br>
...
>
> Обратите внимание на наличие свойства *members@delta*, которое включает в себя идентификаторы объектов членов группы.
...
- [Использование запросов изменений](../../../concepts/delta_query_overview.md) (дополнительные сведения)
- [Получение добавочных изменений для групп](../../../concepts/delta_query_groups.md) (более подробный обзор)

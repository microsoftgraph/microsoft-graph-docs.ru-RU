...
Извлечение списка внутренних спонсоров [connectedOrganization.](../resources/connectedorganization.md)  Внутренние [спонсоры](../resources/internalsponsors.md) — это набор пользователей, которые могут утверждать запросы от имени других пользователей из этой связанной организации.

...
Чтение свойств и связей объекта [androidForWorkSettings](../resources/intune_androidforwork_androidforworksettings.md).
...
В случае успешного выполнения этот метод возвращает код ответа `200 OK` и объект [androidForWorkSettings](../resources/intune_androidforwork_androidforworksettings.md) в теле ответа.

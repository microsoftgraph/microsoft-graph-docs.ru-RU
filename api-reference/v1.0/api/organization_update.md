...
|objectType|Строка|Строка, которая определяет тип объекта. Для клиентов всегда задается значение Company. Наследуется от [directoryObject](../resources/directoryobject.md).|
|postalCode|String|            |

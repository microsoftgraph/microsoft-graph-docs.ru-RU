...
description: Извлечение списка объектов onenoteSection из указанной группы разделов.
ms.localizationpriority: medium
author: jewan-microsoft
ms.prod: onenote
doc_type: apiPageType
ms.openlocfilehash: 863a119f569f4318af88f27d2647601eee060cba
ms.sourcegitcommit: a16b765507093d892022603d521c0ae8043de432
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/20/2022
ms.locfileid: "62088159"
---
# <a name="list-sections"></a>Вывод списка разделов

Пространство имен: microsoft.graph

Извлечение списка [объектов onenoteSection](../resources/section.md) из указанной группы разделов.
...
В случае успешной работы этот метод возвращает код ответа и коллекцию объектов `200 OK` [onenoteSection](../resources/section.md) в теле ответа.

...
Для применения этого API требуется одна из таких **областей**: *User.Read* или *User.ReadBasic.All* и *Group.Read.All*; *Directory.Read.All; Directory.ReadWrite.All; Directory.AccessAsUser.All*.

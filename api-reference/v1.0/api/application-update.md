...
В случае успешной работы этот метод возвращает код `204 No Content` ответа и ничего не возвращает в тексте ответа.

...
Создание объекта [user](../resources/intune_devices_user.md).
...
При успешном выполнении этот метод возвращает код отклика `201 Created` и объект [user](../resources/intune_devices_user.md) в теле отклика.

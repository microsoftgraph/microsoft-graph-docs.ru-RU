...
ms.locfileid: "59016815"
---
# <a name="call-unmute"></a>вызов: не игнорировать

Пространство имен: microsoft.graph

Разрешить приложению отметь себя.
...
##### <a name="notification---roster-updated-with-participant-unmuted"></a>Уведомление — список обновляется с помощью ненагрузки участника
<!-- {
  "blockType": "example",

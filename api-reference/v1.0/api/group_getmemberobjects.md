...
Для применения этого API требуется одна из таких **областей**: Для применения этого API требуется одна из таких **областей**: *Directory.Read.All; Directory.ReadWrite.All; Directory.AccessAsUser.All*.

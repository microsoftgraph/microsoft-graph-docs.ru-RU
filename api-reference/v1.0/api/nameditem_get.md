...
Получение свойств и связей объекта nameditem.
...
В случае успеха этот метод возвращает код отклика `200 OK` и объект [WorkbookNamedItem](../resources/nameditem.md) в теле отклика.

...
>**Примечание:** Номера с пометкой "Скрытые от GAL" не могут быть извлечены с помощью этой конечной точки.
...
В случае успешной работы этот метод возвращает код `200 OK` ответа и коллекцию объектов-мест в тексте отклика.[](../resources/place.md)

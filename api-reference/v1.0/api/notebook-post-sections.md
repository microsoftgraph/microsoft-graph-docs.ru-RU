...
description: Создайте новую onenoteSection в указанной записной книжке.
author: jewan-microsoft
ms.localizationpriority: medium
ms.prod: onenote
doc_type: apiPageType
ms.openlocfilehash: f04bd7aaab7161637c739dd1542bb8ca97de83ed
ms.sourcegitcommit: a6cbea0e45d2e84b867b59b43ba6da86b54495a3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/16/2021
ms.locfileid: "61023323"
---
# <a name="create-section"></a>Создание раздела

Пространство имен: microsoft.graph

Создайте новую [onenoteSection](../resources/section.md) в указанной записной книжке.

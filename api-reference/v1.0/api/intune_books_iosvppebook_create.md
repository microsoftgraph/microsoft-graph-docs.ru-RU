# <a name="create-iosvppebook"></a>Создание iosVppEBook
...
|издатель|Строка|Издатель. Наследуется от [managedEBook](../resources/intune_books_managedebook.md).|

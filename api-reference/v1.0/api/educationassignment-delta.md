...
description: Получение списка только что созданных или обновленных назначений без необходимости выполнять полное чтение коллекции.
author: cristobal-buenrostro
ms.localizationpriority: medium
ms.prod: education
doc_type: apiPageType
ms.openlocfilehash: 830adf307813ab54b928de6dafe6831f2f89c136
ms.sourcegitcommit: 1d9193fa91f44d80ecdc2b82e37272df1c9630f6
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 05/22/2022
ms.locfileid: "65629455"
---
# <a name="educationassignment-delta"></a>educationAssignment: delta
Пространство имен: microsoft.graph

Получение списка только что созданных или обновленных [назначений](../resources/educationassignment.md) без необходимости выполнять полное чтение коллекции.

Преподаватель или приложение, работающее с разрешениями приложения, может просматривать все **объекты** задания для класса. Учащиеся могут видеть **только назначенные** им задания.
...
В случае успешного выполнения эта функция возвращает код `200 OK` отклика и коллекцию [educationAssignment](../resources/educationassignment.md) в тексте отклика.

## <a name="examples"></a>Примеры

### <a name="example-1-get-assignments-with-delta-query-support"></a>Пример 1. Получение назначений с поддержкой разностных запросов

#### <a name="request"></a>Запрос

Ниже приведен пример запроса.

Используйте параметр `$top` , чтобы указать количество возвращаемых назначений. Параметр является необязательным. Используйте его при наличии длинного списка назначений. в противном случае вы получите все назначения в классе.
...
>**Примечание:** Воспользуйтесь ответом `@odata.nextLink` , чтобы выполнить другой вызов и получить следующий набор назначений.
...
### <a name="example-2-get-next-set-of-assignments-with-delta-query-support"></a>Пример 2. Получение следующего набора назначений с поддержкой разностных запросов
...
>**Примечание:** Необходимо продолжать использовать значение для `@odata.nextLink` последующих вызовов, пока не получите `@odata.deltaLink` свойство в ответе.
...
### <a name="example-3-get-the-created-and-modified-assignments-using-delta-token"></a>Пример 3. Получение созданных и измененных назначений с помощью разностного маркера
...
>**Примечание:** Необходимо продолжать использовать эту функцию `@odata.deltaLink` , чтобы получить только что созданные или измененные назначения с момента первоначального разностного вызова.

>**Примечание:** Разностный ответ может быть большим, в этом случае `@odata.nextLink` возвращается ответ. Продолжайте получать изменения, пока не достигнете еще `@odata.deltaLink` раз.

...
description: Получение списка объектов ediscoveryNoncustodialDataSource.
author: SeunginLyu
ms.localizationpriority: medium
ms.prod: ediscovery
doc_type: apiPageType
ms.openlocfilehash: 62f876c812e2355c8fa22d1057ad0667c59824b6
...
---
# <a name="list-ediscoverynoncustodialdatasources"></a>List ediscoveryNoncustodialDataSources
Пространство имен: microsoft.graph.security



Получение списка источников данных [, которые не являются хранителями](../resources/security-ediscoverynoncustodialdatasource.md) , и их свойств.

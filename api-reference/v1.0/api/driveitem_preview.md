...
|   Имя      |  Тип         | Описание
|:------------|:--------------|:-----------------------------------------------
| page        | Строка или номер | Необязательно указывать. Номер документа для запуска, если это возможно. Указан как строка для использования в будущем случаев вокруг типов файлов, например ZIP.
| zoom        | number        | Необязательно указывать. Выбор масштаба для запуска, если это возможно.

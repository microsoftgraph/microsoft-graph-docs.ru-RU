---
title: Перечисление roleEligibilityScheduleRequests
description: В PIM получите запросы о допустимости ролей для субъектов, выполненных с помощью объекта unifiedRoleEligibilityScheduleRequest.
author: rkarim-ms
ms.localizationpriority: medium
ms.prod: governance
doc_type: apiPageType
ms.openlocfilehash: f1fa890d0aa6a5690ae0f1e4801cb73a4879b334
...
---
# <a name="list-roleeligibilityschedulerequests"></a>Перечисление roleEligibilityScheduleRequests
Пространство имен: microsoft.graph

В PIM получите запросы о допустимости ролей для субъектов, выполненных с помощью объекта unifiedRoleEligibilityScheduleRequest.
...
В случае успешного выполнения `200 OK` этот метод возвращает код отклика и коллекцию объектов [unifiedRoleEligibilityScheduleRequest](../resources/unifiedroleeligibilityschedulerequest.md) в теле отклика.

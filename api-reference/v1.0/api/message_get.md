...
В следующем примере используются `$select` параметр для получения заголовков сообщений Интернета сообщения запроса. 
<!-- {
  "blockType": "request",
...
Ниже приведен пример отклика. Примечание: Набор заголовков сообщений в объекте ответа усекается для краткости. Все заголовки будут возвращены из фактический вызов.
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.message"

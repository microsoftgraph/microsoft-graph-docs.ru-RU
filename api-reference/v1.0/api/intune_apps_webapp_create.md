...
Создание объекта [webApp](../resources/intune_apps_webapp.md).
...
|useManagedBrowser|Boolean|Определяет, нужно ли использовать Managed Browser. Это свойство применимо только к Android и iOS.|



## <a name="response"></a>Ответ
В случае успешного выполнения этот метод возвращает код ответа `201 Created` и объект [webApp](../resources/intune_apps_webapp.md) в теле ответа.

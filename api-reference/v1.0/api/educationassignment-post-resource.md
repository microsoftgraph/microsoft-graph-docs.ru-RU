...
Создание ресурса [назначения.](../resources/educationassignmentresource.md) 

Каждый ресурс имеет свойство @odata.type, чтобы указать, какой тип ресурса создается. 

[!IMPORTANT] 
Upload файлообъемный ресурс для назначений `resourcesFolder` перед созданием ресурса. 

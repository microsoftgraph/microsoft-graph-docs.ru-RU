...
Используется `$select` для получения свойств **определенного** места.
...
В случае успеха этот метод возвращает код отклика и объект `200 OK` запрашиваемого места в тексте отклика. [](../resources/place.md)

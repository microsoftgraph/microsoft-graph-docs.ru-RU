...
Чтение свойств и связей объекта [user](../resources/intune_devices_user.md).
...
В случае успеха этот метод возвращает код отклика `200 OK` и объект [user](../resources/intune_devices_user.md) в тексте отклика.
